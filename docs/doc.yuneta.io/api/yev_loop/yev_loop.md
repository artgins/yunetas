...
- [`yev_loop.c`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/yev_loop/src/yev_loop.c)
- [`yev_loop.h`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/yev_loop/src/yev_loop.h)
...
## [`yev_create_accept_event()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/yev_loop/src/yev_loop.c#L2642)
...
## [`yev_create_connect_event()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/yev_loop/src/yev_loop.c#L2261)
...
## [`yev_create_read_event()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/yev_loop/src/yev_loop.c#L3087)
...
## [`yev_create_timer_event()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/yev_loop/src/yev_loop.c#L2185)
...
## [`yev_create_write_event()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/yev_loop/src/yev_loop.c#L3128)
...
(yev_destroy_event)=
## [`yev_destroy_event()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/yev_loop/src/yev_loop.c#L2048)
...
(yev_event_type_name)=
## [`yev_event_type_name()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/yev_loop/src/yev_loop.c#L3299)
...
(yev_flag_strings)=
## [`yev_flag_strings()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/yev_loop/src/yev_loop.c#L3325)
...
(yev_get_state_name)=
## [`yev_get_state_name()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/yev_loop/src/yev_loop.c#L1200)
...
(yev_get_yuno)=
## [`yev_get_yuno()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/yev_loop/src/yev_loop.c#L1250)
...
(yev_loop_create)=
## [`yev_loop_create()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/yev_loop/src/yev_loop.c#L126)
...
(yev_loop_destroy)=
## [`yev_loop_destroy()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/yev_loop/src/yev_loop.c#L293)
...
## [`yev_loop_reset_running()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/yev_loop/src/yev_loop.c#L1087)
...
(yev_loop_run)=
## [`yev_loop_run()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/yev_loop/src/yev_loop.c#L793)
...
(yev_loop_run_once)=
## [`yev_loop_run_once()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/yev_loop/src/yev_loop.c#L970)
...
(yev_loop_stop)=
## [`yev_loop_stop()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/yev_loop/src/yev_loop.c#L1058)
...
## [`yev_protocol_set_protocol_fill_hints_fn()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/yev_loop/src/yev_loop.c#L1095)
...
(yev_set_gbuffer)=
## [`yev_set_gbuffer()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/yev_loop/src/yev_loop.c#L1222)
...
(yev_start_event)=
## [`yev_start_event()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/yev_loop/src/yev_loop.c#L1258)
...
## [`yev_start_timer_event()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/yev_loop/src/yev_loop.c#L1743)
...
(yev_stop_event)=
## [`yev_stop_event()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/yev_loop/src/yev_loop.c#L1901)
...
## [`yev_create_poll_event()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/yev_loop/src/yev_loop.c#L3045)
...
## [`yev_create_recvmsg_event()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/yev_loop/src/yev_loop.c#L3169)
...
## [`yev_create_sendmsg_event()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/yev_loop/src/yev_loop.c#L3218)
...
## [`yev_dup2_accept_event()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/yev_loop/src/yev_loop.c#L2991)
...
## [`yev_dup_accept_event()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/yev_loop/src/yev_loop.c#L2934)
...
## [`yev_rearm_connect_event()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/yev_loop/src/yev_loop.c#L2314)
...
(set_measure_times)=
## [`set_measure_times()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/gobj-c/src/testing.c#L299)
...
(get_measure_times)=
## [`get_measure_times()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/gobj-c/src/testing.c#L316)
