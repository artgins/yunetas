...
(yuno_event_loop)=
## [`yuno_event_loop()`](https://github.com/artgins/yunetas/blob/7.5.5/kernel/c/root-linux/src/c_yuno.c#L5605)
...
(yuno_event_detroy)=
## [`yuno_event_detroy()`](https://github.com/artgins/yunetas/blob/7.5.5/kernel/c/root-linux/src/c_yuno.c#L5613)
...
(set_yuno_must_die)=
## [`set_yuno_must_die()`](https://github.com/artgins/yunetas/blob/7.5.5/kernel/c/root-linux/src/c_yuno.c#L5624)
...
(is_ip_allowed)=
## [`is_ip_allowed()`](https://github.com/artgins/yunetas/blob/7.5.5/kernel/c/root-linux/src/c_yuno.c#L5643)
...
(add_allowed_ip)=
## [`add_allowed_ip()`](https://github.com/artgins/yunetas/blob/7.5.5/kernel/c/root-linux/src/c_yuno.c#L5658)
...
(remove_allowed_ip)=
## [`remove_allowed_ip()`](https://github.com/artgins/yunetas/blob/7.5.5/kernel/c/root-linux/src/c_yuno.c#L5674)
...
(is_ip_denied)=
## [`is_ip_denied()`](https://github.com/artgins/yunetas/blob/7.5.5/kernel/c/root-linux/src/c_yuno.c#L5686)
...
(add_denied_ip)=
## [`add_denied_ip()`](https://github.com/artgins/yunetas/blob/7.5.5/kernel/c/root-linux/src/c_yuno.c#L5701)
...
(remove_denied_ip)=
## [`remove_denied_ip()`](https://github.com/artgins/yunetas/blob/7.5.5/kernel/c/root-linux/src/c_yuno.c#L5717)
