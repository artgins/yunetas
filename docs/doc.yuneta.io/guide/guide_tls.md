...
The ytls module uses a **backend-agnostic** design. The public API ([`ytls.h`](https://github.com/artgins/yunetas/blob/7.9.9/kernel/c/ytls/src/ytls.h) / [`ytls.c`](https://github.com/artgins/yunetas/blob/7.9.9/kernel/c/ytls/src/ytls.c)) exposes a single `api_tls_t` dispatch table, while the actual crypto is provided by two interchangeable backends configured via Kconfig (one or both can be enabled):
...
[`ytls.h`](https://github.com/artgins/yunetas/blob/7.9.9/kernel/c/ytls/src/ytls.h) is the **single source of truth** for the backend names:
...
| File | Purpose |
|------|---------|
| [`ytls.h`](https://github.com/artgins/yunetas/blob/7.9.9/kernel/c/ytls/src/ytls.h) / [`ytls.c`](https://github.com/artgins/yunetas/blob/7.9.9/kernel/c/ytls/src/ytls.c) | Public API and dispatch table |
| [`tls/openssl.c`](https://github.com/artgins/yunetas/blob/7.9.9/kernel/c/ytls/src/tls/openssl.c) / [`openssl.h`](https://github.com/artgins/yunetas/blob/7.9.9/kernel/c/ytls/src/tls/openssl.h) | OpenSSL backend implementation |
| [`tls/mbedtls.c`](https://github.com/artgins/yunetas/blob/7.9.9/kernel/c/ytls/src/tls/mbedtls.c) / [`mbedtls.h`](https://github.com/artgins/yunetas/blob/7.9.9/kernel/c/ytls/src/tls/mbedtls.h) | mbed-TLS backend implementation |
...
Regression coverage:
[`test_tls_floor_openssl.c`](https://github.com/artgins/yunetas/blob/7.9.9/tests/c/ytls/test_tls_floor_openssl.c)
asserts that an explicit sub-TLS1.2 floor is logged and that a real TLS1.0
ClientHello is rejected by the default floor.
[`test_tls_verify_openssl.c`](https://github.com/artgins/yunetas/blob/7.9.9/tests/c/ytls/test_tls_verify_openssl.c)
