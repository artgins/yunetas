...
(gobj_change_state)=
## [`gobj_change_state()`](https://github.com/artgins/yunetas/blob/7.9.4/kernel/c/gobj-c/src/gobj.c#L7739)
...
(gobj_current_state)=
## [`gobj_current_state()`](https://github.com/artgins/yunetas/blob/7.9.4/kernel/c/gobj-c/src/gobj.c#L7826)
...
(gobj_event_type)=
## [`gobj_event_type()`](https://github.com/artgins/yunetas/blob/7.9.4/kernel/c/gobj-c/src/gobj.c#L7908)
...
## [`gobj_event_type_by_name()`](https://github.com/artgins/yunetas/blob/7.9.4/kernel/c/gobj-c/src/gobj.c#L7960)
...
(gobj_has_event)=
## [`gobj_has_event()`](https://github.com/artgins/yunetas/blob/7.9.4/kernel/c/gobj-c/src/gobj.c#L7871)
...
## [`gobj_has_output_event()`](https://github.com/artgins/yunetas/blob/7.9.4/kernel/c/gobj-c/src/gobj.c#L7887)
...
(gobj_has_state)=
## [`gobj_has_state()`](https://github.com/artgins/yunetas/blob/7.9.4/kernel/c/gobj-c/src/gobj.c#L7857)
...
(gobj_in_this_state)=
## [`gobj_in_this_state()`](https://github.com/artgins/yunetas/blob/7.9.4/kernel/c/gobj-c/src/gobj.c#L7845)
...
(gobj_send_event)=
## [`gobj_send_event()`](https://github.com/artgins/yunetas/blob/7.9.4/kernel/c/gobj-c/src/gobj.c#L7455)
...
## [`gobj_send_event_to_children()`](https://github.com/artgins/yunetas/blob/7.9.4/kernel/c/gobj-c/src/gobj.c#L7687)
...
## [`gobj_send_event_to_children_tree()`](https://github.com/artgins/yunetas/blob/7.9.4/kernel/c/gobj-c/src/gobj.c#L7713)
