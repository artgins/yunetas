...
- [`c_authz.h`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/root-linux/src/c_authz.h)

(gobj_authenticate)=
## [`gobj_authenticate()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/gobj.c#L9270)
...
(gobj_authz)=
## [`gobj_authz()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/gobj.c#L9378)
...
(gobj_authzs)=
## [`gobj_authzs()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/gobj.c#L9368)
...
## [`gobj_get_global_authz_table()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/gobj.c#L9457)
...
(gobj_user_has_authz)=
## [`gobj_user_has_authz()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/gobj.c#L9400)
...
## [`authz_get_level_desc()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/gobj.c#L9465)
...
## [`gobj_build_authzs_doc()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/gobj.c#L9508)
...
(authzs_list)=
## [`authzs_list()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/gobj.c#L9324)
...
(authz_checker)=
## [`authz_checker()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/root-linux/src/c_authz.c#L4725)
...
## [`authentication_parser()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/root-linux/src/c_authz.c#L4813)
