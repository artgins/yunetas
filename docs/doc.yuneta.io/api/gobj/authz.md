...
- [`c_authz.h`](https://github.com/artgins/yunetas/blob/7.5.5/kernel/c/root-linux/src/c_authz.h)

(gobj_authenticate)=
## [`gobj_authenticate()`](https://github.com/artgins/yunetas/blob/7.5.5/kernel/c/gobj-c/src/gobj.c#L9270)
...
(gobj_authz)=
## [`gobj_authz()`](https://github.com/artgins/yunetas/blob/7.5.5/kernel/c/gobj-c/src/gobj.c#L9404)
...
(gobj_authzs)=
## [`gobj_authzs()`](https://github.com/artgins/yunetas/blob/7.5.5/kernel/c/gobj-c/src/gobj.c#L9394)
...
## [`gobj_get_global_authz_table()`](https://github.com/artgins/yunetas/blob/7.5.5/kernel/c/gobj-c/src/gobj.c#L9483)
...
(gobj_user_has_authz)=
## [`gobj_user_has_authz()`](https://github.com/artgins/yunetas/blob/7.5.5/kernel/c/gobj-c/src/gobj.c#L9426)
...
## [`authz_get_level_desc()`](https://github.com/artgins/yunetas/blob/7.5.5/kernel/c/gobj-c/src/gobj.c#L9491)
...
## [`gobj_build_authzs_doc()`](https://github.com/artgins/yunetas/blob/7.5.5/kernel/c/gobj-c/src/gobj.c#L9534)
...
(authzs_list)=
## [`authzs_list()`](https://github.com/artgins/yunetas/blob/7.5.5/kernel/c/gobj-c/src/gobj.c#L9324)
...
(authz_checker)=
## [`authz_checker()`](https://github.com/artgins/yunetas/blob/7.5.5/kernel/c/root-linux/src/c_authz.c#L4725)
...
## [`authentication_parser()`](https://github.com/artgins/yunetas/blob/7.5.5/kernel/c/root-linux/src/c_authz.c#L4813)
