...
(gobj_end)=
## [`gobj_end()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/gobj.c#L613)
...
(gobj_get_exit_code)=
## [`gobj_get_exit_code()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/gobj.c#L605)
...
(gobj_is_shutdowning)=
## [`gobj_is_shutdowning()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/gobj.c#L589)
...
(gobj_set_exit_code)=
## [`gobj_set_exit_code()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/gobj.c#L597)
...
(gobj_start_up)=
## [`gobj_start_up()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/gobj.c#L499)
...
(gobj_set_shutdown)=
## [`gobj_set_shutdown()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/gobj.c#L578)
