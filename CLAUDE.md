...
- **`main` branch** (the v2 line, tag `2.0.0`+, npm `7.25.18`) — **active
...
versioned to track `YUNETA_VERSION` (SDK `7.25.4`, package **`7.25.4`** on npm since 2026-09-24)
...
ahead: `yunos/js/*` are on `^7.25.4`, wattyzer's gui on `^7.22.2` (2026-09-24). Check
...
| File | Purpose |
|------|---------|
| `YUNETA_VERSION` | Current version (7.25.4) — used to generate `yuneta_version.h` |
