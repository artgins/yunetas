...
- **Auth + TLS** → [`YUNO_AUTH.md`](YUNO_AUTH.md) covers the `auth_bff` OIDC flow
  ...
  `gobj_user_has_authz` check at [`command_parser.c`](https://github.com/artgins/yunetas/blob/7.5.1/kernel/c/gobj-c/src/command_parser.c) is currently
