...
(gobj_stats)=
## [`gobj_stats()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L4932)
...
(gobj_decr_stat)=
## [`gobj_decr_stat()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L9643)
...
(gobj_get_stat)=
## [`gobj_get_stat()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L9659)
...
(gobj_incr_stat)=
## [`gobj_incr_stat()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L9626)
...
(gobj_jn_stats)=
## [`gobj_jn_stats()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L9670)
...
(gobj_set_stat)=
## [`gobj_set_stat()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L9611)
