...
4. **Database-Like Utilities**:
    - Provides record-based operations such as [`kwid_find_record_in_list`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/gobj-c/src/kwid.c#L937), [`kwid_compare_records`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/gobj-c/src/kwid.c#L1671), and [`kwjr_get`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/gobj-c/src/kwid.c#L3327).
