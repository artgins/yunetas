...
(current_timestamp)=
## [`current_timestamp()`](https://github.com/artgins/yunetas/blob/7.16.2/kernel/c/gobj-c/src/helpers.c#L5301)
...
(date_mode_from_type)=
## [`date_mode_from_type()`](https://github.com/artgins/yunetas/blob/7.16.2/kernel/c/gobj-c/src/helpers.c#L3682)
...
(date_overflows)=
## [`date_overflows()`](https://github.com/artgins/yunetas/blob/7.16.2/kernel/c/gobj-c/src/helpers.c#L4849)
...
(datestamp)=
## [`datestamp()`](https://github.com/artgins/yunetas/blob/7.16.2/kernel/c/gobj-c/src/helpers.c#L4401)
...
(formatdate)=
## [`formatdate()`](https://github.com/artgins/yunetas/blob/7.16.2/kernel/c/gobj-c/src/helpers.c#L5660)
...
(htonll)=
## [`htonll()`](https://github.com/artgins/yunetas/blob/7.16.2/kernel/c/gobj-c/src/helpers.c#L5512)
...
(list_open_files)=
## [`list_open_files()`](https://github.com/artgins/yunetas/blob/7.16.2/kernel/c/gobj-c/src/helpers.c#L5542)
...
(ntohll)=
## [`ntohll()`](https://github.com/artgins/yunetas/blob/7.16.2/kernel/c/gobj-c/src/helpers.c#L5527)
...
(parse_date)=
## [`parse_date()`](https://github.com/artgins/yunetas/blob/7.16.2/kernel/c/gobj-c/src/helpers.c#L4333)
...
(parse_date_basic)=
## [`parse_date_basic()`](https://github.com/artgins/yunetas/blob/7.16.2/kernel/c/gobj-c/src/helpers.c#L4239)
...
(parse_date_format)=
## [`parse_date_format()`](https://github.com/artgins/yunetas/blob/7.16.2/kernel/c/gobj-c/src/helpers.c#L4371)
...
(parse_expiry_date)=
## [`parse_expiry_date()`](https://github.com/artgins/yunetas/blob/7.16.2/kernel/c/gobj-c/src/helpers.c#L4311)
...
(show_date)=
## [`show_date()`](https://github.com/artgins/yunetas/blob/7.16.2/kernel/c/gobj-c/src/helpers.c#L3691)
...
(show_date_relative)=
## [`show_date_relative()`](https://github.com/artgins/yunetas/blob/7.16.2/kernel/c/gobj-c/src/helpers.c#L3605)
...
(start_msectimer)=
## [`start_msectimer()`](https://github.com/artgins/yunetas/blob/7.16.2/kernel/c/gobj-c/src/helpers.c#L5375)
...
(start_sectimer)=
## [`start_sectimer()`](https://github.com/artgins/yunetas/blob/7.16.2/kernel/c/gobj-c/src/helpers.c#L5346)
...
(t2timestamp)=
## [`t2timestamp()`](https://github.com/artgins/yunetas/blob/7.16.2/kernel/c/gobj-c/src/helpers.c#L5327)
...
(test_msectimer)=
## [`test_msectimer()`](https://github.com/artgins/yunetas/blob/7.16.2/kernel/c/gobj-c/src/helpers.c#L5385)
...
(test_sectimer)=
## [`test_sectimer()`](https://github.com/artgins/yunetas/blob/7.16.2/kernel/c/gobj-c/src/helpers.c#L5358)
...
(time_in_seconds)=
## [`time_in_seconds()`](https://github.com/artgins/yunetas/blob/7.16.2/kernel/c/gobj-c/src/helpers.c#L5425)
...
(tm2timestamp)=
## [`tm2timestamp()`](https://github.com/artgins/yunetas/blob/7.16.2/kernel/c/gobj-c/src/helpers.c#L5318)
...
(tm_to_time_t)=
## [`tm_to_time_t()`](https://github.com/artgins/yunetas/blob/7.16.2/kernel/c/gobj-c/src/helpers.c#L3481)
...
(get_days_range)=
## [`get_days_range()`](https://github.com/artgins/yunetas/blob/7.16.2/kernel/c/gobj-c/src/helpers.c#L7718)
...
(get_hours_range)=
## [`get_hours_range()`](https://github.com/artgins/yunetas/blob/7.16.2/kernel/c/gobj-c/src/helpers.c#L7686)
...
(get_months_range)=
## [`get_months_range()`](https://github.com/artgins/yunetas/blob/7.16.2/kernel/c/gobj-c/src/helpers.c#L7794)
...
(get_weeks_range)=
## [`get_weeks_range()`](https://github.com/artgins/yunetas/blob/7.16.2/kernel/c/gobj-c/src/helpers.c#L7749)
...
(get_years_range)=
## [`get_years_range()`](https://github.com/artgins/yunetas/blob/7.16.2/kernel/c/gobj-c/src/helpers.c#L7825)
...
(gmtime2timezone)=
## [`gmtime2timezone()`](https://github.com/artgins/yunetas/blob/7.16.2/kernel/c/gobj-c/src/helpers.c#L5604)
...
## [`time_in_milliseconds()`](https://github.com/artgins/yunetas/blob/7.16.2/kernel/c/gobj-c/src/helpers.c#L5412)
...
## [`time_in_milliseconds_monotonic()`](https://github.com/artgins/yunetas/blob/7.16.2/kernel/c/gobj-c/src/helpers.c#L5400)
