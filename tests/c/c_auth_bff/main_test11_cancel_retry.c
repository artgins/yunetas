/****************************************************************************
 *          MAIN_TEST11_CANCEL_RETRY.C
 *
 *          Self-contained auth_bff test: cancel-then-retry.
 *
 *          Same topology as main_test9_browser_cancel (persistent
 *          channels + mock KC latency_ms=500), different driver.
 *
 ...
 *                      Names
 ***************************************************************************/
#define APP_NAME        "test_auth_bff_test11_cancel_retry"
#define APP_DOC         "Self-contained auth_bff test: cancel first login, retry second"
...
{                                                                   \n\
    ...
    'services': [                                                   \n\
        {                                                           \n\
            'name': 'c_test11_cancel_retry',                        \n\
            'gclass': 'C_TEST11_CANCEL_RETRY',                      \n\
...
static int register_yuno_and_more(void)
{
    ...
    res += register_c_test11_cancel_retry();
