...
(js_createElement2)=
## [`createElement2()`](https://github.com/artgins/gobj-js/blob/7.25.6/src/helpers.js#L3362)
...
(js_createOneHtml)=
### [`createOneHtml(htmlString)`](https://github.com/artgins/gobj-js/blob/7.25.6/src/helpers.js#L3173)

Builds one element from a string of HTML.

(js_parseSVG)=
### [`parseSVG(string)`](https://github.com/artgins/gobj-js/blob/7.25.6/src/helpers.js#L3498)

Builds an SVG element from a string of SVG code.

(js_getPositionRelativeToBody)=
### [`getPositionRelativeToBody(element)`](https://github.com/artgins/gobj-js/blob/7.25.6/src/helpers.js#L3470)
...
(js_escapeHtml)=
### [`escapeHtml(str)`](https://github.com/artgins/gobj-js/blob/7.25.6/src/helpers.js#L3140)
...
(js_safeSrc)=
### [`safeSrc(url)`](https://github.com/artgins/gobj-js/blob/7.25.6/src/helpers.js#L3158)
...
(js_refresh_language)=
## [`refresh_language()`](https://github.com/artgins/gobj-js/blob/7.25.6/src/helpers.js#L3506)
