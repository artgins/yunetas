...
(get_hostname)=
## [`get_hostname()`](https://github.com/artgins/yunetas/blob/7.15.0/kernel/c/gobj-c/src/helpers.c#L5702)
...
(node_uuid)=
## [`node_uuid()`](https://github.com/artgins/yunetas/blob/7.15.0/kernel/c/gobj-c/src/helpers.c#L5852)
...
(check_open_fds)=
## [`check_open_fds()`](https://github.com/artgins/yunetas/blob/7.15.0/kernel/c/gobj-c/src/helpers.c#L6972)
...
(cpu_usage)=
## [`cpu_usage()`](https://github.com/artgins/yunetas/blob/7.15.0/kernel/c/gobj-c/src/helpers.c#L5435)
...
(cpu_usage_percent)=
## [`cpu_usage_percent()`](https://github.com/artgins/yunetas/blob/7.15.0/kernel/c/gobj-c/src/helpers.c#L5471)
...
(create_random_uuid)=
## [`create_random_uuid()`](https://github.com/artgins/yunetas/blob/7.15.0/kernel/c/gobj-c/src/helpers.c#L5728)
...
(free_ram_in_kb)=
## [`free_ram_in_kb()`](https://github.com/artgins/yunetas/blob/7.15.0/kernel/c/gobj-c/src/helpers.c#L6526)
...
## [`get_name_from_nn_table()`](https://github.com/artgins/yunetas/blob/7.15.0/kernel/c/gobj-c/src/helpers.c#L7665)
...
## [`get_number_from_nn_table()`](https://github.com/artgins/yunetas/blob/7.15.0/kernel/c/gobj-c/src/helpers.c#L7644)
...
(get_yunetas_base)=
## [`get_yunetas_base()`](https://github.com/artgins/yunetas/blob/7.15.0/kernel/c/gobj-c/src/helpers.c#L7506)
...
(is_yuneta_user)=
## [`is_yuneta_user()`](https://github.com/artgins/yunetas/blob/7.15.0/kernel/c/gobj-c/src/helpers.c#L7438)
...
(print_open_fds)=
## [`print_open_fds()`](https://github.com/artgins/yunetas/blob/7.15.0/kernel/c/gobj-c/src/helpers.c#L7008)
...
## [`source2base64_for_yunetas()`](https://github.com/artgins/yunetas/blob/7.15.0/kernel/c/gobj-c/src/helpers.c#L7539)
...
(total_ram_in_kb)=
## [`total_ram_in_kb()`](https://github.com/artgins/yunetas/blob/7.15.0/kernel/c/gobj-c/src/helpers.c#L6573)
...
(yuneta_getgrnam)=
## [`yuneta_getgrnam()`](https://github.com/artgins/yunetas/blob/7.15.0/kernel/c/gobj-c/src/helpers.c#L7412)
...
(yuneta_getgrouplist)=
## [`yuneta_getgrouplist()`](https://github.com/artgins/yunetas/blob/7.15.0/kernel/c/gobj-c/src/helpers.c#L7421)
...
(yuneta_getpwnam)=
## [`yuneta_getpwnam()`](https://github.com/artgins/yunetas/blob/7.15.0/kernel/c/gobj-c/src/helpers.c#L7403)
...
(yuneta_getpwuid)=
## [`yuneta_getpwuid()`](https://github.com/artgins/yunetas/blob/7.15.0/kernel/c/gobj-c/src/helpers.c#L7394)
