...
(gobj_change_state)=
## [`gobj_change_state()`](https://github.com/artgins/yunetas/blob/7.9.11/kernel/c/gobj-c/src/gobj.c#L7745)
...
(gobj_current_state)=
## [`gobj_current_state()`](https://github.com/artgins/yunetas/blob/7.9.11/kernel/c/gobj-c/src/gobj.c#L7832)
...
(gobj_event_type)=
## [`gobj_event_type()`](https://github.com/artgins/yunetas/blob/7.9.11/kernel/c/gobj-c/src/gobj.c#L7914)
...
## [`gobj_event_type_by_name()`](https://github.com/artgins/yunetas/blob/7.9.11/kernel/c/gobj-c/src/gobj.c#L7966)
...
(gobj_has_event)=
## [`gobj_has_event()`](https://github.com/artgins/yunetas/blob/7.9.11/kernel/c/gobj-c/src/gobj.c#L7877)
...
## [`gobj_has_output_event()`](https://github.com/artgins/yunetas/blob/7.9.11/kernel/c/gobj-c/src/gobj.c#L7893)
...
(gobj_has_state)=
## [`gobj_has_state()`](https://github.com/artgins/yunetas/blob/7.9.11/kernel/c/gobj-c/src/gobj.c#L7863)
...
(gobj_in_this_state)=
## [`gobj_in_this_state()`](https://github.com/artgins/yunetas/blob/7.9.11/kernel/c/gobj-c/src/gobj.c#L7851)
...
(gobj_send_event)=
## [`gobj_send_event()`](https://github.com/artgins/yunetas/blob/7.9.11/kernel/c/gobj-c/src/gobj.c#L7461)
...
## [`gobj_find_event_type()`](https://github.com/artgins/yunetas/blob/7.9.11/kernel/c/gobj-c/src/gobj.c#L993)
...
## [`gobj_send_event_to_children()`](https://github.com/artgins/yunetas/blob/7.9.11/kernel/c/gobj-c/src/gobj.c#L7693)
...
## [`gobj_send_event_to_children_tree()`](https://github.com/artgins/yunetas/blob/7.9.11/kernel/c/gobj-c/src/gobj.c#L7719)
