...
(gobj_bottom_gobj)=
## [`gobj_bottom_gobj()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L5139)
...
(gobj_change_parent)=
## [`gobj_change_parent()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/js/gobj-js/src/gobj.js#L3680)
...
(gobj_child_by_index)=
## [`gobj_child_by_index()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L5401)
...
(gobj_child_by_name)=
## [`gobj_child_by_name()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L5360)
...
(gobj_child_size)=
## [`gobj_child_size()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L5434)
...
(gobj_child_size2)=
## [`gobj_child_size2()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L5444)
...
(gobj_command)=
## [`gobj_command()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L4902)
...
## [`gobj_default_service()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L5151)
...
(gobj_disable)=
## [`gobj_disable()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L4837)
...
(gobj_enable)=
## [`gobj_enable()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L4869)
...
(gobj_find_child)=
## [`gobj_find_child()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L5560)
...
(gobj_find_gobj)=
## [`gobj_find_gobj()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L5264)
...
## [`gobj_find_service_by_gclass()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L5209)
...
(gobj_first_child)=
## [`gobj_first_child()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L5285)
...
(gobj_free_iter)=
## [`gobj_free_iter()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L5686)
...
## [`gobj_last_bottom_gobj()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L5124)
...
(gobj_last_child)=
## [`gobj_last_child()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L5304)
...
(gobj_local_method)=
## [`gobj_local_method()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L4340)
...
(gobj_match_children)=
## [`gobj_match_children()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L5617)
...
## [`gobj_match_children_tree()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L5654)
...
(gobj_match_gobj)=
## [`gobj_match_gobj()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L5466)
...
(gobj_next_child)=
## [`gobj_next_child()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L5323)
...
(gobj_pause)=
## [`gobj_pause()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L4771)
...
(gobj_play)=
## [`gobj_play()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L4684)
...
(gobj_prev_child)=
## [`gobj_prev_child()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L5341)
...
(gobj_search_path)=
## [`gobj_search_path()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L5722)
...
(gobj_services)=
## [`gobj_services()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L1428)
...
## [`gobj_set_bottom_gobj()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L5064)
...
(gobj_start)=
## [`gobj_start()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L4394)
...
(gobj_start_children)=
## [`gobj_start_children()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L4477)
...
(gobj_start_tree)=
## [`gobj_start_tree()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L4512)
...
(gobj_stop)=
## [`gobj_stop()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L4547)
...
(gobj_stop_children)=
## [`gobj_stop_children()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L4621)
...
(gobj_stop_tree)=
## [`gobj_stop_tree()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L4648)
...
## [`gobj_walk_gobj_children()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L5786)
...
## [`gobj_walk_gobj_children_tree()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L5813)
