...
(js_kw_flag_t)=
## [`kw_flag_t`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L15)
...
(js_kw_has_key)=
### [`kw_has_key(kw, key)`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L1006)

Tells if `kw` has the key as its own property. It takes a key, not a path, and
it takes no `gobj`. Returns a boolean.

(js_kw_find_path)=
### [`kw_find_path(gobj, kw, path, verbose)`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L1019)
...
(js_kw_delete)=
### [`kw_delete(gobj, kw, path)`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L1066)

Deletes the key at a back-tick path. Returns `0`.

(js_kw_pop)=
### [`kw_pop(kw1, kw2)`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L985)
...
### [`kw_set_dict_value(gobj, kw, path, value)`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L1402)

Writes a value at a back-tick path, and creates the intermediate objects that
the path needs.

(js_kw_set_subdict_value)=
### [`kw_set_subdict_value(gobj, kw, path, key, value)`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L1440)
...
(js_kw_get_bool)=
### [`kw_get_bool()`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L1085)

Reads a boolean.

(js_kw_get_int)=
### [`kw_get_int()`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L1117)

Reads an integer.

(js_kw_get_real)=
### [`kw_get_real()`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L1160)

Reads a real number.

(js_kw_get_str)=
### [`kw_get_str()`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L1203)

Reads a string. The function puts the result through `String()`, so the return
value is always a string.

(js_kw_get_dict)=
### [`kw_get_dict()`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L1281)

Reads an object.

(js_kw_get_dict_value)=
### [`kw_get_dict_value()`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L1324)

Reads a value of any type from an object.

(js_kw_get_list)=
### [`kw_get_list()`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L1359)

Reads an array.

(js_kw_get_pointer)=
### [`kw_get_pointer()`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L1246)
...
(js_kw_match_simple)=
### [`kw_match_simple(kw, jn_filter)`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L1556)

Tells if `kw` matches a filter. It compares strings and numbers only. An empty
filter matches everything. It takes no `gobj`.

(js_kw_select)=
### [`kw_select(gobj, kw, jn_filter, match_fn)`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L1605)
...
(js_kw_collect)=
### [`kw_collect(gobj, kw, jn_filter, match_fn)`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L1642)
...
### [`kw_find_json_in_list(gobj, kw_list, item, flag)`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L1573)

Gives the index of a simple JSON item in a list. Returns `-1` when the list does
not hold it.

(js_kw_clone_by_keys)=
### [`kw_clone_by_keys(gobj, kw, keys, verbose)`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L1684)
...
### [`kw_clone_by_not_keys(gobj, kw, keys, verbose)`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L1736)
...
### [`kw_get_local_storage_value(key, default_value, create)`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L1787)
...
### [`kw_set_local_storage_value(key, value)`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L1820)
...
### [`kw_remove_local_storage_value(key)`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L1843)
...
(js_kwid_match_id)=
### [`kwid_match_id(ids, id)`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L1864)

Tells if `id` is in the collection `ids`. An empty `ids` matches every
identifier, because no filter lets everything through.

(js_kwid_collect)=
### [`kwid_collect(gobj, kw, ids, jn_filter, match_fn)`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L1922)
...
### [`kwid_find_one_record(gobj, kw, ids, jn_filter, match_fn)`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L2078)

Gives the first record that matches. It takes the parameters of
[`kwid_collect()`](#js_kwid_collect).

(js_kwid_new_dict)=
### [`kwid_new_dict(gobj, kw, path)`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L1989)
...
(js_kwid_new_list)=
### [`kwid_new_list(gobj, kw, path)`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L2041)
...
(js_kwid_get_ids)=
### [`kwid_get_ids(gobj, ids)`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L2122)
...
### [`msg_iev_write_key(kw, key, value)`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L2353)

Writes a key in the metadata of the message, and creates the metadata object
when it does not exist. It takes no `gobj`.

(js_msg_iev_read_key)=
### [`msg_iev_read_key(kw, key)`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L2337)

Reads a key of the metadata. Returns `undefined` when the message has no
metadata. It takes no `gobj`.

(js_msg_iev_push_stack)=
### [`msg_iev_push_stack(gobj, kw, stack, jn_data)`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L2366)
...
### [`msg_iev_get_stack(gobj, kw, stack, verbose)`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L2394)

Reads the top of a stack with a name. It does not take the element out.

(js_msg_iev_set_msg_type)=
### [`msg_iev_set_msg_type(gobj, kw, msg_type)`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L2443)

Writes the type of the message. An empty string deletes the key. Returns `0`.

(js_msg_iev_get_msg_type)=
### [`msg_iev_get_msg_type(gobj, kw)`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L2460)
...
(js_is_metadata_key)=
### [`is_metadata_key(key)`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L944)

Tells if a key is a metadata key. A metadata key begins with two underscores.

(js_is_private_key)=
### [`is_private_key(key)`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L964)
