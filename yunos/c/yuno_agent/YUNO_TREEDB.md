...
Path-building lives in [`kernel/c/timeranger2/src/timeranger2.c`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/timeranger2.c).
...
order. The struct ([`timeranger2.c`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/timeranger2.c), in-memory shape
`md2_record_ex_t` at [`timeranger2.h`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/timeranger2.h)):
...
at [`timeranger2.c`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/timeranger2.c) extract and pack them. Lookup by rowid is
...
[`tranger2_append_record`](#tranger2_append_record) ([`timeranger2.c:2332`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/timeranger2.c#L2332)) computes both and
returns them in `md_record_ex->rowid` ([`timeranger2.c`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/timeranger2.c)). **Callers
never set them.** For topics with `sf_rowid_key`, timeranger2 also
asserts `g_rowid == i_rowid` ([`timeranger2.c`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/timeranger2.c)) — a mismatch is
...
([`timeranger2.h`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/timeranger2.h)):
...
`system_flag` bits ([`timeranger2.h`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/timeranger2.h)):
...
Persisted in `topic_desc.json` at create time ([`timeranger2.c`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/timeranger2.c))
and loaded on open.

### 2.6 Public API in 12 calls

[`timeranger2.h`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/timeranger2.h). Grouped by purpose:
...
[`tranger2_startup`](#tranger2_startup) ([`timeranger2.c:330`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/timeranger2.c#L330)) attempts an **exclusive
...
- **Whole record** (= a primary key + every instance under it).
  **[`tranger2_delete_key()`](#tranger2_delete_key)** (renamed from `tranger2_delete_record`
  on 2026-05-25. A `#define` in [`timeranger2.h`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/timeranger2.h) keeps the legacy alias).
...
- **One instance** (one row in the `.md2` file).
  **`tranger2_delete_instance(tranger, topic, key, __t__, rowid,
  ...
  [`publish_new_rt_disk_records`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/timeranger2.c#L5294)) skip dead rows. Master-only,
...
- **Across-process** (`rt_by_disk` followers): the master
  ...
  `key_deleted_callback`. [`fire_key_deleted_locally()`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/timeranger2.c#L2884) is split by
...
([`timeranger2.c`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/timeranger2.c)). Durability is whatever the OS gives you —
...
Column types live in the JSON spec, parsed by [`tr_treedb.c`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/tr_treedb.c). Common
ones: `string`, `integer`, `boolean`, `real`, `array`, `object`,
`blob`, `enum`, `wild`. Plus semantic decorations: `email`, `url`,
`password`, `time`.

Flags (parsed by [`kw_has_word`](#kw_has_word) throughout [`tr_treedb.c`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/tr_treedb.c)):
...
Every loaded node carries a metadata sidecar ([`tr_treedb.c`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/tr_treedb.c),
attached at [`tr_treedb.c`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/tr_treedb.c)):
...
What happens: [`treedb_open_db()`](#treedb_open_db) ([`tr_treedb.c:485`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/tr_treedb.c#L485)) reads the
...
Low-level ([`tr_treedb.h`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/tr_treedb.h)):
...
gobj-level wrappers ([`gobj.h`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/gobj-c/src/gobj.h)):
...
CLAUDE.md hard rule, reproduced verbatim from [`tr_treedb.c`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/tr_treedb.c):
...
stores *non-master* via this pattern. **[`cmd_command_yuno`](https://github.com/artgins/yunetas/blob/7.9.13/yunos/c/yuno_agent/src/c_agent.c#L6213) does not
work** for B+ yunos, because they do not publish their service through
`__top_side__`. The store path is the correct one.

Code: `tranger2_open_rt_disk` at [`timeranger2.h`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/timeranger2.h). The
...
[`tr_treedb.h`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/tr_treedb.h):
...
([`gobj_list_snaps`](#gobj_list_snaps), [`c_agent.c`](https://github.com/artgins/yunetas/blob/7.9.13/yunos/c/yuno_agent/src/c_agent.c)). If that fails, it does a
...
[`DESIGN-immutable-topics-records.md`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/DESIGN-immutable-topics-records.md).
...
[`tests/c/tr_treedb_immutable`](https://github.com/artgins/yunetas/tree/7.9.13/tests/c/tr_treedb_immutable).
...
| What                                              | Where                                                                 |
|---------------------------------------------------|-----------------------------------------------------------------------|
| timeranger2 public API                            | [`kernel/c/timeranger2/src/timeranger2.h`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/timeranger2.h) (747 lines)                  |
| timeranger2 runtime                               | [`kernel/c/timeranger2/src/timeranger2.c`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/timeranger2.c) (~7.8k lines)                |
| `md2_record_t` (32-byte index)                    | [`timeranger2.c`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/timeranger2.c)                                                 |
| `md2_record_ex_t` (in-memory)                     | [`timeranger2.h`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/timeranger2.h)                                               |
| `system_flag2_t` (sf_string_key, sf_int_key, …)   | [`timeranger2.h`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/timeranger2.h)                                               |
| Master / non-master lock                          | [`timeranger2.c`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/timeranger2.c)                                               |
| `tranger2_append_record`                          | [`timeranger2.c`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/timeranger2.c) (g_rowid set at 2667, i_rowid at 2634)      |
| `tranger2_open_rt_disk` (cross-yuno reads)        | [`timeranger2.h`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/timeranger2.h)                                               |
| TRACE_FS sites                                    | [`timeranger2.c`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/timeranger2.c) (multiple)                   |
| treedb public API                                 | [`kernel/c/timeranger2/src/tr_treedb.h`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/tr_treedb.h) (617 lines)                    |
| treedb runtime                                    | [`kernel/c/timeranger2/src/tr_treedb.c`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/tr_treedb.c) (~8.9k lines)                  |
| `__md_treedb__` builder                           | [`tr_treedb.c`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/tr_treedb.c)                                    |
| Topic schema loader (`topic_cols.json`)           | [`tr_treedb.c`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/tr_treedb.c)                                                 |
| `topic_version` matching                          | [`tr_treedb.c`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/tr_treedb.c)                                            |
| `treedb_link_nodes` / `treedb_unlink_nodes`       | [`tr_treedb.c`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/tr_treedb.c) (saves child only)                            |
| `treedb_create/update/delete/get/list_node[s]`    | [`tr_treedb.h`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/tr_treedb.h), [`tr_treedb.c`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/tr_treedb.c)                        |
| Snapshot API                                      | [`tr_treedb.h`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/timeranger2/src/tr_treedb.h)                                                 |
| gobj wrappers (`gobj_*node`)                      | [`gobj.h`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/gobj-c/src/gobj.h)                                                    |
| `gobj_list_snaps`                                 | [`gobj.h`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/gobj-c/src/gobj.h)                                                    |
| Canonical schemas                                 | [`yunos/c/yuno_agent/src/treedb_schema_yuneta_agent.c`](https://github.com/artgins/yunetas/blob/7.9.13/yunos/c/yuno_agent/src/treedb_schema_yuneta_agent.c), [`kernel/c/root-linux/src/treedb_schema_authzs.c`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/root-linux/src/treedb_schema_authzs.c) |
| Treedb gclass (gobj wrapper)                      | [`kernel/c/root-linux/src/c_treedb.c`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/root-linux/src/c_treedb.c), [`c_node.c`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/root-linux/src/c_node.c)                      |
