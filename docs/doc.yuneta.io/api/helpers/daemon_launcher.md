...
(launch_daemon)=
### [`launch_daemon()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L6602)
...
Declared in
[`ydaemon.h`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/root-linux/src/ydaemon.h).
...
(daemon_run)=
### [`daemon_run()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/root-linux/src/ydaemon.c#L291)
...
(daemon_shutdown)=
### [`daemon_shutdown()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/root-linux/src/ydaemon.c#L369)
...
(get_watcher_pid)=
### [`get_watcher_pid()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/root-linux/src/ydaemon.c#L486)
...
(get_relaunch_times)=
### [`get_relaunch_times()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/root-linux/src/ydaemon.c#L461)
...
(search_process)=
### [`search_process()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/root-linux/src/ydaemon.c#L450)
...
### [`daemon_set_debug_mode()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/root-linux/src/ydaemon.c#L469)
...
### [`daemon_get_debug_mode()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/root-linux/src/ydaemon.c#L478)
