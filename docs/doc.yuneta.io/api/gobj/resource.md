...
## [`gobj_create_resource()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L9957)
...
## [`gobj_delete_resource()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L10041)
...
(gobj_get_resource)=
## [`gobj_get_resource()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L10126)
...
(gobj_list_resource)=
## [`gobj_list_resource()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L10089)
...
(gobj_save_resource)=
## [`gobj_save_resource()`](https://github.com/artgins/yunetas/blob/7.16.5/kernel/c/gobj-c/src/gobj.c#L9995)
