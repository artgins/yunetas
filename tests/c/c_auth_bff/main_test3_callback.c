/****************************************************************************
 *          MAIN_TEST3_CALLBACK.C
 *
 *          Self-contained auth_bff test: /auth/callback PKCE happy path.
 *
 *          Differs from main_test1_login only in the BFF's
 *          `allowed_redirect_uri` attr (set to "http://localhost/" so
 *          the driver's redirect_uri "http://localhost/callback" passes
 *          the prefix check) and in the default service wiring.
 *
 ...
 *                      Names
 ***************************************************************************/
#define APP_NAME        "test_auth_bff_test3_callback"
#define APP_DOC         "Self-contained auth_bff /auth/callback PKCE happy path"
...
{                                                                   \n\
    ...
    'services': [                                                   \n\
        {                                                           \n\
            'name': 'c_test3_callback',                             \n\
            'gclass': 'C_TEST3_CALLBACK',                           \n\
                    ...
                    'children': [                                   \n\
                        {                                           \n\
                            ...
                            'kw': {                                 \n\
                                ...
                                'cookie_domain': '',                \n\
                                'allowed_origin': '',               \n\
                                'allowed_redirect_uri': 'http://localhost/', \n\
                                'crypto': {},                       \n\
