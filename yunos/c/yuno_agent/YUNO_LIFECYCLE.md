...
Defined in [`treedb_schema_yuneta_agent.c`](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/treedb_schema_yuneta_agent.c). Composite key:
...
**On-disk path**, built by [`yuneta_repos_yuno_dir()`](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c#L7494) ([c_agent.c:7313](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c#L7313)) and
[`yuneta_repos_yuno_file()`](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c#L7523) ([c_agent.c:7342](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c#L7342)):
...
inside [`run_yuno()`](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c#L8477):
it writes the config through
[`build_yuno_running_script()`](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c#L8084),
then exec's the binary with the materialised paths.

### 2.3 The `yunos` topic

Defined in [`treedb_schema_yuneta_agent.c`](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/treedb_schema_yuneta_agent.c). Per-yuno record. Important
columns:
...
[`cmd_create_yuno()`](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c#L4666)
...
Built by [`build_yuno_private_domain()`](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c#L7549) ([c_agent.c:7368](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c#L7368)):
...
Driven by [`run_yuno()`](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c#L8477):

1. Select yunos: `disabled=false ∧ running=false`.
2. Resolve the binary via [`get_yuno_binary()`](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c#L7689):
...
3. Materialise each `configurations.zcontent` blob to a JSON file under the
   yuno's `bin/` directory ([`build_yuno_running_script()`](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c#L8084)).
...
6. The yuno opens a channel back to the agent and emits **`EV_ON_OPEN`**
   ...
   [`ac_on_open()`](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c#L11026)).
...
[`kill_yuno()`](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c#L8591):
...
5. When the channel closes, [`ac_on_close()`](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c#L11316)
...
first-fork survivor in [`ydaemon.c`](https://github.com/artgins/yunetas/blob/7.9.0/kernel/c/root-linux/src/ydaemon.c)). When the yuno child dies abnormally
...
- At agent boot the timer `ac_timeout()` ([c_agent.c:11393](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c#L11393)) runs:
    1. [`run_util_yunos()`](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c#L9044) ([c_agent.c:9044](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c#L9044)) — yunos tagged `util`,
       ignoring `disabled`.
    2. [`run_enabled_yunos()`](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c#L8980) ([c_agent.c:8980](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c#L8980)) — every row with
...
|-------|-------|------------------|
| OS scheduling | yuno attr `sched_priority` + `cpu_core` ([`c_yuno.c`](https://github.com/artgins/yunetas/blob/7.9.0/kernel/c/root-linux/src/c_yuno.c), [`boost_process_performance`](https://github.com/artgins/yunetas/blob/7.9.0/kernel/c/root-linux/src/c_yuno.c#L4561)) | `sched_setscheduler` + CPU affinity of the process |
| Intra-yuno | each service's `priority` 0..9 ([`manage_services.c`](https://github.com/artgins/yunetas/blob/7.9.0/kernel/c/root-linux/src/manage_services.c)) | order services start **within** a yuno |
| Inter-yuno | agent col `start_priority` 0..9 (this section) | order yunos start **on this node** |

**Launch order.** [`cmd_run_yuno`](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c#L5113) sorts the matched yunos by `start_priority`
**ascending** before spawning ([`sort_yunos_by_start_priority`](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c#L8392), c_agent.c). Lower
...
is applied by `run_enabled_yunos`, so a node bounce ([`restart_nodes`](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c#L9456) /
...
[`tools/agent/set_start_priorities.py`](https://github.com/artgins/yunetas/blob/7.9.0/tools/agent/set_start_priorities.py).

**Inherited across version bumps.** A version-bump deploy (`find-new-yunos
create=1`) does NOT reset placement: [`cmd_find_new_yunos`](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c#L4487) copies
...
bump. [`set_start_priorities.py`](https://github.com/artgins/yunetas/blob/7.9.0/tools/agent/set_start_priorities.py) is therefore a first-time-only step per node, not
...
([`c_agent.c`](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c), and [`ENTRY_POINT.md §7`](ENTRY_POINT.md#entry-point-kill-yuno)).
...
> one pass, use [`tools/agent/sync_binaries.py`](https://github.com/artgins/yunetas/blob/7.9.0/tools/agent/sync_binaries.py) (drives from the agent's
...
- **Node-wide bounce.** `restart_nodes()` SIGKILLs every running
  ...
  [`promote_highest_release_yunos()`](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c#L8908); what remains is making the
...
| What                                  | Where                                                                 |
|---------------------------------------|-----------------------------------------------------------------------|
| Agent gclass                          | [`src/c_agent.c`](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c)                                                       |
| Treedb schema (yunos / binaries / configurations) | [`src/treedb_schema_yuneta_agent.c`](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/treedb_schema_yuneta_agent.c)                          |
| Command table                         | [`src/c_agent.c`](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c)                                               |
| Agent attributes                      | [`src/c_agent.c`](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c)                                               |
| FSM (`ST_IDLE`, event types)          | [`src/c_agent.c`](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c)                                           |
| Subscription model (SERVICE)          | [`src/c_agent.c`](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c)                                             |
| Per-yuno on-disk path                 | [`src/c_agent.c`](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c) (`build_yuno_private_domain`)                    |
| Repos binary path                     | [`src/c_agent.c`](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c)                                             |
| Binary resolution at start            | [`src/c_agent.c`](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c) (`get_yuno_binary`)                         |
| Launcher script + `--config-file`     | [`src/c_agent.c`](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c)                                             |
| `EV_ON_OPEN` handshake                | [`src/c_agent.c`](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c) (`ac_on_open`)                                  |
| `EV_ON_CLOSE` (death detection)       | [`src/c_agent.c`](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c) (`ac_on_close`)                                 |
| Boot-time reconciliation              | [`src/c_agent.c`](https://github.com/artgins/yunetas/blob/7.9.0/yunos/c/yuno_agent/src/c_agent.c) (`run_enabled_yunos`, `ac_timeout`)  |
