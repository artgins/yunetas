 ...
 *          MAIN.C
 *
 *          Test: the HARD subscriptions. A repeated hard subscription is
 *          one; gobj_unsubscribe_event() leaves it with a warning, and
 *          gobj_unsubscribe_list() with force removes it. See c_test3.c.
 *
 ...
 *                      Names
 ***************************************************************************/
#define APP_NAME        "test_subs_" "test3"
