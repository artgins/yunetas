...
**Source code:** [`src/c_yui_shell.js`](https://github.com/artgins/gobj-ui.js/blob/7.25.18/src/c_yui_shell.js)
...
## [`yui_shell_navigate(shell_gobj, route, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.25.18/src/c_yui_shell.js#L3337)
...
## [`yui_shell_last_route_under(shell_gobj, route)`](https://github.com/artgins/gobj-ui.js/blob/7.25.18/src/c_yui_shell.js#L3264)
...
such route, it returns `route`.

Use it for a control that goes back to a view as the reader left it. A treedb
graph keeps its focused topic in the URL (`<graph>/<topic>`), so a control that
goes to the bare route of the graph removes the focus. Ask this function first,
then give its answer to `yui_shell_navigate()`.

The memory is a copy of the URL for the life of the page. The shell keeps the
last 64 routes, does not store them, and does not apply them. Only a control
that asks gets the answer.

(js_yui_shell_set_sub_routes)=
## [`yui_shell_set_sub_routes(shell_gobj, base_route, nodes)`](https://github.com/artgins/gobj-ui.js/blob/7.25.18/src/c_yui_shell.js#L3380)
...
## [`yui_shell_register_event_handler(shell_gobj, event, gclass)`](https://github.com/artgins/gobj-ui.js/blob/7.25.18/src/c_yui_shell.js#L3400)
...
## [`yui_shell_unpark_route(route)`](https://github.com/artgins/gobj-ui.js/blob/7.25.18/src/c_yui_shell.js#L3476)
...
### [`yui_shell_open_drawer(shell_gobj, menu_id)`](https://github.com/artgins/gobj-ui.js/blob/7.25.18/src/c_yui_shell.js#L3414)

Opens the drawer.

(js_yui_shell_close_drawer)=
### [`yui_shell_close_drawer(shell_gobj, menu_id)`](https://github.com/artgins/gobj-ui.js/blob/7.25.18/src/c_yui_shell.js#L3415)

Closes the drawer.

(js_yui_shell_toggle_drawer)=
### [`yui_shell_toggle_drawer(shell_gobj, menu_id)`](https://github.com/artgins/gobj-ui.js/blob/7.25.18/src/c_yui_shell.js#L3416)
...
### [`yui_shell_push_escape(shell_gobj, layer, handler)`](https://github.com/artgins/gobj-ui.js/blob/7.25.18/src/c_yui_shell.js#L3431)
...
### [`yui_shell_pop_escape(shell_gobj, handler)`](https://github.com/artgins/gobj-ui.js/blob/7.25.18/src/c_yui_shell.js#L3435)
...
### [`yui_shell_register_overlay(shell_gobj, close_fn, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.25.18/src/c_yui_shell.js#L3454)
...
### [`yui_shell_overlay_dismissed(shell_gobj, overlay)`](https://github.com/artgins/gobj-ui.js/blob/7.25.18/src/c_yui_shell.js#L3458)
...
### [`yui_shell_set_avatar_provider(shell_gobj, provider)`](https://github.com/artgins/gobj-ui.js/blob/7.25.18/src/c_yui_shell.js#L3493)

Gives the function that the shell asks for the image of a user.

(js_yui_shell_refresh_avatars)=
### [`yui_shell_refresh_avatars(shell_gobj)`](https://github.com/artgins/gobj-ui.js/blob/7.25.18/src/c_yui_shell.js#L3503)
...
### [`yui_shell_set_translator(shell_gobj, t)`](https://github.com/artgins/gobj-ui.js/blob/7.25.18/src/c_yui_shell.js#L3518)
...
### [`yui_shell_set_connection_state(shell_gobj, connected)`](https://github.com/artgins/gobj-ui.js/blob/7.25.18/src/c_yui_shell.js#L3589)
...
```js
// the app, in the handlers of its transport
function ac_on_open(gobj, event, kw, src)
{
    yui_shell_set_connection_state(gobj.priv.shell, true);
    return 0;
}
function ac_on_close(gobj, event, kw, src)
{
    yui_shell_set_connection_state(gobj.priv.shell, false);    // EV_CONNECTION_STATE {connected: false}
    return 0;
}
```

(js_yui_shell_set_toolbar_item_icon)=
### [`yui_shell_set_toolbar_item_icon(shell_gobj, item_id, icon_class)`](https://github.com/artgins/gobj-ui.js/blob/7.25.18/src/c_yui_shell.js#L3625)

Changes the icon of an item of the toolbar.

(js_yui_shell_set_toolbar_item_badge)=
### [`yui_shell_set_toolbar_item_badge(shell_gobj, item_id, value)`](https://github.com/artgins/gobj-ui.js/blob/7.25.18/src/c_yui_shell.js#L3658)

Writes a badge on an item of the toolbar, such as a count of messages.

(js_yui_shell_close_dropdown)=
### [`yui_shell_close_dropdown(shell_gobj)`](https://github.com/artgins/gobj-ui.js/blob/7.25.18/src/c_yui_shell.js#L3695)
...
### [`yui_shell_show_route_map(shell, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.25.18/src/shell_route_map.js#L447)
