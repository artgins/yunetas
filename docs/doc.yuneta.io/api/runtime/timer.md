...
(register_c_timer0)=
## [`register_c_timer0()`](https://github.com/artgins/yunetas/blob/7.8.7/kernel/c/root-linux/src/c_timer0.c#L309)
...
(set_timeout0)=
## [`set_timeout0()`](https://github.com/artgins/yunetas/blob/7.8.7/kernel/c/root-linux/src/c_timer0.c#L327)
...
## [`set_timeout_periodic0()`](https://github.com/artgins/yunetas/blob/7.8.7/kernel/c/root-linux/src/c_timer0.c#L371)
...
(clear_timeout0)=
## [`clear_timeout0()`](https://github.com/artgins/yunetas/blob/7.8.7/kernel/c/root-linux/src/c_timer0.c#L415)
