...
**Current version: [7.25.6](https://github.com/artgins/yunetas/tree/7.25.6)** ·
*Documentation updated: 2026-09-25*
...
- [Installation](installation.md) — system prerequisites, the apt dependency
  list, and the one-time environment setup ([`menuconfig`](installation.md#configure-menuconfig), [`yunetas-env.sh`](https://github.com/artgins/yunetas/blob/7.25.6/yunetas-env.sh),
