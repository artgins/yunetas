...
(js_gobj_flag_t)=
### [`gobj_flag_t`](https://github.com/artgins/gobj-js/blob/7.25.3/src/gobj.js#L277)
...
(js_gobj_create)=
### [`gobj_create(gobj_name, gclass_name, kw, parent)`](https://github.com/artgins/gobj-js/blob/7.25.3/src/gobj.js#L2130)

Builds a child gobj. It is the function that a gclass uses in `mt_create`.

(js_gobj_create_yuno)=
### [`gobj_create_yuno(gobj_name, gclass_name, kw)`](https://github.com/artgins/gobj-js/blob/7.25.3/src/gobj.js#L2068)

Builds the root of the tree. There is one for each process.

(js_gobj_create_service)=
### [`gobj_create_service(gobj_name, gclass_name, kw, parent)`](https://github.com/artgins/gobj-js/blob/7.25.3/src/gobj.js#L2076)
...
### [`gobj_create_default_service(gobj_name, gclass_name, kw, parent)`](https://github.com/artgins/gobj-js/blob/7.25.3/src/gobj.js#L2085)
...
### [`gobj_create_volatil(gobj_name, gclass_name, kw, parent)`](https://github.com/artgins/gobj-js/blob/7.25.3/src/gobj.js#L2100)

Builds a child that the parent destroys with itself.

(js_gobj_create_pure_child)=
### [`gobj_create_pure_child(gobj_name, gclass_name, kw, parent)`](https://github.com/artgins/gobj-js/blob/7.25.3/src/gobj.js#L2115)
...
(js_gobj_create2)=
### [`gobj_create2(gobj_name, gclass_name, kw, parent, gobj_flag)`](https://github.com/artgins/gobj-js/blob/7.25.3/src/gobj.js#L1886)
...
(js_gobj_destroy)=
### [`gobj_destroy(gobj)`](https://github.com/artgins/gobj-js/blob/7.25.3/src/gobj.js#L2148)
...
(js_gobj_start)=
### [`gobj_start(gobj)`](https://github.com/artgins/gobj-js/blob/7.25.3/src/gobj.js#L2297)

Starts a gobj, and calls its `mt_start` method.

(js_gobj_stop)=
### [`gobj_stop(gobj)`](https://github.com/artgins/gobj-js/blob/7.25.3/src/gobj.js#L2412)

Stops a gobj, and calls its `mt_stop` method.

(js_gobj_start_children)=
### [`gobj_start_children(gobj)`](https://github.com/artgins/gobj-js/blob/7.25.3/src/gobj.js#L2357)

Starts the children of a gobj, and not the gobj.

(js_gobj_stop_children)=
### [`gobj_stop_children(gobj)`](https://github.com/artgins/gobj-js/blob/7.25.3/src/gobj.js#L2455)

Stops the children of a gobj.

(js_gobj_start_tree)=
### [`gobj_start_tree(gobj)`](https://github.com/artgins/gobj-js/blob/7.25.3/src/gobj.js#L2383)

Starts a gobj and each one of the gobjs below it. A gclass with the flag
`gcflag_manual_start` does not start here.

(js_gobj_stop_tree)=
### [`gobj_stop_tree(gobj)`](https://github.com/artgins/gobj-js/blob/7.25.3/src/gobj.js#L2468)
...
(js_gobj_play)=
### [`gobj_play(gobj)`](https://github.com/artgins/gobj-js/blob/7.25.3/src/gobj.js#L2491)

Plays a gobj, and calls its `mt_play` method.

(js_gobj_pause)=
### [`gobj_pause(gobj)`](https://github.com/artgins/gobj-js/blob/7.25.3/src/gobj.js#L2542)
...
(js_gobj_is_running)=
### [`gobj_is_running(gobj)`](https://github.com/artgins/gobj-js/blob/7.25.3/src/gobj.js#L2572)

Tells if a gobj is running.

(js_gobj_is_playing)=
### [`gobj_is_playing(gobj)`](https://github.com/artgins/gobj-js/blob/7.25.3/src/gobj.js#L2606)

Tells if a gobj is playing.

(js_gobj_is_service)=
### [`gobj_is_service(gobj)`](https://github.com/artgins/gobj-js/blob/7.25.3/src/gobj.js#L2594)

Tells if a gobj is a service.

(js_gobj_is_volatil)=
### [`gobj_is_volatil(gobj)`](https://github.com/artgins/gobj-js/blob/7.25.3/src/gobj.js#L2736)

Tells if the parent destroys this gobj with itself.

(js_gobj_is_pure_child)=
### [`gobj_is_pure_child(gobj)`](https://github.com/artgins/gobj-js/blob/7.25.3/src/gobj.js#L2752)

Tells if a gobj is a pure child.

(js_gobj_is_destroying)=
### [`gobj_is_destroying(gobj)`](https://github.com/artgins/gobj-js/blob/7.25.3/src/gobj.js#L2768)
