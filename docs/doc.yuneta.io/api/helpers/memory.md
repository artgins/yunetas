...
(print_track_mem)=
## [`print_track_mem()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/gbmem.c#L285)
...
## [`set_memory_check_list()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/gbmem.c#L275)
...
(gbmem_calloc)=
## [`gbmem_calloc()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/gbmem.c#L192)
...
(gbmem_free)=
## [`gbmem_free()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/gbmem.c#L176)
...
## [`gbmem_get_allocators()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/gbmem.c#L143)
...
## [`gbmem_get_maximum_block()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/gbmem.c#L247)
...
(gbmem_malloc)=
## [`gbmem_malloc()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/gbmem.c#L168)
...
(gbmem_realloc)=
## [`gbmem_realloc()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/gbmem.c#L184)
...
## [`gbmem_set_allocators()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/gbmem.c#L126)
...
(gbmem_setup)=
## [`gbmem_setup()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/gbmem.c#L90)
...
(gbmem_shutdown)=
## [`gbmem_shutdown()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/gbmem.c#L118)
...
(gbmem_strdup)=
## [`gbmem_strdup()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/gbmem.c#L236)
...
(gbmem_strndup)=
## [`gbmem_strndup()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/gbmem.c#L200)
...
## [`get_cur_system_memory()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/gbmem.c#L263)
...
## [`get_max_system_memory()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/gbmem.c#L255)
