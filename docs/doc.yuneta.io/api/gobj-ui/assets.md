...
**Source code:** [`src/yui_asset.js`](https://github.com/artgins/gobj-ui.js/blob/7.25.5/src/yui_asset.js)
...
(js_yui_asset_ids)=
### [`yui_asset_ids(ref)`](https://github.com/artgins/gobj-ui.js/blob/7.25.5/src/yui_asset.js#L72)

Every asset id the column names, in order. Always an array, possibly empty.

(js_yui_asset_id)=
### [`yui_asset_id(ref)`](https://github.com/artgins/gobj-ui.js/blob/7.25.5/src/yui_asset.js#L84)
...
(js_yui_asset_src)=
### [`yui_asset_src(answer)`](https://github.com/artgins/gobj-ui.js/blob/7.25.5/src/yui_asset.js#L97)
...
### [`yui_asset_element(answer, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.25.5/src/yui_asset.js#L330)
...
### [`yui_asset_missing(detail, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.25.5/src/yui_asset.js#L121)
...
([`src/yui_file_field.js`](https://github.com/artgins/gobj-ui.js/blob/7.25.5/src/yui_file_field.js)). The form and the treedb topic table use it
...
(js_YUI_FILE_ACCEPT)=
### [`YUI_FILE_ACCEPT`](https://github.com/artgins/gobj-ui.js/blob/7.25.5/src/yui_file_field.js#L56)
...
(js_yui_file_control)=
### [`yui_file_control(gobj, {name, value, readonly, accept, on_pick})`](https://github.com/artgins/gobj-ui.js/blob/7.25.5/src/yui_file_field.js#L243)
...
(js_yui_file_read)=
### [`yui_file_read(file)`](https://github.com/artgins/gobj-ui.js/blob/7.25.5/src/yui_file_field.js#L151)
...
### [`yui_files_manifest(picks, record)`](https://github.com/artgins/gobj-ui.js/blob/7.25.5/src/yui_file_field.js#L178)
...
(js_yui_file_sha256)=
### [`yui_file_sha256(buffer)`](https://github.com/artgins/gobj-ui.js/blob/7.25.5/src/yui_file_field.js#L102)
...
### [`yui_array_buffer_to_base64(buffer)`](https://github.com/artgins/gobj-ui.js/blob/7.25.5/src/yui_file_field.js#L131)
...
### [`yui_file_size_label(bytes)`](https://github.com/artgins/gobj-ui.js/blob/7.25.5/src/yui_file_field.js#L74)

A size a person reads: bytes up to 1 KB, then one decimal.

(js_yui_file_id_label)=
### [`yui_file_id_label(id)`](https://github.com/artgins/gobj-ui.js/blob/7.25.5/src/yui_file_field.js#L217)
