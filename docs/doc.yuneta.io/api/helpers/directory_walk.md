...
## [`get_ordered_filename_array()`](https://github.com/artgins/yunetas/blob/7.9.0/kernel/c/gobj-c/src/helpers.c#L3377)
...
(walk_dir_tree)=
## [`walk_dir_tree()`](https://github.com/artgins/yunetas/blob/7.9.0/kernel/c/gobj-c/src/helpers.c#L3113)
...
(dir_array_free)=
## [`dir_array_free()`](https://github.com/artgins/yunetas/blob/7.9.0/kernel/c/gobj-c/src/helpers.c#L3165)
...
(dir_array_sort)=
## [`dir_array_sort()`](https://github.com/artgins/yunetas/blob/7.9.0/kernel/c/gobj-c/src/helpers.c#L3292)
...
## [`find_files_with_suffix_array()`](https://github.com/artgins/yunetas/blob/7.9.0/kernel/c/gobj-c/src/helpers.c#L3207)
...
(walk_dir_array)=
## [`walk_dir_array()`](https://github.com/artgins/yunetas/blob/7.9.0/kernel/c/gobj-c/src/helpers.c#L3330)
