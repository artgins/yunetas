...
(gobj_stats)=
## [`gobj_stats()`](https://github.com/artgins/yunetas/blob/7.18.1/kernel/c/gobj-c/src/gobj.c#L4995)
...
(gobj_decr_stat)=
## [`gobj_decr_stat()`](https://github.com/artgins/yunetas/blob/7.18.1/kernel/c/gobj-c/src/gobj.c#L9912)
...
(gobj_get_stat)=
## [`gobj_get_stat()`](https://github.com/artgins/yunetas/blob/7.18.1/kernel/c/gobj-c/src/gobj.c#L9928)
...
(gobj_incr_stat)=
## [`gobj_incr_stat()`](https://github.com/artgins/yunetas/blob/7.18.1/kernel/c/gobj-c/src/gobj.c#L9895)
...
(gobj_jn_stats)=
## [`gobj_jn_stats()`](https://github.com/artgins/yunetas/blob/7.18.1/kernel/c/gobj-c/src/gobj.c#L9939)
...
(gobj_set_stat)=
## [`gobj_set_stat()`](https://github.com/artgins/yunetas/blob/7.18.1/kernel/c/gobj-c/src/gobj.c#L9880)
