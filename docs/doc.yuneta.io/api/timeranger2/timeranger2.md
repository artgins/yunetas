...
- [`timeranger2.h`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.h)
- [`timeranger2.c`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c)

## Function reference

(tranger2_append_record)=
## [`tranger2_append_record()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L3562)
...
## [`tranger2_backup_topic()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L2521)
...
That holds for EVERY tranger, also one opened with `on_critical_error` `LOG_OPT_EXIT_ZERO` (the MQTT broker's queues, `C_TRANGER`'s default): the create of a backup runs with the exit bits of `on_critical_error` off (`LOG_OPT_EXIT_ZERO`, `LOG_OPT_EXIT_NEGATIVE`, `LOG_OPT_ABORT`), because its failure is recovered; the CRITICALs are still logged, and the tranger's value is back when the create returns. If the create exited there, the data of the topic would stay in `<topic>.bak` until moved back by hand.
...
## [`tranger2_close_all_lists()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L13432)
...
## [`tranger2_close_iterator()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L10761)
...
(tranger2_close_list)=
## [`tranger2_close_list()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L13404)
...
## [`tranger2_close_rt_disk()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L5902)
...
## [`tranger2_close_rt_mem()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L5600)
...
## [`tranger2_close_topic()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L2303)
...
## [`tranger2_create_topic()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L1306)
...
the topic left on disk. Up to 7.25.4 it exited in the log of the first
...
(tranger2_delete_key)=
## [`tranger2_delete_key()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L4467)
...
deleted, dropped from memory or announced. Up to 7.25.4 it was taken as
...
## [`tranger2_delete_instance()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L5175)
...
## [`tranger2_set_rt_key_deleted_callback()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L6068)
...
## [`tranger2_delete_topic()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L2359)
...
## [`tranger2_dict_topic_desc_cols()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L2988)
...
## [`tranger2_get_iterator_by_id()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L10824)
...
## [`tranger2_get_rt_disk_by_id()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L6014)
...
## [`tranger2_get_rt_mem_by_id()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L5669)
...
## [`tranger2_iterator_get_page()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L11040)
...
## [`tranger2_iterator_size()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L10981)
...
(tranger2_list_keys)=
## [`tranger2_list_keys()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L2182)
...
## [`tranger2_list_topic_desc_cols()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L2970)
...
## [`tranger2_list_topics()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L2087)
...
## [`tranger2_mark_tm_order()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L10126)
...
## [`tranger2_open_iterator()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L10383)
...
(tranger2_open_list)=
## [`tranger2_open_list()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L13122)
...
## [`tranger2_open_rt_disk()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L5724)
...
## [`tranger2_open_rt_mem()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L5476)
...
(tranger2_open_topic)=
## [`tranger2_open_topic()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L1834)
...
It also returns `NULL` when the `keys/` directory of the topic exists and cannot be listed (`EMFILE`, `EACCES`, `ENOMEM`, or a `readdir()` that fails): *"Cannot list the keys of the topic"* (with `errno`), then *"Cannot open topic: its keys cannot be listed"*. On a filesystem whose `readdir()` gives no `d_type` (XFS with `ftype=0`, NFS, FUSE, overlay) each key is asked with `lstat()`, as the entry type tells it: a symbolic link is not a key (up to 7.25.4 `stat()` followed it, and made a key of another key). An `lstat()` that fails with `EACCES` (`keys/` can be read and not searched) takes the entry as a key, as the entry type does, and the listing of that key says the `EACCES` and flags it; one that fails with anything else but `ENOENT` (a key removed meanwhile) fails the listing the same way: *"Cannot list the keys of the topic, stat() FAILED"*. Up to 7.25.4 that key was taken as "not a directory" and left out with no log, and the topic opened without it. The topic is not left open: opened with no keys, a key nobody read looked like a key that does not exist, and a treedb accepted a create of its id (so up to 7.25.4). The next open, or the next [`tranger2_topic()`](#tranger2_topic), tries again:
...
## [`tranger2_print_md0_record()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L13572)
...
## [`tranger2_print_md1_record()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L13636)
...
## [`tranger2_print_md2_record()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L13704)
...
## [`tranger2_print_record_filename()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L13756)
...
## [`tranger2_read_record_content()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L12790)
...
## [`tranger2_read_user_flag()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L5425)
...
## [`tranger2_set_trace_level()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L13782)
...
## [`tranger2_set_system_flag()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L5056)
...
## [`tranger2_set_user_flag()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L4953)
...
(tranger2_shutdown)=
## [`tranger2_shutdown()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L890)
...
(tranger2_startup)=
## [`tranger2_startup()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L530)
...
(tranger2_stop)=
## [`tranger2_stop()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L743)
...
## [`tranger2_str2system_flag()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L905)
...
(tranger2_topic)=
## [`tranger2_topic()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L2037)
...
(tranger2_topic_desc)=
## [`tranger2_topic_desc()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L2918)
...
## [`tranger2_topic_key_size()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L2232)
...
## [`tranger2_topic_key_range()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L2255)
...
## [`tranger2_topic_is_open()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L2277)
...
(tranger2_topic_name)=
## [`tranger2_topic_name()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L2293)
...
(tranger2_topic_size)=
## [`tranger2_topic_size()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L2207)
...
## [`tranger2_write_topic_cols()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L2842)
...
## [`tranger2_write_topic_var()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L2765)
...
## [`tranger2_write_user_flag()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L4867)
...
## [`tranger2_list_topic_names()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L2108)
...
(tranger2_topic_path)=
## [`tranger2_topic_path()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/timeranger2/src/timeranger2.c#L2064)
