...
(launch_daemon)=
### [`launch_daemon()`](https://github.com/artgins/yunetas/blob/7.5.11/kernel/c/gobj-c/src/helpers.c#L5991)
...
Declared in
[`ydaemon.h`](https://github.com/artgins/yunetas/blob/7.5.11/kernel/c/root-linux/src/ydaemon.h).
...
(daemon_run)=
### [`daemon_run()`](https://github.com/artgins/yunetas/blob/7.5.11/kernel/c/root-linux/src/ydaemon.c#L280)
...
(daemon_shutdown)=
### [`daemon_shutdown()`](https://github.com/artgins/yunetas/blob/7.5.11/kernel/c/root-linux/src/ydaemon.c#L358)
...
(get_watcher_pid)=
### [`get_watcher_pid()`](https://github.com/artgins/yunetas/blob/7.5.11/kernel/c/root-linux/src/ydaemon.c#L475)
...
(get_relaunch_times)=
### [`get_relaunch_times()`](https://github.com/artgins/yunetas/blob/7.5.11/kernel/c/root-linux/src/ydaemon.c#L450)
...
(search_process)=
### [`search_process()`](https://github.com/artgins/yunetas/blob/7.5.11/kernel/c/root-linux/src/ydaemon.c#L439)
...
### [`daemon_set_debug_mode()`](https://github.com/artgins/yunetas/blob/7.5.11/kernel/c/root-linux/src/ydaemon.c#L458)
...
### [`daemon_get_debug_mode()`](https://github.com/artgins/yunetas/blob/7.5.11/kernel/c/root-linux/src/ydaemon.c#L467)
