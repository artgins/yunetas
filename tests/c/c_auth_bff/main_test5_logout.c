 ...
 *          MAIN_TEST5_LOGOUT.C
 *
 *          Self-contained auth_bff test: /auth/logout happy path.
 *
 *          Same topology as main_test1_login.  Mock Keycloak returns
 *          its default 204 for /logout (spec-compliant).
 *
 ...
 *                      Names
 ***************************************************************************/
#define APP_NAME        "test_auth_bff_test5_logout"
#define APP_DOC         "Self-contained auth_bff /auth/logout happy path"
