 ...
 *          MAIN.C
 *
 *          Main of test_c_agent_find_new_yunos
 *          Tests the rows of the agent's find-new-yunos (find_new_yunos.c)
 *
 ...
 *                      Names
 ***************************************************************************/
#define APP_NAME        "test_c_agent_find_new_yunos"
#define APP_DOC         "Test the rows of the agent find-new-yunos"
...
{                                                                   \n\
    ...
    'services': [                                                   \n\
        {                                                           \n\
            'name': 'test_find_new_yunos',                             \n\
            'gclass': 'C_TEST_FIND_NEW_YUNOS',                         \n\
...
/***************************************************************************
 *  C_NODE asks a permission of every command and of some methods. With no
 *  checker installed the default one is C_AUTHZ's, which looks for an authz
 *  SERVICE this test yuno does not run. This test is about which rows
 *  find-new-yunos answers, not about who may ask for them.
 ***************************************************************************/
...
static int register_yuno_and_more(void)
{
     ...
     *  Register gclass
     *--------------------*/
    result += register_c_test_find_new_yunos();
    ...
    set_expected_results(
        ...
        json_pack("[{s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}]",
            ...
            "msg", "new release found",
            "msg", "new release found",
            "msg", "All find-new-yunos tests PASSED",
            "msg", "Exit to die",
            "msg", "Exit to die",
            "msg", "Pausing yuno",
