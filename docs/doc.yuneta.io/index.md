...
**Current version: [7.9.8](https://github.com/artgins/yunetas/tree/7.9.8)**
...
[`kernel/js/gobj-ui/test-app/`](https://github.com/artgins/yunetas/tree/7.9.8/kernel/js/gobj-ui/test-app),
