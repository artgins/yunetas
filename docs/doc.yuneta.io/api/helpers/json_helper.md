...
Jansson helpers: load and dump JSON, copy/merge objects, traverse trees, and convert between JSON values and common C types.

Source code:

- [`helpers.h`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.h)
- [`helpers.c`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c)

(anystring2json)=
## [`anystring2json()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L2491)
...
(bits2gbuffer)=
## [`bits2gbuffer()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L1948)
...
(bits2jn_strlist)=
## [`bits2jn_strlist()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L1929)
...
(cmp_two_simple_json)=
## [`cmp_two_simple_json()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L2397)
...
(create_json_record)=
## [`create_json_record()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L1757)
...
(debug_json)=
## [`debug_json()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L5227)
...
(get_real_precision)=
## [`get_real_precision()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L2680)
...
(jn2bool)=
## [`jn2bool()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L2372)
...
(jn2integer)=
## [`jn2integer()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L2318)
...
(jn2real)=
## [`jn2real()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L2295)
...
(jn2string)=
## [`jn2string()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L2347)
...
(json2str)=
## [`json2str()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L2689)
...
(json2uglystr)=
## [`json2uglystr()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L2702)
...
## [`json_check_refcounts()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L2715)
...
(json_config)=
## [`json_config()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/json_config.c#L333)
...
(json_desc_to_schema)=
## [`json_desc_to_schema()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L1897)
...
(json_is_identical)=
## [`json_is_identical()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L2471)
...
(json_list_str_index)=
## [`json_list_str_index()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L2007)
...
## [`json_print_refcounts()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L2879)
...
(json_str_in_list)=
## [`json_str_in_list()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L2973)
...
(load_json_from_file)=
## [`load_json_from_file()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L1599)
...
## [`load_persistent_json()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L1519)
...
(print_json)=
## [`print_json()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L5073)
...
(save_json_to_file)=
## [`save_json_to_file()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L1647)
...
(set_real_precision)=
## [`set_real_precision()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L2674)
...
(string2json)=
## [`string2json()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L2558)
...
(strings2bits)=
## [`strings2bits()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L1980)
...
(anyfile2json)=
## [`anyfile2json()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L2529)
...
(is_metadata_key)=
## [`is_metadata_key()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L5868)
...
(is_private_key)=
## [`is_private_key()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L5889)
...
## [`json_config_string2json()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L2585)
...
## [`json_dict_recursive_update()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L2249)
...
(json_is_range)=
## [`json_is_range()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L2149)
...
(json_list_find)=
## [`json_list_find()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L2105)
...
(json_list_int)=
## [`json_list_int()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L2043)
...
(json_list_int_index)=
## [`json_list_int_index()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L2075)
...
(json_list_update)=
## [`json_list_update()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L2124)
...
(json_listsrange2set)=
## [`json_listsrange2set()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L2209)
...
(json_range_list)=
## [`json_range_list()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L2180)
...
(json_size)=
## [`json_size()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.h#L128)

Returns the size of a JSON value based on its type. It is a `static inline` in
the header, so it costs no call.

```C
static inline size_t json_size(
    const json_t *jn
);
```
...
| Key | Type | Description |
|---|---|---|
| `jn` | `const json_t *` | The JSON value whose size is to be determined. May be NULL. |

**Returns**

Returns the number of elements for arrays and objects, 1 for non-empty strings, and 0 for all other types (including a C NULL, empty strings, integers, reals, booleans, and null).

---

(empty_json)=
## [`empty_json()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.h#L151)

Tells whether there is anything usable in a JSON value. **This is the guard to
write over a `json_t *`, never `if(!jn)`**: an attribute declared `DTP_JSON`
with a null default holds `json_null()` — a valid pointer — so the pointer
test is a branch that can never be taken. The same applies to every optional
key of a subscription (`__config__`, `__global__`, `__local__`, `__filter__`).

It also answers TRUE for an empty container, which a null test does not: an
empty filter is as much "no filter" as an absent one.

```C
static inline BOOL empty_json(
    const json_t *jn
);
```
...
| Key | Type | Description |
|---|---|---|
| `jn` | `const json_t *` | The JSON value to test. May be NULL. |

**Returns**

TRUE for a C NULL, a json null, `{}`, `[]`, `""` and any scalar. FALSE only when there is content. It is `json_size(jn)==0`.

---

(json_absent)=
## [`json_absent()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.h#L162)

Tells whether there is no value at all. Use it **only** where a null and an
empty container mean different things — a field written null on purpose against
a field never written. Everywhere else the question is
[`empty_json()`](#empty_json).

Its twin in `gobj-js` is `is_null()`: JavaScript has no second null to tell
apart.

```C
static inline BOOL json_absent(
    const json_t *jn
);
```
...
TRUE for a C NULL and for an explicit json null, FALSE for everything else.
