/****************************************************************************
 *          MAIN_TEST7_SLOW_LOGIN.C
 *
 *          Self-contained auth_bff test: slow Keycloak.
 *
 *          Same topology as main_test1_login with one change: the mock
 *          Keycloak service kw sets `latency_ms: 200`, so every
 *          /token response is deferred for 200 ms via c_mock_keycloak's
 *          internal C_TIMER child before it reaches the BFF.
 *
 ...
 *                      Names
 ***************************************************************************/
#define APP_NAME        "test_auth_bff_test7_slow_login"
#define APP_DOC         "Self-contained auth_bff test: slow Keycloak (latency_ms=200)"
...
{                                                                   \n\
    ...
    'services': [                                                   \n\
        {                                                           \n\
            'name': 'c_test7_slow_login',                           \n\
            'gclass': 'C_TEST7_SLOW_LOGIN',                         \n\
...
static int register_yuno_and_more(void)
{
    ...
    res += register_c_test7_slow_login();
