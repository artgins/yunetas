...
- [`tr_treedb.c`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c)

(_treedb_create_topic_cols_desc)=
## [`_treedb_create_topic_cols_desc()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L440)
...
(add_jtree_path)=
## [`add_jtree_path()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L8721)
...
## [`create_template_record()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L9434)
...
(current_snap_tag)=
## [`current_snap_tag()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L119)
...
(decode_child_ref)=
## [`decode_child_ref()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L3531)
...
(decode_parent_ref)=
## [`decode_parent_ref()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L3477)
...
(node_collapsed_view)=
## [`node_collapsed_view()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L7713)
...
(parse_hooks)=
## [`parse_hooks()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L1976)
...
(parse_schema)=
## [`parse_schema()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L1897)
...
(parse_schema_cols)=
## [`parse_schema_cols()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L1932)
...
(set_volatil_values)=
## [`set_volatil_values()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L2873)
...
## [`treedb_activate_snap()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L9296)
...
(treedb_autolink)=
## [`treedb_autolink()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L7102)
...
(treedb_clean_node)=
## [`treedb_clean_node()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L6950)
...
(treedb_close_db)=
## [`treedb_close_db()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L1123)
...
(treedb_close_topic)=
## [`treedb_close_topic()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L1468)
...
(treedb_create_node)=
## [`treedb_create_node()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L4574)
...
(treedb_create_topic)=
## [`treedb_create_topic()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L1162)
...
## [`treedb_delete_instance()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L5668)
...
(treedb_delete_node)=
## [`treedb_delete_node()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L5283)
...
(treedb_delete_topic)=
## [`treedb_delete_topic()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L1518)
...
(treedb_get_id_index)=
## [`treedb_get_id_index()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L246)
...
(treedb_get_instance)=
## [`treedb_get_instance()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L7654)
...
(treedb_get_node)=
## [`treedb_get_node()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L7611)
...
## [`treedb_get_topic_hooks()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L8941)
...
## [`treedb_get_topic_links()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L8900)
...
## [`treedb_is_treedbs_topic()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L231)
...
(treedb_link_nodes)=
## [`treedb_link_nodes()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L7279)
...
## [`treedb_list_instances()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L7985)
...
(treedb_list_nodes)=
## [`treedb_list_nodes()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L7844)
...
(treedb_list_parents)=
## [`treedb_list_parents()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L8460)
...
(treedb_list_snaps)=
## [`treedb_list_snaps()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L9414)
...
(treedb_list_treedb)=
## [`treedb_list_treedb()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L1564)
...
## [`treedb_node_children()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L8669)
...
(treedb_node_jtree)=
## [`treedb_node_jtree()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L8829)
...
(treedb_open_db)=
## [`treedb_open_db()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L505)
...
(treedb_parent_refs)=
## [`treedb_parent_refs()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L8370)
...
(treedb_save_node)=
## [`treedb_save_node()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L4973)
...
(treedb_set_callback)=
## [`treedb_set_callback()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L1078)
...
## [`treedb_set_node_immutable()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L5153)
...
(treedb_set_trace)=
## [`treedb_set_trace()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L4396)
...
(treedb_shoot_snap)=
## [`treedb_shoot_snap()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L9085)
...
(treedb_topic_pkey2s)=
## [`treedb_topic_pkey2s()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L132)
...
## [`treedb_topic_pkey2s_filter()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L147)
...
(treedb_topic_size)=
## [`treedb_topic_size()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L1646)
...
(treedb_topics)=
## [`treedb_topics()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L1597)
...
(treedb_unlink_nodes)=
## [`treedb_unlink_nodes()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L7310)
...
(treedb_update_node)=
## [`treedb_update_node()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L5203)
...
(get_hook_list)=
## [`get_hook_list()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L4406)
...
## [`topic_desc_fkey_names()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L2180)
...
## [`topic_desc_hook_names()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/timeranger2/src/tr_treedb.c#L2155)
