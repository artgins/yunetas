...
(gobj_stats)=
## [`gobj_stats()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/gobj.c#L4995)
...
(gobj_decr_stat)=
## [`gobj_decr_stat()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/gobj.c#L9902)
...
(gobj_get_stat)=
## [`gobj_get_stat()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/gobj.c#L9918)
...
(gobj_incr_stat)=
## [`gobj_incr_stat()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/gobj.c#L9885)
...
(gobj_jn_stats)=
## [`gobj_jn_stats()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/gobj.c#L9929)
...
(gobj_set_stat)=
## [`gobj_set_stat()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/gobj.c#L9870)
