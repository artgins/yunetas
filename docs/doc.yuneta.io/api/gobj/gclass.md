...
(gclass2json)=
## [`gclass2json()`](https://github.com/artgins/yunetas/blob/7.6.8/kernel/c/gobj-c/src/gobj.c#L7149)
...
## [`gclass_add_ev_action()`](https://github.com/artgins/yunetas/blob/7.6.8/kernel/c/gobj-c/src/gobj.c#L898)
...
## [`gclass_add_event_type()`](https://github.com/artgins/yunetas/blob/7.6.8/kernel/c/gobj-c/src/gobj.c#L979)
...
(gclass_add_state)=
## [`gclass_add_state()`](https://github.com/artgins/yunetas/blob/7.6.8/kernel/c/gobj-c/src/gobj.c#L817)
...
(gclass_attr_desc)=
## [`gclass_attr_desc()`](https://github.com/artgins/yunetas/blob/7.6.8/kernel/c/gobj-c/src/gobj.c#L3333)
...
(gclass_authz_desc)=
## [`gclass_authz_desc()`](https://github.com/artgins/yunetas/blob/7.6.8/kernel/c/gobj-c/src/gobj.c#L3319)
...
(gclass_check_fsm)=
## [`gclass_check_fsm()`](https://github.com/artgins/yunetas/blob/7.6.8/kernel/c/gobj-c/src/gobj.c#L1225)
...
(gclass_command_desc)=
## [`gclass_command_desc()`](https://github.com/artgins/yunetas/blob/7.6.8/kernel/c/gobj-c/src/gobj.c#L6405)
...
(gclass_create)=
## [`gclass_create()`](https://github.com/artgins/yunetas/blob/7.6.8/kernel/c/gobj-c/src/gobj.c#L665)
...
(gclass_find_by_name)=
## [`gclass_find_by_name()`](https://github.com/artgins/yunetas/blob/7.6.8/kernel/c/gobj-c/src/gobj.c#L1144)
...
(gclass_event_type)=
## [`gclass_event_type()`](https://github.com/artgins/yunetas/blob/7.6.8/kernel/c/gobj-c/src/gobj.c#L1209)
...
## [`gclass_find_public_event()`](https://github.com/artgins/yunetas/blob/7.6.8/kernel/c/gobj-c/src/gobj.c#L1023)
...
(gclass_gclass_name)=
## [`gclass_gclass_name()`](https://github.com/artgins/yunetas/blob/7.6.8/kernel/c/gobj-c/src/gobj.c#L1076)
...
## [`gclass_gclass_register()`](https://github.com/artgins/yunetas/blob/7.6.8/kernel/c/gobj-c/src/gobj.c#L1116)
...
(gclass_has_attr)=
## [`gclass_has_attr()`](https://github.com/artgins/yunetas/blob/7.6.8/kernel/c/gobj-c/src/gobj.c#L1089)
...
(gclass_unregister)=
## [`gclass_unregister()`](https://github.com/artgins/yunetas/blob/7.6.8/kernel/c/gobj-c/src/gobj.c#L1035)
