...
[`packages/README.md`](https://github.com/artgins/yunetas/tree/7.9.2/packages).
...
> ([`AMD64.sh`](https://github.com/artgins/yunetas/blob/7.9.2/packages/deb/AMD64.sh), [`ARM32.sh`](https://github.com/artgins/yunetas/blob/7.9.2/packages/deb/ARM32.sh), [`ARMhf.sh`](https://github.com/artgins/yunetas/blob/7.9.2/packages/deb/ARMhf.sh), [`RISCV64.sh`](https://github.com/artgins/yunetas/blob/7.9.2/packages/deb/RISCV64.sh)). Requires the
...
[`yunetas-env.sh`](https://github.com/artgins/yunetas/blob/7.9.2/yunetas-env.sh) exports four variables and prepends `/yuneta/bin`
...
> to source [`yunetas-env.sh`](https://github.com/artgins/yunetas/blob/7.9.2/yunetas-env.sh) again. Without it, [`ybatch`](#util-ybatch) / [`ycommand`](#util-ycommand) /
...
> re-run [`./set_compiler.sh`](https://github.com/artgins/yunetas/blob/7.9.2/set_compiler.sh) so the external libs are rebuilt with
