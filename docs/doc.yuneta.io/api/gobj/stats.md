...
(gobj_stats)=
## [`gobj_stats()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/gobj.c#L4992)
...
(gobj_decr_stat)=
## [`gobj_decr_stat()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/gobj.c#L9890)
...
(gobj_get_stat)=
## [`gobj_get_stat()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/gobj.c#L9906)
...
(gobj_incr_stat)=
## [`gobj_incr_stat()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/gobj.c#L9873)
...
(gobj_jn_stats)=
## [`gobj_jn_stats()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/gobj.c#L9917)
...
(gobj_set_stat)=
## [`gobj_set_stat()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/gobj.c#L9858)
