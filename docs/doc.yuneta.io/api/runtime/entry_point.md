...
(yuneta_setup)=
## [`yuneta_setup()`](https://github.com/artgins/yunetas/blob/7.8.6/kernel/c/root-linux/src/entry_point.c#L248)
...
(yuneta_entry_point)=
## [`yuneta_entry_point()`](https://github.com/artgins/yunetas/blob/7.8.6/kernel/c/root-linux/src/entry_point.c#L304)
...
(set_auto_kill_time)=
## [`set_auto_kill_time()`](https://github.com/artgins/yunetas/blob/7.8.6/kernel/c/root-linux/src/entry_point.c#L980)
...
(yuneta_json_config)=
## [`yuneta_json_config()`](https://github.com/artgins/yunetas/blob/7.8.6/kernel/c/root-linux/src/entry_point.c#L988)
...
(run_services)=
## [`run_services()`](https://github.com/artgins/yunetas/blob/7.8.6/kernel/c/root-linux/src/manage_services.c#L36)
...
(stop_services)=
## [`stop_services()`](https://github.com/artgins/yunetas/blob/7.8.6/kernel/c/root-linux/src/manage_services.c#L62)
...
(yuno_shutdown)=
## [`yuno_shutdown()`](https://github.com/artgins/yunetas/blob/7.8.6/kernel/c/root-linux/src/manage_services.c#L92)
...
## [`yunetas_register_c_core()`](https://github.com/artgins/yunetas/blob/7.8.6/kernel/c/root-linux/src/yunetas_register.c#L49)
