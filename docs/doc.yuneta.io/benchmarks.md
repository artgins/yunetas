...
| Script | Description |
|--------|-------------|
| [`stress-connections.js`](https://github.com/artgins/yunetas/blob/7.9.5/stress/c/listen/stress-connections.js) | Connection load generator. |
| [`stress-traffic.js`](https://github.com/artgins/yunetas/blob/7.9.5/stress/c/listen/stress-traffic.js) | Message traffic generator. |
