...
(comm_prot_free)=
## [`comm_prot_free()`](https://github.com/artgins/yunetas/blob/7.24.1/kernel/c/gobj-c/src/helpers.c#L5991)
...
## [`comm_prot_get_gclass()`](https://github.com/artgins/yunetas/blob/7.24.1/kernel/c/gobj-c/src/helpers.c#L5964)
...
(comm_prot_register)=
## [`comm_prot_register()`](https://github.com/artgins/yunetas/blob/7.24.1/kernel/c/gobj-c/src/helpers.c#L5935)
...
(get_peername)=
## [`get_peername()`](https://github.com/artgins/yunetas/blob/7.24.1/kernel/c/gobj-c/src/helpers.c#L6922)
...
(get_sockname)=
## [`get_sockname()`](https://github.com/artgins/yunetas/blob/7.24.1/kernel/c/gobj-c/src/helpers.c#L6941)
...
(is_tcp_socket)=
## [`is_tcp_socket()`](https://github.com/artgins/yunetas/blob/7.24.1/kernel/c/gobj-c/src/helpers.c#L6850)
...
(is_udp_socket)=
## [`is_udp_socket()`](https://github.com/artgins/yunetas/blob/7.24.1/kernel/c/gobj-c/src/helpers.c#L6867)
...
## [`print_socket_address()`](https://github.com/artgins/yunetas/blob/7.24.1/kernel/c/gobj-c/src/helpers.c#L6884)
...
## [`set_tcp_socket_options()`](https://github.com/artgins/yunetas/blob/7.24.1/kernel/c/gobj-c/src/helpers.c#L6821)
