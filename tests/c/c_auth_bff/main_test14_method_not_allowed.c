/****************************************************************************
 *          MAIN_TEST14_METHOD_NOT_ALLOWED.C
 *
 *          Self-contained auth_bff test: GET /auth/login → 405.
 *
 *          Same topology as main_test6_invalid_body.  The mock Keycloak
 *          is present but never called — the BFF rejects the request on
 *          the method check before parsing the URL or body.
 *
 ...
 *                      Names
 ***************************************************************************/
#define APP_NAME        "test_auth_bff_test14_method_not_allowed"
#define APP_DOC         "Self-contained auth_bff GET /auth/login → 405 method_not_allowed"
...
{                                                                   \n\
    ...
    'services': [                                                   \n\
        {                                                           \n\
            'name': 'c_test14_method_not_allowed',                  \n\
            'gclass': 'C_TEST14_METHOD_NOT_ALLOWED',                \n\
...
static int register_yuno_and_more(void)
{
    ...
    res += register_c_test14_method_not_allowed();
