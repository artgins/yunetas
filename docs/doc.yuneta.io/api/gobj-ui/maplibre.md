...
**Source code:** [`src/lib_maplibre.js`](https://github.com/artgins/gobj-ui.js/blob/6.1.2/src/lib_maplibre.js)

---

(js_EditControl)=
## [`EditControl`](https://github.com/artgins/gobj-ui.js/blob/6.1.2/src/lib_maplibre.js#L18)
...
(js_MarkerControl)=
## [`MarkerControl`](https://github.com/artgins/gobj-ui.js/blob/6.1.2/src/lib_maplibre.js#L99)
