...
versioned to track `YUNETA_VERSION` (SDK `7.9.12`; the gobj-js package is at
`7.9.11` on npm — 7.9.12 carries no JS change, so the package did not move)
...
| File | Purpose |
|------|---------|
| `YUNETA_VERSION` | Current version (7.9.12) — used to generate `yuneta_version.h` |
