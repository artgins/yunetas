 ...
 *
 *          The config only declares the echo server (__input_side__) using
 *          the RAW protocol so bytes are echoed verbatim. The client under
 *          test is a pure C_TCP created directly by C_TEST1.
 *
 ...
 *                      Names
 ***************************************************************************/
#define APP_NAME        "test_tcp_inactivity_" "test1"
#define APP_DOC         "Test C_TCP timeout_inactivity (no TLS)"
