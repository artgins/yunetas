...
- [`fs_watcher.h`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/fs_watcher.h)
- [`fs_watcher.c`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/fs_watcher.c)

(fs_create_watcher_event)=
## [`fs_create_watcher_event()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/fs_watcher.c#L89)
