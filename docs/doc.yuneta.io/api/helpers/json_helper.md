...
(anystring2json)=
## [`anystring2json()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L2858)
...
(bits2gbuffer)=
## [`bits2gbuffer()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L2315)
...
(bits2jn_strlist)=
## [`bits2jn_strlist()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L2296)
...
(cmp_two_simple_json)=
## [`cmp_two_simple_json()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L2764)
...
(create_json_record)=
## [`create_json_record()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L2124)
...
(debug_json)=
## [`debug_json()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L5840)
...
(get_real_precision)=
## [`get_real_precision()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L3047)
...
(jn2bool)=
## [`jn2bool()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L2739)
...
(jn2integer)=
## [`jn2integer()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L2685)
...
(jn2real)=
## [`jn2real()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L2662)
...
(jn2string)=
## [`jn2string()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L2714)
...
(json2str)=
## [`json2str()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L3056)
...
(json2uglystr)=
## [`json2uglystr()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L3069)
...
## [`json_check_refcounts()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L3082)
...
(json_config)=
## [`json_config()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/json_config.c#L333)
...
(json_desc_to_schema)=
## [`json_desc_to_schema()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L2264)
...
(json_is_identical)=
## [`json_is_identical()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L2838)
...
(json_list_str_index)=
## [`json_list_str_index()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L2374)
...
## [`json_print_refcounts()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L3246)
...
(json_str_in_list)=
## [`json_str_in_list()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L3340)
...
(load_json_from_file)=
## [`load_json_from_file()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L1941)
...
## [`load_persistent_json()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L1867)
...
(print_json)=
## [`print_json()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L5686)
...
(save_json_to_file)=
## [`save_json_to_file()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L1992)
...
(set_real_precision)=
## [`set_real_precision()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L3041)
...
(string2json)=
## [`string2json()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L2925)
...
(strings2bits)=
## [`strings2bits()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L2347)
...
(anyfile2json)=
## [`anyfile2json()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L2896)
...
(is_metadata_key)=
## [`is_metadata_key()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L6481)
...
(is_private_key)=
## [`is_private_key()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L6502)
...
## [`json_config_string2json()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L2952)
...
## [`json_dict_recursive_update()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L2616)
...
(json_is_range)=
## [`json_is_range()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L2516)
...
(json_list_find)=
## [`json_list_find()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L2472)
...
(json_list_int)=
## [`json_list_int()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L2410)
...
(json_list_int_index)=
## [`json_list_int_index()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L2442)
...
(json_list_update)=
## [`json_list_update()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L2491)
...
(json_listsrange2set)=
## [`json_listsrange2set()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L2576)
...
(json_range_list)=
## [`json_range_list()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L2547)
...
(json_size)=
## [`json_size()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.h#L138)
...
(empty_json)=
## [`empty_json()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.h#L161)
...
(json_absent)=
## [`json_absent()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.h#L172)
