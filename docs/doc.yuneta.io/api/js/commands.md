...
(js_SDataDesc)=
### [`SDataDesc`](https://github.com/artgins/gobj-js/blob/7.25.4/src/gobj.js#L139)
...
(js_SDATA_END)=
### [`SDATA_END()`](https://github.com/artgins/gobj-js/blob/7.25.4/src/gobj.js#L156)
...
(js_SDATACM)=
### [`SDATACM(type, name, alias, items, json_fn, description)`](https://github.com/artgins/gobj-js/blob/7.25.4/src/gobj.js#L158)
...
(js_SDATACM2)=
### [`SDATACM2(type, name, flag, alias, items, json_fn, description)`](https://github.com/artgins/gobj-js/blob/7.25.4/src/gobj.js#L159)
...
(js_SDATAPM)=
### [`SDATAPM(type, name, flag, default_value, description)`](https://github.com/artgins/gobj-js/blob/7.25.4/src/gobj.js#L160)
...
(js_SDATAPM0)=
### [`SDATAPM0(type, name, flag, authpth, description)`](https://github.com/artgins/gobj-js/blob/7.25.4/src/gobj.js#L162)
...
(js_SDATAAUTHZ)=
### [`SDATAAUTHZ(type, name, flag, alias, items, description)`](https://github.com/artgins/gobj-js/blob/7.25.4/src/gobj.js#L161)
...
(js_SDATADF)=
### [`SDATADF(type, name, flag, header, fillspace, description)`](https://github.com/artgins/gobj-js/blob/7.25.4/src/gobj.js#L163)
