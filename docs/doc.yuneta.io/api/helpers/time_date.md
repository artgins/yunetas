...
(current_timestamp)=
## [`current_timestamp()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L5289)
...
(date_mode_from_type)=
## [`date_mode_from_type()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L3670)
...
(date_overflows)=
## [`date_overflows()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L4837)
...
(datestamp)=
## [`datestamp()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L4389)
...
(formatdate)=
## [`formatdate()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L5648)
...
(htonll)=
## [`htonll()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L5500)
...
(list_open_files)=
## [`list_open_files()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L5530)
...
(ntohll)=
## [`ntohll()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L5515)
...
(parse_date)=
## [`parse_date()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L4321)
...
(parse_date_basic)=
## [`parse_date_basic()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L4227)
...
(parse_date_format)=
## [`parse_date_format()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L4359)
...
(parse_expiry_date)=
## [`parse_expiry_date()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L4299)
...
(show_date)=
## [`show_date()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L3679)
...
(show_date_relative)=
## [`show_date_relative()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L3593)
...
(start_msectimer)=
## [`start_msectimer()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L5363)
...
(start_sectimer)=
## [`start_sectimer()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L5334)
...
(t2timestamp)=
## [`t2timestamp()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L5315)
...
(test_msectimer)=
## [`test_msectimer()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L5373)
...
(test_sectimer)=
## [`test_sectimer()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L5346)
...
(time_in_seconds)=
## [`time_in_seconds()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L5413)
...
(tm2timestamp)=
## [`tm2timestamp()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L5306)
...
(tm_to_time_t)=
## [`tm_to_time_t()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L3469)
...
(get_days_range)=
## [`get_days_range()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L7706)
...
(get_hours_range)=
## [`get_hours_range()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L7674)
...
(get_months_range)=
## [`get_months_range()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L7782)
...
(get_weeks_range)=
## [`get_weeks_range()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L7737)
...
(get_years_range)=
## [`get_years_range()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L7813)
...
(gmtime2timezone)=
## [`gmtime2timezone()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L5592)
...
## [`time_in_milliseconds()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L5400)
...
## [`time_in_milliseconds_monotonic()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L5388)
