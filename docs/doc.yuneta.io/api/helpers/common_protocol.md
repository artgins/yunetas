...
(comm_prot_free)=
## [`comm_prot_free()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L6599)
...
## [`comm_prot_get_gclass()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L6572)
...
(comm_prot_register)=
## [`comm_prot_register()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L6543)
...
(get_peername)=
## [`get_peername()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L7530)
...
(get_sockname)=
## [`get_sockname()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L7549)
...
(is_tcp_socket)=
## [`is_tcp_socket()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L7458)
...
(is_udp_socket)=
## [`is_udp_socket()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L7475)
...
## [`print_socket_address()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L7492)
...
## [`set_tcp_socket_options()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L7429)
