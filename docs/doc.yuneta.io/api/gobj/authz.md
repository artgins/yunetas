...
- [`c_authz.h`](https://github.com/artgins/yunetas/blob/7.13.1/kernel/c/root-linux/src/c_authz.h)

(gobj_authenticate)=
## [`gobj_authenticate()`](https://github.com/artgins/yunetas/blob/7.13.1/kernel/c/gobj-c/src/gobj.c#L9549)
...
(gobj_authz)=
## [`gobj_authz()`](https://github.com/artgins/yunetas/blob/7.13.1/kernel/c/gobj-c/src/gobj.c#L9683)
...
(gobj_authzs)=
## [`gobj_authzs()`](https://github.com/artgins/yunetas/blob/7.13.1/kernel/c/gobj-c/src/gobj.c#L9673)
...
## [`gobj_get_global_authz_table()`](https://github.com/artgins/yunetas/blob/7.13.1/kernel/c/gobj-c/src/gobj.c#L9762)
...
(gobj_user_has_authz)=
## [`gobj_user_has_authz()`](https://github.com/artgins/yunetas/blob/7.13.1/kernel/c/gobj-c/src/gobj.c#L9705)
...
## [`authz_get_level_desc()`](https://github.com/artgins/yunetas/blob/7.13.1/kernel/c/gobj-c/src/gobj.c#L9770)
...
## [`gobj_build_authzs_doc()`](https://github.com/artgins/yunetas/blob/7.13.1/kernel/c/gobj-c/src/gobj.c#L9813)
...
(authzs_list)=
## [`authzs_list()`](https://github.com/artgins/yunetas/blob/7.13.1/kernel/c/gobj-c/src/gobj.c#L9603)
...
(authz_checker)=
## [`authz_checker()`](https://github.com/artgins/yunetas/blob/7.13.1/kernel/c/root-linux/src/c_authz.c#L4550)
...
## [`authentication_parser()`](https://github.com/artgins/yunetas/blob/7.13.1/kernel/c/root-linux/src/c_authz.c#L4638)
