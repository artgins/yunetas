...
(get_hostname)=
## [`get_hostname()`](https://github.com/artgins/yunetas/blob/7.17.0/kernel/c/gobj-c/src/helpers.c#L5708)
...
(node_uuid)=
## [`node_uuid()`](https://github.com/artgins/yunetas/blob/7.17.0/kernel/c/gobj-c/src/helpers.c#L5858)
...
(check_open_fds)=
## [`check_open_fds()`](https://github.com/artgins/yunetas/blob/7.17.0/kernel/c/gobj-c/src/helpers.c#L6978)
...
(cpu_usage)=
## [`cpu_usage()`](https://github.com/artgins/yunetas/blob/7.17.0/kernel/c/gobj-c/src/helpers.c#L5441)
...
(cpu_usage_percent)=
## [`cpu_usage_percent()`](https://github.com/artgins/yunetas/blob/7.17.0/kernel/c/gobj-c/src/helpers.c#L5477)
...
(create_random_uuid)=
## [`create_random_uuid()`](https://github.com/artgins/yunetas/blob/7.17.0/kernel/c/gobj-c/src/helpers.c#L5734)
...
(free_ram_in_kb)=
## [`free_ram_in_kb()`](https://github.com/artgins/yunetas/blob/7.17.0/kernel/c/gobj-c/src/helpers.c#L6532)
...
## [`get_name_from_nn_table()`](https://github.com/artgins/yunetas/blob/7.17.0/kernel/c/gobj-c/src/helpers.c#L7671)
...
## [`get_number_from_nn_table()`](https://github.com/artgins/yunetas/blob/7.17.0/kernel/c/gobj-c/src/helpers.c#L7650)
...
(get_yunetas_base)=
## [`get_yunetas_base()`](https://github.com/artgins/yunetas/blob/7.17.0/kernel/c/gobj-c/src/helpers.c#L7512)
...
(is_yuneta_user)=
## [`is_yuneta_user()`](https://github.com/artgins/yunetas/blob/7.17.0/kernel/c/gobj-c/src/helpers.c#L7444)
...
(print_open_fds)=
## [`print_open_fds()`](https://github.com/artgins/yunetas/blob/7.17.0/kernel/c/gobj-c/src/helpers.c#L7014)
...
## [`source2base64_for_yunetas()`](https://github.com/artgins/yunetas/blob/7.17.0/kernel/c/gobj-c/src/helpers.c#L7545)
...
(total_ram_in_kb)=
## [`total_ram_in_kb()`](https://github.com/artgins/yunetas/blob/7.17.0/kernel/c/gobj-c/src/helpers.c#L6579)
...
(yuneta_getgrnam)=
## [`yuneta_getgrnam()`](https://github.com/artgins/yunetas/blob/7.17.0/kernel/c/gobj-c/src/helpers.c#L7418)
...
(yuneta_getgrouplist)=
## [`yuneta_getgrouplist()`](https://github.com/artgins/yunetas/blob/7.17.0/kernel/c/gobj-c/src/helpers.c#L7427)
...
(yuneta_getpwnam)=
## [`yuneta_getpwnam()`](https://github.com/artgins/yunetas/blob/7.17.0/kernel/c/gobj-c/src/helpers.c#L7409)
...
(yuneta_getpwuid)=
## [`yuneta_getpwuid()`](https://github.com/artgins/yunetas/blob/7.17.0/kernel/c/gobj-c/src/helpers.c#L7400)
