...
(iev_create2)=
## [`iev_create2()`](https://github.com/artgins/yunetas/blob/7.8.5/kernel/c/root-linux/src/msg_ievent.c#L81)
...
## [`iev_create_to_gbuffer()`](https://github.com/artgins/yunetas/blob/7.8.5/kernel/c/root-linux/src/msg_ievent.c#L107)
...
## [`iev_create_from_gbuffer()`](https://github.com/artgins/yunetas/blob/7.8.5/kernel/c/root-linux/src/msg_ievent.c#L152)
...
(msg_iev_pop_stack)=
## [`msg_iev_pop_stack()`](https://github.com/artgins/yunetas/blob/7.8.5/kernel/c/root-linux/src/msg_ievent.c#L425)
...
## [`msg_iev_set_back_metadata()`](https://github.com/artgins/yunetas/blob/7.8.5/kernel/c/root-linux/src/msg_ievent.c#L506)
...
## [`msg_iev_build_response()`](https://github.com/artgins/yunetas/blob/7.8.5/kernel/c/root-linux/src/msg_ievent.c#L547)
...
## [`msg_iev_build_response_without_reverse_dst()`](https://github.com/artgins/yunetas/blob/7.8.5/kernel/c/root-linux/src/msg_ievent.c#L563)
...
## [`msg_iev_clean_metadata()`](https://github.com/artgins/yunetas/blob/7.8.5/kernel/c/root-linux/src/msg_ievent.c#L584)
...
(trace_inter_event2)=
## [`trace_inter_event2()`](https://github.com/artgins/yunetas/blob/7.8.5/kernel/c/root-linux/src/msg_ievent.c#L647)
