...
`--url`/`-u`, plus the same OAuth2 / OIDC flags as `ycommand` (`--issuer`/`-I`,
...
- [`utils/c/mqtt_tui/README.md`](https://github.com/artgins/yunetas/blob/main/utils/c/mqtt_tui/README.md).
