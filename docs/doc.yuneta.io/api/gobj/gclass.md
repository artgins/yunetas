...
(gclass2json)=
## [`gclass2json()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L7232)
...
## [`gclass_add_ev_action()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L954)
...
## [`gclass_add_event_type()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L1035)
...
(gclass_add_state)=
## [`gclass_add_state()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L873)
...
(gclass_attr_desc)=
## [`gclass_attr_desc()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L3410)
...
(gclass_authz_desc)=
## [`gclass_authz_desc()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L3396)
...
(gclass_check_fsm)=
## [`gclass_check_fsm()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L1281)
...
(gclass_command_desc)=
## [`gclass_command_desc()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L6488)
...
(gclass_create)=
## [`gclass_create()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L721)
...
(gclass_find_by_name)=
## [`gclass_find_by_name()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L1200)
...
(gclass_event_type)=
## [`gclass_event_type()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L1265)
...
## [`gclass_find_public_event()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L1079)
...
(gclass_gclass_name)=
## [`gclass_gclass_name()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L1132)
...
## [`gclass_gclass_register()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L1172)
...
(gclass_has_attr)=
## [`gclass_has_attr()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L1145)
...
(gclass_unregister)=
## [`gclass_unregister()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L1091)
