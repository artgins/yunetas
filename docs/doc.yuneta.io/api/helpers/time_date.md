...
(current_timestamp)=
## [`current_timestamp()`](https://github.com/artgins/yunetas/blob/7.17.2/kernel/c/gobj-c/src/helpers.c#L5307)
...
(date_mode_from_type)=
## [`date_mode_from_type()`](https://github.com/artgins/yunetas/blob/7.17.2/kernel/c/gobj-c/src/helpers.c#L3688)
...
(date_overflows)=
## [`date_overflows()`](https://github.com/artgins/yunetas/blob/7.17.2/kernel/c/gobj-c/src/helpers.c#L4855)
...
(datestamp)=
## [`datestamp()`](https://github.com/artgins/yunetas/blob/7.17.2/kernel/c/gobj-c/src/helpers.c#L4407)
...
(formatdate)=
## [`formatdate()`](https://github.com/artgins/yunetas/blob/7.17.2/kernel/c/gobj-c/src/helpers.c#L5666)
...
(htonll)=
## [`htonll()`](https://github.com/artgins/yunetas/blob/7.17.2/kernel/c/gobj-c/src/helpers.c#L5518)
...
(list_open_files)=
## [`list_open_files()`](https://github.com/artgins/yunetas/blob/7.17.2/kernel/c/gobj-c/src/helpers.c#L5548)
...
(ntohll)=
## [`ntohll()`](https://github.com/artgins/yunetas/blob/7.17.2/kernel/c/gobj-c/src/helpers.c#L5533)
...
(parse_date)=
## [`parse_date()`](https://github.com/artgins/yunetas/blob/7.17.2/kernel/c/gobj-c/src/helpers.c#L4339)
...
(parse_date_basic)=
## [`parse_date_basic()`](https://github.com/artgins/yunetas/blob/7.17.2/kernel/c/gobj-c/src/helpers.c#L4245)
...
(parse_date_format)=
## [`parse_date_format()`](https://github.com/artgins/yunetas/blob/7.17.2/kernel/c/gobj-c/src/helpers.c#L4377)
...
(parse_expiry_date)=
## [`parse_expiry_date()`](https://github.com/artgins/yunetas/blob/7.17.2/kernel/c/gobj-c/src/helpers.c#L4317)
...
(show_date)=
## [`show_date()`](https://github.com/artgins/yunetas/blob/7.17.2/kernel/c/gobj-c/src/helpers.c#L3697)
...
(show_date_relative)=
## [`show_date_relative()`](https://github.com/artgins/yunetas/blob/7.17.2/kernel/c/gobj-c/src/helpers.c#L3611)
...
(start_msectimer)=
## [`start_msectimer()`](https://github.com/artgins/yunetas/blob/7.17.2/kernel/c/gobj-c/src/helpers.c#L5381)
...
(start_sectimer)=
## [`start_sectimer()`](https://github.com/artgins/yunetas/blob/7.17.2/kernel/c/gobj-c/src/helpers.c#L5352)
...
(t2timestamp)=
## [`t2timestamp()`](https://github.com/artgins/yunetas/blob/7.17.2/kernel/c/gobj-c/src/helpers.c#L5333)
...
(test_msectimer)=
## [`test_msectimer()`](https://github.com/artgins/yunetas/blob/7.17.2/kernel/c/gobj-c/src/helpers.c#L5391)
...
(test_sectimer)=
## [`test_sectimer()`](https://github.com/artgins/yunetas/blob/7.17.2/kernel/c/gobj-c/src/helpers.c#L5364)
...
(time_in_seconds)=
## [`time_in_seconds()`](https://github.com/artgins/yunetas/blob/7.17.2/kernel/c/gobj-c/src/helpers.c#L5431)
...
(tm2timestamp)=
## [`tm2timestamp()`](https://github.com/artgins/yunetas/blob/7.17.2/kernel/c/gobj-c/src/helpers.c#L5324)
...
(tm_to_time_t)=
## [`tm_to_time_t()`](https://github.com/artgins/yunetas/blob/7.17.2/kernel/c/gobj-c/src/helpers.c#L3487)
...
(get_days_range)=
## [`get_days_range()`](https://github.com/artgins/yunetas/blob/7.17.2/kernel/c/gobj-c/src/helpers.c#L7724)
...
(get_hours_range)=
## [`get_hours_range()`](https://github.com/artgins/yunetas/blob/7.17.2/kernel/c/gobj-c/src/helpers.c#L7692)
...
(get_months_range)=
## [`get_months_range()`](https://github.com/artgins/yunetas/blob/7.17.2/kernel/c/gobj-c/src/helpers.c#L7800)
...
(get_weeks_range)=
## [`get_weeks_range()`](https://github.com/artgins/yunetas/blob/7.17.2/kernel/c/gobj-c/src/helpers.c#L7755)
...
(get_years_range)=
## [`get_years_range()`](https://github.com/artgins/yunetas/blob/7.17.2/kernel/c/gobj-c/src/helpers.c#L7831)
...
(gmtime2timezone)=
## [`gmtime2timezone()`](https://github.com/artgins/yunetas/blob/7.17.2/kernel/c/gobj-c/src/helpers.c#L5610)
...
## [`time_in_milliseconds()`](https://github.com/artgins/yunetas/blob/7.17.2/kernel/c/gobj-c/src/helpers.c#L5418)
...
## [`time_in_milliseconds_monotonic()`](https://github.com/artgins/yunetas/blob/7.17.2/kernel/c/gobj-c/src/helpers.c#L5406)
