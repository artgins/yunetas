...
## [`gobj_create_resource()`](https://github.com/artgins/yunetas/blob/7.11.0/kernel/c/gobj-c/src/gobj.c#L9947)
...
## [`gobj_delete_resource()`](https://github.com/artgins/yunetas/blob/7.11.0/kernel/c/gobj-c/src/gobj.c#L10031)
...
(gobj_get_resource)=
## [`gobj_get_resource()`](https://github.com/artgins/yunetas/blob/7.11.0/kernel/c/gobj-c/src/gobj.c#L10116)
...
(gobj_list_resource)=
## [`gobj_list_resource()`](https://github.com/artgins/yunetas/blob/7.11.0/kernel/c/gobj-c/src/gobj.c#L10079)
...
(gobj_save_resource)=
## [`gobj_save_resource()`](https://github.com/artgins/yunetas/blob/7.11.0/kernel/c/gobj-c/src/gobj.c#L9985)
