...
- [`helpers.h`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.h)
- [`helpers.c`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c)

(anystring2json)=
## [`anystring2json()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L2439)
...
(bits2gbuffer)=
## [`bits2gbuffer()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L1896)
...
(bits2jn_strlist)=
## [`bits2jn_strlist()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L1877)
...
(cmp_two_simple_json)=
## [`cmp_two_simple_json()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L2345)
...
(create_json_record)=
## [`create_json_record()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L1705)
...
(debug_json)=
## [`debug_json()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L5192)
...
(get_real_precision)=
## [`get_real_precision()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L2628)
...
(jn2bool)=
## [`jn2bool()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L2320)
...
(jn2integer)=
## [`jn2integer()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L2266)
...
(jn2real)=
## [`jn2real()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L2243)
...
(jn2string)=
## [`jn2string()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L2295)
...
(json2str)=
## [`json2str()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L2637)
...
(json2uglystr)=
## [`json2uglystr()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L2650)
...
## [`json_check_refcounts()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L2686)
...
(json_config)=
## [`json_config()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/json_config.c#L333)
...
(json_desc_to_schema)=
## [`json_desc_to_schema()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L1845)
...
(json_is_identical)=
## [`json_is_identical()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L2419)
...
(json_list_str_index)=
## [`json_list_str_index()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L1955)
...
## [`json_print_refcounts()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L2844)
...
(json_str_in_list)=
## [`json_str_in_list()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L2938)
...
(load_json_from_file)=
## [`load_json_from_file()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L1547)
...
## [`load_persistent_json()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L1467)
...
(print_json)=
## [`print_json()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L5038)
...
(save_json_to_file)=
## [`save_json_to_file()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L1595)
...
(set_real_precision)=
## [`set_real_precision()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L2622)
...
(string2json)=
## [`string2json()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L2506)
...
(strings2bits)=
## [`strings2bits()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L1928)
...
(anyfile2json)=
## [`anyfile2json()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L2477)
...
(is_metadata_key)=
## [`is_metadata_key()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L5833)
...
(is_private_key)=
## [`is_private_key()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L5854)
...
## [`json_config_string2json()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L2533)
...
## [`json_dict_recursive_update()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L2197)
...
(json_is_range)=
## [`json_is_range()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L2097)
...
(json_list_find)=
## [`json_list_find()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L2053)
...
(json_list_int)=
## [`json_list_int()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L1991)
...
(json_list_int_index)=
## [`json_list_int_index()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L2023)
...
(json_list_update)=
## [`json_list_update()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L2072)
...
(json_listsrange2set)=
## [`json_listsrange2set()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L2157)
...
(json_range_list)=
## [`json_range_list()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L2128)
...
(json_size)=
## [`json_size()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/gobj-c/src/helpers.c#L2662)
