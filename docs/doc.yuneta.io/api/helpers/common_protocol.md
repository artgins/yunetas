...
(comm_prot_free)=
## [`comm_prot_free()`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/gobj-c/src/helpers.c#L6003)
...
## [`comm_prot_get_gclass()`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/gobj-c/src/helpers.c#L5976)
...
(comm_prot_register)=
## [`comm_prot_register()`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/gobj-c/src/helpers.c#L5947)
...
(get_peername)=
## [`get_peername()`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/gobj-c/src/helpers.c#L6934)
...
(get_sockname)=
## [`get_sockname()`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/gobj-c/src/helpers.c#L6953)
...
(is_tcp_socket)=
## [`is_tcp_socket()`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/gobj-c/src/helpers.c#L6862)
...
(is_udp_socket)=
## [`is_udp_socket()`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/gobj-c/src/helpers.c#L6879)
...
## [`print_socket_address()`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/gobj-c/src/helpers.c#L6896)
...
## [`set_tcp_socket_options()`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/gobj-c/src/helpers.c#L6833)
