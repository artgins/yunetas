...
(yuno_event_loop)=
## [`yuno_event_loop()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/root-linux/src/c_yuno.c#L5604)
...
(yuno_event_detroy)=
## [`yuno_event_detroy()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/root-linux/src/c_yuno.c#L5612)
...
(set_yuno_must_die)=
## [`set_yuno_must_die()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/root-linux/src/c_yuno.c#L5623)
...
(is_ip_allowed)=
## [`is_ip_allowed()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/root-linux/src/c_yuno.c#L5642)
...
(add_allowed_ip)=
## [`add_allowed_ip()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/root-linux/src/c_yuno.c#L5657)
...
(remove_allowed_ip)=
## [`remove_allowed_ip()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/root-linux/src/c_yuno.c#L5673)
...
(is_ip_denied)=
## [`is_ip_denied()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/root-linux/src/c_yuno.c#L5685)
...
(add_denied_ip)=
## [`add_denied_ip()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/root-linux/src/c_yuno.c#L5700)
...
(remove_denied_ip)=
## [`remove_denied_ip()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/root-linux/src/c_yuno.c#L5716)
