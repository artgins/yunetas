...
(get_hostname)=
## [`get_hostname()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L5690)
...
(node_uuid)=
## [`node_uuid()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L5840)
...
(check_open_fds)=
## [`check_open_fds()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L6960)
...
(cpu_usage)=
## [`cpu_usage()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L5423)
...
(cpu_usage_percent)=
## [`cpu_usage_percent()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L5459)
...
(create_random_uuid)=
## [`create_random_uuid()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L5716)
...
(free_ram_in_kb)=
## [`free_ram_in_kb()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L6514)
...
## [`get_name_from_nn_table()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L7653)
...
## [`get_number_from_nn_table()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L7632)
...
(get_yunetas_base)=
## [`get_yunetas_base()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L7494)
...
(is_yuneta_user)=
## [`is_yuneta_user()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L7426)
...
(print_open_fds)=
## [`print_open_fds()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L6996)
...
## [`source2base64_for_yunetas()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L7527)
...
(total_ram_in_kb)=
## [`total_ram_in_kb()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L6561)
...
(yuneta_getgrnam)=
## [`yuneta_getgrnam()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L7400)
...
(yuneta_getgrouplist)=
## [`yuneta_getgrouplist()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L7409)
...
(yuneta_getpwnam)=
## [`yuneta_getpwnam()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L7391)
...
(yuneta_getpwuid)=
## [`yuneta_getpwuid()`](https://github.com/artgins/yunetas/blob/7.25.0/kernel/c/gobj-c/src/helpers.c#L7382)
