...
- [`tr_treedb.c`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c)

(_treedb_create_topic_cols_desc)=
## [`_treedb_create_topic_cols_desc()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L518)
...
(add_jtree_path)=
## [`add_jtree_path()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L10402)
...
## [`create_template_record()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L13599)
...
(current_snap_tag)=
## [`current_snap_tag()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L167)
...
(decode_child_ref)=
## [`decode_child_ref()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L4220)
...
(decode_parent_ref)=
## [`decode_parent_ref()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L4166)
...
(node_collapsed_view)=
## [`node_collapsed_view()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L9350)
...
(parse_hooks)=
## [`parse_hooks()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L2338)
...
(parse_schema)=
## [`parse_schema()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L2250)
...
(parse_schema_cols)=
## [`parse_schema_cols()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L2285)
...
(set_volatil_values)=
## [`set_volatil_values()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L3331)
...
## [`treedb_activate_snap()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L13461)
...
(treedb_autolink)=
## [`treedb_autolink()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L8424)
...
(treedb_clean_node)=
## [`treedb_clean_node()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L8351)
...
(treedb_close_db)=
## [`treedb_close_db()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L1333)
...
(treedb_close_topic)=
## [`treedb_close_topic()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L1809)
...
(treedb_create_node)=
## [`treedb_create_node()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L5395)
...
(treedb_create_topic)=
## [`treedb_create_topic()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L1452)
...
## [`treedb_delete_instance()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L6807)
...
(treedb_delete_node)=
## [`treedb_delete_node()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L6325)
...
(treedb_delete_topic)=
## [`treedb_delete_topic()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L1859)
...
(treedb_get_id_index)=
## [`treedb_get_id_index()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L294)
...
(treedb_get_instance)=
## [`treedb_get_instance()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L9291)
...
(treedb_get_node)=
## [`treedb_get_node()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L9248)
...
## [`treedb_get_topic_hooks()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L10634)
...
## [`treedb_get_topic_links()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L10593)
...
## [`treedb_is_treedbs_topic()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L279)
...
(treedb_link_nodes)=
## [`treedb_link_nodes()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L8869)
...
## [`treedb_list_instances()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L9622)
...
(treedb_list_nodes)=
## [`treedb_list_nodes()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L9481)
...
(treedb_list_parents)=
## [`treedb_list_parents()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L10097)
...
(treedb_list_snaps)=
## [`treedb_list_snaps()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L13579)
...
(treedb_list_treedb)=
## [`treedb_list_treedb()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L1914)
...
## [`treedb_node_children()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L10346)
...
(treedb_node_jtree)=
## [`treedb_node_jtree()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L10518)
...
(treedb_open_db)=
## [`treedb_open_db()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L604)
...
([`treedb_schema_yuneta_agent.c`](https://github.com/artgins/yunetas/blob/7.22.0/yunos/c/yuno_agent/src/treedb_schema_yuneta_agent.c)):
...
(treedb_parent_refs)=
## [`treedb_parent_refs()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L10007)
...
## [`treedb_replace_links()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L8718)
...
(treedb_set_callback)=
## [`treedb_set_callback()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L1288)
...
## [`treedb_set_node_immutable()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L6086)
...
(treedb_set_trace)=
## [`treedb_set_trace()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L5065)
...
(treedb_shoot_snap)=
## [`treedb_shoot_snap()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L13268)
...
(treedb_topic_pkey2s)=
## [`treedb_topic_pkey2s()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L180)
...
## [`treedb_topic_pkey2s_filter()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L195)
...
## [`treedb_create_system_schema()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L487)
...
(treedb_topic_size)=
## [`treedb_topic_size()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L1996)
...
(treedb_topics)=
## [`treedb_topics()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L1947)
...
(treedb_unlink_nodes)=
## [`treedb_unlink_nodes()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L8947)
...
(treedb_update_node)=
## [`treedb_update_node()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L6137)
...
(get_hook_list)=
## [`get_hook_list()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L5075)
...
## [`topic_desc_fkey_names()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L2559)
...
## [`topic_desc_hook_names()`](https://github.com/artgins/yunetas/blob/7.22.0/kernel/c/timeranger2/src/tr_treedb.c#L2534)
