...
Defined in [`treedb_schema_yuneta_agent.c`](https://github.com/artgins/yunetas/blob/7.5.6/yunos/c/yuno_agent/src/treedb_schema_yuneta_agent.c). Required fields (all
...
- [`c_agent.c`](https://github.com/artgins/yunetas/blob/7.5.6/yunos/c/yuno_agent/src/c_agent.c) — builds the URL when computing a yuno's working
  directory:
...
Because the four parts (`name`, [`role`](https://github.com/artgins/yunetas/blob/7.5.6/utils/c/yuno-skeleton/make_skeleton.c#L195), `env`, plus `owner`) are
...
Built by [`build_yuno_private_domain()`](https://github.com/artgins/yunetas/blob/7.5.6/yunos/c/yuno_agent/src/c_agent.c#L7388) at [`c_agent.c`](https://github.com/artgins/yunetas/blob/7.5.6/yunos/c/yuno_agent/src/c_agent.c):
...
Registered in the agent's command table at [`c_agent.c`](https://github.com/artgins/yunetas/blob/7.5.6/yunos/c/yuno_agent/src/c_agent.c). Same
...
Handler at [`c_agent.c`](https://github.com/artgins/yunetas/blob/7.5.6/yunos/c/yuno_agent/src/c_agent.c). Schema `pm_create_realm`.
...
Handler at [`c_agent.c`](https://github.com/artgins/yunetas/blob/7.5.6/yunos/c/yuno_agent/src/c_agent.c). Schema `pm_update_realm`.
...
Handler at [`c_agent.c`](https://github.com/artgins/yunetas/blob/7.5.6/yunos/c/yuno_agent/src/c_agent.c).
...
([`treedb_schema_yuneta_agent.c`](https://github.com/artgins/yunetas/blob/7.5.6/yunos/c/yuno_agent/src/treedb_schema_yuneta_agent.c)). One realm has N yunos
(`realms.yunos` hook); one yuno belongs to exactly one realm.

At `run-yuno` time the agent reads the realm record to compute the
working directory ([`c_agent.c`](https://github.com/artgins/yunetas/blob/7.5.6/yunos/c/yuno_agent/src/c_agent.c)):
...
Agent-level attributes ([`c_agent.c`](https://github.com/artgins/yunetas/blob/7.5.6/yunos/c/yuno_agent/src/c_agent.c)):
...
Allocation in [`get_new_service_port()`](https://github.com/artgins/yunetas/blob/7.5.6/yunos/c/yuno_agent/src/c_agent.c#L9092) at [`c_agent.c`](https://github.com/artgins/yunetas/blob/7.5.6/yunos/c/yuno_agent/src/c_agent.c) reads the
...
Agent-level ([`c_agent.c`](https://github.com/artgins/yunetas/blob/7.5.6/yunos/c/yuno_agent/src/c_agent.c)): a single
...
The agent has one `__username__` attribute ([`c_agent.c`](https://github.com/artgins/yunetas/blob/7.5.6/yunos/c/yuno_agent/src/c_agent.c)) with
...
Nothing in [`c_agent.c`](https://github.com/artgins/yunetas/blob/7.5.6/yunos/c/yuno_agent/src/c_agent.c)'s start path checks it before running yunos of a
...
pool is on the agent ([`c_agent.c`](https://github.com/artgins/yunetas/blob/7.5.6/yunos/c/yuno_agent/src/c_agent.c)). If you find code reading
...
| What                                              | Where                                                              |
|---------------------------------------------------|--------------------------------------------------------------------|
| `realms` topic schema                             | [`treedb_schema_yuneta_agent.c`](https://github.com/artgins/yunetas/blob/7.5.6/yunos/c/yuno_agent/src/treedb_schema_yuneta_agent.c)                             |
| `create-realm` handler                            | [`yunos/c/yuno_agent/src/c_agent.c`](https://github.com/artgins/yunetas/blob/7.5.6/yunos/c/yuno_agent/src/c_agent.c)                       |
| `update-realm` handler                            | [`c_agent.c`](https://github.com/artgins/yunetas/blob/7.5.6/yunos/c/yuno_agent/src/c_agent.c)                                              |
| `delete-realm` handler                            | [`c_agent.c`](https://github.com/artgins/yunetas/blob/7.5.6/yunos/c/yuno_agent/src/c_agent.c)                                              |
| Realm URL composition (`<name>.<role>.<env>`)     | [`c_agent.c`](https://github.com/artgins/yunetas/blob/7.5.6/yunos/c/yuno_agent/src/c_agent.c)                                              |
| Yuno working-dir from realm                       | [`c_agent.c`](https://github.com/artgins/yunetas/blob/7.5.6/yunos/c/yuno_agent/src/c_agent.c) (`build_yuno_private_domain`)                |
| Agent's port pool                                 | [`c_agent.c`](https://github.com/artgins/yunetas/blob/7.5.6/yunos/c/yuno_agent/src/c_agent.c)                                     |
| Agent's cert sync attrs                           | [`c_agent.c`](https://github.com/artgins/yunetas/blob/7.5.6/yunos/c/yuno_agent/src/c_agent.c)                                                |
| `bind_ip` default                                 | [`treedb_schema_yuneta_agent.c`](https://github.com/artgins/yunetas/blob/7.5.6/yunos/c/yuno_agent/src/treedb_schema_yuneta_agent.c) (realms topic, `bind_ip` field)     |
| `parent_realm_id` self-fkey                       | [`treedb_schema_yuneta_agent.c`](https://github.com/artgins/yunetas/blob/7.5.6/yunos/c/yuno_agent/src/treedb_schema_yuneta_agent.c)                                 |
| `realms.yunos` hook                               | [`treedb_schema_yuneta_agent.c`](https://github.com/artgins/yunetas/blob/7.5.6/yunos/c/yuno_agent/src/treedb_schema_yuneta_agent.c)                                 |
