...
(yuno_event_loop)=
## [`yuno_event_loop()`](https://github.com/artgins/yunetas/blob/7.9.3/kernel/c/root-linux/src/c_yuno.c#L5690)
...
(yuno_event_detroy)=
## [`yuno_event_detroy()`](https://github.com/artgins/yunetas/blob/7.9.3/kernel/c/root-linux/src/c_yuno.c#L5698)
...
(set_yuno_must_die)=
## [`set_yuno_must_die()`](https://github.com/artgins/yunetas/blob/7.9.3/kernel/c/root-linux/src/c_yuno.c#L5709)
...
(is_ip_allowed)=
## [`is_ip_allowed()`](https://github.com/artgins/yunetas/blob/7.9.3/kernel/c/root-linux/src/c_yuno.c#L5728)
...
(add_allowed_ip)=
## [`add_allowed_ip()`](https://github.com/artgins/yunetas/blob/7.9.3/kernel/c/root-linux/src/c_yuno.c#L5743)
...
(remove_allowed_ip)=
## [`remove_allowed_ip()`](https://github.com/artgins/yunetas/blob/7.9.3/kernel/c/root-linux/src/c_yuno.c#L5759)
...
(is_ip_denied)=
## [`is_ip_denied()`](https://github.com/artgins/yunetas/blob/7.9.3/kernel/c/root-linux/src/c_yuno.c#L5771)
...
(add_denied_ip)=
## [`add_denied_ip()`](https://github.com/artgins/yunetas/blob/7.9.3/kernel/c/root-linux/src/c_yuno.c#L5786)
...
(remove_denied_ip)=
## [`remove_denied_ip()`](https://github.com/artgins/yunetas/blob/7.9.3/kernel/c/root-linux/src/c_yuno.c#L5802)
