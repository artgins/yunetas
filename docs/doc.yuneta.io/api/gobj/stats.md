...
(gobj_stats)=
## [`gobj_stats()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/gobj.c#L4926)
...
(gobj_decr_stat)=
## [`gobj_decr_stat()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/gobj.c#L9637)
...
(gobj_get_stat)=
## [`gobj_get_stat()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/gobj.c#L9653)
...
(gobj_incr_stat)=
## [`gobj_incr_stat()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/gobj.c#L9620)
...
(gobj_jn_stats)=
## [`gobj_jn_stats()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/gobj.c#L9664)
...
(gobj_set_stat)=
## [`gobj_set_stat()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/gobj.c#L9605)
