...
(js_trace_level_t)=
### [`trace_level_t`](https://github.com/artgins/gobj-js/blob/7.10.0/src/gobj.js#L400)
...
### [`gobj_set_global_trace(level, set)`](https://github.com/artgins/gobj-js/blob/7.10.0/src/gobj.js#L616)
...
### [`gobj_set_global_no_trace(level, set)`](https://github.com/artgins/gobj-js/blob/7.10.0/src/gobj.js#L630)
...
### [`gobj_global_trace_level()`](https://github.com/artgins/gobj-js/blob/7.10.0/src/gobj.js#L644)

Gives the global mask, as a number.

(js_gobj_repr_global_trace_levels)=
### [`gobj_repr_global_trace_levels()`](https://github.com/artgins/gobj-js/blob/7.10.0/src/gobj.js#L745)
...
### [`gobj_set_deep_trace(value)`](https://github.com/artgins/gobj-js/blob/7.10.0/src/gobj.js#L650)
...
### [`gobj_set_gclass_trace(gclass, level, set)`](https://github.com/artgins/gobj-js/blob/7.10.0/src/gobj.js#L660)
...
### [`gobj_set_gclass_no_trace(gclass, level, set)`](https://github.com/artgins/gobj-js/blob/7.10.0/src/gobj.js#L707)
...
### [`gobj_set_gobj_trace(gobj, level, set)`](https://github.com/artgins/gobj-js/blob/7.10.0/src/gobj.js#L679)

Turns a level on or off for one gobj. Returns `0`, or `-1` when `gobj` is empty.

(js_gobj_set_gobj_no_trace)=
### [`gobj_set_gobj_no_trace(gobj, level, set)`](https://github.com/artgins/gobj-js/blob/7.10.0/src/gobj.js#L726)

Silences a level for one gobj.

(js_gobj_trace_level)=
### [`gobj_trace_level(gobj)`](https://github.com/artgins/gobj-js/blob/7.10.0/src/gobj.js#L479)
...
### [`gobj_trace_no_level(gobj)`](https://github.com/artgins/gobj-js/blob/7.10.0/src/gobj.js#L494)
...
### [`gobj_set_trace_machine_format(format)`](https://github.com/artgins/gobj-js/blob/7.10.0/src/gobj.js#L364)

Chooses the format of the lines of the `machine` trace.

(js_gobj_trace_machine_format)=
### [`gobj_trace_machine_format()`](https://github.com/artgins/gobj-js/blob/7.10.0/src/gobj.js#L369)
