...
(glog_end)=
## [`glog_end()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/glogger.c#L208)
...
(glog_init)=
## [`glog_init()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/glogger.c#L172)
...
(gobj_get_log_data)=
## [`gobj_get_log_data()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/glogger.c#L583)
...
## [`gobj_get_log_priority_name()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/glogger.c#L572)
...
## [`gobj_log_add_handler()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/glogger.c#L281)
...
(gobj_log_alert)=
## [`gobj_log_alert()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/glogger.c#L482)
...
## [`gobj_log_clear_counters()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/glogger.c#L598)
...
(gobj_log_critical)=
## [`gobj_log_critical()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/glogger.c#L497)
...
(gobj_log_debug)=
## [`gobj_log_debug()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/glogger.c#L557)
...
## [`gobj_log_del_handler()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/glogger.c#L344)
...
(gobj_log_error)=
## [`gobj_log_error()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/glogger.c#L512)
...
## [`gobj_log_exist_handler()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/glogger.c#L256)
...
(gobj_log_info)=
## [`gobj_log_info()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/glogger.c#L542)
...
## [`gobj_log_last_message()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/glogger.c#L629)
...
## [`gobj_log_list_handlers()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/glogger.c#L386)
...
## [`gobj_log_register_handler()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/glogger.c#L231)
...
## [`gobj_log_set_global_handler_option()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/glogger.c#L415)
...
(gobj_log_warning)=
## [`gobj_log_warning()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/glogger.c#L527)
...
(print_backtrace)=
## [`print_backtrace()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/glogger.c#L751)
...
## [`set_show_backtrace_fn()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/glogger.c#L723)
...
(stdout_fwrite)=
## [`stdout_fwrite()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/glogger.c#L690)
...
(stdout_write)=
## [`stdout_write()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/glogger.c#L648)
...
(trace_vjson)=
## [`trace_vjson()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/glogger.c#L1114)
...
(_log_bf)=
## [`_log_bf()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/glogger.c#L945)
...
## [`gobj_log_clear_log_file()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/glogger.c#L611)
...
## [`set_trace_with_full_name()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/glogger.c#L741)
...
## [`set_trace_with_short_name()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/glogger.c#L731)
