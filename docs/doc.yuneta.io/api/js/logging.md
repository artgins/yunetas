...
[`src/sprintf.js`](https://github.com/artgins/gobj-js/blob/7.22.2/src/sprintf.js)
...
(js_log_error)=
### [`log_error(format, ...args)`](https://github.com/artgins/gobj-js/blob/7.22.2/src/helpers.js#L240)

Writes an error. It goes to the remote handler too.

(js_log_warning)=
### [`log_warning(format, ...args)`](https://github.com/artgins/gobj-js/blob/7.22.2/src/helpers.js#L260)

Writes a warning. It goes to the remote handler too.

(js_log_info)=
### [`log_info(format, ...args)`](https://github.com/artgins/gobj-js/blob/7.22.2/src/helpers.js#L280)

Writes an information message. It stays in the console.

(js_log_debug)=
### [`log_debug(format, ...args)`](https://github.com/artgins/gobj-js/blob/7.22.2/src/helpers.js#L293)
...
(js_trace_msg)=
### [`trace_msg(format, ...args)`](https://github.com/artgins/gobj-js/blob/7.22.2/src/helpers.js#L306)

Writes one line of trace.

(js_trace_json)=
### [`trace_json(json, msg)`](https://github.com/artgins/gobj-js/blob/7.22.2/src/helpers.js#L319)
...
### [`set_remote_log_functions(remote_log_fn)`](https://github.com/artgins/gobj-js/blob/7.22.2/src/helpers.js#L190)
...
(js_set_log_callback)=
### [`set_log_callback(callback)`](https://github.com/artgins/gobj-js/blob/7.22.2/src/helpers.js#L85)

Sends every log to one function of the application.

(js_set_console_log_enabled)=
### [`set_console_log_enabled(enabled)`](https://github.com/artgins/gobj-js/blob/7.22.2/src/helpers.js#L118)

Turns the write to the console on or off.

(js_set_console_log_filter)=
### [`set_console_log_filter(fn)`](https://github.com/artgins/gobj-js/blob/7.22.2/src/helpers.js#L139)
...
(js_sprintf)=
### [`sprintf(format, ...args)`](https://github.com/artgins/gobj-js/blob/7.22.2/src/sprintf.js#L24)

Builds a string in the style of `printf`.

(js_vsprintf)=
### [`vsprintf(fmt, argv)`](https://github.com/artgins/gobj-js/blob/7.22.2/src/sprintf.js#L29)
