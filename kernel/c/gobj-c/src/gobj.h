...
PUBLIC void gobj_set_shutdown(void); /* Mark shutdowning */
 ...
 *---------------------------------*/
PUBLIC json_t * gobj_service_register(void); /* Get list of registered services (gclass, service name, has-commands)*/
 ...
 *
    {
        ...
        'priority': 5,  // 0-9, 0 is highest priority (first running, last in stopping), default 5
