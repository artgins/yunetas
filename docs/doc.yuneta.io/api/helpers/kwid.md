...
- [`kwid.h`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.h)
- [`kwid.c`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c)

(kw_add_binary_type)=
## [`kw_add_binary_type()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L77)
...
(kw_clone_by_keys)=
## [`kw_clone_by_keys()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L2438)
...
## [`kw_clone_by_not_keys()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L2522)
...
(kw_clone_by_path)=
## [`kw_clone_by_path()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L2407)
...
(kw_collapse)=
## [`kw_collapse()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L2996)
...
(kw_decref)=
## [`kw_decref()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L340)
...
(kw_delete)=
## [`kw_delete()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L824)
...
## [`kw_delete_metadata_keys()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L2770)
...
## [`kw_delete_private_keys()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L2740)
...
(kw_delete_subkey)=
## [`kw_delete_subkey()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L875)
...
(kw_deserialize)=
## [`kw_deserialize()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L238)
...
(kw_duplicate)=
## [`kw_duplicate()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L2381)
...
(kw_filter_metadata)=
## [`kw_filter_metadata()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L3328)
...
(kw_filter_private)=
## [`kw_filter_private()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L3302)
...
## [`kw_find_json_in_list()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L989)
...
(kw_find_path)=
## [`kw_find_path()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L674)
...
(kw_find_str_in_list)=
## [`kw_find_str_in_list()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L907)
...
(kw_get_bool)=
## [`kw_get_bool()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L2003)
...
(kw_get_dict)=
## [`kw_get_dict()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L1711)
...
(kw_get_dict_value)=
## [`kw_get_dict_value()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L2143)
...
(kw_get_int)=
## [`kw_get_int()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L1853)
...
(kw_get_list)=
## [`kw_get_list()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L1762)
...
(kw_get_list_value)=
## [`kw_get_list_value()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L1813)
...
(kw_get_real)=
## [`kw_get_real()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L1932)
...
(kw_get_str)=
## [`kw_get_str()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L2081)
...
## [`kw_get_subdict_value()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L2180)
...
(kw_has_key)=
## [`kw_has_key()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L384)
...
(kw_has_word)=
## [`kw_has_word()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L3668)
...
(kw_incref)=
## [`kw_incref()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L296)
...
(kw_match_simple)=
## [`kw_match_simple()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L2722)
...
(kw_pop)=
## [`kw_pop()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L2603)
...
(kw_select)=
## [`kw_select()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L1035)
...
(kw_serialize)=
## [`kw_serialize()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L109)
...
(kw_set_dict_value)=
## [`kw_set_dict_value()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L683)
...
## [`kw_set_path_delimiter()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L398)
...
## [`kw_set_subdict_value()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L794)
...
(kw_update_except)=
## [`kw_update_except()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L2229)
...
(kwid_compare_lists)=
## [`kwid_compare_lists()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L1692)
...
## [`kwid_compare_records()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L1671)
...
(kwid_get_ids)=
## [`kwid_get_ids()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L3549)
...
(kwid_match_id)=
## [`kwid_match_id()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L3735)
...
(kwid_match_nid)=
## [`kwid_match_nid()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L3796)
...
(kwjr_get)=
## [`kwjr_get()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L3378)
...
(json_flatten_dict)=
## [`json_flatten_dict()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L3924)
...
(json_unflatten_dict)=
## [`json_unflatten_dict()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L4055)
...
(kw_collect)=
## [`kw_collect()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L1086)
...
## [`kw_serialize_to_string()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L165)
...
(kw_size)=
## [`kw_size()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L3353)
...
(kw_walk)=
## [`kw_walk()`](https://github.com/artgins/yunetas/blob/7.12.0/kernel/c/gobj-c/src/kwid.c#L2830)
