 ...
 *                      Names
 ***************************************************************************/
#define APP_NAME        "test_auth_bff_test16_unknown_endpoint"
#define APP_DOC         "Self-contained auth_bff POST /auth/nonexistent → 404 unknown_endpoint"
...
{                                                                   \n\
    ...
    'services': [                                                   \n\
        {                                                           \n\
            'name': 'c_test16_unknown_endpoint',                    \n\
            'gclass': 'C_TEST16_UNKNOWN_ENDPOINT',                  \n\
...
static int register_yuno_and_more(void)
{
    ...
    res += register_c_test16_unknown_endpoint();
