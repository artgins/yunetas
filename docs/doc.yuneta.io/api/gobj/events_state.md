...
(gobj_change_state)=
## [`gobj_change_state()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/gobj.c#L7992)
...
(gobj_current_state)=
## [`gobj_current_state()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/gobj.c#L8079)
...
(gobj_event_type)=
## [`gobj_event_type()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/gobj.c#L8161)
...
## [`gobj_event_type_by_name()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/gobj.c#L8213)
...
(gobj_has_event)=
## [`gobj_has_event()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/gobj.c#L8124)
...
## [`gobj_has_output_event()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/gobj.c#L8140)
...
(gobj_has_state)=
## [`gobj_has_state()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/gobj.c#L8110)
...
(gobj_in_this_state)=
## [`gobj_in_this_state()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/gobj.c#L8098)
...
(gobj_send_event)=
## [`gobj_send_event()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/gobj.c#L7521)
...
## [`gobj_find_event_type()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/gobj.c#L1046)
...
## [`gobj_send_event_to_children()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/gobj.c#L7753)
...
## [`gobj_send_event_to_children_tree()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/gobj.c#L7779)
