 ...
 *          MAIN_QUEUED_IN.C
 *
 *          Self-contained MQTT broker test: the incoming QoS 2 messages of
 *          a persistent session that are QUEUED at its reload (more pending
 *          than max_inflight_messages) go in flight as slots free, each one
 *          with ITS OWN packet identifier. See c_queued_in.c.
 *
 *          Embedded C_AUTHZ + C_MQTT_BROKER, an input gate on port 18112,
 ...
 *                      Names
 ***************************************************************************/
#define APP_NAME        "test_mqtt_" "queued_in"
#define APP_DOC         "Incoming QoS 2 messages queued at the reload of a session"
 ...
 */
#define WORK_DIR        "/tmp/test_mqtt_queued_in"
#define MQTT_TEST_PORT  "18112"
