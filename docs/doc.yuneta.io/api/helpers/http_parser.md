...
(ghttp_parser_create)=
## [`ghttp_parser_create()`](https://github.com/artgins/yunetas/blob/7.9.4/kernel/c/root-linux/src/ghttp_parser.c#L63)
...
## [`ghttp_parser_destroy()`](https://github.com/artgins/yunetas/blob/7.9.4/kernel/c/root-linux/src/ghttp_parser.c#L107)
...
## [`ghttp_parser_received()`](https://github.com/artgins/yunetas/blob/7.9.4/kernel/c/root-linux/src/ghttp_parser.c#L136)
