...
defined in [`kernel/c/gobj-c/src/glogger.c`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/glogger.c):

| Function                | Priority      | At                    |
|-------------------------|---------------|-----------------------|
| [`gobj_log_alert`](#gobj_log_alert)        | `LOG_ALERT`   | [glogger.c:499](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/glogger.c#L499)         |
| [`gobj_log_critical`](#gobj_log_critical)     | `LOG_CRIT`    | [glogger.c:514](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/glogger.c#L514)         |
| [`gobj_log_error`](#gobj_log_error)        | `LOG_ERR`     | [glogger.c:529](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/glogger.c#L529)         |
| [`gobj_log_warning`](#gobj_log_warning)      | `LOG_WARNING` | [glogger.c:544](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/glogger.c#L544)         |
| [`gobj_log_info`](#gobj_log_info)         | `LOG_INFO`    | [glogger.c:559](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/glogger.c#L559)         |
| [`gobj_log_debug`](#gobj_log_debug)        | `LOG_DEBUG`   | [glogger.c:574](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/glogger.c#L574)         |
...
Defined in `s_global_trace_level[16]` at [`kernel/c/gobj-c/src/gobj.c`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c):
...
Example: [`c_tcp_s.c`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/root-linux/src/c_tcp_s.c)
...
[`gobj_set_gobj_trace()`](#gobj_set_gobj_trace) at [`kernel/c/gobj-c/src/gobj.c:11256`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L11256).
...
gobjs.
Functions: [`gobj_set_global_no_trace()`](#gobj_set_global_no_trace) at [gobj.c:11711](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L11711),
[`gobj_set_gclass_no_trace()`](#gobj_set_gclass_no_trace) at [gobj.c:11617](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L11617), [`gobj_set_gobj_no_trace()`](#gobj_set_gobj_no_trace) at [gobj.c:11746](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L11746).

### 3.5 Deep trace mode

[`gobj_set_deep_tracing(level)`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L11338)
...
Handlers in [`kernel/c/root-linux/src/c_yuno.c`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/root-linux/src/c_yuno.c):
...
>
> The C API [`gobj_set_global_no_trace()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.h#L2112) is a different thing and is
...
|-------------------------|----------------------------------------------|--------------------|
| `set-global-trace`      | [`save_global_trace`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/root-linux/src/c_yuno.c#L2164)  | `__global_trace__` |
| `set-gclass-trace`      | [`save_user_trace`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/root-linux/src/c_yuno.c#L2247)    | the gclass name    |
| `set-gobj-trace`        | [`save_user_trace`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/root-linux/src/c_yuno.c#L2247)    | the gobj name      |
| `set-gclass-no-trace`   | [`save_user_no_trace`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/root-linux/src/c_yuno.c#L2300) | the gclass name    |
| `set-gobj-no-trace`     | [`save_user_no_trace`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/root-linux/src/c_yuno.c#L2300) | the gobj name      |
...
> a log** at start up ([`c_yuno.c:4992`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/root-linux/src/c_yuno.c#L4992), a deliberate exception to the
...
[`kernel/c/root-linux/src/yunetas_environment.c`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/root-linux/src/yunetas_environment.c):
...
Every log record is a **JSON object** built in [`glogger.c`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/glogger.c). Fields
added automatically by [`discover()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/glogger.c#L1231) at [glogger.c:1231](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/glogger.c#L1231):
...
| [`process`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/root-linux/src/entry_point.c#L123)         | yuno binary name                                         |
...
[`entry_point.c`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/root-linux/src/entry_point.c)). The library renames the old files, and the active filename never moves.
...
[`kernel/c/root-linux/src/entry_point.c`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/root-linux/src/entry_point.c):
...
`del-log-handler` commands of [`c_yuno.c`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/root-linux/src/c_yuno.c).
...
[`glogger.c`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/glogger.c) (`trace_machine`). Called from the event dispatcher in
[`gobj.c`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L7507):
...
- Constant `IEVENT_STACK_ID = "ievent_gate_stack"` at
  [`kernel/c/root-linux/src/msg_ievent.h`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/root-linux/src/msg_ievent.h).
- Pushed on outgoing request, popped + reversed on incoming response, at
  [`kernel/c/root-linux/src/msg_ievent.c`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/root-linux/src/msg_ievent.c).
...
- C side: nothing special — inter-events flow as usual through `C_IEVENT_SRV`
  → `C_WEBSOCKET`.
- JS side: `C_IEVENT_CLI` ([`kernel/js/gobj-js/src/c_ievent_cli.js`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/js/gobj-js/src/c_ievent_cli.js)) parses
  incoming inter-events in [`ac_on_message()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/js/gobj-js/src/c_ievent_cli.js#L1181) and, if
...
- The SPA installs that callback by writing the attribute:
  ...
  ([`kernel/js/gobj-ui/src/yui_dev.js`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/js/gobj-ui/src/yui_dev.js)).
- The `info_traffic()` function ([yui_dev.js:29](https://github.com/artgins/yunetas/blob/7.18.0/kernel/js/gobj-ui/src/yui_dev.js#L29)) appends the message into the
  DOM container `#developer-traffic-logger`, which lives inside either:
  - the **legacy** `C_YUI_WINDOW` modal, or
  - the **modern** `build_dev_panel()` modal ([yui_dev.js:452](https://github.com/artgins/yunetas/blob/7.18.0/kernel/js/gobj-ui/src/yui_dev.js#L452)).
...
When the websocket closes, `ac_on_close` ([`c_ievent_cli.js:897`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/js/gobj-js/src/c_ievent_cli.js#L897)) fires
...
The correction at [`c_ievent_cli.js`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/js/gobj-js/src/c_ievent_cli.js) is to call
...
[`helpers.js`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/js/gobj-js/src/helpers.js)). The memory note "Remote-log unwire order" records the
incident.
...
- UDP server (`c_gss_udp_s`) on `udp://127.0.0.1:1992` by default
  ([`c_logcenter.c`](https://github.com/artgins/yunetas/blob/7.18.0/yunos/c/logcenter/src/c_logcenter.c)).
- Wire format: `<priority-digit><8hex-seq><json-payload><8hex-crc>`,
  fragmented per `udp_frame_size` (default 1500, [`log_udp_handler.c`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/log_udp_handler.c)).

### What it does on receipt

In [`c_logcenter.c`](https://github.com/artgins/yunetas/blob/7.18.0/yunos/c/logcenter/src/c_logcenter.c):

- [`ac_on_message()`](https://github.com/artgins/yunetas/blob/7.18.0/yunos/c/logcenter/src/c_logcenter.c#L1324) parses each packet.
- Writes the JSON record to its own rotatory file `W.log` via
  [`write2logs()`](https://github.com/artgins/yunetas/blob/7.18.0/yunos/c/logcenter/src/c_logcenter.c#L848) / [`_log_bf()`](#_log_bf).
  Default size cap **600 MB** (`max_rotatoryfile_size`, in megabytes).
- Updates in-memory counters per severity / `msgset` / `msg`
  ([`do_log_stats()`](https://github.com/artgins/yunetas/blob/7.18.0/yunos/c/logcenter/src/c_logcenter.c#L858), [c_logcenter.c:858](https://github.com/artgins/yunetas/blob/7.18.0/yunos/c/logcenter/src/c_logcenter.c#L858)).

### What it exposes

Commands ([`c_logcenter.c`](https://github.com/artgins/yunetas/blob/7.18.0/yunos/c/logcenter/src/c_logcenter.c)):
...
Three more commands are useful ([`c_logcenter.c`](https://github.com/artgins/yunetas/blob/7.18.0/yunos/c/logcenter/src/c_logcenter.c)):
...
[`glogger.c`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/glogger.c) writes the audit lines raw. A line filter that expects
...
[`do_disconnect`](https://github.com/artgins/yunetas/blob/7.18.0/modules/c/mqtt/src/c_prot_mqtt.c#L1580) / `destroy_shell`. See §8 and memory
...
| What                                          | Where                                                                  |
|-----------------------------------------------|------------------------------------------------------------------------|
| Severity log API                              | [`kernel/c/gobj-c/src/glogger.c`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/glogger.c)                                |
| `LOG_AUDIT` / `LOG_MONITOR`                   | [`kernel/c/gobj-c/src/glogger.c`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/glogger.c)                                  |
| Trace emit API (`gobj_trace_msg/json/dump`)   | [`kernel/c/gobj-c/src/glogger.c:778`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/glogger.c#L778)                          |
| Global trace level table                      | [`kernel/c/gobj-c/src/gobj.c`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c)                                   |
| Per-gclass trace declaration (example)        | [`kernel/c/root-linux/src/c_tcp_s.c`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/root-linux/src/c_tcp_s.c)                             |
| Trace mask lookup                             | [`kernel/c/gobj-c/src/gobj.c`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c) ([`gobj_trace_level`](#gobj_trace_level))          |
| Per-gobj trace API                            | [`kernel/c/gobj-c/src/gobj.c`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c) (`gobj_set_gobj_trace`)             |
| `no_trace` API                                | [`kernel/c/gobj-c/src/gobj.c`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c)                       |
| Deep trace                                    | [`kernel/c/gobj-c/src/gobj.c`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c)                               |
| `trace_machine` print                         | [`kernel/c/gobj-c/src/glogger.c:1161`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/glogger.c#L1161)                                   |
| FSM dispatch trace sites                      | [`kernel/c/gobj-c/src/gobj.c`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c)                           |
| Trace persistence (`trace_levels` attr)       | [`kernel/c/root-linux/src/c_yuno.c`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/root-linux/src/c_yuno.c)                           |
| Trace commands exposed by every yuno          | [`kernel/c/root-linux/src/c_yuno.c`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/root-linux/src/c_yuno.c)                             |
| `daemon_log_handlers` parser                  | [`kernel/c/root-linux/src/entry_point.c`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/root-linux/src/entry_point.c)                        |
| Log file path builder                         | [`kernel/c/root-linux/src/yunetas_environment.c`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/root-linux/src/yunetas_environment.c)                    |
| Log line `discover()` (metadata fields)       | [`kernel/c/gobj-c/src/glogger.c:1234`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/glogger.c#L1234)                              |
| UDP wire format                               | [`kernel/c/gobj-c/src/log_udp_handler.c`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/log_udp_handler.c)                        |
| `ievent_gate_stack` constant                  | [`kernel/c/root-linux/src/msg_ievent.h`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/root-linux/src/msg_ievent.h)                                  |
| `ievent_gate_stack` push/pop                  | [`kernel/c/root-linux/src/msg_ievent.c`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/root-linux/src/msg_ievent.c)                             |
| logcenter listener                            | [`yunos/c/logcenter/src/c_logcenter.c`](https://github.com/artgins/yunetas/blob/7.18.0/yunos/c/logcenter/src/c_logcenter.c)                     |
| logcenter commands                            | [`yunos/c/logcenter/src/c_logcenter.c`](https://github.com/artgins/yunetas/blob/7.18.0/yunos/c/logcenter/src/c_logcenter.c)                           |
| SPA dev-panel renderer                        | [`kernel/js/gobj-ui/src/yui_dev.js`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/js/gobj-ui/src/yui_dev.js)                         |
| SPA inter-event callback hook                 | [`kernel/js/gobj-js/src/c_ievent_cli.js`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/js/gobj-js/src/c_ievent_cli.js)                     |
| SPA teardown order                            | [`kernel/js/gobj-js/src/c_ievent_cli.js`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/js/gobj-js/src/c_ievent_cli.js)                       |
