...
- [`tr_queue.h`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/timeranger2/src/tr_queue.h)
- [`tr_queue.c`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/timeranger2/src/tr_queue.c)

(trq_answer)=
## [`trq_answer()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/timeranger2/src/tr_queue.c#L578)
...
(trq_check_backup)=
## [`trq_check_backup()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/timeranger2/src/tr_queue.c#L605)
...
## [`trq_check_pending_rowid()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/timeranger2/src/tr_queue.c#L443)
...
(trq_close)=
## [`trq_close()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/timeranger2/src/tr_queue.c#L106)
...
(trq_get_by_rowid)=
## [`trq_get_by_rowid()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/timeranger2/src/tr_queue.c#L427)
...
(trq_get_metadata)=
## [`trq_get_metadata()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/timeranger2/src/tr_queue.c#L563)
...
(trq_load)=
## [`trq_load()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/timeranger2/src/tr_queue.c#L217)
...
(trq_load_all)=
## [`trq_load_all()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/timeranger2/src/tr_queue.c#L305)
...
(trq_msg_json)=
## [`trq_msg_json()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/timeranger2/src/tr_queue.c#L513)
...
(trq_open)=
## [`trq_open()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/timeranger2/src/tr_queue.c#L36)
...
(trq_set_hard_flag)=
## [`trq_set_hard_flag()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/timeranger2/src/tr_queue.c#L477)
...
(trq_set_metadata)=
## [`trq_set_metadata()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/timeranger2/src/tr_queue.c#L548)
...
(trq_set_soft_mark)=
## [`trq_set_soft_mark()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/timeranger2/src/tr_queue.c#L493)
...
(trq_unload_msg)=
## [`trq_unload_msg()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/timeranger2/src/tr_queue.c#L466)
...
(trq_append2)=
## [`trq_append2()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/timeranger2/src/tr_queue.c#L385)
...
## [`trq_load_all_by_time()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/timeranger2/src/tr_queue.c#L337)
...
(trq_msg_md)=
## [`trq_msg_md()`](https://github.com/artgins/yunetas/blob/7.7.0/kernel/c/timeranger2/src/tr_queue.h#L202)
