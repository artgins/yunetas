...
- [`tr_treedb.c`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c)

(_treedb_create_topic_cols_desc)=
## [`_treedb_create_topic_cols_desc()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L520)
...
(add_jtree_path)=
## [`add_jtree_path()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L10412)
...
## [`create_template_record()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L13727)
...
(current_snap_tag)=
## [`current_snap_tag()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L169)
...
(decode_child_ref)=
## [`decode_child_ref()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L4222)
...
(decode_parent_ref)=
## [`decode_parent_ref()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L4168)
...
(node_collapsed_view)=
## [`node_collapsed_view()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L9360)
...
(parse_hooks)=
## [`parse_hooks()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L2340)
...
(parse_schema)=
## [`parse_schema()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L2252)
...
(parse_schema_cols)=
## [`parse_schema_cols()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L2287)
...
(set_volatil_values)=
## [`set_volatil_values()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L3333)
...
## [`treedb_activate_snap()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L13589)
...
(treedb_autolink)=
## [`treedb_autolink()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L8434)
...
(treedb_clean_node)=
## [`treedb_clean_node()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L8361)
...
(treedb_close_db)=
## [`treedb_close_db()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L1335)
...
(treedb_close_topic)=
## [`treedb_close_topic()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L1811)
...
(treedb_create_node)=
## [`treedb_create_node()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L5401)
...
(treedb_create_topic)=
## [`treedb_create_topic()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L1454)
...
## [`treedb_delete_instance()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L6826)
...
(treedb_delete_node)=
## [`treedb_delete_node()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L6339)
...
(treedb_delete_topic)=
## [`treedb_delete_topic()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L1861)
...
(treedb_get_id_index)=
## [`treedb_get_id_index()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L296)
...
(treedb_get_instance)=
## [`treedb_get_instance()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L9301)
...
(treedb_get_node)=
## [`treedb_get_node()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L9258)
...
## [`treedb_get_topic_hooks()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L10644)
...
## [`treedb_get_topic_links()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L10603)
...
## [`treedb_is_treedbs_topic()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L281)
...
(treedb_link_nodes)=
## [`treedb_link_nodes()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L8879)
...
## [`treedb_list_instances()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L9632)
...
(treedb_list_nodes)=
## [`treedb_list_nodes()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L9491)
...
(treedb_list_parents)=
## [`treedb_list_parents()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L10107)
...
(treedb_list_snaps)=
## [`treedb_list_snaps()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L13707)
...
(treedb_list_treedb)=
## [`treedb_list_treedb()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L1916)
...
## [`treedb_node_children()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L10356)
...
(treedb_node_jtree)=
## [`treedb_node_jtree()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L10528)
...
(treedb_open_db)=
## [`treedb_open_db()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L606)
...
([`treedb_schema_yuneta_agent.c`](https://github.com/artgins/yunetas/blob/7.23.0/yunos/c/yuno_agent/src/treedb_schema_yuneta_agent.c)):
...
(treedb_parent_refs)=
## [`treedb_parent_refs()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L10017)
...
## [`treedb_replace_links()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L8728)
...
(treedb_set_callback)=
## [`treedb_set_callback()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L1290)
...
## [`treedb_set_node_immutable()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L6100)
...
(treedb_set_trace)=
## [`treedb_set_trace()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L5068)
...
(treedb_shoot_snap)=
## [`treedb_shoot_snap()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L13396)
...
(treedb_topic_pkey2s)=
## [`treedb_topic_pkey2s()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L182)
...
## [`treedb_topic_pkey2s_filter()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L197)
...
## [`treedb_create_system_schema()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L489)
...
(treedb_topic_size)=
## [`treedb_topic_size()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L1998)
...
(treedb_topics)=
## [`treedb_topics()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L1949)
...
(treedb_unlink_nodes)=
## [`treedb_unlink_nodes()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L8957)
...
(treedb_update_node)=
## [`treedb_update_node()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L6151)
...
(get_hook_list)=
## [`get_hook_list()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L5078)
...
## [`topic_desc_fkey_names()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L2561)
...
## [`topic_desc_hook_names()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/timeranger2/src/tr_treedb.c#L2536)
