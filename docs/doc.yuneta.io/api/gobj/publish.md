...
## [`gobj_find_subscribings()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/gobj-c/src/gobj.c#L9045)
...
## [`gobj_find_subscriptions()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/gobj-c/src/gobj.c#L9019)
...
## [`gobj_list_subscriptions()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/gobj-c/src/gobj.c#L9102)
...
(gobj_publish_event)=
## [`gobj_publish_event()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/gobj-c/src/gobj.c#L9156)
...
## [`gobj_subscribe_event()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/gobj-c/src/gobj.c#L8670)
...
## [`gobj_unsubscribe_event()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/gobj-c/src/gobj.c#L8875)
...
## [`gobj_unsubscribe_list()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/gobj-c/src/gobj.c#L8995)
...
## [`gobj_list_subscribings()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/gobj-c/src/gobj.c#L9129)
...
(gobj_subs_desc)=
## [`gobj_subs_desc()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/gobj-c/src/gobj.c#L8297)
