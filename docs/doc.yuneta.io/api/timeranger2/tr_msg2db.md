...
- [`tr_msg2db.h`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_msg2db.h)
- [`tr_msg2db.c`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_msg2db.c)

(build_msg2db_index_path)=
## [`build_msg2db_index_path()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_msg2db.c#L63)
...
(msg2db_open_db)=
## [`msg2db_open_db()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_msg2db.c#L94)
