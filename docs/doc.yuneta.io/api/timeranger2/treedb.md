...
- [`tr_treedb.c`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c)

(_treedb_create_topic_cols_desc)=
## [`_treedb_create_topic_cols_desc()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L498)
...
(add_jtree_path)=
## [`add_jtree_path()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L9641)
...
## [`create_template_record()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L12784)
...
(current_snap_tag)=
## [`current_snap_tag()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L147)
...
(decode_child_ref)=
## [`decode_child_ref()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L4047)
...
(decode_parent_ref)=
## [`decode_parent_ref()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L3993)
...
(node_collapsed_view)=
## [`node_collapsed_view()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L8633)
...
(parse_hooks)=
## [`parse_hooks()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L2182)
...
(parse_schema)=
## [`parse_schema()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L2103)
...
(parse_schema_cols)=
## [`parse_schema_cols()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L2138)
...
(set_volatil_values)=
## [`set_volatil_values()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L3158)
...
## [`treedb_activate_snap()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L12646)
...
(treedb_autolink)=
## [`treedb_autolink()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L7966)
...
(treedb_clean_node)=
## [`treedb_clean_node()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L7814)
...
(treedb_close_db)=
## [`treedb_close_db()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L1288)
...
(treedb_close_topic)=
## [`treedb_close_topic()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L1665)
...
(treedb_create_node)=
## [`treedb_create_node()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L5175)
...
(treedb_create_topic)=
## [`treedb_create_topic()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L1328)
...
## [`treedb_delete_instance()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L6528)
...
(treedb_delete_node)=
## [`treedb_delete_node()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L6046)
...
(treedb_delete_topic)=
## [`treedb_delete_topic()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L1715)
...
(treedb_get_id_index)=
## [`treedb_get_id_index()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L274)
...
(treedb_get_instance)=
## [`treedb_get_instance()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L8574)
...
(treedb_get_node)=
## [`treedb_get_node()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L8531)
...
## [`treedb_get_topic_hooks()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L9861)
...
## [`treedb_get_topic_links()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L9820)
...
## [`treedb_is_treedbs_topic()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L259)
...
(treedb_link_nodes)=
## [`treedb_link_nodes()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L8152)
...
## [`treedb_list_instances()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L8905)
...
(treedb_list_nodes)=
## [`treedb_list_nodes()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L8764)
...
(treedb_list_parents)=
## [`treedb_list_parents()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L9380)
...
(treedb_list_snaps)=
## [`treedb_list_snaps()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L12764)
...
(treedb_list_treedb)=
## [`treedb_list_treedb()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L1770)
...
## [`treedb_node_children()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L9589)
...
(treedb_node_jtree)=
## [`treedb_node_jtree()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L9749)
...
(treedb_open_db)=
## [`treedb_open_db()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L584)
...
(treedb_parent_refs)=
## [`treedb_parent_refs()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L9290)
...
(treedb_save_node)=
## [`treedb_save_node()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L5663)
...
(treedb_set_callback)=
## [`treedb_set_callback()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L1243)
...
## [`treedb_set_node_immutable()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L5843)
...
(treedb_set_trace)=
## [`treedb_set_trace()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L4892)
...
(treedb_shoot_snap)=
## [`treedb_shoot_snap()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L12435)
...
(treedb_topic_pkey2s)=
## [`treedb_topic_pkey2s()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L160)
...
## [`treedb_topic_pkey2s_filter()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L175)
...
## [`treedb_create_system_schema()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L467)
...
(treedb_topic_size)=
## [`treedb_topic_size()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L1852)
...
(treedb_topics)=
## [`treedb_topics()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L1803)
...
(treedb_unlink_nodes)=
## [`treedb_unlink_nodes()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L8230)
...
(treedb_update_node)=
## [`treedb_update_node()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L5893)
...
(get_hook_list)=
## [`get_hook_list()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L4902)
...
## [`topic_desc_fkey_names()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L2386)
...
## [`topic_desc_hook_names()`](https://github.com/artgins/yunetas/blob/7.19.0/kernel/c/timeranger2/src/tr_treedb.c#L2361)
