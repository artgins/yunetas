...
**Source code:** [`src/yui_asset.js`](https://github.com/artgins/gobj-ui.js/blob/7.23.141/src/yui_asset.js)
...
(js_yui_asset_ids)=
### [`yui_asset_ids(ref)`](https://github.com/artgins/gobj-ui.js/blob/7.23.141/src/yui_asset.js#L63)

Every asset id the column names, in order. Always an array, possibly empty.

(js_yui_asset_id)=
### [`yui_asset_id(ref)`](https://github.com/artgins/gobj-ui.js/blob/7.23.141/src/yui_asset.js#L75)
...
(js_yui_asset_src)=
### [`yui_asset_src(answer)`](https://github.com/artgins/gobj-ui.js/blob/7.23.141/src/yui_asset.js#L88)
...
### [`yui_asset_element(answer, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.23.141/src/yui_asset.js#L152)
...
### [`yui_asset_missing(detail, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.23.141/src/yui_asset.js#L112)
...
([`src/yui_file_field.js`](https://github.com/artgins/gobj-ui.js/blob/7.23.141/src/yui_file_field.js)). The form and the treedb topic table use it
...
(js_YUI_FILE_ACCEPT)=
### [`YUI_FILE_ACCEPT`](https://github.com/artgins/gobj-ui.js/blob/7.23.141/src/yui_file_field.js#L52)
...
(js_yui_file_control)=
### [`yui_file_control(gobj, {name, value, readonly, accept, on_pick})`](https://github.com/artgins/gobj-ui.js/blob/7.23.141/src/yui_file_field.js#L239)
...
(js_yui_file_read)=
### [`yui_file_read(file)`](https://github.com/artgins/gobj-ui.js/blob/7.23.141/src/yui_file_field.js#L147)
...
### [`yui_files_manifest(picks, record)`](https://github.com/artgins/gobj-ui.js/blob/7.23.141/src/yui_file_field.js#L174)
...
(js_yui_file_sha256)=
### [`yui_file_sha256(buffer)`](https://github.com/artgins/gobj-ui.js/blob/7.23.141/src/yui_file_field.js#L98)
...
### [`yui_array_buffer_to_base64(buffer)`](https://github.com/artgins/gobj-ui.js/blob/7.23.141/src/yui_file_field.js#L127)
...
### [`yui_file_size_label(bytes)`](https://github.com/artgins/gobj-ui.js/blob/7.23.141/src/yui_file_field.js#L70)

A size a person reads: bytes up to 1 KB, then one decimal.

(js_yui_file_id_label)=
### [`yui_file_id_label(id)`](https://github.com/artgins/gobj-ui.js/blob/7.23.141/src/yui_file_field.js#L213)
