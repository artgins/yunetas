...
(js_jdb_init)=
### [`jdb_init(jdb, prefix, duplicate)`](https://github.com/artgins/gobj-js/blob/7.25.2/src/helpers.js#L2696)
...
(js_jdb_update)=
### [`jdb_update(jdb, topic_name, path, kw)`](https://github.com/artgins/gobj-js/blob/7.25.2/src/helpers.js#L2721)

Writes a record in a topic. The function writes a log error when the topic does
not exist.

(js_jdb_delete)=
### [`jdb_delete(jdb, topic_name, path, kw)`](https://github.com/artgins/gobj-js/blob/7.25.2/src/helpers.js#L2775)

Deletes a record from a topic.

(js_jdb_get)=
### [`jdb_get(jdb, topic_name, id, recursive)`](https://github.com/artgins/gobj-js/blob/7.25.2/src/helpers.js#L2846)
...
(js_jdb_get_by_idx)=
### [`jdb_get_by_idx(jdb, topic_name, idx)`](https://github.com/artgins/gobj-js/blob/7.25.2/src/helpers.js#L2863)

Gives the record at an index of a topic.

(js_jdb_get_topic)=
### [`jdb_get_topic(jdb, topic_name)`](https://github.com/artgins/gobj-js/blob/7.25.2/src/helpers.js#L2826)
...
(js_load_json_file)=
### [`load_json_file(url, on_success, on_error)`](https://github.com/artgins/gobj-js/blob/7.25.2/src/helpers.js#L2564)
...
### [`send_http_json_post(url, data, on_response)`](https://github.com/artgins/gobj-js/blob/7.25.2/src/helpers.js#L2597)
...
(js_jwtDecode)=
### [`jwtDecode(jwt)`](https://github.com/artgins/gobj-js/blob/7.25.2/src/helpers.js#L2935)

Reads a JWT, and gives its three parts back.

(js_jwt2json)=
### [`jwt2json(jwt, what)`](https://github.com/artgins/gobj-js/blob/7.25.2/src/helpers.js#L2983)
