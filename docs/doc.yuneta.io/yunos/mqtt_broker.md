...
(`treedb_mqtt_broker`, schema [`treedb_schema_mqtt_broker.c`](https://github.com/artgins/yunetas/blob/7.13.0/modules/c/mqtt/src/treedb_schema_mqtt_broker.c)) plus TimeRanger2
queues:
...
- The `client_groups` topic
  ([`treedb_schema_mqtt_broker.c`](https://github.com/artgins/yunetas/blob/7.13.0/modules/c/mqtt/src/treedb_schema_mqtt_broker.c))
...
Regression test: [`tests/c/c_mqtt/acl`](https://github.com/artgins/yunetas/blob/7.13.0/tests/c/c_mqtt/acl)
