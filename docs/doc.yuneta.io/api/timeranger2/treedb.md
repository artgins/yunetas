...
(add_jtree_path)=
## [`add_jtree_path()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L8681)
...
## [`create_template_record()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L9394)
...
(decode_child_ref)=
## [`decode_child_ref()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L3519)
...
(decode_parent_ref)=
## [`decode_parent_ref()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L3465)
...
(node_collapsed_view)=
## [`node_collapsed_view()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L7673)
...
(parse_hooks)=
## [`parse_hooks()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L1964)
...
(parse_schema)=
## [`parse_schema()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L1885)
...
(parse_schema_cols)=
## [`parse_schema_cols()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L1920)
...
(set_volatil_values)=
## [`set_volatil_values()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L2861)
...
## [`treedb_activate_snap()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L9256)
...
(treedb_autolink)=
## [`treedb_autolink()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L7062)
...
(treedb_clean_node)=
## [`treedb_clean_node()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L6910)
...
(treedb_close_db)=
## [`treedb_close_db()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L1111)
...
(treedb_close_topic)=
## [`treedb_close_topic()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L1456)
...
(treedb_create_node)=
## [`treedb_create_node()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L4562)
...
(treedb_create_topic)=
## [`treedb_create_topic()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L1150)
...
## [`treedb_delete_instance()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L5628)
...
(treedb_delete_node)=
## [`treedb_delete_node()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L5254)
...
(treedb_delete_topic)=
## [`treedb_delete_topic()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L1506)
...
(treedb_get_instance)=
## [`treedb_get_instance()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L7614)
...
(treedb_get_node)=
## [`treedb_get_node()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L7571)
...
## [`treedb_get_topic_hooks()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L8901)
...
## [`treedb_get_topic_links()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L8860)
...
(treedb_link_nodes)=
## [`treedb_link_nodes()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L7239)
...
## [`treedb_list_instances()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L7945)
...
(treedb_list_nodes)=
## [`treedb_list_nodes()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L7804)
...
(treedb_list_parents)=
## [`treedb_list_parents()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L8420)
...
(treedb_list_snaps)=
## [`treedb_list_snaps()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L9374)
...
(treedb_list_treedb)=
## [`treedb_list_treedb()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L1552)
...
## [`treedb_node_children()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L8629)
...
(treedb_node_jtree)=
## [`treedb_node_jtree()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L8789)
...
(treedb_parent_refs)=
## [`treedb_parent_refs()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L8330)
...
(treedb_save_node)=
## [`treedb_save_node()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L4944)
...
(treedb_set_callback)=
## [`treedb_set_callback()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L1066)
...
## [`treedb_set_node_immutable()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L5124)
...
(treedb_set_trace)=
## [`treedb_set_trace()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L4384)
...
(treedb_shoot_snap)=
## [`treedb_shoot_snap()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L9045)
...
(treedb_topic_size)=
## [`treedb_topic_size()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L1634)
...
(treedb_topics)=
## [`treedb_topics()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L1585)
...
(treedb_unlink_nodes)=
## [`treedb_unlink_nodes()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L7270)
...
(treedb_update_node)=
## [`treedb_update_node()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L5174)
...
(get_hook_list)=
## [`get_hook_list()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L4394)
...
## [`topic_desc_fkey_names()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L2168)
...
## [`topic_desc_hook_names()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/timeranger2/src/tr_treedb.c#L2143)
