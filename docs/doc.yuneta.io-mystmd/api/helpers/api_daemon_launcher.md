...
- [`helpers.h`](https://github.com/artgins/yunetas/blob/main/kernel/c/gobj-c/src/helpers.h) /
  ...
  — the portable `launch_daemon()` helper.
- [`ydaemon.h`](https://github.com/artgins/yunetas/blob/main/kernel/c/root-linux/src/ydaemon.h) /
  [`ydaemon.c`](https://github.com/artgins/yunetas/blob/main/kernel/c/root-linux/src/ydaemon.c)
  — the Linux-only yuno daemon supervisor (watcher + relaunch + debug
  mode). Inspired by the `daemon.c` from the NXWEB project.
