...
(gobj_stats)=
## [`gobj_stats()`](https://github.com/artgins/yunetas/blob/7.5.4/kernel/c/gobj-c/src/gobj.c#L4912)
...
(gobj_decr_stat)=
## [`gobj_decr_stat()`](https://github.com/artgins/yunetas/blob/7.5.4/kernel/c/gobj-c/src/gobj.c#L9623)
...
(gobj_get_stat)=
## [`gobj_get_stat()`](https://github.com/artgins/yunetas/blob/7.5.4/kernel/c/gobj-c/src/gobj.c#L9639)
...
(gobj_incr_stat)=
## [`gobj_incr_stat()`](https://github.com/artgins/yunetas/blob/7.5.4/kernel/c/gobj-c/src/gobj.c#L9606)
...
(gobj_jn_stats)=
## [`gobj_jn_stats()`](https://github.com/artgins/yunetas/blob/7.5.4/kernel/c/gobj-c/src/gobj.c#L9650)
...
(gobj_set_stat)=
## [`gobj_set_stat()`](https://github.com/artgins/yunetas/blob/7.5.4/kernel/c/gobj-c/src/gobj.c#L9591)
