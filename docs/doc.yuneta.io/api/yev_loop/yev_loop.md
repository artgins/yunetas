...
- [`yev_loop.c`](https://github.com/artgins/yunetas/blob/7.5.12/kernel/c/yev_loop/src/yev_loop.c)
- [`yev_loop.h`](https://github.com/artgins/yunetas/blob/7.5.12/kernel/c/yev_loop/src/yev_loop.h)
...
## [`yev_create_accept_event()`](https://github.com/artgins/yunetas/blob/7.5.12/kernel/c/yev_loop/src/yev_loop.c#L2488)
...
## [`yev_create_connect_event()`](https://github.com/artgins/yunetas/blob/7.5.12/kernel/c/yev_loop/src/yev_loop.c#L2111)
...
## [`yev_create_read_event()`](https://github.com/artgins/yunetas/blob/7.5.12/kernel/c/yev_loop/src/yev_loop.c#L2931)
...
## [`yev_create_timer_event()`](https://github.com/artgins/yunetas/blob/7.5.12/kernel/c/yev_loop/src/yev_loop.c#L2073)
...
## [`yev_create_write_event()`](https://github.com/artgins/yunetas/blob/7.5.12/kernel/c/yev_loop/src/yev_loop.c#L2972)
...
(yev_destroy_event)=
## [`yev_destroy_event()`](https://github.com/artgins/yunetas/blob/7.5.12/kernel/c/yev_loop/src/yev_loop.c#L1948)
...
(yev_event_type_name)=
## [`yev_event_type_name()`](https://github.com/artgins/yunetas/blob/7.5.12/kernel/c/yev_loop/src/yev_loop.c#L3143)
...
(yev_flag_strings)=
## [`yev_flag_strings()`](https://github.com/artgins/yunetas/blob/7.5.12/kernel/c/yev_loop/src/yev_loop.c#L3169)
...
(yev_get_state_name)=
## [`yev_get_state_name()`](https://github.com/artgins/yunetas/blob/7.5.12/kernel/c/yev_loop/src/yev_loop.c#L1100)
...
(yev_get_yuno)=
## [`yev_get_yuno()`](https://github.com/artgins/yunetas/blob/7.5.12/kernel/c/yev_loop/src/yev_loop.c#L1150)
...
(yev_loop_create)=
## [`yev_loop_create()`](https://github.com/artgins/yunetas/blob/7.5.12/kernel/c/yev_loop/src/yev_loop.c#L125)
...
(yev_loop_destroy)=
## [`yev_loop_destroy()`](https://github.com/artgins/yunetas/blob/7.5.12/kernel/c/yev_loop/src/yev_loop.c#L250)
...
## [`yev_loop_reset_running()`](https://github.com/artgins/yunetas/blob/7.5.12/kernel/c/yev_loop/src/yev_loop.c#L987)
...
(yev_loop_run)=
## [`yev_loop_run()`](https://github.com/artgins/yunetas/blob/7.5.12/kernel/c/yev_loop/src/yev_loop.c#L729)
...
(yev_loop_run_once)=
## [`yev_loop_run_once()`](https://github.com/artgins/yunetas/blob/7.5.12/kernel/c/yev_loop/src/yev_loop.c#L877)
...
(yev_loop_stop)=
## [`yev_loop_stop()`](https://github.com/artgins/yunetas/blob/7.5.12/kernel/c/yev_loop/src/yev_loop.c#L958)
...
## [`yev_protocol_set_protocol_fill_hints_fn()`](https://github.com/artgins/yunetas/blob/7.5.12/kernel/c/yev_loop/src/yev_loop.c#L995)
...
(yev_set_gbuffer)=
## [`yev_set_gbuffer()`](https://github.com/artgins/yunetas/blob/7.5.12/kernel/c/yev_loop/src/yev_loop.c#L1122)
...
(yev_start_event)=
## [`yev_start_event()`](https://github.com/artgins/yunetas/blob/7.5.12/kernel/c/yev_loop/src/yev_loop.c#L1158)
...
## [`yev_start_timer_event()`](https://github.com/artgins/yunetas/blob/7.5.12/kernel/c/yev_loop/src/yev_loop.c#L1643)
...
(yev_stop_event)=
## [`yev_stop_event()`](https://github.com/artgins/yunetas/blob/7.5.12/kernel/c/yev_loop/src/yev_loop.c#L1801)
...
## [`yev_create_poll_event()`](https://github.com/artgins/yunetas/blob/7.5.12/kernel/c/yev_loop/src/yev_loop.c#L2889)
...
## [`yev_create_recvmsg_event()`](https://github.com/artgins/yunetas/blob/7.5.12/kernel/c/yev_loop/src/yev_loop.c#L3013)
...
## [`yev_create_sendmsg_event()`](https://github.com/artgins/yunetas/blob/7.5.12/kernel/c/yev_loop/src/yev_loop.c#L3062)
...
## [`yev_dup2_accept_event()`](https://github.com/artgins/yunetas/blob/7.5.12/kernel/c/yev_loop/src/yev_loop.c#L2835)
...
## [`yev_dup_accept_event()`](https://github.com/artgins/yunetas/blob/7.5.12/kernel/c/yev_loop/src/yev_loop.c#L2778)
...
## [`yev_rearm_connect_event()`](https://github.com/artgins/yunetas/blob/7.5.12/kernel/c/yev_loop/src/yev_loop.c#L2164)
...
(set_measure_times)=
## [`set_measure_times()`](https://github.com/artgins/yunetas/blob/7.5.12/kernel/c/gobj-c/src/testing.c#L299)
...
(get_measure_times)=
## [`get_measure_times()`](https://github.com/artgins/yunetas/blob/7.5.12/kernel/c/gobj-c/src/testing.c#L316)
