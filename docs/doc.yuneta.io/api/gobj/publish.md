...
## [`gobj_find_subscribings()`](https://github.com/artgins/yunetas/blob/7.9.12/kernel/c/gobj-c/src/gobj.c#L8786)
...
## [`gobj_find_subscriptions()`](https://github.com/artgins/yunetas/blob/7.9.12/kernel/c/gobj-c/src/gobj.c#L8760)
...
## [`gobj_list_subscriptions()`](https://github.com/artgins/yunetas/blob/7.9.12/kernel/c/gobj-c/src/gobj.c#L8843)
...
(gobj_publish_event)=
## [`gobj_publish_event()`](https://github.com/artgins/yunetas/blob/7.9.12/kernel/c/gobj-c/src/gobj.c#L8897)
...
## [`gobj_subscribe_event()`](https://github.com/artgins/yunetas/blob/7.9.12/kernel/c/gobj-c/src/gobj.c#L8411)
...
## [`gobj_unsubscribe_event()`](https://github.com/artgins/yunetas/blob/7.9.12/kernel/c/gobj-c/src/gobj.c#L8616)
...
## [`gobj_unsubscribe_list()`](https://github.com/artgins/yunetas/blob/7.9.12/kernel/c/gobj-c/src/gobj.c#L8736)
...
## [`gobj_list_subscribings()`](https://github.com/artgins/yunetas/blob/7.9.12/kernel/c/gobj-c/src/gobj.c#L8870)
...
(gobj_subs_desc)=
## [`gobj_subs_desc()`](https://github.com/artgins/yunetas/blob/7.9.12/kernel/c/gobj-c/src/gobj.c#L8038)
