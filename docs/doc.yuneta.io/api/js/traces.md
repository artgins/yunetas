...
(js_trace_level_t)=
### [`trace_level_t`](https://github.com/artgins/gobj-js/blob/7.16.1/src/gobj.js#L406)
...
### [`gobj_set_global_trace(level, set)`](https://github.com/artgins/gobj-js/blob/7.16.1/src/gobj.js#L622)
...
### [`gobj_set_global_no_trace(level, set)`](https://github.com/artgins/gobj-js/blob/7.16.1/src/gobj.js#L636)
...
### [`gobj_global_trace_level()`](https://github.com/artgins/gobj-js/blob/7.16.1/src/gobj.js#L650)

Gives the global mask, as a number.

(js_gobj_repr_global_trace_levels)=
### [`gobj_repr_global_trace_levels()`](https://github.com/artgins/gobj-js/blob/7.16.1/src/gobj.js#L751)
...
### [`gobj_set_deep_trace(value)`](https://github.com/artgins/gobj-js/blob/7.16.1/src/gobj.js#L656)
...
### [`gobj_set_gclass_trace(gclass, level, set)`](https://github.com/artgins/gobj-js/blob/7.16.1/src/gobj.js#L666)
...
### [`gobj_set_gclass_no_trace(gclass, level, set)`](https://github.com/artgins/gobj-js/blob/7.16.1/src/gobj.js#L713)
...
### [`gobj_set_gobj_trace(gobj, level, set)`](https://github.com/artgins/gobj-js/blob/7.16.1/src/gobj.js#L685)

Turns a level on or off for one gobj. Returns `0`, or `-1` when `gobj` is empty.

(js_gobj_set_gobj_no_trace)=
### [`gobj_set_gobj_no_trace(gobj, level, set)`](https://github.com/artgins/gobj-js/blob/7.16.1/src/gobj.js#L732)

Silences a level for one gobj.

(js_gobj_trace_level)=
### [`gobj_trace_level(gobj)`](https://github.com/artgins/gobj-js/blob/7.16.1/src/gobj.js#L485)
...
### [`gobj_trace_no_level(gobj)`](https://github.com/artgins/gobj-js/blob/7.16.1/src/gobj.js#L500)
...
### [`gobj_set_trace_machine_format(format)`](https://github.com/artgins/gobj-js/blob/7.16.1/src/gobj.js#L370)

Chooses the format of the lines of the `machine` trace.

(js_gobj_trace_machine_format)=
### [`gobj_trace_machine_format()`](https://github.com/artgins/gobj-js/blob/7.16.1/src/gobj.js#L375)
