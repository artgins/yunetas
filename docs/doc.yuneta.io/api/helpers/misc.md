...
(get_hostname)=
## [`get_hostname()`](https://github.com/artgins/yunetas/blob/7.5.10/kernel/c/gobj-c/src/helpers.c#L5650)
...
(node_uuid)=
## [`node_uuid()`](https://github.com/artgins/yunetas/blob/7.5.10/kernel/c/gobj-c/src/helpers.c#L5800)
...
(check_open_fds)=
## [`check_open_fds()`](https://github.com/artgins/yunetas/blob/7.5.10/kernel/c/gobj-c/src/helpers.c#L6920)
...
(cpu_usage)=
## [`cpu_usage()`](https://github.com/artgins/yunetas/blob/7.5.10/kernel/c/gobj-c/src/helpers.c#L5383)
...
(cpu_usage_percent)=
## [`cpu_usage_percent()`](https://github.com/artgins/yunetas/blob/7.5.10/kernel/c/gobj-c/src/helpers.c#L5419)
...
(create_random_uuid)=
## [`create_random_uuid()`](https://github.com/artgins/yunetas/blob/7.5.10/kernel/c/gobj-c/src/helpers.c#L5676)
...
(free_ram_in_kb)=
## [`free_ram_in_kb()`](https://github.com/artgins/yunetas/blob/7.5.10/kernel/c/gobj-c/src/helpers.c#L6474)
...
## [`get_name_from_nn_table()`](https://github.com/artgins/yunetas/blob/7.5.10/kernel/c/gobj-c/src/helpers.c#L7534)
...
## [`get_number_from_nn_table()`](https://github.com/artgins/yunetas/blob/7.5.10/kernel/c/gobj-c/src/helpers.c#L7513)
...
(get_yunetas_base)=
## [`get_yunetas_base()`](https://github.com/artgins/yunetas/blob/7.5.10/kernel/c/gobj-c/src/helpers.c#L7375)
...
(is_yuneta_user)=
## [`is_yuneta_user()`](https://github.com/artgins/yunetas/blob/7.5.10/kernel/c/gobj-c/src/helpers.c#L7307)
...
(print_open_fds)=
## [`print_open_fds()`](https://github.com/artgins/yunetas/blob/7.5.10/kernel/c/gobj-c/src/helpers.c#L6956)
...
## [`source2base64_for_yunetas()`](https://github.com/artgins/yunetas/blob/7.5.10/kernel/c/gobj-c/src/helpers.c#L7408)
...
(total_ram_in_kb)=
## [`total_ram_in_kb()`](https://github.com/artgins/yunetas/blob/7.5.10/kernel/c/gobj-c/src/helpers.c#L6521)
...
(yuneta_getgrnam)=
## [`yuneta_getgrnam()`](https://github.com/artgins/yunetas/blob/7.5.10/kernel/c/gobj-c/src/helpers.c#L7281)
...
(yuneta_getgrouplist)=
## [`yuneta_getgrouplist()`](https://github.com/artgins/yunetas/blob/7.5.10/kernel/c/gobj-c/src/helpers.c#L7290)
...
(yuneta_getpwnam)=
## [`yuneta_getpwnam()`](https://github.com/artgins/yunetas/blob/7.5.10/kernel/c/gobj-c/src/helpers.c#L7272)
...
(yuneta_getpwuid)=
## [`yuneta_getpwuid()`](https://github.com/artgins/yunetas/blob/7.5.10/kernel/c/gobj-c/src/helpers.c#L7263)
