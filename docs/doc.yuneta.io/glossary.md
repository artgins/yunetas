...
:   A private method on a GClass, invoked explicitly via [`gobj_local_method()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/gobj-c/src/gobj.c#L4263) — not part of the FSM dispatch.
...
(snapshot)=
**Snapshot**
:   A point-in-time capture of [TreeDB](#glossary-treedb) state for backup/restore. Managed via [`treedb_shoot_snap()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/timeranger2/src/tr_treedb.c#L8844) / [`treedb_activate_snap()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/timeranger2/src/tr_treedb.c#L9055).
