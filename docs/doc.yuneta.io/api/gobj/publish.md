...
## [`gobj_find_subscribings()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/gobj.c#L8780)
...
## [`gobj_find_subscriptions()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/gobj.c#L8754)
...
## [`gobj_list_subscriptions()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/gobj.c#L8837)
...
(gobj_publish_event)=
## [`gobj_publish_event()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/gobj.c#L8891)
...
## [`gobj_subscribe_event()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/gobj.c#L8405)
...
## [`gobj_unsubscribe_event()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/gobj.c#L8610)
...
## [`gobj_unsubscribe_list()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/gobj.c#L8730)
...
## [`gobj_list_subscribings()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/gobj.c#L8864)
...
(gobj_subs_desc)=
## [`gobj_subs_desc()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/gobj.c#L8032)
