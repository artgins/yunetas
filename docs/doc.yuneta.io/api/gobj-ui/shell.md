...
**Source code:** [`src/c_yui_shell.js`](https://github.com/artgins/gobj-ui.js/blob/7.23.4/src/c_yui_shell.js)
...
## [`yui_shell_navigate(shell_gobj, route, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.23.4/src/c_yui_shell.js#L3177)
...
## [`yui_shell_set_sub_routes(shell_gobj, base_route, nodes)`](https://github.com/artgins/gobj-ui.js/blob/7.23.4/src/c_yui_shell.js#L3220)
...
## [`yui_shell_register_event_handler(shell_gobj, event, gclass)`](https://github.com/artgins/gobj-ui.js/blob/7.23.4/src/c_yui_shell.js#L3240)
...
## [`yui_shell_unpark_route(route)`](https://github.com/artgins/gobj-ui.js/blob/7.23.4/src/c_yui_shell.js#L3316)
...
### [`yui_shell_open_drawer(shell_gobj, menu_id)`](https://github.com/artgins/gobj-ui.js/blob/7.23.4/src/c_yui_shell.js#L3254)

Opens the drawer.

(js_yui_shell_close_drawer)=
### [`yui_shell_close_drawer(shell_gobj, menu_id)`](https://github.com/artgins/gobj-ui.js/blob/7.23.4/src/c_yui_shell.js#L3255)

Closes the drawer.

(js_yui_shell_toggle_drawer)=
### [`yui_shell_toggle_drawer(shell_gobj, menu_id)`](https://github.com/artgins/gobj-ui.js/blob/7.23.4/src/c_yui_shell.js#L3256)
...
### [`yui_shell_push_escape(shell_gobj, layer, handler)`](https://github.com/artgins/gobj-ui.js/blob/7.23.4/src/c_yui_shell.js#L3271)
...
### [`yui_shell_pop_escape(shell_gobj, handler)`](https://github.com/artgins/gobj-ui.js/blob/7.23.4/src/c_yui_shell.js#L3275)
...
### [`yui_shell_register_overlay(shell_gobj, close_fn, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.23.4/src/c_yui_shell.js#L3294)
...
### [`yui_shell_overlay_dismissed(shell_gobj, overlay)`](https://github.com/artgins/gobj-ui.js/blob/7.23.4/src/c_yui_shell.js#L3298)
...
### [`yui_shell_set_avatar_provider(shell_gobj, provider)`](https://github.com/artgins/gobj-ui.js/blob/7.23.4/src/c_yui_shell.js#L3333)

Gives the function that the shell asks for the image of a user.

(js_yui_shell_refresh_avatars)=
### [`yui_shell_refresh_avatars(shell_gobj)`](https://github.com/artgins/gobj-ui.js/blob/7.23.4/src/c_yui_shell.js#L3343)
...
### [`yui_shell_set_translator(shell_gobj, t)`](https://github.com/artgins/gobj-ui.js/blob/7.23.4/src/c_yui_shell.js#L3358)
...
### [`yui_shell_set_connection_state(shell_gobj, connected)`](https://github.com/artgins/gobj-ui.js/blob/7.23.4/src/c_yui_shell.js#L3429)

Draws the state of the connection in the toolbar.

(js_yui_shell_set_toolbar_item_icon)=
### [`yui_shell_set_toolbar_item_icon(shell_gobj, item_id, icon_class)`](https://github.com/artgins/gobj-ui.js/blob/7.23.4/src/c_yui_shell.js#L3448)

Changes the icon of an item of the toolbar.

(js_yui_shell_set_toolbar_item_badge)=
### [`yui_shell_set_toolbar_item_badge(shell_gobj, item_id, value)`](https://github.com/artgins/gobj-ui.js/blob/7.23.4/src/c_yui_shell.js#L3481)

Writes a badge on an item of the toolbar, such as a count of messages.

(js_yui_shell_close_dropdown)=
### [`yui_shell_close_dropdown(shell_gobj)`](https://github.com/artgins/gobj-ui.js/blob/7.23.4/src/c_yui_shell.js#L3518)
...
### [`yui_shell_show_route_map(shell, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.23.4/src/shell_route_map.js#L437)
