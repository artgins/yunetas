/****************************************************************************
 *          MAIN_TEST8_QUEUE_FULL.C
 *
 *          Self-contained auth_bff test: queue-full overflow branch.
 *
 *          Same topology as main_test7_slow_login, with two knobs
 *          tuned for the overflow scenario:
 *            - BFF   pending_queue_size = 2   (tight enough that
 *                                              4 pipelined POSTs
 *                                              trip the overflow)
 *            - MockKC latency_ms      = 300   (holds processing
 *                                              busy so the queue
 *                                              actually fills)
 *
 ...
 *                      Names
 ***************************************************************************/
#define APP_NAME        "test_auth_bff_test8_queue_full"
#define APP_DOC         "Self-contained auth_bff test: queue-full overflow"
...
{                                                                   \n\
    ...
    'services': [                                                   \n\
        {                                                           \n\
            'name': 'c_test8_queue_full',                           \n\
            'gclass': 'C_TEST8_QUEUE_FULL',                         \n\
...
static int register_yuno_and_more(void)
{
    ...
    res += register_c_test8_queue_full();
