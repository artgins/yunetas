...
(yuno_event_loop)=
## [`yuno_event_loop()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/root-linux/src/c_yuno.c#L5680)
...
(yuno_event_detroy)=
## [`yuno_event_detroy()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/root-linux/src/c_yuno.c#L5688)
...
(set_yuno_must_die)=
## [`set_yuno_must_die()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/root-linux/src/c_yuno.c#L5699)
...
(is_ip_allowed)=
## [`is_ip_allowed()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/root-linux/src/c_yuno.c#L5718)
...
(add_allowed_ip)=
## [`add_allowed_ip()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/root-linux/src/c_yuno.c#L5733)
...
(remove_allowed_ip)=
## [`remove_allowed_ip()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/root-linux/src/c_yuno.c#L5749)
...
(is_ip_denied)=
## [`is_ip_denied()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/root-linux/src/c_yuno.c#L5761)
...
(add_denied_ip)=
## [`add_denied_ip()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/root-linux/src/c_yuno.c#L5776)
...
(remove_denied_ip)=
## [`remove_denied_ip()`](https://github.com/artgins/yunetas/blob/7.8.0/kernel/c/root-linux/src/c_yuno.c#L5792)
