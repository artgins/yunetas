...
(glog_end)=
## [`glog_end()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/gobj-c/src/glogger.c#L225)
...
(glog_init)=
## [`glog_init()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/gobj-c/src/glogger.c#L189)
...
(gobj_get_log_data)=
## [`gobj_get_log_data()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/gobj-c/src/glogger.c#L600)
...
## [`gobj_get_log_priority_name()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/gobj-c/src/glogger.c#L589)
...
## [`gobj_log_add_handler()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/gobj-c/src/glogger.c#L298)
...
(gobj_log_alert)=
## [`gobj_log_alert()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/gobj-c/src/glogger.c#L499)
...
## [`gobj_log_clear_counters()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/gobj-c/src/glogger.c#L615)
...
(gobj_log_critical)=
## [`gobj_log_critical()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/gobj-c/src/glogger.c#L514)
...
(gobj_log_debug)=
## [`gobj_log_debug()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/gobj-c/src/glogger.c#L574)
...
## [`gobj_log_del_handler()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/gobj-c/src/glogger.c#L361)
...
(gobj_log_error)=
## [`gobj_log_error()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/gobj-c/src/glogger.c#L529)
...
## [`gobj_log_exist_handler()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/gobj-c/src/glogger.c#L273)
...
(gobj_log_info)=
## [`gobj_log_info()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/gobj-c/src/glogger.c#L559)
...
## [`gobj_log_last_message()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/gobj-c/src/glogger.c#L646)
...
## [`gobj_log_list_handlers()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/gobj-c/src/glogger.c#L403)
...
## [`gobj_log_register_handler()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/gobj-c/src/glogger.c#L248)
...
## [`gobj_log_set_global_handler_option()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/gobj-c/src/glogger.c#L432)
...
(gobj_log_warning)=
## [`gobj_log_warning()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/gobj-c/src/glogger.c#L544)
...
(print_backtrace)=
## [`print_backtrace()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/gobj-c/src/glogger.c#L768)
...
## [`set_show_backtrace_fn()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/gobj-c/src/glogger.c#L740)
...
(stdout_fwrite)=
## [`stdout_fwrite()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/gobj-c/src/glogger.c#L707)
...
(stdout_write)=
## [`stdout_write()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/gobj-c/src/glogger.c#L665)
...
(trace_vjson)=
## [`trace_vjson()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/gobj-c/src/glogger.c#L1086)
...
(_log_bf)=
## [`_log_bf()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/gobj-c/src/glogger.c#L943)
...
## [`gobj_log_clear_log_file()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/gobj-c/src/glogger.c#L628)
...
## [`set_trace_with_full_name()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/gobj-c/src/glogger.c#L758)
...
## [`set_trace_with_short_name()`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/gobj-c/src/glogger.c#L748)
