...
- [stats_parser.c](https://github.com/artgins/yunetas/blob/7.5.10/kernel/c/gobj-c/src/stats_parser.c)
- [stats_parser.h](https://github.com/artgins/yunetas/blob/7.5.10/kernel/c/gobj-c/src/stats_parser.h)
...
#### Example — [`c_auth_bff.c`](https://github.com/artgins/yunetas/blob/7.5.10/kernel/c/root-linux/src/c_auth_bff.c)

[`C_AUTH_BFF`](#gclass-c-auth-bff) is the per-channel BFF processor of the auth_bff yuno.
Each browser request crosses several increment points ([`enqueue`](https://github.com/artgins/yunetas/blob/7.5.10/kernel/c/root-linux/src/c_auth_bff.c#L1036),
[`process_next`](https://github.com/artgins/yunetas/blob/7.5.10/kernel/c/root-linux/src/c_auth_bff.c#L1770), `result_token_response`, [`send_error_response`](https://github.com/artgins/yunetas/blob/7.5.10/kernel/c/root-linux/src/c_auth_bff.c#L960)), and
...
The full source is in [`kernel/c/root-linux/src/c_auth_bff.c`](https://github.com/artgins/yunetas/blob/7.5.10/kernel/c/root-linux/src/c_auth_bff.c).
