...
**Source code:** [`src/lib_graph.js`](https://github.com/artgins/gobj-ui.js/blob/7.23.140/src/lib_graph.js),
[`src/lib_icons.js`](https://github.com/artgins/gobj-ui.js/blob/7.23.140/src/lib_icons.js),
[`src/yui_inputs.js`](https://github.com/artgins/gobj-ui.js/blob/7.23.140/src/yui_inputs.js),
[`src/yui_toolbar.js`](https://github.com/artgins/gobj-ui.js/blob/7.23.140/src/yui_toolbar.js)
...
(js_addClasses)=
### [`addClasses($container, selector, ...classNames)`](https://github.com/artgins/gobj-ui.js/blob/7.23.140/src/lib_graph.js#L21)

Adds the classes.

(js_removeClasses)=
### [`removeClasses($container, selector, ...classNames)`](https://github.com/artgins/gobj-ui.js/blob/7.23.140/src/lib_graph.js#L31)

Removes the classes.

(js_toggleClasses)=
### [`toggleClasses($container, selector, ...classNames)`](https://github.com/artgins/gobj-ui.js/blob/7.23.140/src/lib_graph.js#L41)

Adds the classes that are absent, and removes the classes that are present.

(js_removeChildElements)=
### [`removeChildElements($element)`](https://github.com/artgins/gobj-ui.js/blob/7.23.140/src/lib_graph.js#L51)

Removes every child of an element.

(js_disableElements)=
### [`disableElements($container, selector)`](https://github.com/artgins/gobj-ui.js/blob/7.23.140/src/lib_graph.js#L59)

Disables the elements that match.

(js_enableElements)=
### [`enableElements($container, selector)`](https://github.com/artgins/gobj-ui.js/blob/7.23.140/src/lib_graph.js#L66)
...
(js_set_submit_state)=
### [`set_submit_state($container, selector, set)`](https://github.com/artgins/gobj-ui.js/blob/7.23.140/src/lib_graph.js#L79)

Writes the state of *"there are changes to save"*, in orange.

(js_set_cancel_state)=
### [`set_cancel_state($container, selector, set)`](https://github.com/artgins/gobj-ui.js/blob/7.23.140/src/lib_graph.js#L92)

Writes the state of *"the cancel is possible"*, in red.

(js_set_active_state)=
### [`set_active_state($container, selector, set)`](https://github.com/artgins/gobj-ui.js/blob/7.23.140/src/lib_graph.js#L105)

Writes the state of *"active"*, in violet. The library uses it for the buttons
of the history, undo and redo.

(js_set_pressed_state)=
### [`set_pressed_state($container, selector, set)`](https://github.com/artgins/gobj-ui.js/blob/7.23.140/src/lib_graph.js#L122)
...
(js_getStrokeColor)=
### [`getStrokeColor(fillColor, theme, factor)`](https://github.com/artgins/gobj-ui.js/blob/7.23.140/src/lib_graph.js#L132)
...
(js_inject_svg_icons)=
### [`inject_svg_icons()`](https://github.com/artgins/gobj-ui.js/blob/7.23.140/src/lib_icons.js#L160)
...
(js_attach_clear)=
### [`attach_clear($control, $input, on_clear)`](https://github.com/artgins/gobj-ui.js/blob/7.23.140/src/yui_inputs.js#L48)
...
(js_refresh_clear)=
### [`refresh_clear($input)`](https://github.com/artgins/gobj-ui.js/blob/7.23.140/src/yui_inputs.js#L98)
...
(js_yui_toolbar)=
### [`yui_toolbar(attrs, items)`](https://github.com/artgins/gobj-ui.js/blob/7.23.140/src/yui_toolbar.js#L56)
