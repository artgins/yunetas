...
- [`tr_queue.h`](https://github.com/artgins/yunetas/blob/7.9.2/kernel/c/timeranger2/src/tr_queue.h)
- [`tr_queue.c`](https://github.com/artgins/yunetas/blob/7.9.2/kernel/c/timeranger2/src/tr_queue.c)

(trq_answer)=
## [`trq_answer()`](https://github.com/artgins/yunetas/blob/7.9.2/kernel/c/timeranger2/src/tr_queue.c#L582)
...
(trq_check_backup)=
## [`trq_check_backup()`](https://github.com/artgins/yunetas/blob/7.9.2/kernel/c/timeranger2/src/tr_queue.c#L609)
...
## [`trq_check_pending_rowid()`](https://github.com/artgins/yunetas/blob/7.9.2/kernel/c/timeranger2/src/tr_queue.c#L447)
...
(trq_close)=
## [`trq_close()`](https://github.com/artgins/yunetas/blob/7.9.2/kernel/c/timeranger2/src/tr_queue.c#L106)
...
(trq_get_by_rowid)=
## [`trq_get_by_rowid()`](https://github.com/artgins/yunetas/blob/7.9.2/kernel/c/timeranger2/src/tr_queue.c#L431)
...
(trq_get_metadata)=
## [`trq_get_metadata()`](https://github.com/artgins/yunetas/blob/7.9.2/kernel/c/timeranger2/src/tr_queue.c#L567)
...
(trq_load)=
## [`trq_load()`](https://github.com/artgins/yunetas/blob/7.9.2/kernel/c/timeranger2/src/tr_queue.c#L217)
...
(trq_load_all)=
## [`trq_load_all()`](https://github.com/artgins/yunetas/blob/7.9.2/kernel/c/timeranger2/src/tr_queue.c#L305)
...
(trq_msg_json)=
## [`trq_msg_json()`](https://github.com/artgins/yunetas/blob/7.9.2/kernel/c/timeranger2/src/tr_queue.c#L517)
...
(trq_open)=
## [`trq_open()`](https://github.com/artgins/yunetas/blob/7.9.2/kernel/c/timeranger2/src/tr_queue.c#L36)
...
(trq_set_hard_flag)=
## [`trq_set_hard_flag()`](https://github.com/artgins/yunetas/blob/7.9.2/kernel/c/timeranger2/src/tr_queue.c#L481)
...
(trq_set_metadata)=
## [`trq_set_metadata()`](https://github.com/artgins/yunetas/blob/7.9.2/kernel/c/timeranger2/src/tr_queue.c#L552)
...
(trq_set_soft_mark)=
## [`trq_set_soft_mark()`](https://github.com/artgins/yunetas/blob/7.9.2/kernel/c/timeranger2/src/tr_queue.c#L497)
...
(trq_unload_msg)=
## [`trq_unload_msg()`](https://github.com/artgins/yunetas/blob/7.9.2/kernel/c/timeranger2/src/tr_queue.c#L470)
...
(trq_append2)=
## [`trq_append2()`](https://github.com/artgins/yunetas/blob/7.9.2/kernel/c/timeranger2/src/tr_queue.c#L385)
...
## [`trq_load_all_by_time()`](https://github.com/artgins/yunetas/blob/7.9.2/kernel/c/timeranger2/src/tr_queue.c#L337)
...
(trq_msg_md)=
## [`trq_msg_md()`](https://github.com/artgins/yunetas/blob/7.9.2/kernel/c/timeranger2/src/tr_queue.h#L202)
