...
SDATAPM (DTP_STRING,    "system_flag",  0,              "sf_string_key|sf_t_ms", "System flag: sf_string_key|sf_int_key|sf_t_ms|sf_tm_ms|sf_no_disk, future: sf2_zip_record|sf2_cipher_record"),
