...
- [`tr_treedb.h`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.h)
- [`tr_treedb.c`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c)

(_treedb_create_topic_cols_desc)=
## [`_treedb_create_topic_cols_desc()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L553)
...
(add_jtree_path)=
## [`add_jtree_path()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L10986)
...
## [`create_template_record()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L14536)
...
(current_snap_tag)=
## [`current_snap_tag()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L202)
...
(decode_child_ref)=
## [`decode_child_ref()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L4409)
...
(decode_parent_ref)=
## [`decode_parent_ref()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L4355)
...
(node_collapsed_view)=
## [`node_collapsed_view()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L9933)
...
(parse_hooks)=
## [`parse_hooks()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L2535)
...
(parse_schema)=
## [`parse_schema()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L2402)
...
(parse_schema_cols)=
## [`parse_schema_cols()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L2437)
...
(set_volatil_values)=
## [`set_volatil_values()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L3539)
...
## [`treedb_activate_snap()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L14380)
...
(treedb_autolink)=
## [`treedb_autolink()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L8870)
...
(treedb_blob_path)=
## [`treedb_blob_path()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L11538)
...
(treedb_clean_node)=
## [`treedb_clean_node()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L8797)
...
(treedb_close_db)=
## [`treedb_close_db()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L1388)
...
(treedb_close_topic)=
## [`treedb_close_topic()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L1943)
...
## [`treedb_content_type_of_name()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L11389)
...
(treedb_create_node)=
## [`treedb_create_node()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L5689)
...
(treedb_create_topic)=
## [`treedb_create_topic()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L1564)
...
## [`treedb_delete_instance()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L7149)
...
(treedb_delete_node)=
## [`treedb_delete_node()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L6652)
...
(treedb_delete_topic)=
## [`treedb_delete_topic()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L1993)
...
(treedb_file_ext)=
## [`treedb_file_ext()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L11362)
...
(treedb_gc_files)=
## [`treedb_gc_files()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L13642)
...
(treedb_get_id_index)=
## [`treedb_get_id_index()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L329)
...
(treedb_get_instance)=
## [`treedb_get_instance()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L9874)
...
(treedb_get_node)=
## [`treedb_get_node()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L9831)
...
## [`treedb_get_topic_hooks()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L11218)
...
## [`treedb_get_topic_links()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L11177)
...
(treedb_import_files)=
## [`treedb_import_files()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L13914)
...
## [`treedb_is_treedbs_topic()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L314)
...
(treedb_link_nodes)=
## [`treedb_link_nodes()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L9453)
...
## [`treedb_list_instances()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L10206)
...
(treedb_list_nodes)=
## [`treedb_list_nodes()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L10065)
...
(treedb_list_parents)=
## [`treedb_list_parents()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L10681)
...
(treedb_list_snaps)=
## [`treedb_list_snaps()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L14516)
...
(treedb_list_treedb)=
## [`treedb_list_treedb()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L2066)
...
## [`treedb_node_children()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L10930)
...
(treedb_node_jtree)=
## [`treedb_node_jtree()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L11102)
...
(treedb_open_db)=
## [`treedb_open_db()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L639)
...
([`treedb_schema_yuneta_agent.c`](https://github.com/artgins/yunetas/blob/7.25.3/yunos/c/yuno_agent/src/treedb_schema_yuneta_agent.c)):
...
(treedb_parent_refs)=
## [`treedb_parent_refs()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L10591)
...
## [`treedb_replace_links()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L9282)
...
(treedb_save_node)=
## [`treedb_save_node()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L6256)
...
(treedb_set_callback)=
## [`treedb_set_callback()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L1343)
...
## [`treedb_set_files_limits()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L11575)
...
## [`treedb_set_node_immutable()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L6377)
...
(treedb_set_trace)=
## [`treedb_set_trace()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L5349)
...
(treedb_shoot_snap)=
## [`treedb_shoot_snap()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L14126)
...
(treedb_sniff_content_type)=
## [`treedb_sniff_content_type()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L11423)
...
(treedb_topic_pkey2s)=
## [`treedb_topic_pkey2s()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L215)
...
## [`treedb_topic_pkey2s_filter()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L230)
...
## [`treedb_create_system_schema()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L522)
...
(treedb_topic_size)=
## [`treedb_topic_size()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L2148)
...
(treedb_topics)=
## [`treedb_topics()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L2099)
...
(treedb_unlink_nodes)=
## [`treedb_unlink_nodes()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L9530)
...
(treedb_update_node)=
## [`treedb_update_node()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L6428)
...
(get_hook_list)=
## [`get_hook_list()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L5359)
...
## [`topic_desc_fkey_names()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L2766)
...
## [`topic_desc_hook_names()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/timeranger2/src/tr_treedb.c#L2741)
