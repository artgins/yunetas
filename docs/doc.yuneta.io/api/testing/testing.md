...
- [`testing.h`](https://github.com/artgins/yunetas/blob/7.5.9/kernel/c/gobj-c/src/testing.h)
- [`testing.c`](https://github.com/artgins/yunetas/blob/7.5.9/kernel/c/gobj-c/src/testing.c)

(capture_log_write)=
## [`capture_log_write()`](https://github.com/artgins/yunetas/blob/7.5.9/kernel/c/gobj-c/src/testing.c#L47)
...
## [`set_expected_results()`](https://github.com/artgins/yunetas/blob/7.5.9/kernel/c/gobj-c/src/testing.c#L113)
...
## [`test_directory_permission()`](https://github.com/artgins/yunetas/blob/7.5.9/kernel/c/gobj-c/src/testing.c#L209)
...
## [`test_file_permission_and_size()`](https://github.com/artgins/yunetas/blob/7.5.9/kernel/c/gobj-c/src/testing.c#L222)
...
(test_json)=
## [`test_json()`](https://github.com/artgins/yunetas/blob/7.5.9/kernel/c/gobj-c/src/testing.c#L169)
...
(test_json_file)=
## [`test_json_file()`](https://github.com/artgins/yunetas/blob/7.5.9/kernel/c/gobj-c/src/testing.c#L139)
