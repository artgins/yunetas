...
(gbuf2json)=
## [`gbuf2json()`](https://github.com/artgins/yunetas/blob/7.5.4/kernel/c/gobj-c/src/gbuffer.c#L1127)
...
(gbuffer_append)=
## [`gbuffer_append()`](https://github.com/artgins/yunetas/blob/7.5.4/kernel/c/gobj-c/src/gbuffer.c#L292)
...
(gbuffer_append_gbuf)=
## [`gbuffer_append_gbuf()`](https://github.com/artgins/yunetas/blob/7.5.4/kernel/c/gobj-c/src/gbuffer.c#L355)
...
(gbuffer_create)=
## [`gbuffer_create()`](https://github.com/artgins/yunetas/blob/7.5.4/kernel/c/gobj-c/src/gbuffer.c#L28)
...
(gbuffer_deserialize)=
## [`gbuffer_deserialize()`](https://github.com/artgins/yunetas/blob/7.5.4/kernel/c/gobj-c/src/gbuffer.c#L634)
...
## [`gbuffer_encode_base64()`](https://github.com/artgins/yunetas/blob/7.5.4/kernel/c/gobj-c/src/gbuffer.c#L1057)
...
(gbuffer_get)=
## [`gbuffer_get()`](https://github.com/artgins/yunetas/blob/7.5.4/kernel/c/gobj-c/src/gbuffer.c#L212)
...
(gbuffer_getline)=
## [`gbuffer_getline()`](https://github.com/artgins/yunetas/blob/7.5.4/kernel/c/gobj-c/src/gbuffer.c#L231)
...
(gbuffer_remove)=
## [`gbuffer_remove()`](https://github.com/artgins/yunetas/blob/7.5.4/kernel/c/gobj-c/src/gbuffer.c#L139)
...
(gbuffer_serialize)=
## [`gbuffer_serialize()`](https://github.com/artgins/yunetas/blob/7.5.4/kernel/c/gobj-c/src/gbuffer.c#L594)
...
## [`gbuffer_set_rd_offset()`](https://github.com/artgins/yunetas/blob/7.5.4/kernel/c/gobj-c/src/gbuffer.c#L180)
...
(gbuffer_set_wr)=
## [`gbuffer_set_wr()`](https://github.com/artgins/yunetas/blob/7.5.4/kernel/c/gobj-c/src/gbuffer.c#L263)
...
(gbuffer_setlabel)=
## [`gbuffer_setlabel()`](https://github.com/artgins/yunetas/blob/7.5.4/kernel/c/gobj-c/src/gbuffer.c#L516)
...
(json2gbuf)=
## [`json2gbuf()`](https://github.com/artgins/yunetas/blob/7.5.4/kernel/c/gobj-c/src/gbuffer.c#L1109)
...
(config_gbuffer2json)=
## [`config_gbuffer2json()`](https://github.com/artgins/yunetas/blob/7.5.4/kernel/c/gobj-c/src/gbuffer.c#L1166)
...
(gbuf2file)=
## [`gbuf2file()`](https://github.com/artgins/yunetas/blob/7.5.4/kernel/c/gobj-c/src/gbuffer.c#L541)
...
(gbuffer_append_json)=
## [`gbuffer_append_json()`](https://github.com/artgins/yunetas/blob/7.5.4/kernel/c/gobj-c/src/gbuffer.c#L392)
...
## [`gbuffer_base64_to_binary()`](https://github.com/artgins/yunetas/blob/7.5.4/kernel/c/gobj-c/src/gbuffer.c#L1011)
...
## [`gbuffer_binary_to_base64()`](https://github.com/artgins/yunetas/blob/7.5.4/kernel/c/gobj-c/src/gbuffer.c#L934)
...
(gbuffer_file2base64)=
## [`gbuffer_file2base64()`](https://github.com/artgins/yunetas/blob/7.5.4/kernel/c/gobj-c/src/gbuffer.c#L970)
