...
**Source code:** [`src/yui_theme.js`](https://github.com/artgins/gobj-ui.js/blob/7.23.138/src/yui_theme.js)
...
(js_yui_theme_now)=
## [`yui_theme_now()`](https://github.com/artgins/gobj-ui.js/blob/7.23.138/src/yui_theme.js#L37)
...
(js_yui_is_dark)=
## [`yui_is_dark()`](https://github.com/artgins/gobj-ui.js/blob/7.23.138/src/yui_theme.js#L56)

Tells if the application draws dark.

(js_yui_watch_theme)=
## [`yui_watch_theme(gobj, event)`](https://github.com/artgins/gobj-ui.js/blob/7.23.138/src/yui_theme.js#L85)
