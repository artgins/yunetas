...
(comm_prot_free)=
## [`comm_prot_free()`](https://github.com/artgins/yunetas/blob/7.6.7/kernel/c/gobj-c/src/helpers.c#L5951)
...
## [`comm_prot_get_gclass()`](https://github.com/artgins/yunetas/blob/7.6.7/kernel/c/gobj-c/src/helpers.c#L5924)
...
(comm_prot_register)=
## [`comm_prot_register()`](https://github.com/artgins/yunetas/blob/7.6.7/kernel/c/gobj-c/src/helpers.c#L5895)
...
(get_peername)=
## [`get_peername()`](https://github.com/artgins/yunetas/blob/7.6.7/kernel/c/gobj-c/src/helpers.c#L6882)
...
(get_sockname)=
## [`get_sockname()`](https://github.com/artgins/yunetas/blob/7.6.7/kernel/c/gobj-c/src/helpers.c#L6901)
...
(is_tcp_socket)=
## [`is_tcp_socket()`](https://github.com/artgins/yunetas/blob/7.6.7/kernel/c/gobj-c/src/helpers.c#L6810)
...
(is_udp_socket)=
## [`is_udp_socket()`](https://github.com/artgins/yunetas/blob/7.6.7/kernel/c/gobj-c/src/helpers.c#L6827)
...
## [`print_socket_address()`](https://github.com/artgins/yunetas/blob/7.6.7/kernel/c/gobj-c/src/helpers.c#L6844)
...
## [`set_tcp_socket_options()`](https://github.com/artgins/yunetas/blob/7.6.7/kernel/c/gobj-c/src/helpers.c#L6781)
