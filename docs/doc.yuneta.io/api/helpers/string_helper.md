...
(all_numbers)=
## [`all_numbers()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/helpers.c#L821)
...
(bin2hex)=
## [`bin2hex()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/helpers.c#L4900)
...
(build_path)=
## [`build_path()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/helpers.c#L673)
...
(change_char)=
## [`change_char()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/helpers.c#L1030)
...
(count_char)=
## [`count_char()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/helpers.c#L5636)
...
(delete_left_blanks)=
## [`delete_left_blanks()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/helpers.c#L894)
...
(delete_left_char)=
## [`delete_left_char()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/helpers.c#L584)
...
(delete_right_blanks)=
## [`delete_right_blanks()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/helpers.c#L871)
...
(delete_right_char)=
## [`delete_right_char()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/helpers.c#L563)
...
## [`get_key_value_parameter()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/helpers.c#L1113)
...
(get_last_segment)=
## [`get_last_segment()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/helpers.c#L750)
...
(get_parameter)=
## [`get_parameter()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/helpers.c#L1048)
...
## [`helper_doublequote2quote()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/helpers.c#L806)
...
## [`helper_quote2doublequote()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/helpers.c#L791)
...
(hex2bin)=
## [`hex2bin()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/helpers.c#L4868)
...
(idx_in_list)=
## [`idx_in_list()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/helpers.c#L1414)
...
(left_justify)=
## [`left_justify()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/helpers.c#L920)
...
(nice_size)=
## [`nice_size()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/helpers.c#L840)
...
(pop_last_segment)=
## [`pop_last_segment()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/helpers.c#L772)
...
(split2)=
## [`split2()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/helpers.c#L1204)
...
(split3)=
## [`split3()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/helpers.c#L1273)
...
(split_free2)=
## [`split_free2()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/helpers.c#L1253)
...
(split_free3)=
## [`split_free3()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/helpers.c#L1325)
...
(str_concat)=
## [`str_concat()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/helpers.c#L1342)
...
(str_concat3)=
## [`str_concat3()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/helpers.c#L1371)
...
(str_concat_free)=
## [`str_concat_free()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/helpers.c#L1405)
...
(str_in_list)=
## [`str_in_list()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/helpers.c#L1437)
...
(strntolower)=
## [`strntolower()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/helpers.c#L957)
...
(strntoupper)=
## [`strntoupper()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/helpers.c#L938)
...
(translate_string)=
## [`translate_string()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/helpers.c#L985)
...
(capitalize)=
## [`capitalize()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/helpers.c#L6771)
...
(lower)=
## [`lower()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/helpers.c#L6758)
...
(path_basename)=
## [`path_basename()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/helpers.c#L7443)
...
(replace_cli_vars)=
## [`replace_cli_vars()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/helpers.c#L7529)
...
(upper)=
## [`upper()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/gobj-c/src/helpers.c#L6745)
