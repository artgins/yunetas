...
(get_attrs_schema)=
## [`get_attrs_schema()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L6509)
...
## [`get_sdata_flag_table()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L6486)
...
(gobj2json)=
## [`gobj2json()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L7243)
...
(gobj_command_desc)=
## [`gobj_command_desc()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L6461)
...
(gobj_full_name)=
## [`gobj_full_name()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L6073)
...
(gobj_gclass)=
## [`gobj_gclass()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L6064)
...
(gobj_gclass_name)=
## [`gobj_gclass_name()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L6055)
...
## [`gobj_global_variables()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L6143)
...
## [`gobj_add_global_variable()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L6198)
...
(gobj_is_destroying)=
## [`gobj_is_destroying()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L6233)
...
(gobj_is_disabled)=
## [`gobj_is_disabled()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L6298)
...
(gobj_is_playing)=
## [`gobj_is_playing()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L6257)
...
(gobj_is_pure_child)=
## [`gobj_is_pure_child()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L6351)
...
(gobj_is_running)=
## [`gobj_is_running()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L6245)
...
(gobj_is_service)=
## [`gobj_is_service()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L6270)
...
(gobj_is_volatil)=
## [`gobj_is_volatil()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L6309)
...
(gobj_name)=
## [`gobj_name()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L6046)
...
(gobj_parent)=
## [`gobj_parent()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L6222)
...
(gobj_priv_data)=
## [`gobj_priv_data()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L6214)
...
## [`gobj_set_manual_start()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L6336)
...
(gobj_set_volatil)=
## [`gobj_set_volatil()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L6321)
...
(gobj_short_name)=
## [`gobj_short_name()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L6120)
...
(gobj_typeof_gclass)=
## [`gobj_typeof_gclass()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L6375)
...
## [`gobj_typeof_inherited_gclass()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L6387)
...
(gobj_view_tree)=
## [`gobj_view_tree()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L7417)
...
(gobj_yuno)=
## [`gobj_yuno()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L5953)
...
(gobj_yuno_id)=
## [`gobj_yuno_id()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L5978)
...
(gobj_yuno_name)=
## [`gobj_yuno_name()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L5964)
...
## [`gobj_yuno_node_owner()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L6035)
...
(gobj_yuno_realm_env)=
## [`gobj_yuno_realm_env()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L6028)
...
(gobj_yuno_realm_id)=
## [`gobj_yuno_realm_id()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L6000)
...
## [`gobj_yuno_realm_name()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L6021)
...
## [`gobj_yuno_realm_owner()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L6007)
...
## [`gobj_yuno_realm_role()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L6014)
...
(gobj_yuno_role)=
## [`gobj_yuno_role()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L5971)
...
## [`gobj_yuno_role_plus_name()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L5992)
...
(gobj_yuno_tag)=
## [`gobj_yuno_tag()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L5985)
...
(gobj_audit_commands)=
## [`gobj_audit_commands()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L4900)
...
(gobj_is_bottom_gobj)=
## [`gobj_is_bottom_gobj()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L6363)
...
(gobj_is_top_service)=
## [`gobj_is_top_service()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L6284)
...
## [`gobj_kw_get_user_data()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L3720)
...
## [`gobj_nearest_top_service()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L5155)
...
(gobj_top_services)=
## [`gobj_top_services()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/gobj-c/src/gobj.c#L1420)
