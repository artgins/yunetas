...
(function (exports) {
    ...
    var IEVENT_STACK_ID = "ievent_gate_stack";
    ...
    function ac_identity_card_ack(self, event, kw, src)
    {
         ...
         */
        var request = msg_iev_get_stack(kw, IEVENT_STACK_ID);
    ...
    function ac_on_message(self, event, kw, src)
    {
         ...
         *----------------------------------------*/
        let event_id = msg_iev_get_stack(iev_kw, IEVENT_STACK_ID);
    ...
    proto.mt_start = function(kw)
    {
        ...
        msg_iev_add_answer_filter(self, IEVENT_STACK_ID, ievent_answer_filter);
        self.websocket = setup_websocket(self);
    };
    ...
    proto.mt_inject_event = function(event, kw, src)
    {
         ...
         *      __MESSAGE__
         */
        let jn_request = msg_iev_get_stack(kw, IEVENT_STACK_ID);
        if(!jn_request) {
            /*
