...
- [`tr_treedb.c`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c)

(_treedb_create_topic_cols_desc)=
## [`_treedb_create_topic_cols_desc()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L498)
...
(add_jtree_path)=
## [`add_jtree_path()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L9940)
...
## [`create_template_record()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L13083)
...
(current_snap_tag)=
## [`current_snap_tag()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L147)
...
(decode_child_ref)=
## [`decode_child_ref()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L4072)
...
(decode_parent_ref)=
## [`decode_parent_ref()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L4018)
...
(node_collapsed_view)=
## [`node_collapsed_view()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L8932)
...
(parse_hooks)=
## [`parse_hooks()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L2207)
...
(parse_schema)=
## [`parse_schema()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L2128)
...
(parse_schema_cols)=
## [`parse_schema_cols()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L2163)
...
(set_volatil_values)=
## [`set_volatil_values()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L3183)
...
## [`treedb_activate_snap()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L12945)
...
(treedb_autolink)=
## [`treedb_autolink()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L8006)
...
(treedb_clean_node)=
## [`treedb_clean_node()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L7933)
...
(treedb_close_db)=
## [`treedb_close_db()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L1313)
...
(treedb_close_topic)=
## [`treedb_close_topic()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L1690)
...
(treedb_create_node)=
## [`treedb_create_node()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L5200)
...
(treedb_create_topic)=
## [`treedb_create_topic()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L1353)
...
## [`treedb_delete_instance()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L6553)
...
(treedb_delete_node)=
## [`treedb_delete_node()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L6071)
...
(treedb_delete_topic)=
## [`treedb_delete_topic()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L1740)
...
(treedb_get_id_index)=
## [`treedb_get_id_index()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L274)
...
(treedb_get_instance)=
## [`treedb_get_instance()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L8873)
...
(treedb_get_node)=
## [`treedb_get_node()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L8830)
...
## [`treedb_get_topic_hooks()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L10160)
...
## [`treedb_get_topic_links()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L10119)
...
## [`treedb_is_treedbs_topic()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L259)
...
(treedb_link_nodes)=
## [`treedb_link_nodes()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L8451)
...
## [`treedb_list_instances()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L9204)
...
(treedb_list_nodes)=
## [`treedb_list_nodes()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L9063)
...
(treedb_list_parents)=
## [`treedb_list_parents()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L9679)
...
(treedb_list_snaps)=
## [`treedb_list_snaps()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L13063)
...
(treedb_list_treedb)=
## [`treedb_list_treedb()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L1795)
...
## [`treedb_node_children()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L9888)
...
(treedb_node_jtree)=
## [`treedb_node_jtree()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L10048)
...
(treedb_open_db)=
## [`treedb_open_db()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L584)
...
([`treedb_schema_yuneta_agent.c`](https://github.com/artgins/yunetas/blob/7.20.0/yunos/c/yuno_agent/src/treedb_schema_yuneta_agent.c)):
...
(treedb_parent_refs)=
## [`treedb_parent_refs()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L9589)
...
## [`treedb_replace_links()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L8300)
...
(treedb_save_node)=
## [`treedb_save_node()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L5688)
...
(treedb_set_callback)=
## [`treedb_set_callback()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L1268)
...
## [`treedb_set_node_immutable()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L5868)
...
(treedb_set_trace)=
## [`treedb_set_trace()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L4917)
...
(treedb_shoot_snap)=
## [`treedb_shoot_snap()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L12734)
...
(treedb_topic_pkey2s)=
## [`treedb_topic_pkey2s()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L160)
...
## [`treedb_topic_pkey2s_filter()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L175)
...
## [`treedb_create_system_schema()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L467)
...
(treedb_topic_size)=
## [`treedb_topic_size()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L1877)
...
(treedb_topics)=
## [`treedb_topics()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L1828)
...
(treedb_unlink_nodes)=
## [`treedb_unlink_nodes()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L8529)
...
(treedb_update_node)=
## [`treedb_update_node()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L5918)
...
(get_hook_list)=
## [`get_hook_list()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L4927)
...
## [`topic_desc_fkey_names()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L2411)
...
## [`topic_desc_hook_names()`](https://github.com/artgins/yunetas/blob/7.20.0/kernel/c/timeranger2/src/tr_treedb.c#L2386)
