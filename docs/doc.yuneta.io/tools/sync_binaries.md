(tool-sync_binaries)=
# [`sync_binaries.py`](https://github.com/artgins/yunetas/blob/7.9.4/tools/agent/sync_binaries.py)

Operator utility ([`tools/agent/sync_binaries.py`](https://github.com/artgins/yunetas/blob/7.9.4/tools/agent/sync_binaries.py)) that reconciles the freshly
