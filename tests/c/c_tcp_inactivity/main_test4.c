 ...
 *          play time: C_TEST4 starts the client first (connect refused), lets
 ...
 *                      Names
 ***************************************************************************/
#define APP_NAME        "test_tcp_inactivity_" "test4"
#define APP_DOC         "Test C_TCP dl_tx survives failed reconnects (inactivity)"
...
{                                                                   \n\
    ...
    'global': {                                                     \n\
        '__input_side__.__json_config_variables__': {               \n\
            '__input_url__': 'tcp://0.0.0.0:7782',                  \n\
...
static int register_yuno_and_more(void)
{
    ...
    json_t *errors_list = json_pack("[{s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}]",
        "msg", "Starting yuno",
        "msg", "Playing yuno",
        "msg", "Tx queued while disconnected",
