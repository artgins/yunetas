...
(js_createElement2)=
## [`createElement2()`](https://github.com/artgins/gobj-js/blob/7.25.3/src/helpers.js#L3235)
...
(js_createOneHtml)=
### [`createOneHtml(htmlString)`](https://github.com/artgins/gobj-js/blob/7.25.3/src/helpers.js#L3046)

Builds one element from a string of HTML.

(js_parseSVG)=
### [`parseSVG(string)`](https://github.com/artgins/gobj-js/blob/7.25.3/src/helpers.js#L3371)

Builds an SVG element from a string of SVG code.

(js_getPositionRelativeToBody)=
### [`getPositionRelativeToBody(element)`](https://github.com/artgins/gobj-js/blob/7.25.3/src/helpers.js#L3343)
...
(js_escapeHtml)=
### [`escapeHtml(str)`](https://github.com/artgins/gobj-js/blob/7.25.3/src/helpers.js#L3013)
...
(js_safeSrc)=
### [`safeSrc(url)`](https://github.com/artgins/gobj-js/blob/7.25.3/src/helpers.js#L3031)
...
(js_refresh_language)=
## [`refresh_language()`](https://github.com/artgins/gobj-js/blob/7.25.3/src/helpers.js#L3379)
