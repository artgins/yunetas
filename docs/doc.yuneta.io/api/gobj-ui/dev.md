...
**Source code:** [`src/yui_dev.js`](https://github.com/artgins/gobj-ui.js/blob/7.25.18/src/yui_dev.js),
[`src/yui_frontend_view.js`](https://github.com/artgins/gobj-ui.js/blob/7.25.18/src/yui_frontend_view.js)

---

(js_build_dev_panel)=
## [`build_dev_panel()`](https://github.com/artgins/gobj-ui.js/blob/7.25.18/src/yui_dev.js#L1826)
...
(js_setup_dev)=
## [`setup_dev(self, show)`](https://github.com/artgins/gobj-ui.js/blob/7.25.18/src/yui_dev.js#L1762)
...
## [`dev_window_was_open()`](https://github.com/artgins/gobj-ui.js/blob/7.25.18/src/yui_dev.js#L1719)
...
(js_apply_dev_traces)=
## [`apply_dev_traces()`](https://github.com/artgins/gobj-ui.js/blob/7.25.18/src/yui_dev.js#L1733)
...
(js_info_traffic)=
## [`info_traffic(title, msg, direction, size)`](https://github.com/artgins/gobj-ui.js/blob/7.25.18/src/yui_dev.js#L1101)
...
## [`setup_frontend_view(self)`](https://github.com/artgins/gobj-ui.js/blob/7.25.18/src/yui_frontend_view.js#L42)
...
(js_setup_json_pad)=
## [`setup_json_pad(self)`](https://github.com/artgins/gobj-ui.js/blob/7.25.18/src/yui_json_pad.js#L45)
