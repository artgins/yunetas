...
same fault that
[`libc_guard.cmake`](https://github.com/artgins/yunetas/blob/7.25.2/tools/cmake/libc_guard.cmake)
...
[`packages/README.md`](https://github.com/artgins/yunetas/tree/7.25.2/packages).
...
> architecture
> ([`AMD64.sh`](https://github.com/artgins/yunetas/blob/7.25.2/packages/deb/AMD64.sh), [`ARM32.sh`](https://github.com/artgins/yunetas/blob/7.25.2/packages/deb/ARM32.sh), [`ARMhf.sh`](https://github.com/artgins/yunetas/blob/7.25.2/packages/deb/ARMhf.sh), [`RISCV64.sh`](https://github.com/artgins/yunetas/blob/7.25.2/packages/deb/RISCV64.sh)). The SDK must be built
> first (next section).
...
[`packages/deb/README.md`](https://github.com/artgins/yunetas/blob/7.25.2/packages/deb/README.md).
...
[`yunetas-env.sh`](https://github.com/artgins/yunetas/blob/7.25.2/yunetas-env.sh) exports four variables. It also puts `/yuneta/bin` and
...
> and CI must source [`yunetas-env.sh`](https://github.com/artgins/yunetas/blob/7.25.2/yunetas-env.sh) again. Without it, [`ybatch`](#util-ybatch), [`ycommand`](#util-ycommand)
...
> ⚠️ **Save `.config`, or the build fails.** If you change the compiler, run [`./set_compiler.sh`](https://github.com/artgins/yunetas/blob/7.25.2/set_compiler.sh) again. It builds the external
