...
(run_command)=
## [`run_command()`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/root-linux/src/run_command.c#L28)
...
(run_process2)=
## [`run_process2()`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/root-linux/src/run_command.c#L81)
...
(pty_sync_spawn)=
## [`pty_sync_spawn()`](https://github.com/artgins/yunetas/blob/7.9.13/kernel/c/root-linux/src/run_command.c#L163)
