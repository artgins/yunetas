...
(gobj_create)=
## [`gobj_create()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L1860)
...
(gobj_create2)=
## [`gobj_create2()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L1509)
...
## [`gobj_create_default_service()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L1815)
...
## [`gobj_create_pure_child()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L1845)
...
(gobj_create_service)=
## [`gobj_create_service()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L1806)
...
(gobj_create_tree)=
## [`gobj_create_tree()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L2278)
...
(gobj_create_volatil)=
## [`gobj_create_volatil()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L1830)
...
(gobj_create_yuno)=
## [`gobj_create_yuno()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L1798)
...
(gobj_destroy)=
## [`gobj_destroy()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L2328)
...
## [`gobj_destroy_children()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L2516)
...
## [`gobj_service_factory()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L2149)
...
## [`gobj_destroy_named_children()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L2574)
...
(gobj_sdata_create)=
## [`gobj_sdata_create()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L3132)
