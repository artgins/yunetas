...
**Source code:** [`src/yui_time.js`](https://github.com/artgins/gobj-ui.js/blob/7.23.79/src/yui_time.js)
...
(js_YUI_PERIODS)=
### [`YUI_PERIODS`](https://github.com/artgins/gobj-ui.js/blob/7.23.79/src/yui_time.js#L61)
...
### [`YUI_PERIODS_DEFAULT`](https://github.com/artgins/gobj-ui.js/blob/7.23.79/src/yui_time.js#L80)
...
(js_YUI_ROLLING)=
### [`YUI_ROLLING`](https://github.com/artgins/gobj-ui.js/blob/7.23.79/src/yui_time.js#L85)
...
(js_period_spec)=
### [`period_spec(period)`](https://github.com/artgins/gobj-ui.js/blob/7.23.79/src/yui_time.js#L302)
...
(js_period_start)=
### [`period_start(period, anchor_ms)`](https://github.com/artgins/gobj-ui.js/blob/7.23.79/src/yui_time.js#L338)
...
(js_period_shift)=
### [`period_shift(period, anchor_ms, delta)`](https://github.com/artgins/gobj-ui.js/blob/7.23.79/src/yui_time.js#L385)
...
(js_period_bounds)=
### [`period_bounds(period, anchor_ms)`](https://github.com/artgins/gobj-ui.js/blob/7.23.79/src/yui_time.js#L422)
...
### [`period_bounds_epoch(period, anchor_ms, ms)`](https://github.com/artgins/gobj-ui.js/blob/7.23.79/src/yui_time.js#L438)
...
(js_rolling_bounds)=
### [`rolling_bounds(rolling, ms, now_ms)`](https://github.com/artgins/gobj-ui.js/blob/7.23.79/src/yui_time.js#L455)
...
### [`is_current_period(period, anchor_ms, now_ms)`](https://github.com/artgins/gobj-ui.js/blob/7.23.79/src/yui_time.js#L469)
...
(js_infer_period)=
### [`infer_period(from, to, candidates, ms)`](https://github.com/artgins/gobj-ui.js/blob/7.23.79/src/yui_time.js#L497)
...
(js_period_name)=
### [`period_name(period, t)`](https://github.com/artgins/gobj-ui.js/blob/7.23.79/src/yui_time.js#L528)
...
(js_period_label)=
### [`period_label(period, anchor_ms, t, locale)`](https://github.com/artgins/gobj-ui.js/blob/7.23.79/src/yui_time.js#L554)
...
(js_safe_locale)=
### [`safe_locale(locale)`](https://github.com/artgins/gobj-ui.js/blob/7.23.79/src/yui_time.js#L108)
...
(js_epoch_to_ms)=
### [`epoch_to_ms(value, ms)`](https://github.com/artgins/gobj-ui.js/blob/7.23.79/src/yui_time.js#L162)

Changes a time of the consumer into milliseconds. With `ms` set to `true` the
value is in milliseconds already.

(js_ms_to_epoch)=
### [`ms_to_epoch(value_ms, ms)`](https://github.com/artgins/gobj-ui.js/blob/7.23.79/src/yui_time.js#L170)

Changes milliseconds into the unit of the consumer.

(js_epoch_to_local_input)=
### [`epoch_to_local_input(value, ms)`](https://github.com/artgins/gobj-ui.js/blob/7.23.79/src/yui_time.js#L184)

Changes a time into the form that an input of date and time takes.

(js_local_input_to_epoch)=
### [`local_input_to_epoch(v, ms)`](https://github.com/artgins/gobj-ui.js/blob/7.23.79/src/yui_time.js#L195)

Changes the value of an input of date and time into a time.

(js_fmt_epoch)=
### [`fmt_epoch(value, ms)`](https://github.com/artgins/gobj-ui.js/blob/7.23.79/src/yui_time.js#L213)

Writes a time for a human.

(js_iso_week)=
### [`iso_week(d)`](https://github.com/artgins/gobj-ui.js/blob/7.23.79/src/yui_time.js#L270)
