...
(js_SDATA)=
### [`SDATA(type, name, flag, default_value, description)`](https://github.com/artgins/gobj-js/blob/7.25.2/src/gobj.js#L157)

Declares one attribute. The table finishes with
[`SDATA_END()`](commands.md#js_SDATA_END).

(js_data_type_t)=
### [`data_type_t`](https://github.com/artgins/gobj-js/blob/7.25.2/src/gobj.js#L85)
...
(js_sdata_flag_t)=
### [`sdata_flag_t`](https://github.com/artgins/gobj-js/blob/7.25.2/src/gobj.js#L109)
...
(js_gobj_has_attr)=
### [`gobj_has_attr(gobj, name)`](https://github.com/artgins/gobj-js/blob/7.25.2/src/gobj.js#L3274)

Tells if a gobj has an attribute with that name.

(js_gobj_read_attr)=
### [`gobj_read_attr(gobj, name, src)`](https://github.com/artgins/gobj-js/blob/7.25.2/src/gobj.js#L3285)

Reads an attribute of any type. `src` names the gobj that asks, for the
authorization and for the log.

(js_gobj_read_attrs)=
### [`gobj_read_attrs(gobj, include_flag, src)`](https://github.com/artgins/gobj-js/blob/7.25.2/src/gobj.js#L3308)

Reads every attribute whose flags match `include_flag`, as one object.

(js_gobj_read_bool_attr)=
### [`gobj_read_bool_attr(gobj, name)`](https://github.com/artgins/gobj-js/blob/7.25.2/src/gobj.js#L3344)

Reads a boolean attribute.

(js_gobj_read_integer_attr)=
### [`gobj_read_integer_attr(gobj, name)`](https://github.com/artgins/gobj-js/blob/7.25.2/src/gobj.js#L3375)

Reads an integer attribute.

(js_gobj_read_str_attr)=
### [`gobj_read_str_attr(gobj, name)`](https://github.com/artgins/gobj-js/blob/7.25.2/src/gobj.js#L3398)

Reads a string attribute.

(js_gobj_read_pointer_attr)=
### [`gobj_read_pointer_attr(gobj, name)`](https://github.com/artgins/gobj-js/blob/7.25.2/src/gobj.js#L3421)

Reads an attribute that holds a value which is not JSON. The `subscriber`
attribute of the subscription model uses it.

(js_gobj_hsdata)=
### [`gobj_hsdata(gobj)`](https://github.com/artgins/gobj-js/blob/7.25.2/src/gobj.js#L1132)
...
(js_gobj_write_attr)=
### [`gobj_write_attr(gobj, path, value, src)`](https://github.com/artgins/gobj-js/blob/7.25.2/src/gobj.js#L3440)

Writes an attribute of any type.

(js_gobj_write_attrs)=
### [`gobj_write_attrs(gobj, kw, include_flag, src)`](https://github.com/artgins/gobj-js/blob/7.25.2/src/gobj.js#L3581)

Writes every attribute of `kw` whose flags match `include_flag`.

(js_gobj_write_bool_attr)=
### [`gobj_write_bool_attr(gobj, name, value)`](https://github.com/artgins/gobj-js/blob/7.25.2/src/gobj.js#L3606)

Writes a boolean attribute.

(js_gobj_write_integer_attr)=
### [`gobj_write_integer_attr(gobj, name, value)`](https://github.com/artgins/gobj-js/blob/7.25.2/src/gobj.js#L3634)

Writes an integer attribute.

(js_gobj_write_str_attr)=
### [`gobj_write_str_attr(gobj, name, value)`](https://github.com/artgins/gobj-js/blob/7.25.2/src/gobj.js#L3662)

Writes a string attribute.

(js_gobj_reset_volatil_attrs)=
### [`gobj_reset_volatil_attrs(gobj)`](https://github.com/artgins/gobj-js/blob/7.25.2/src/gobj.js#L3569)
