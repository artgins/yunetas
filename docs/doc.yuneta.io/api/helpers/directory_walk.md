...
## [`get_ordered_filename_array()`](https://github.com/artgins/yunetas/blob/7.5.6/kernel/c/gobj-c/src/helpers.c#L3376)
...
(walk_dir_tree)=
## [`walk_dir_tree()`](https://github.com/artgins/yunetas/blob/7.5.6/kernel/c/gobj-c/src/helpers.c#L3112)
...
(dir_array_free)=
## [`dir_array_free()`](https://github.com/artgins/yunetas/blob/7.5.6/kernel/c/gobj-c/src/helpers.c#L3164)
...
(dir_array_sort)=
## [`dir_array_sort()`](https://github.com/artgins/yunetas/blob/7.5.6/kernel/c/gobj-c/src/helpers.c#L3291)
...
## [`find_files_with_suffix_array()`](https://github.com/artgins/yunetas/blob/7.5.6/kernel/c/gobj-c/src/helpers.c#L3206)
...
(walk_dir_array)=
## [`walk_dir_array()`](https://github.com/artgins/yunetas/blob/7.5.6/kernel/c/gobj-c/src/helpers.c#L3329)
