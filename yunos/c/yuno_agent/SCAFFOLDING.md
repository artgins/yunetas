...
build. Arguments declared at [`yuno_skeleton.c`](https://github.com/artgins/yunetas/blob/7.24.1/utils/c/yuno-skeleton/yuno_skeleton.c):
...
`make_skeleton.c` + [`tmpl_dir.c`](https://github.com/artgins/yunetas/blob/7.24.1/utils/c/yuno-skeleton/tmpl_dir.c). Two substitution layers, both using
[PCRE2](https://www.pcre.org/) regex.

### 4.1 Content placeholders: `{{varname}}`

[`tmpl_dir.c`](https://github.com/artgins/yunetas/blob/7.24.1/utils/c/yuno-skeleton/tmpl_dir.c). Pattern `(\{\{.+?\}\})`. Every `{{var}}` block in a
...
on output ([`tmpl_dir.c`](https://github.com/artgins/yunetas/blob/7.24.1/utils/c/yuno-skeleton/tmpl_dir.c)). Example:
...
automatically in [`make_skeleton.c`](https://github.com/artgins/yunetas/blob/7.24.1/utils/c/yuno-skeleton/make_skeleton.c):
...
`PRIVATE DATA`, `Event types` and `States`. See [`c_yuno.c`](https://github.com/artgins/yunetas/blob/7.24.1/kernel/c/root-linux/src/c_yuno.c) (large
reference example) and [`c_timer.c`](https://github.com/artgins/yunetas/blob/7.24.1/kernel/c/root-linux/src/c_timer.c) (minimal reference example).
...
| What                                              | Where                                                                  |
|---------------------------------------------------|------------------------------------------------------------------------|
| Tool entry point                                  | [`utils/c/yuno-skeleton/yuno_skeleton.c`](https://github.com/artgins/yunetas/blob/7.24.1/utils/c/yuno-skeleton/yuno_skeleton.c)                          |
| Templating engine (variables + dispatch)          | [`utils/c/yuno-skeleton/make_skeleton.c`](https://github.com/artgins/yunetas/blob/7.24.1/utils/c/yuno-skeleton/make_skeleton.c)                        |
| Directory walker + content rendering              | [`utils/c/yuno-skeleton/tmpl_dir.c`](https://github.com/artgins/yunetas/blob/7.24.1/utils/c/yuno-skeleton/tmpl_dir.c)                     |
...
| Canonical large gclass examples                   | [`kernel/c/root-linux/src/c_yuno.c`](https://github.com/artgins/yunetas/blob/7.24.1/kernel/c/root-linux/src/c_yuno.c), [`yunos/c/yuno_agent/src/c_agent.c`](https://github.com/artgins/yunetas/blob/7.24.1/yunos/c/yuno_agent/src/c_agent.c) |
| Canonical minimal gclass example                  | [`kernel/c/root-linux/src/c_timer.c`](https://github.com/artgins/yunetas/blob/7.24.1/kernel/c/root-linux/src/c_timer.c)                                    |
