...
### [`register_c_yui_shell()`](https://github.com/artgins/gobj-ui.js/blob/7.23.11/src/c_yui_shell.js#L3037)
...
### [`register_c_yui_nav()`](https://github.com/artgins/gobj-ui.js/blob/7.23.11/src/c_yui_nav.js#L1027)
...
### [`register_c_yui_pager()`](https://github.com/artgins/gobj-ui.js/blob/7.23.11/src/c_yui_pager.js#L540)

`C_YUI_PAGER` holds a stack of pages inside one zone, for a movement that goes
in and returns.

(js_register_c_yui_wizard)=
### [`register_c_yui_wizard()`](https://github.com/artgins/gobj-ui.js/blob/7.23.11/src/c_yui_wizard.js#L607)

`C_YUI_WIZARD` drives a sequence of steps with a way forward and a way back.

(js_register_c_yui_service_view)=
### [`register_c_yui_service_view()`](https://github.com/artgins/gobj-ui.js/blob/7.23.11/src/c_yui_service_view.js#L353)

`C_YUI_SERVICE_VIEW` puts a view of a service in a zone of the shell.

(js_yui_mount_service_view)=
### [`yui_mount_service_view(host, spec)`](https://github.com/artgins/gobj-ui.js/blob/7.23.11/src/c_yui_service_view.js#L147)

Puts a view of a service in a host, from a description of it.

(js_expose_view_container)=
### [`expose_view_container(host, view)`](https://github.com/artgins/gobj-ui.js/blob/7.23.11/src/c_yui_service_view.js#L210)
...
### [`register_c_yui_window()`](https://github.com/artgins/gobj-ui.js/blob/7.23.11/src/c_yui_window.js#L1266)

`C_YUI_WINDOW` draws a window that floats above the application.

(js_register_c_yui_window_manager)=
### [`register_c_yui_window_manager()`](https://github.com/artgins/gobj-ui.js/blob/7.23.11/src/c_yui_window_manager.js#L645)
...
### [`register_c_yui_form()`](https://github.com/artgins/gobj-ui.js/blob/7.23.11/src/c_yui_form.js#L3093)
...
### [`register_c_yui_json()`](https://github.com/artgins/gobj-ui.js/blob/7.23.11/src/c_yui_json.js#L1371)
...
### [`register_c_yui_json_graph()`](https://github.com/artgins/gobj-ui.js/blob/7.23.11/src/c_yui_json_graph.js#L1683)

`C_YUI_JSON_GRAPH` draws a JSON value as a graph.

(js_register_c_yui_period)=
### [`register_c_yui_period()`](https://github.com/artgins/gobj-ui.js/blob/7.23.11/src/c_yui_period.js#L1436)
...
### [`register_c_yui_treedb_topics()`](https://github.com/artgins/gobj-ui.js/blob/7.23.11/src/c_yui_treedb_topics.js#L2522)

`C_YUI_TREEDB_TOPICS` draws the topics of a treedb as cards, with a panel of
information.

(js_register_c_yui_treedb_graph)=
### [`register_c_yui_treedb_graph()`](https://github.com/artgins/gobj-ui.js/blob/7.23.11/src/c_yui_treedb_graph.js#L2606)
...
### [`register_c_yui_treedb_schema()`](https://github.com/artgins/gobj-ui.js/blob/7.23.11/src/c_yui_treedb_schema.js#L820)
...
### [`register_c_yui_schema_editor()`](https://github.com/artgins/gobj-ui.js/blob/7.23.11/src/c_yui_schema_editor.js#L3398)
...
### [`register_c_yui_treedb_topic_with_form()`](https://github.com/artgins/gobj-ui.js/blob/7.23.11/src/c_yui_treedb_topic_with_form.js#L3748)

`C_YUI_TREEDB_TOPIC_WITH_FORM` draws one topic with the form of its records.

(js_register_c_g6_nodes_tree)=
### [`register_c_g6_nodes_tree()`](https://github.com/artgins/gobj-ui.js/blob/7.23.11/src/c_g6_nodes_tree.js#L8170)
...
### [`register_c_yui_gobj_tree_js()`](https://github.com/artgins/gobj-ui.js/blob/7.23.11/src/c_yui_gobj_tree_js.js#L2118)
...
### [`register_c_yui_uplot()`](https://github.com/artgins/gobj-ui.js/blob/7.23.11/src/c_yui_uplot.js#L507)

`C_YUI_UPLOT` draws a chart of a series of time with the library uPlot.

(js_register_c_yui_map)=
### [`register_c_yui_map()`](https://github.com/artgins/gobj-ui.js/blob/7.23.11/src/c_yui_map.js#L929)
