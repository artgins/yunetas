...
(get_url_schema)=
## [`get_url_schema()`](https://github.com/artgins/yunetas/blob/7.5.9/kernel/c/gobj-c/src/helpers.c#L6317)
...
(parse_url)=
## [`parse_url()`](https://github.com/artgins/yunetas/blob/7.5.9/kernel/c/gobj-c/src/helpers.c#L6186)
