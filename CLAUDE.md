...
versioned to track `YUNETA_VERSION` (SDK `7.11.0`; the gobj-js package is at
`7.10.0` on npm — it moved for the `gobj_post_event()` alignment, and 7.11.0
...
| File | Purpose |
|------|---------|
| `YUNETA_VERSION` | Current version (7.11.0) — used to generate `yuneta_version.h` |
