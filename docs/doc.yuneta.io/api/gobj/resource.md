...
## [`gobj_create_resource()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/gobj.c#L9682)
...
## [`gobj_delete_resource()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/gobj.c#L9766)
...
(gobj_get_resource)=
## [`gobj_get_resource()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/gobj.c#L9851)
...
(gobj_list_resource)=
## [`gobj_list_resource()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/gobj.c#L9814)
...
(gobj_save_resource)=
## [`gobj_save_resource()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/gobj.c#L9720)
