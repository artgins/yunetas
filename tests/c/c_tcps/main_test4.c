 ...
 *          MAIN.C
 *
 *          Test: Large TLS payload (1 MB) — triggers many TLS records
 *
 *          Tasks
 ...
 *          - Shutdown
 *
 *          This test exercises the mbedTLS output_buffer accumulation fix.
 *          A 1 MB payload produces ~64 TLS records of 16 KB each.
 *          Without the fix, each record would be a separate io_uring write,
 *          risking reordering and bad_record_mac on the peer.
 *
 ...
 *                      Names
 ***************************************************************************/
#define APP_NAME        "test_tcps_" "test4"
#define APP_DOC         "Test C_TCPS large payload"
...
static int register_yuno_and_more(void)
{
     ...
     *  Start test
     *------------------------------*/
    json_t *errors_list = json_pack("[{s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}]",
        "msg", "Starting yuno",
        "msg", "Listening...",
        "msg", "Playing yuno",
        "msg", "Connected",
