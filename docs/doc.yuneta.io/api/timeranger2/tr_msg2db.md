...
- [`tr_msg2db.h`](https://github.com/artgins/yunetas/blob/7.17.0/kernel/c/timeranger2/src/tr_msg2db.h)
- [`tr_msg2db.c`](https://github.com/artgins/yunetas/blob/7.17.0/kernel/c/timeranger2/src/tr_msg2db.c)

(build_msg2db_index_path)=
## [`build_msg2db_index_path()`](https://github.com/artgins/yunetas/blob/7.17.0/kernel/c/timeranger2/src/tr_msg2db.c#L62)
...
## [`msg2db_append_message()`](https://github.com/artgins/yunetas/blob/7.17.0/kernel/c/timeranger2/src/tr_msg2db.c#L1052)
...
(msg2db_close_db)=
## [`msg2db_close_db()`](https://github.com/artgins/yunetas/blob/7.17.0/kernel/c/timeranger2/src/tr_msg2db.c#L438)
...
(msg2db_get_message)=
## [`msg2db_get_message()`](https://github.com/artgins/yunetas/blob/7.17.0/kernel/c/timeranger2/src/tr_msg2db.c#L1321)
...
## [`msg2db_list_messages()`](https://github.com/artgins/yunetas/blob/7.17.0/kernel/c/timeranger2/src/tr_msg2db.c#L1240)
...
(msg2db_open_db)=
## [`msg2db_open_db()`](https://github.com/artgins/yunetas/blob/7.17.0/kernel/c/timeranger2/src/tr_msg2db.c#L93)
