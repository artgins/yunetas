...
Declared in [`gobj.h`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.h) as `gobj_method_t`. The framework calls
...
| `mt_start(gobj)`             | `gobj_start()` flips `running=TRUE` ([gobj.c:4311](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.c#L4311)) then calls this  | Start timers, subscribe to peers, open sockets          |
...
| `mt_authz_checker`           | Inside [`gobj_user_has_authz`](#gobj_user_has_authz) if installed ([gobj.c:9400](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.c#L9400))       | Per-gclass authz hook — see [`YUNO_AUTH.md`](YUNO_AUTH.md) §4.3   |

The full table (28+ slots — [`mt_create_resource`](#mt_create_resource), [`mt_save_resource`](#mt_save_resource),
[`mt_create_node`](#mt_create_node), [`mt_link_nodes`](#mt_link_nodes), etc.) is in [`gobj.h`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.h). Most
...
- `gobj_create()` ([`gobj.c:1804`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.c#L1804)): allocate, init attrs, set
  `obflag_created`, call `mt_create()`, then call parent's
  `mt_child_added()`.
- `gobj_start()` ([`gobj.c:4311`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.c#L4311)): set `running=TRUE`
  **before** calling `mt_start()`. Inside your `mt_start`,
  `gobj_is_running(gobj)` already returns `TRUE`.
- `gobj_stop()` ([`gobj.c:4464`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.c#L4464)): set `running=FALSE`
  before calling `mt_stop()`. Symmetric.
- `gobj_destroy()` ([`gobj.c:2272`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.c#L2272)): pauses + stops if needed,
...
`gobj_start_tree(gobj)` ([`gobj.c:4429`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.c#L4429)) walks the gobj's subtree and
...
### 5.1 The types ([`gobj.h`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.h))
...
### 5.2 The flags ([`gobj.h`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.h))
...
[`gobj.h`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.h). Typed accessors:
...
- `gobj_read_attrs(gobj, include_flag, src)` ([`gobj.c:3546`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.c#L3546)) — returns
...
- `gobj_write_attrs(gobj, kw, include_flag, src)` ([`gobj.c:3622`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.c#L3622)) —
  bulk write.
...
data directory. APIs ([`gobj.c`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.c)):
...
Example from [`c_yuno.c`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/root-linux/src/c_yuno.c):
...
Navigation helpers ([`gobj.c`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.c)):
...
Identification helpers ([`gobj.c`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.c)):
...
Predicates ([`gobj.c`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.c)):
...
`__jn_services__` (a global dict at [`gobj.c`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.c)) maps service name →
...
## 7. Worked example: [`c_timer.c`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/root-linux/src/c_timer.c)
...
[`c_timer.c`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/root-linux/src/c_timer.c) is a periodic / one-shot timer. The subscriber sets the
...
not the one that fired the event ([`gobj.c`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.c)). Documented in
...
([`gobj.c`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.c)). You can free shared resources without checking
...
([`gobj.c`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.c), memory
`feedback_gobj_js_gotchas`).
...
[`c_prot_mqtt2.c`](https://github.com/artgins/yunetas/blob/7.7.2/modules/c/mqtt/src/c_prot_mqtt2.c) uses the more defensive
`gobj_is_running(gobj) && !gobj_in_this_state(gobj, ST_DISCONNECTED)`
form (also handles the gobj-stopped case). Either is fine.

Sites with this guard today: [`c_websocket.c`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/root-linux/src/c_websocket.c), [`c_prot_tcp4h.c`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/root-linux/src/c_prot_tcp4h.c),
[`c_prot_mqtt.c`](https://github.com/artgins/yunetas/blob/7.7.2/modules/c/mqtt/src/c_prot_mqtt.c), [`c_prot_mqtt2.c`](https://github.com/artgins/yunetas/blob/7.7.2/modules/c/mqtt/src/c_prot_mqtt2.c). Fixed in commits
`635b06a41` and `855527770` (2026-05-24).

**Intentionally unguarded:** [`c_prot_modbus_m.c`](https://github.com/artgins/yunetas/blob/7.7.2/modules/c/modbus/src/c_prot_modbus_m.c) (`ac_rx_data`). The guard was applied in `855527770` and then reverted in
...
| What                                              | Where                                                              |
|---------------------------------------------------|--------------------------------------------------------------------|
| Public API surface                                | [`kernel/c/gobj-c/src/gobj.h`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.h) (2081 lines)                          |
| Runtime                                           | [`kernel/c/gobj-c/src/gobj.c`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.c) (~12k lines)                          |
| `GMETHODS` struct                                 | [`gobj.h`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.h)                                                   |
| `gobj_create` family                              | [`gobj.h`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.h)                                                   |
| Lifecycle implementation                          | [`gobj.c`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.c) (create, start/stop, destroy)                     |
| `mt_writing` / `mt_reading` call sites            | [`gobj.c`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.c)                                    |
| `obflag` flags                                    | [`gobj.c`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.c)                                                     |
| Attr R/W API                                      | [`gobj.h`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.h)                                                 |
| Bulk attr API + `mt_reading` route                | [`gobj.c`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.c)                                                |
| Persistent attr load/save                         | [`gobj.c`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.c)                                                 |
| SData types (`DTP_*`)                             | [`gobj.h`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.h)                                                     |
| SData flags (`SDF_*`)                             | [`gobj.h`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.h)                                                    |
| Service registry                                  | [`gobj.c`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.c)                                            |
| Tree navigation                                   | [`gobj.c`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.c) (children walks, predicates)                    |
| `gobj_yuno()` / `__yuno__`                        | [`gobj.c`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/gobj-c/src/gobj.c)                                            |
| Canonical minimal gclass                          | [`kernel/c/root-linux/src/c_timer.c`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/root-linux/src/c_timer.c) (426 lines)                    |
| Canonical large gclass                            | [`kernel/c/root-linux/src/c_yuno.c`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/root-linux/src/c_yuno.c), [`yunos/c/yuno_agent/src/c_agent.c`](https://github.com/artgins/yunetas/blob/7.7.2/yunos/c/yuno_agent/src/c_agent.c) |
