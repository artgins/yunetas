...
(all_numbers)=
## [`all_numbers()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L1051)
...
(bin2hex)=
## [`bin2hex()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L5510)
...
(build_path)=
## [`build_path()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L903)
...
(change_char)=
## [`change_char()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L1260)
...
(count_char)=
## [`count_char()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L6246)
...
(delete_left_blanks)=
## [`delete_left_blanks()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L1124)
...
(delete_left_char)=
## [`delete_left_char()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L814)
...
(delete_right_blanks)=
## [`delete_right_blanks()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L1101)
...
(delete_right_char)=
## [`delete_right_char()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L793)
...
## [`get_key_value_parameter()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L1343)
...
(get_last_segment)=
## [`get_last_segment()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L980)
...
(get_parameter)=
## [`get_parameter()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L1278)
...
## [`helper_doublequote2quote()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L1036)
...
## [`helper_quote2doublequote()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L1021)
...
(hex2bin)=
## [`hex2bin()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L5478)
...
(idx_in_list)=
## [`idx_in_list()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L1695)
...
(left_justify)=
## [`left_justify()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L1150)
...
(nice_size)=
## [`nice_size()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L1070)
...
(pop_last_segment)=
## [`pop_last_segment()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L1002)
...
(split2)=
## [`split2()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L1485)
...
(split3)=
## [`split3()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L1554)
...
(split_free2)=
## [`split_free2()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L1534)
...
(split_free3)=
## [`split_free3()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L1606)
...
(str_concat)=
## [`str_concat()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L1623)
...
(str_concat3)=
## [`str_concat3()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L1652)
...
(str_concat_free)=
## [`str_concat_free()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L1686)
...
(str_in_list)=
## [`str_in_list()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L1718)
...
(strntolower)=
## [`strntolower()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L1187)
...
(strntoupper)=
## [`strntoupper()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L1168)
...
(translate_string)=
## [`translate_string()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L1215)
...
(capitalize)=
## [`capitalize()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L7381)
...
(lower)=
## [`lower()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L7368)
...
(path_basename)=
## [`path_basename()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L8053)
...
(replace_cli_vars)=
## [`replace_cli_vars()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L8139)
...
(upper)=
## [`upper()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L7355)
