...
(get_hostname)=
## [`get_hostname()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/helpers.c#L5685)
...
(node_uuid)=
## [`node_uuid()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/helpers.c#L5835)
...
(check_open_fds)=
## [`check_open_fds()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/helpers.c#L6955)
...
(cpu_usage)=
## [`cpu_usage()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/helpers.c#L5418)
...
(cpu_usage_percent)=
## [`cpu_usage_percent()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/helpers.c#L5454)
...
(create_random_uuid)=
## [`create_random_uuid()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/helpers.c#L5711)
...
(free_ram_in_kb)=
## [`free_ram_in_kb()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/helpers.c#L6509)
...
## [`get_name_from_nn_table()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/helpers.c#L7648)
...
## [`get_number_from_nn_table()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/helpers.c#L7627)
...
(get_yunetas_base)=
## [`get_yunetas_base()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/helpers.c#L7489)
...
(is_yuneta_user)=
## [`is_yuneta_user()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/helpers.c#L7421)
...
(print_open_fds)=
## [`print_open_fds()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/helpers.c#L6991)
...
## [`source2base64_for_yunetas()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/helpers.c#L7522)
...
(total_ram_in_kb)=
## [`total_ram_in_kb()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/helpers.c#L6556)
...
(yuneta_getgrnam)=
## [`yuneta_getgrnam()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/helpers.c#L7395)
...
(yuneta_getgrouplist)=
## [`yuneta_getgrouplist()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/helpers.c#L7404)
...
(yuneta_getpwnam)=
## [`yuneta_getpwnam()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/helpers.c#L7386)
...
(yuneta_getpwuid)=
## [`yuneta_getpwuid()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/helpers.c#L7377)
