...
- [`tr_msg2db.h`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/timeranger2/src/tr_msg2db.h)
- [`tr_msg2db.c`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/timeranger2/src/tr_msg2db.c)

(build_msg2db_index_path)=
## [`build_msg2db_index_path()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/timeranger2/src/tr_msg2db.c#L63)
...
## [`msg2db_append_message()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/timeranger2/src/tr_msg2db.c#L1013)
...
(msg2db_close_db)=
## [`msg2db_close_db()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/timeranger2/src/tr_msg2db.c#L418)
...
(msg2db_get_message)=
## [`msg2db_get_message()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/timeranger2/src/tr_msg2db.c#L1268)
...
## [`msg2db_list_messages()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/timeranger2/src/tr_msg2db.c#L1187)
...
(msg2db_open_db)=
## [`msg2db_open_db()`](https://github.com/artgins/yunetas/blob/7.10.0/kernel/c/timeranger2/src/tr_msg2db.c#L94)
