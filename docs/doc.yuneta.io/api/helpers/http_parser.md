...
(ghttp_parser_create)=
## [`ghttp_parser_create()`](https://github.com/artgins/yunetas/blob/7.5.5/kernel/c/root-linux/src/ghttp_parser.c#L62)
...
## [`ghttp_parser_destroy()`](https://github.com/artgins/yunetas/blob/7.5.5/kernel/c/root-linux/src/ghttp_parser.c#L106)
...
## [`ghttp_parser_received()`](https://github.com/artgins/yunetas/blob/7.5.5/kernel/c/root-linux/src/ghttp_parser.c#L135)
...
(ghttp_parser_finish)=
## [`ghttp_parser_finish()`](https://github.com/artgins/yunetas/blob/7.5.5/kernel/c/root-linux/src/ghttp_parser.c#L195)
