...
html_theme_options = {
    ...
    "extra_footer": "Built with <a href='https://www.sphinx-doc.org/en/master/' target='_blank'>Sphinx</a> using <a href='https://sphinx-book-theme.readthedocs.io' target='_blank'>sphinx-book-theme</a>"
}
