...
[`packages/README.md`](https://github.com/artgins/yunetas/tree/7.11.0/packages).
...
> ([`AMD64.sh`](https://github.com/artgins/yunetas/blob/7.11.0/packages/deb/AMD64.sh), [`ARM32.sh`](https://github.com/artgins/yunetas/blob/7.11.0/packages/deb/ARM32.sh), [`ARMhf.sh`](https://github.com/artgins/yunetas/blob/7.11.0/packages/deb/ARMhf.sh), [`RISCV64.sh`](https://github.com/artgins/yunetas/blob/7.11.0/packages/deb/RISCV64.sh)). Requires the
...
[`packages/deb/README.md`](https://github.com/artgins/yunetas/blob/7.11.0/packages/deb/README.md).
...
[`yunetas-env.sh`](https://github.com/artgins/yunetas/blob/7.11.0/yunetas-env.sh) exports four variables and prepends `/yuneta/bin`
...
> to source [`yunetas-env.sh`](https://github.com/artgins/yunetas/blob/7.11.0/yunetas-env.sh) again. Without it, [`ybatch`](#util-ybatch) / [`ycommand`](#util-ycommand) /
...
> re-run [`./set_compiler.sh`](https://github.com/artgins/yunetas/blob/7.11.0/set_compiler.sh) so the external libs are rebuilt with
