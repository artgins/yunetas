...
- [`tr_treedb.c`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c)

(_treedb_create_topic_cols_desc)=
## [`_treedb_create_topic_cols_desc()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L488)
...
(add_jtree_path)=
## [`add_jtree_path()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L9412)
...
## [`create_template_record()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L11913)
...
(current_snap_tag)=
## [`current_snap_tag()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L137)
...
(decode_child_ref)=
## [`decode_child_ref()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L3964)
...
(decode_parent_ref)=
## [`decode_parent_ref()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L3910)
...
(node_collapsed_view)=
## [`node_collapsed_view()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L8404)
...
(parse_hooks)=
## [`parse_hooks()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L2099)
...
(parse_schema)=
## [`parse_schema()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L2020)
...
(parse_schema_cols)=
## [`parse_schema_cols()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L2055)
...
(set_volatil_values)=
## [`set_volatil_values()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L3075)
...
## [`treedb_activate_snap()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L11775)
...
(treedb_autolink)=
## [`treedb_autolink()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L7737)
...
(treedb_clean_node)=
## [`treedb_clean_node()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L7585)
...
(treedb_close_db)=
## [`treedb_close_db()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L1226)
...
(treedb_close_topic)=
## [`treedb_close_topic()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L1582)
...
(treedb_create_node)=
## [`treedb_create_node()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L5092)
...
(treedb_create_topic)=
## [`treedb_create_topic()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L1266)
...
## [`treedb_delete_instance()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L6303)
...
(treedb_delete_node)=
## [`treedb_delete_node()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L5881)
...
(treedb_delete_topic)=
## [`treedb_delete_topic()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L1632)
...
(treedb_get_id_index)=
## [`treedb_get_id_index()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L264)
...
(treedb_get_instance)=
## [`treedb_get_instance()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L8345)
...
(treedb_get_node)=
## [`treedb_get_node()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L8302)
...
## [`treedb_get_topic_hooks()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L9632)
...
## [`treedb_get_topic_links()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L9591)
...
## [`treedb_is_treedbs_topic()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L249)
...
(treedb_link_nodes)=
## [`treedb_link_nodes()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L7923)
...
## [`treedb_list_instances()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L8676)
...
(treedb_list_nodes)=
## [`treedb_list_nodes()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L8535)
...
(treedb_list_parents)=
## [`treedb_list_parents()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L9151)
...
(treedb_list_snaps)=
## [`treedb_list_snaps()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L11893)
...
(treedb_list_treedb)=
## [`treedb_list_treedb()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L1687)
...
## [`treedb_node_children()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L9360)
...
(treedb_node_jtree)=
## [`treedb_node_jtree()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L9520)
...
(treedb_open_db)=
## [`treedb_open_db()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L574)
...
(treedb_parent_refs)=
## [`treedb_parent_refs()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L9061)
...
(treedb_save_node)=
## [`treedb_save_node()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L5518)
...
(treedb_set_callback)=
## [`treedb_set_callback()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L1181)
...
## [`treedb_set_node_immutable()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L5698)
...
(treedb_set_trace)=
## [`treedb_set_trace()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L4809)
...
(treedb_shoot_snap)=
## [`treedb_shoot_snap()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L11564)
...
(treedb_topic_pkey2s)=
## [`treedb_topic_pkey2s()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L150)
...
## [`treedb_topic_pkey2s_filter()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L165)
...
## [`treedb_create_system_schema()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L457)
...
(treedb_topic_size)=
## [`treedb_topic_size()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L1769)
...
(treedb_topics)=
## [`treedb_topics()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L1720)
...
(treedb_unlink_nodes)=
## [`treedb_unlink_nodes()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L8001)
...
(treedb_update_node)=
## [`treedb_update_node()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L5748)
...
(get_hook_list)=
## [`get_hook_list()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L4819)
...
## [`topic_desc_fkey_names()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L2303)
...
## [`topic_desc_hook_names()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/timeranger2/src/tr_treedb.c#L2278)
