...
(yuneta_setup)=
## [`yuneta_setup()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/root-linux/src/entry_point.c#L251)
...
(yuneta_entry_point)=
## [`yuneta_entry_point()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/root-linux/src/entry_point.c#L338)
...
(set_auto_kill_time)=
## [`set_auto_kill_time()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/root-linux/src/entry_point.c#L1041)
...
(yuneta_is_daemon)=
## [`yuneta_is_daemon()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/root-linux/src/entry_point.c#L1049)
...
(yuneta_json_config)=
## [`yuneta_json_config()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/root-linux/src/entry_point.c#L1057)
...
(run_services)=
## [`run_services()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/root-linux/src/manage_services.c#L36)
...
(stop_services)=
## [`stop_services()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/root-linux/src/manage_services.c#L62)
...
(yuno_shutdown)=
## [`yuno_shutdown()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/root-linux/src/manage_services.c#L92)
...
## [`yunetas_register_c_core()`](https://github.com/artgins/yunetas/blob/7.25.3/kernel/c/root-linux/src/yunetas_register.c#L51)
