...
(get_attrs_schema)=
## [`get_attrs_schema()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L6529)
...
## [`get_sdata_flag_table()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L6506)
...
(gobj2json)=
## [`gobj2json()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L7263)
...
(gobj_command_desc)=
## [`gobj_command_desc()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L6481)
...
(gobj_full_name)=
## [`gobj_full_name()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L6093)
...
(gobj_gclass)=
## [`gobj_gclass()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L6084)
...
(gobj_gclass_name)=
## [`gobj_gclass_name()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L6075)
...
## [`gobj_global_variables()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L6163)
...
## [`gobj_add_global_variable()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L6218)
...
(gobj_is_destroying)=
## [`gobj_is_destroying()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L6253)
...
(gobj_is_disabled)=
## [`gobj_is_disabled()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L6318)
...
(gobj_is_playing)=
## [`gobj_is_playing()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L6277)
...
(gobj_is_pure_child)=
## [`gobj_is_pure_child()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L6371)
...
(gobj_is_running)=
## [`gobj_is_running()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L6265)
...
(gobj_is_service)=
## [`gobj_is_service()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L6290)
...
(gobj_is_volatil)=
## [`gobj_is_volatil()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L6329)
...
(gobj_name)=
## [`gobj_name()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L6066)
...
(gobj_parent)=
## [`gobj_parent()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L6242)
...
(gobj_priv_data)=
## [`gobj_priv_data()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L6234)
...
## [`gobj_set_manual_start()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L6356)
...
(gobj_set_volatil)=
## [`gobj_set_volatil()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L6341)
...
(gobj_short_name)=
## [`gobj_short_name()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L6140)
...
(gobj_typeof_gclass)=
## [`gobj_typeof_gclass()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L6395)
...
## [`gobj_typeof_inherited_gclass()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L6407)
...
(gobj_view_tree)=
## [`gobj_view_tree()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L7437)
...
(gobj_yuno)=
## [`gobj_yuno()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L5973)
...
(gobj_yuno_id)=
## [`gobj_yuno_id()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L5998)
...
(gobj_yuno_name)=
## [`gobj_yuno_name()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L5984)
...
## [`gobj_yuno_node_owner()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L6055)
...
(gobj_yuno_realm_env)=
## [`gobj_yuno_realm_env()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L6048)
...
(gobj_yuno_realm_id)=
## [`gobj_yuno_realm_id()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L6020)
...
## [`gobj_yuno_realm_name()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L6041)
...
## [`gobj_yuno_realm_owner()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L6027)
...
## [`gobj_yuno_realm_role()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L6034)
...
(gobj_yuno_role)=
## [`gobj_yuno_role()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L5991)
...
## [`gobj_yuno_role_plus_name()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L6012)
...
(gobj_yuno_tag)=
## [`gobj_yuno_tag()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L6005)
...
(gobj_audit_commands)=
## [`gobj_audit_commands()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L4920)
...
(gobj_is_bottom_gobj)=
## [`gobj_is_bottom_gobj()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L6383)
...
(gobj_is_top_service)=
## [`gobj_is_top_service()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L6304)
...
## [`gobj_kw_get_user_data()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L3734)
...
## [`gobj_nearest_top_service()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L5175)
...
(gobj_top_services)=
## [`gobj_top_services()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L1420)
