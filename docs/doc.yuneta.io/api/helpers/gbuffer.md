...
(gbuf2json)=
## [`gbuf2json()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/gobj-c/src/gbuffer.c#L1160)
...
(gbuffer_append)=
## [`gbuffer_append()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/gobj-c/src/gbuffer.c#L315)
...
(gbuffer_append_gbuf)=
## [`gbuffer_append_gbuf()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/gobj-c/src/gbuffer.c#L378)
...
(gbuffer_create)=
## [`gbuffer_create()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/gobj-c/src/gbuffer.c#L28)
...
(gbuffer_deserialize)=
## [`gbuffer_deserialize()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/gobj-c/src/gbuffer.c#L657)
...
## [`gbuffer_encode_base64()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/gobj-c/src/gbuffer.c#L1090)
...
(gbuffer_get)=
## [`gbuffer_get()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/gobj-c/src/gbuffer.c#L235)
...
(gbuffer_getline)=
## [`gbuffer_getline()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/gobj-c/src/gbuffer.c#L254)
...
(gbuffer_remove)=
## [`gbuffer_remove()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/gobj-c/src/gbuffer.c#L162)
...
(gbuffer_serialize)=
## [`gbuffer_serialize()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/gobj-c/src/gbuffer.c#L617)
...
## [`gbuffer_set_rd_offset()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/gobj-c/src/gbuffer.c#L203)
...
(gbuffer_set_wr)=
## [`gbuffer_set_wr()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/gobj-c/src/gbuffer.c#L286)
...
(gbuffer_setlabel)=
## [`gbuffer_setlabel()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/gobj-c/src/gbuffer.c#L539)
...
(json2gbuf)=
## [`json2gbuf()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/gobj-c/src/gbuffer.c#L1142)
...
(config_gbuffer2json)=
## [`config_gbuffer2json()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/gobj-c/src/gbuffer.c#L1198)
...
(gbuf2file)=
## [`gbuf2file()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/gobj-c/src/gbuffer.c#L564)
...
(gbuffer_append_json)=
## [`gbuffer_append_json()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/gobj-c/src/gbuffer.c#L415)
...
## [`gbuffer_base64_to_binary()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/gobj-c/src/gbuffer.c#L1044)
...
## [`gbuffer_binary_to_base64()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/gobj-c/src/gbuffer.c#L967)
...
(gbuffer_file2base64)=
## [`gbuffer_file2base64()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/gobj-c/src/gbuffer.c#L1003)
