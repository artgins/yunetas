...
(get_hostname)=
## [`get_hostname()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L5692)
...
(node_uuid)=
## [`node_uuid()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L5842)
...
(check_open_fds)=
## [`check_open_fds()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L6962)
...
(cpu_usage)=
## [`cpu_usage()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L5425)
...
(cpu_usage_percent)=
## [`cpu_usage_percent()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L5461)
...
(create_random_uuid)=
## [`create_random_uuid()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L5718)
...
(free_ram_in_kb)=
## [`free_ram_in_kb()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L6516)
...
## [`get_name_from_nn_table()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L7655)
...
## [`get_number_from_nn_table()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L7634)
...
(get_yunetas_base)=
## [`get_yunetas_base()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L7496)
...
(is_yuneta_user)=
## [`is_yuneta_user()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L7428)
...
(print_open_fds)=
## [`print_open_fds()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L6998)
...
(sha256_digest)=
## [`sha256_digest()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L7909)
...
(sha256_hex)=
## [`sha256_hex()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L7951)
...
## [`source2base64_for_yunetas()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L7529)
...
(total_ram_in_kb)=
## [`total_ram_in_kb()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L6563)
...
(yuneta_getgrnam)=
## [`yuneta_getgrnam()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L7402)
...
(yuneta_getgrouplist)=
## [`yuneta_getgrouplist()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L7411)
...
(yuneta_getpwnam)=
## [`yuneta_getpwnam()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L7393)
...
(yuneta_getpwuid)=
## [`yuneta_getpwuid()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L7384)
