...
TreeDB node helpers accessible directly from a gobj — create, read, update, delete, link, and unlink nodes in the in-memory graph database backed by timeranger2.
...
(gobj_activate_snap)=
## [`gobj_activate_snap()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L10925)
...
Returns 0 on success, or -1 if an error occurs (for example if `gobj` is NULL, destroyed, or if `mt_activate_snap` is not defined).

**Notes**

['If `gobj` is NULL or destroyed, an error is logged and the function returns -1.', "If `mt_activate_snap` is not defined in the `gobj`'s gclass, an error is logged and the function returns -1.", "The function ensures that the snapshot activation is properly handled by the `gobj`'s gclass."]

---

(gobj_create_node)=
## [`gobj_create_node()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L10379)
...
(gobj_delete_node)=
## [`gobj_delete_node()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L10455)
...
Returns 0 on success, or -1 if an error occurs (for example if the `hgobj` is NULL, destroyed, or lacks the `mt_delete_node` method).

**Notes**

['If `gobj` is NULL or destroyed, an error is logged and the function returns -1.', "If `mt_delete_node` is not defined in the `gobj`'s gclass, an error is logged and the function returns -1.", 'The `kw` and `jn_options` parameters are owned and will be decremented within the function.']

---

(gobj_get_node)=
## [`gobj_get_node()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L10589)
...
(gobj_link_nodes)=
## [`gobj_link_nodes()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L10493)
...
Returns 0 on success, or -1 if an error occurs (for example if `gobj` is NULL, destroyed, or if the `mt_link_nodes` method is not defined).
...
(gobj_list_instances)=
## [`gobj_list_instances()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L10666)
...
(gobj_list_nodes)=
## [`gobj_list_nodes()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L10627)
...
(gobj_list_snaps)=
## [`gobj_list_snaps()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L10960)
...
(gobj_node_children)=
## [`gobj_node_children()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L10750)
...
(gobj_node_parents)=
## [`gobj_node_parents()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L10710)
...
(gobj_node_tree)=
## [`gobj_node_tree()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L10846)
...
(gobj_shoot_snap)=
## [`gobj_shoot_snap()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L10890)
...
(gobj_topic_desc)=
## [`gobj_topic_desc()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L10244)
...
(gobj_topic_hooks)=
## [`gobj_topic_hooks()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L10311)
...
(gobj_topic_jtree)=
## [`gobj_topic_jtree()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L10794)
...
(gobj_topic_links)=
## [`gobj_topic_links()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L10275)
...
(gobj_topic_size)=
## [`gobj_topic_size()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L10347)
...
(gobj_treedb_topics)=
## [`gobj_treedb_topics()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L10209)
...
(gobj_treedbs)=
## [`gobj_treedbs()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L10175)
...
(gobj_unlink_nodes)=
## [`gobj_unlink_nodes()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L10541)
...
Returns `0` on success, or `-1` if an error occurs (for example if `gobj` is `NULL` or destroyed, or if `mt_unlink_nodes` is not defined).

**Notes**

['The function checks if `gobj` is valid before proceeding.', "If `mt_unlink_nodes` is not defined in the `gobj`'s gclass, an error is logged and `-1` is returned.", 'Both `parent_record` and `child_record` are decremented after use.']

---

(gobj_update_node)=
## [`gobj_update_node()`](https://github.com/artgins/yunetas/blob/7.18.0/kernel/c/gobj-c/src/gobj.c#L10417)
...
If the GObj does not implement `mt_update_node`, an error is logged and NULL is returned. The function makes sure that the GObj is not destroyed before proceeding.
