...
- [`tr_treedb.c`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c)

(_treedb_create_topic_cols_desc)=
## [`_treedb_create_topic_cols_desc()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L451)
...
(add_jtree_path)=
## [`add_jtree_path()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L9272)
...
## [`create_template_record()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L9985)
...
(current_snap_tag)=
## [`current_snap_tag()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L119)
...
(decode_child_ref)=
## [`decode_child_ref()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L3871)
...
(decode_parent_ref)=
## [`decode_parent_ref()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L3817)
...
(node_collapsed_view)=
## [`node_collapsed_view()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L8264)
...
(parse_hooks)=
## [`parse_hooks()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L2006)
...
(parse_schema)=
## [`parse_schema()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L1927)
...
(parse_schema_cols)=
## [`parse_schema_cols()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L1962)
...
(set_volatil_values)=
## [`set_volatil_values()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L2982)
...
## [`treedb_activate_snap()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L9847)
...
(treedb_autolink)=
## [`treedb_autolink()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L7606)
...
(treedb_clean_node)=
## [`treedb_clean_node()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L7454)
...
(treedb_close_db)=
## [`treedb_close_db()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L1153)
...
(treedb_close_topic)=
## [`treedb_close_topic()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L1498)
...
(treedb_create_node)=
## [`treedb_create_node()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L5019)
...
(treedb_create_topic)=
## [`treedb_create_topic()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L1192)
...
## [`treedb_delete_instance()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L6172)
...
(treedb_delete_node)=
## [`treedb_delete_node()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L5787)
...
(treedb_delete_topic)=
## [`treedb_delete_topic()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L1548)
...
(treedb_get_id_index)=
## [`treedb_get_id_index()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L246)
...
(treedb_get_instance)=
## [`treedb_get_instance()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L8205)
...
(treedb_get_node)=
## [`treedb_get_node()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L8162)
...
## [`treedb_get_topic_hooks()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L9492)
...
## [`treedb_get_topic_links()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L9451)
...
## [`treedb_is_treedbs_topic()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L231)
...
(treedb_link_nodes)=
## [`treedb_link_nodes()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L7783)
...
## [`treedb_list_instances()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L8536)
...
(treedb_list_nodes)=
## [`treedb_list_nodes()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L8395)
...
(treedb_list_parents)=
## [`treedb_list_parents()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L9011)
...
(treedb_list_snaps)=
## [`treedb_list_snaps()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L9965)
...
(treedb_list_treedb)=
## [`treedb_list_treedb()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L1594)
...
## [`treedb_node_children()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L9220)
...
(treedb_node_jtree)=
## [`treedb_node_jtree()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L9380)
...
(treedb_open_db)=
## [`treedb_open_db()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L535)
...
(treedb_parent_refs)=
## [`treedb_parent_refs()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L8921)
...
(treedb_save_node)=
## [`treedb_save_node()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L5436)
...
(treedb_set_callback)=
## [`treedb_set_callback()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L1108)
...
## [`treedb_set_node_immutable()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L5616)
...
(treedb_set_trace)=
## [`treedb_set_trace()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L4736)
...
(treedb_shoot_snap)=
## [`treedb_shoot_snap()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L9636)
...
(treedb_topic_pkey2s)=
## [`treedb_topic_pkey2s()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L132)
...
## [`treedb_topic_pkey2s_filter()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L147)
...
(treedb_topic_size)=
## [`treedb_topic_size()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L1676)
...
(treedb_topics)=
## [`treedb_topics()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L1627)
...
(treedb_unlink_nodes)=
## [`treedb_unlink_nodes()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L7861)
...
(treedb_update_node)=
## [`treedb_update_node()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L5666)
...
(get_hook_list)=
## [`get_hook_list()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L4746)
...
## [`topic_desc_fkey_names()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L2210)
...
## [`topic_desc_hook_names()`](https://github.com/artgins/yunetas/blob/7.13.2/kernel/c/timeranger2/src/tr_treedb.c#L2185)
