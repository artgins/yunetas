...
- [`helpers.c`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c)

(anystring2json)=
## [`anystring2json()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L2491)
...
(bits2gbuffer)=
## [`bits2gbuffer()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L1948)
...
(bits2jn_strlist)=
## [`bits2jn_strlist()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L1929)
...
(cmp_two_simple_json)=
## [`cmp_two_simple_json()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L2397)
...
(create_json_record)=
## [`create_json_record()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L1757)
...
(debug_json)=
## [`debug_json()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L5232)
...
(get_real_precision)=
## [`get_real_precision()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L2680)
...
(jn2bool)=
## [`jn2bool()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L2372)
...
(jn2integer)=
## [`jn2integer()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L2318)
...
(jn2real)=
## [`jn2real()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L2295)
...
(jn2string)=
## [`jn2string()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L2347)
...
(json2str)=
## [`json2str()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L2689)
...
(json2uglystr)=
## [`json2uglystr()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L2702)
...
## [`json_check_refcounts()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L2715)
...
(json_config)=
## [`json_config()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/json_config.c#L333)
...
(json_desc_to_schema)=
## [`json_desc_to_schema()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L1897)
...
(json_is_identical)=
## [`json_is_identical()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L2471)
...
(json_list_str_index)=
## [`json_list_str_index()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L2007)
...
## [`json_print_refcounts()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L2879)
...
(json_str_in_list)=
## [`json_str_in_list()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L2973)
...
(load_json_from_file)=
## [`load_json_from_file()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L1599)
...
## [`load_persistent_json()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L1519)
...
(print_json)=
## [`print_json()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L5078)
...
(save_json_to_file)=
## [`save_json_to_file()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L1647)
...
(set_real_precision)=
## [`set_real_precision()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L2674)
...
(string2json)=
## [`string2json()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L2558)
...
(strings2bits)=
## [`strings2bits()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L1980)
...
(anyfile2json)=
## [`anyfile2json()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L2529)
...
(is_metadata_key)=
## [`is_metadata_key()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L5873)
...
(is_private_key)=
## [`is_private_key()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L5894)
...
## [`json_config_string2json()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L2585)
...
## [`json_dict_recursive_update()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L2249)
...
(json_is_range)=
## [`json_is_range()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L2149)
...
(json_list_find)=
## [`json_list_find()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L2105)
...
(json_list_int)=
## [`json_list_int()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L2043)
...
(json_list_int_index)=
## [`json_list_int_index()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L2075)
...
(json_list_update)=
## [`json_list_update()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L2124)
...
(json_listsrange2set)=
## [`json_listsrange2set()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L2209)
...
(json_range_list)=
## [`json_range_list()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.c#L2180)
...
(json_size)=
## [`json_size()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.h#L128)
...
(empty_json)=
## [`empty_json()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.h#L151)
...
(json_absent)=
## [`json_absent()`](https://github.com/artgins/yunetas/blob/7.23.0/kernel/c/gobj-c/src/helpers.h#L162)
