...
(glog_end)=
## [`glog_end()`](https://github.com/artgins/yunetas/blob/7.16.4/kernel/c/gobj-c/src/glogger.c#L205)
...
(glog_init)=
## [`glog_init()`](https://github.com/artgins/yunetas/blob/7.16.4/kernel/c/gobj-c/src/glogger.c#L169)
...
(gobj_get_log_data)=
## [`gobj_get_log_data()`](https://github.com/artgins/yunetas/blob/7.16.4/kernel/c/gobj-c/src/glogger.c#L580)
...
## [`gobj_get_log_priority_name()`](https://github.com/artgins/yunetas/blob/7.16.4/kernel/c/gobj-c/src/glogger.c#L569)
...
## [`gobj_log_add_handler()`](https://github.com/artgins/yunetas/blob/7.16.4/kernel/c/gobj-c/src/glogger.c#L278)
...
(gobj_log_alert)=
## [`gobj_log_alert()`](https://github.com/artgins/yunetas/blob/7.16.4/kernel/c/gobj-c/src/glogger.c#L479)
...
## [`gobj_log_clear_counters()`](https://github.com/artgins/yunetas/blob/7.16.4/kernel/c/gobj-c/src/glogger.c#L595)
...
(gobj_log_critical)=
## [`gobj_log_critical()`](https://github.com/artgins/yunetas/blob/7.16.4/kernel/c/gobj-c/src/glogger.c#L494)
...
(gobj_log_debug)=
## [`gobj_log_debug()`](https://github.com/artgins/yunetas/blob/7.16.4/kernel/c/gobj-c/src/glogger.c#L554)
...
## [`gobj_log_del_handler()`](https://github.com/artgins/yunetas/blob/7.16.4/kernel/c/gobj-c/src/glogger.c#L341)
...
(gobj_log_error)=
## [`gobj_log_error()`](https://github.com/artgins/yunetas/blob/7.16.4/kernel/c/gobj-c/src/glogger.c#L509)
...
## [`gobj_log_exist_handler()`](https://github.com/artgins/yunetas/blob/7.16.4/kernel/c/gobj-c/src/glogger.c#L253)
...
(gobj_log_info)=
## [`gobj_log_info()`](https://github.com/artgins/yunetas/blob/7.16.4/kernel/c/gobj-c/src/glogger.c#L539)
...
## [`gobj_log_last_message()`](https://github.com/artgins/yunetas/blob/7.16.4/kernel/c/gobj-c/src/glogger.c#L626)
...
## [`gobj_log_list_handlers()`](https://github.com/artgins/yunetas/blob/7.16.4/kernel/c/gobj-c/src/glogger.c#L383)
...
## [`gobj_log_register_handler()`](https://github.com/artgins/yunetas/blob/7.16.4/kernel/c/gobj-c/src/glogger.c#L228)
...
## [`gobj_log_set_global_handler_option()`](https://github.com/artgins/yunetas/blob/7.16.4/kernel/c/gobj-c/src/glogger.c#L412)
...
(gobj_log_warning)=
## [`gobj_log_warning()`](https://github.com/artgins/yunetas/blob/7.16.4/kernel/c/gobj-c/src/glogger.c#L524)
...
(print_backtrace)=
## [`print_backtrace()`](https://github.com/artgins/yunetas/blob/7.16.4/kernel/c/gobj-c/src/glogger.c#L748)
...
## [`set_show_backtrace_fn()`](https://github.com/artgins/yunetas/blob/7.16.4/kernel/c/gobj-c/src/glogger.c#L720)
...
(stdout_fwrite)=
## [`stdout_fwrite()`](https://github.com/artgins/yunetas/blob/7.16.4/kernel/c/gobj-c/src/glogger.c#L687)
...
(stdout_write)=
## [`stdout_write()`](https://github.com/artgins/yunetas/blob/7.16.4/kernel/c/gobj-c/src/glogger.c#L645)
...
(trace_vjson)=
## [`trace_vjson()`](https://github.com/artgins/yunetas/blob/7.16.4/kernel/c/gobj-c/src/glogger.c#L1083)
...
(_log_bf)=
## [`_log_bf()`](https://github.com/artgins/yunetas/blob/7.16.4/kernel/c/gobj-c/src/glogger.c#L940)
...
## [`gobj_log_clear_log_file()`](https://github.com/artgins/yunetas/blob/7.16.4/kernel/c/gobj-c/src/glogger.c#L608)
...
## [`set_trace_with_full_name()`](https://github.com/artgins/yunetas/blob/7.16.4/kernel/c/gobj-c/src/glogger.c#L738)
...
## [`set_trace_with_short_name()`](https://github.com/artgins/yunetas/blob/7.16.4/kernel/c/gobj-c/src/glogger.c#L728)
