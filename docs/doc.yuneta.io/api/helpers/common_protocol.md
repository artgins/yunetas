...
(comm_prot_free)=
## [`comm_prot_free()`](https://github.com/artgins/yunetas/blob/7.17.1/kernel/c/gobj-c/src/helpers.c#L6009)
...
## [`comm_prot_get_gclass()`](https://github.com/artgins/yunetas/blob/7.17.1/kernel/c/gobj-c/src/helpers.c#L5982)
...
(comm_prot_register)=
## [`comm_prot_register()`](https://github.com/artgins/yunetas/blob/7.17.1/kernel/c/gobj-c/src/helpers.c#L5953)
...
(get_peername)=
## [`get_peername()`](https://github.com/artgins/yunetas/blob/7.17.1/kernel/c/gobj-c/src/helpers.c#L6940)
...
(get_sockname)=
## [`get_sockname()`](https://github.com/artgins/yunetas/blob/7.17.1/kernel/c/gobj-c/src/helpers.c#L6959)
...
(is_tcp_socket)=
## [`is_tcp_socket()`](https://github.com/artgins/yunetas/blob/7.17.1/kernel/c/gobj-c/src/helpers.c#L6868)
...
(is_udp_socket)=
## [`is_udp_socket()`](https://github.com/artgins/yunetas/blob/7.17.1/kernel/c/gobj-c/src/helpers.c#L6885)
...
## [`print_socket_address()`](https://github.com/artgins/yunetas/blob/7.17.1/kernel/c/gobj-c/src/helpers.c#L6902)
...
## [`set_tcp_socket_options()`](https://github.com/artgins/yunetas/blob/7.17.1/kernel/c/gobj-c/src/helpers.c#L6839)
