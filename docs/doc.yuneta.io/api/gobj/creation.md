...
(gobj_create)=
## [`gobj_create()`](https://github.com/artgins/yunetas/blob/7.9.0/kernel/c/gobj-c/src/gobj.c#L1804)
...
(gobj_create2)=
## [`gobj_create2()`](https://github.com/artgins/yunetas/blob/7.9.0/kernel/c/gobj-c/src/gobj.c#L1453)
...
## [`gobj_create_default_service()`](https://github.com/artgins/yunetas/blob/7.9.0/kernel/c/gobj-c/src/gobj.c#L1759)
...
## [`gobj_create_pure_child()`](https://github.com/artgins/yunetas/blob/7.9.0/kernel/c/gobj-c/src/gobj.c#L1789)
...
(gobj_create_service)=
## [`gobj_create_service()`](https://github.com/artgins/yunetas/blob/7.9.0/kernel/c/gobj-c/src/gobj.c#L1750)
...
(gobj_create_tree)=
## [`gobj_create_tree()`](https://github.com/artgins/yunetas/blob/7.9.0/kernel/c/gobj-c/src/gobj.c#L2222)
...
(gobj_create_volatil)=
## [`gobj_create_volatil()`](https://github.com/artgins/yunetas/blob/7.9.0/kernel/c/gobj-c/src/gobj.c#L1774)
...
(gobj_create_yuno)=
## [`gobj_create_yuno()`](https://github.com/artgins/yunetas/blob/7.9.0/kernel/c/gobj-c/src/gobj.c#L1742)
...
(gobj_destroy)=
## [`gobj_destroy()`](https://github.com/artgins/yunetas/blob/7.9.0/kernel/c/gobj-c/src/gobj.c#L2272)
...
## [`gobj_destroy_children()`](https://github.com/artgins/yunetas/blob/7.9.0/kernel/c/gobj-c/src/gobj.c#L2439)
...
## [`gobj_service_factory()`](https://github.com/artgins/yunetas/blob/7.9.0/kernel/c/gobj-c/src/gobj.c#L2093)
...
## [`gobj_destroy_named_children()`](https://github.com/artgins/yunetas/blob/7.9.0/kernel/c/gobj-c/src/gobj.c#L2497)
...
(gobj_sdata_create)=
## [`gobj_sdata_create()`](https://github.com/artgins/yunetas/blob/7.9.0/kernel/c/gobj-c/src/gobj.c#L3055)
