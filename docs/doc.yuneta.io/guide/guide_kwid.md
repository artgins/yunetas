...
4. **Database-Like Utilities**:
    - Provides record-based operations such as [`kwid_find_record_in_list`](https://github.com/artgins/yunetas/blob/7.13.1/kernel/c/gobj-c/src/kwid.c#L937), [`kwid_compare_records`](#kwid_compare_records), and [`kwjr_get`](#kwjr_get).
