...
- [`ytls.c`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/ytls/src/ytls.c) /
  [`ytls.h`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/ytls/src/ytls.h)
- [`openssl.c`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/ytls/src/tls/openssl.c) /
  [`openssl.h`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/ytls/src/tls/openssl.h)
- [`mbedtls.c`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/ytls/src/tls/mbedtls.c) /
  [`mbedtls.h`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/ytls/src/tls/mbedtls.h)
...
(ytls_cleanup)=
## [`ytls_cleanup()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/ytls/src/ytls.c#L127)
...
## [`ytls_reload_certificates()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/ytls/src/ytls.c#L136)
...
(ytls_decrypt_data)=
## [`ytls_decrypt_data()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/ytls/src/ytls.c#L245)
...
(ytls_do_handshake)=
## [`ytls_do_handshake()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/ytls/src/ytls.c#L221)
...
(ytls_encrypt_data)=
## [`ytls_encrypt_data()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/ytls/src/ytls.c#L231)
...
(ytls_flush)=
## [`ytls_flush()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/ytls/src/ytls.c#L285)
...
## [`ytls_free_secure_filter()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/ytls/src/ytls.c#L212)
...
(ytls_get_cert_info)=
## [`ytls_get_cert_info()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/ytls/src/ytls.c#L151)
...
(ytls_get_last_error)=
## [`ytls_get_last_error()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/ytls/src/ytls.c#L258)
...
## [`ytls_get_system_ca_bundle()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/ytls/src/ytls.c#L47)
...
(ytls_init)=
## [`ytls_init()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/ytls/src/ytls.c#L68)
...
## [`ytls_new_secure_filter()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/ytls/src/ytls.c#L176)
...
(ytls_set_peer_name)=
## [`ytls_set_peer_name()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/ytls/src/ytls.c#L276)
...
(ytls_set_trace)=
## [`ytls_set_trace()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/ytls/src/ytls.c#L267)
...
(ytls_shutdown)=
## [`ytls_shutdown()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/ytls/src/ytls.c#L203)
...
(ytls_version)=
## [`ytls_version()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/ytls/src/ytls.c#L167)
...
(openssl_api_tls)=
## [`openssl_api_tls()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/ytls/src/tls/openssl.c#L1528)
...
(mbed_api_tls)=
## [`mbed_api_tls()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/ytls/src/tls/mbedtls.c#L1467)
