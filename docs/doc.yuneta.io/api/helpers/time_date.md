...
(current_timestamp)=
## [`current_timestamp()`](https://github.com/artgins/yunetas/blob/7.7.1/kernel/c/gobj-c/src/helpers.c#L5250)
...
(date_mode_from_type)=
## [`date_mode_from_type()`](https://github.com/artgins/yunetas/blob/7.7.1/kernel/c/gobj-c/src/helpers.c#L3631)
...
(date_overflows)=
## [`date_overflows()`](https://github.com/artgins/yunetas/blob/7.7.1/kernel/c/gobj-c/src/helpers.c#L4798)
...
(datestamp)=
## [`datestamp()`](https://github.com/artgins/yunetas/blob/7.7.1/kernel/c/gobj-c/src/helpers.c#L4350)
...
(formatdate)=
## [`formatdate()`](https://github.com/artgins/yunetas/blob/7.7.1/kernel/c/gobj-c/src/helpers.c#L5609)
...
(htonll)=
## [`htonll()`](https://github.com/artgins/yunetas/blob/7.7.1/kernel/c/gobj-c/src/helpers.c#L5461)
...
(list_open_files)=
## [`list_open_files()`](https://github.com/artgins/yunetas/blob/7.7.1/kernel/c/gobj-c/src/helpers.c#L5491)
...
(ntohll)=
## [`ntohll()`](https://github.com/artgins/yunetas/blob/7.7.1/kernel/c/gobj-c/src/helpers.c#L5476)
...
(parse_date)=
## [`parse_date()`](https://github.com/artgins/yunetas/blob/7.7.1/kernel/c/gobj-c/src/helpers.c#L4282)
...
(parse_date_basic)=
## [`parse_date_basic()`](https://github.com/artgins/yunetas/blob/7.7.1/kernel/c/gobj-c/src/helpers.c#L4188)
...
(parse_date_format)=
## [`parse_date_format()`](https://github.com/artgins/yunetas/blob/7.7.1/kernel/c/gobj-c/src/helpers.c#L4320)
...
(parse_expiry_date)=
## [`parse_expiry_date()`](https://github.com/artgins/yunetas/blob/7.7.1/kernel/c/gobj-c/src/helpers.c#L4260)
...
(show_date)=
## [`show_date()`](https://github.com/artgins/yunetas/blob/7.7.1/kernel/c/gobj-c/src/helpers.c#L3640)
...
(show_date_relative)=
## [`show_date_relative()`](https://github.com/artgins/yunetas/blob/7.7.1/kernel/c/gobj-c/src/helpers.c#L3554)
...
(start_msectimer)=
## [`start_msectimer()`](https://github.com/artgins/yunetas/blob/7.7.1/kernel/c/gobj-c/src/helpers.c#L5324)
...
(start_sectimer)=
## [`start_sectimer()`](https://github.com/artgins/yunetas/blob/7.7.1/kernel/c/gobj-c/src/helpers.c#L5295)
...
(t2timestamp)=
## [`t2timestamp()`](https://github.com/artgins/yunetas/blob/7.7.1/kernel/c/gobj-c/src/helpers.c#L5276)
...
(test_msectimer)=
## [`test_msectimer()`](https://github.com/artgins/yunetas/blob/7.7.1/kernel/c/gobj-c/src/helpers.c#L5334)
...
(test_sectimer)=
## [`test_sectimer()`](https://github.com/artgins/yunetas/blob/7.7.1/kernel/c/gobj-c/src/helpers.c#L5307)
...
(time_in_seconds)=
## [`time_in_seconds()`](https://github.com/artgins/yunetas/blob/7.7.1/kernel/c/gobj-c/src/helpers.c#L5374)
...
(tm2timestamp)=
## [`tm2timestamp()`](https://github.com/artgins/yunetas/blob/7.7.1/kernel/c/gobj-c/src/helpers.c#L5267)
...
(tm_to_time_t)=
## [`tm_to_time_t()`](https://github.com/artgins/yunetas/blob/7.7.1/kernel/c/gobj-c/src/helpers.c#L3430)
...
(get_days_range)=
## [`get_days_range()`](https://github.com/artgins/yunetas/blob/7.7.1/kernel/c/gobj-c/src/helpers.c#L7588)
...
(get_hours_range)=
## [`get_hours_range()`](https://github.com/artgins/yunetas/blob/7.7.1/kernel/c/gobj-c/src/helpers.c#L7556)
...
(get_months_range)=
## [`get_months_range()`](https://github.com/artgins/yunetas/blob/7.7.1/kernel/c/gobj-c/src/helpers.c#L7664)
...
(get_weeks_range)=
## [`get_weeks_range()`](https://github.com/artgins/yunetas/blob/7.7.1/kernel/c/gobj-c/src/helpers.c#L7619)
...
(get_years_range)=
## [`get_years_range()`](https://github.com/artgins/yunetas/blob/7.7.1/kernel/c/gobj-c/src/helpers.c#L7695)
...
(gmtime2timezone)=
## [`gmtime2timezone()`](https://github.com/artgins/yunetas/blob/7.7.1/kernel/c/gobj-c/src/helpers.c#L5553)
...
## [`time_in_milliseconds()`](https://github.com/artgins/yunetas/blob/7.7.1/kernel/c/gobj-c/src/helpers.c#L5361)
...
## [`time_in_milliseconds_monotonic()`](https://github.com/artgins/yunetas/blob/7.7.1/kernel/c/gobj-c/src/helpers.c#L5349)
