...
- [`kwid.h`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.h)
- [`kwid.c`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c)

(kw_add_binary_type)=
## [`kw_add_binary_type()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L77)
...
(kw_clone_by_keys)=
## [`kw_clone_by_keys()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L2557)
...
## [`kw_clone_by_not_keys()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L2641)
...
(kw_clone_by_path)=
## [`kw_clone_by_path()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L2526)
...
(kw_collapse)=
## [`kw_collapse()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L3115)
...
(kw_decref)=
## [`kw_decref()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L340)
...
(kw_delete)=
## [`kw_delete()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L853)
...
## [`kw_delete_metadata_keys()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L2889)
...
## [`kw_delete_private_keys()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L2859)
...
(kw_delete_subkey)=
## [`kw_delete_subkey()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L904)
...
(kw_deserialize)=
## [`kw_deserialize()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L238)
...
(kw_duplicate)=
## [`kw_duplicate()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L2457)
...
(kw_twin)=
## [`kw_twin()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L2481)
...
(kw_filter_metadata)=
## [`kw_filter_metadata()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L3447)
...
(kw_filter_private)=
## [`kw_filter_private()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L3421)
...
## [`kw_find_json_in_list()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L1018)
...
(kw_find_path)=
## [`kw_find_path()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L674)
...
(kw_find_str_in_list)=
## [`kw_find_str_in_list()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L936)
...
(kw_get_bool)=
## [`kw_get_bool()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L2032)
...
(kw_get_dict)=
## [`kw_get_dict()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L1740)
...
(kw_get_dict_value)=
## [`kw_get_dict_value()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L2172)
...
(kw_get_int)=
## [`kw_get_int()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L1882)
...
(kw_get_list)=
## [`kw_get_list()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L1791)
...
(kw_get_list_value)=
## [`kw_get_list_value()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L1842)
...
(kw_get_real)=
## [`kw_get_real()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L1961)
...
(kw_get_str)=
## [`kw_get_str()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L2110)
...
## [`kw_get_subdict_value()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L2209)
...
(kw_has_key)=
## [`kw_has_key()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L384)
...
(kw_has_word)=
## [`kw_has_word()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L3787)
...
(kw_incref)=
## [`kw_incref()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L296)
...
(kw_match_simple)=
## [`kw_match_simple()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L2841)
...
(kw_pop)=
## [`kw_pop()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L2722)
...
(kw_select)=
## [`kw_select()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L1064)
...
(kw_serialize)=
## [`kw_serialize()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L109)
...
(kw_set_dict_value)=
## [`kw_set_dict_value()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L695)
...
## [`kw_set_path_delimiter()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L398)
...
## [`kw_set_subdict_value()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L823)
...
(kw_update_except)=
## [`kw_update_except()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L2258)
...
(kw_update_missing)=
## [`kw_update_missing()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L2299)
...
(kwid_compare_lists)=
## [`kwid_compare_lists()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L1721)
...
## [`kwid_compare_records()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L1700)
...
(kwid_get_ids)=
## [`kwid_get_ids()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L3668)
...
(kwid_match_id)=
## [`kwid_match_id()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L3854)
...
(kwid_match_nid)=
## [`kwid_match_nid()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L3915)
...
(kwjr_get)=
## [`kwjr_get()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L3497)
...
(flat2json)=
## [`flat2json()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L4510)
...
(flat_apply)=
## [`flat_apply()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L4588)
...
(flat_diff)=
## [`flat_diff()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L4543)
...
(flat_key_join)=
## [`flat_key_join()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L4145)
...
(flat_key_split)=
## [`flat_key_split()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L4187)
...
(json2flat)=
## [`json2flat()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L4320)
...
(json_flatten_dict)=
## [`json_flatten_dict()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L4645)
...
(json_unflatten_dict)=
## [`json_unflatten_dict()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L4650)
...
(kw_collect)=
## [`kw_collect()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L1115)
...
## [`kw_serialize_to_string()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L165)
...
(kw_size)=
## [`kw_size()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L3472)
...
(kw_walk)=
## [`kw_walk()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/kwid.c#L2949)
