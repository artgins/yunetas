...
**Source code:** [`src/c_yui_shell.js`](https://github.com/artgins/gobj-ui.js/blob/7.14.3/src/c_yui_shell.js)
...
## [`yui_shell_navigate(shell_gobj, route, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.14.3/src/c_yui_shell.js#L3160)
...
## [`yui_shell_set_sub_routes(shell_gobj, base_route, nodes)`](https://github.com/artgins/gobj-ui.js/blob/7.14.3/src/c_yui_shell.js#L3203)
...
## [`yui_shell_register_event_handler(shell_gobj, event, gclass)`](https://github.com/artgins/gobj-ui.js/blob/7.14.3/src/c_yui_shell.js#L3223)
...
## [`yui_shell_unpark_route(route)`](https://github.com/artgins/gobj-ui.js/blob/7.14.3/src/c_yui_shell.js#L3299)
...
### [`yui_shell_open_drawer(shell_gobj, menu_id)`](https://github.com/artgins/gobj-ui.js/blob/7.14.3/src/c_yui_shell.js#L3237)

Opens the drawer.

(js_yui_shell_close_drawer)=
### [`yui_shell_close_drawer(shell_gobj, menu_id)`](https://github.com/artgins/gobj-ui.js/blob/7.14.3/src/c_yui_shell.js#L3238)

Closes the drawer.

(js_yui_shell_toggle_drawer)=
### [`yui_shell_toggle_drawer(shell_gobj, menu_id)`](https://github.com/artgins/gobj-ui.js/blob/7.14.3/src/c_yui_shell.js#L3239)
...
### [`yui_shell_push_escape(shell_gobj, layer, handler)`](https://github.com/artgins/gobj-ui.js/blob/7.14.3/src/c_yui_shell.js#L3254)
...
### [`yui_shell_pop_escape(shell_gobj, handler)`](https://github.com/artgins/gobj-ui.js/blob/7.14.3/src/c_yui_shell.js#L3258)
...
### [`yui_shell_register_overlay(shell_gobj, close_fn, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.14.3/src/c_yui_shell.js#L3277)
...
### [`yui_shell_overlay_dismissed(shell_gobj, overlay)`](https://github.com/artgins/gobj-ui.js/blob/7.14.3/src/c_yui_shell.js#L3281)
...
### [`yui_shell_set_avatar_provider(shell_gobj, provider)`](https://github.com/artgins/gobj-ui.js/blob/7.14.3/src/c_yui_shell.js#L3316)

Gives the function that the shell asks for the image of a user.

(js_yui_shell_refresh_avatars)=
### [`yui_shell_refresh_avatars(shell_gobj)`](https://github.com/artgins/gobj-ui.js/blob/7.14.3/src/c_yui_shell.js#L3326)
...
### [`yui_shell_set_translator(shell_gobj, t)`](https://github.com/artgins/gobj-ui.js/blob/7.14.3/src/c_yui_shell.js#L3341)
...
### [`yui_shell_set_connection_state(shell_gobj, connected)`](https://github.com/artgins/gobj-ui.js/blob/7.14.3/src/c_yui_shell.js#L3412)

Draws the state of the connection in the toolbar.

(js_yui_shell_set_toolbar_item_icon)=
### [`yui_shell_set_toolbar_item_icon(shell_gobj, item_id, icon_class)`](https://github.com/artgins/gobj-ui.js/blob/7.14.3/src/c_yui_shell.js#L3431)

Changes the icon of an item of the toolbar.

(js_yui_shell_set_toolbar_item_badge)=
### [`yui_shell_set_toolbar_item_badge(shell_gobj, item_id, value)`](https://github.com/artgins/gobj-ui.js/blob/7.14.3/src/c_yui_shell.js#L3464)

Writes a badge on an item of the toolbar, such as a count of messages.

(js_yui_shell_close_dropdown)=
### [`yui_shell_close_dropdown(shell_gobj)`](https://github.com/artgins/gobj-ui.js/blob/7.14.3/src/c_yui_shell.js#L3501)
...
### [`yui_shell_show_route_map(shell, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.14.3/src/shell_route_map.js#L437)
