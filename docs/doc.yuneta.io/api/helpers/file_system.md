...
(file_exists)=
## [`file_exists()`](https://github.com/artgins/yunetas/blob/7.5.7/kernel/c/gobj-c/src/helpers.c#L290)
...
(file_permission)=
## [`file_permission()`](https://github.com/artgins/yunetas/blob/7.5.7/kernel/c/gobj-c/src/helpers.c#L278)
...
(file_remove)=
## [`file_remove()`](https://github.com/artgins/yunetas/blob/7.5.7/kernel/c/gobj-c/src/helpers.c#L320)
...
(file_size)=
## [`file_size()`](https://github.com/artgins/yunetas/blob/7.5.7/kernel/c/gobj-c/src/helpers.c#L263)
...
(filesize)=
## [`filesize()`](https://github.com/artgins/yunetas/blob/7.5.7/kernel/c/gobj-c/src/helpers.c#L175)
...
(filesize2)=
## [`filesize2()`](https://github.com/artgins/yunetas/blob/7.5.7/kernel/c/gobj-c/src/helpers.c#L189)
...
(is_directory)=
## [`is_directory()`](https://github.com/artgins/yunetas/blob/7.5.7/kernel/c/gobj-c/src/helpers.c#L250)
...
(is_regular_file)=
## [`is_regular_file()`](https://github.com/artgins/yunetas/blob/7.5.7/kernel/c/gobj-c/src/helpers.c#L237)
...
(lock_file)=
## [`lock_file()`](https://github.com/artgins/yunetas/blob/7.5.7/kernel/c/gobj-c/src/helpers.c#L203)
...
(mkrdir)=
## [`mkrdir()`](https://github.com/artgins/yunetas/blob/7.5.7/kernel/c/gobj-c/src/helpers.c#L334)
...
(newdir)=
## [`newdir()`](https://github.com/artgins/yunetas/blob/7.5.7/kernel/c/gobj-c/src/helpers.c#L119)
...
(newfile)=
## [`newfile()`](https://github.com/artgins/yunetas/blob/7.5.7/kernel/c/gobj-c/src/helpers.c#L135)
...
(open_exclusive)=
## [`open_exclusive()`](https://github.com/artgins/yunetas/blob/7.5.7/kernel/c/gobj-c/src/helpers.c#L157)
...
(rmrcontentdir)=
## [`rmrcontentdir()`](https://github.com/artgins/yunetas/blob/7.5.7/kernel/c/gobj-c/src/helpers.c#L502)
...
(rmrdir)=
## [`rmrdir()`](https://github.com/artgins/yunetas/blob/7.5.7/kernel/c/gobj-c/src/helpers.c#L422)
...
(subdir_exists)=
## [`subdir_exists()`](https://github.com/artgins/yunetas/blob/7.5.7/kernel/c/gobj-c/src/helpers.c#L305)
...
(unlock_file)=
## [`unlock_file()`](https://github.com/artgins/yunetas/blob/7.5.7/kernel/c/gobj-c/src/helpers.c#L220)
...
(copyfile)=
## [`copyfile()`](https://github.com/artgins/yunetas/blob/7.5.7/kernel/c/gobj-c/src/helpers.c#L6608)
...
## [`read_process_cmdline()`](https://github.com/artgins/yunetas/blob/7.5.7/kernel/c/gobj-c/src/helpers.c#L6562)
...
(set_cloexec)=
## [`set_cloexec()`](https://github.com/artgins/yunetas/blob/7.5.7/kernel/c/gobj-c/src/helpers.c#L6702)
...
(set_nonblocking)=
## [`set_nonblocking()`](https://github.com/artgins/yunetas/blob/7.5.7/kernel/c/gobj-c/src/helpers.c#L6669)
