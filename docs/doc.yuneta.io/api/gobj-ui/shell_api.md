...
**Source code:** [`src/c_yui_shell.js`](https://github.com/artgins/gobj-ui.js/blob/7.23.193/src/c_yui_shell.js)
...
## [`yui_shell_navigate(shell_gobj, route, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.23.193/src/c_yui_shell.js#L3301)
...
## [`yui_shell_last_route_under(shell_gobj, route)`](https://github.com/artgins/gobj-ui.js/blob/7.23.193/src/c_yui_shell.js#L3228)
...
## [`yui_shell_set_sub_routes(shell_gobj, base_route, nodes)`](https://github.com/artgins/gobj-ui.js/blob/7.23.193/src/c_yui_shell.js#L3344)
...
## [`yui_shell_register_event_handler(shell_gobj, event, gclass)`](https://github.com/artgins/gobj-ui.js/blob/7.23.193/src/c_yui_shell.js#L3364)
...
## [`yui_shell_unpark_route(route)`](https://github.com/artgins/gobj-ui.js/blob/7.23.193/src/c_yui_shell.js#L3440)
...
### [`yui_shell_open_drawer(shell_gobj, menu_id)`](https://github.com/artgins/gobj-ui.js/blob/7.23.193/src/c_yui_shell.js#L3378)

Opens the drawer.

(js_yui_shell_close_drawer)=
### [`yui_shell_close_drawer(shell_gobj, menu_id)`](https://github.com/artgins/gobj-ui.js/blob/7.23.193/src/c_yui_shell.js#L3379)

Closes the drawer.

(js_yui_shell_toggle_drawer)=
### [`yui_shell_toggle_drawer(shell_gobj, menu_id)`](https://github.com/artgins/gobj-ui.js/blob/7.23.193/src/c_yui_shell.js#L3380)
...
### [`yui_shell_push_escape(shell_gobj, layer, handler)`](https://github.com/artgins/gobj-ui.js/blob/7.23.193/src/c_yui_shell.js#L3395)
...
### [`yui_shell_pop_escape(shell_gobj, handler)`](https://github.com/artgins/gobj-ui.js/blob/7.23.193/src/c_yui_shell.js#L3399)
...
### [`yui_shell_register_overlay(shell_gobj, close_fn, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.23.193/src/c_yui_shell.js#L3418)
...
### [`yui_shell_overlay_dismissed(shell_gobj, overlay)`](https://github.com/artgins/gobj-ui.js/blob/7.23.193/src/c_yui_shell.js#L3422)
...
### [`yui_shell_set_avatar_provider(shell_gobj, provider)`](https://github.com/artgins/gobj-ui.js/blob/7.23.193/src/c_yui_shell.js#L3457)

Gives the function that the shell asks for the image of a user.

(js_yui_shell_refresh_avatars)=
### [`yui_shell_refresh_avatars(shell_gobj)`](https://github.com/artgins/gobj-ui.js/blob/7.23.193/src/c_yui_shell.js#L3467)
...
### [`yui_shell_set_translator(shell_gobj, t)`](https://github.com/artgins/gobj-ui.js/blob/7.23.193/src/c_yui_shell.js#L3482)
...
### [`yui_shell_set_connection_state(shell_gobj, connected)`](https://github.com/artgins/gobj-ui.js/blob/7.23.193/src/c_yui_shell.js#L3553)

Draws the state of the connection in the toolbar.

(js_yui_shell_set_toolbar_item_icon)=
### [`yui_shell_set_toolbar_item_icon(shell_gobj, item_id, icon_class)`](https://github.com/artgins/gobj-ui.js/blob/7.23.193/src/c_yui_shell.js#L3572)

Changes the icon of an item of the toolbar.

(js_yui_shell_set_toolbar_item_badge)=
### [`yui_shell_set_toolbar_item_badge(shell_gobj, item_id, value)`](https://github.com/artgins/gobj-ui.js/blob/7.23.193/src/c_yui_shell.js#L3605)

Writes a badge on an item of the toolbar, such as a count of messages.

(js_yui_shell_close_dropdown)=
### [`yui_shell_close_dropdown(shell_gobj)`](https://github.com/artgins/gobj-ui.js/blob/7.23.193/src/c_yui_shell.js#L3642)
...
### [`yui_shell_show_route_map(shell, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.23.193/src/shell_route_map.js#L447)
