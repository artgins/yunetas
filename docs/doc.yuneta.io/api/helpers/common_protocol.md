...
(comm_prot_free)=
## [`comm_prot_free()`](https://github.com/artgins/yunetas/blob/7.9.8/kernel/c/gobj-c/src/helpers.c#L5952)
...
## [`comm_prot_get_gclass()`](https://github.com/artgins/yunetas/blob/7.9.8/kernel/c/gobj-c/src/helpers.c#L5925)
...
(comm_prot_register)=
## [`comm_prot_register()`](https://github.com/artgins/yunetas/blob/7.9.8/kernel/c/gobj-c/src/helpers.c#L5896)
...
(get_peername)=
## [`get_peername()`](https://github.com/artgins/yunetas/blob/7.9.8/kernel/c/gobj-c/src/helpers.c#L6883)
...
(get_sockname)=
## [`get_sockname()`](https://github.com/artgins/yunetas/blob/7.9.8/kernel/c/gobj-c/src/helpers.c#L6902)
...
(is_tcp_socket)=
## [`is_tcp_socket()`](https://github.com/artgins/yunetas/blob/7.9.8/kernel/c/gobj-c/src/helpers.c#L6811)
...
(is_udp_socket)=
## [`is_udp_socket()`](https://github.com/artgins/yunetas/blob/7.9.8/kernel/c/gobj-c/src/helpers.c#L6828)
...
## [`print_socket_address()`](https://github.com/artgins/yunetas/blob/7.9.8/kernel/c/gobj-c/src/helpers.c#L6845)
...
## [`set_tcp_socket_options()`](https://github.com/artgins/yunetas/blob/7.9.8/kernel/c/gobj-c/src/helpers.c#L6782)
