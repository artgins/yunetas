...
does [`gbuf2json`](#gbuf2json) + [`kw_deserialize`](#kw_deserialize) ([`msg_ievent.c`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/root-linux/src/msg_ievent.c)).
...
`msg_iev_get_stack`, [`msg_iev_pop_stack`](#msg_iev_pop_stack) ([`msg_ievent.c:419`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/root-linux/src/msg_ievent.c#L419)).
...
1. [`iev_create_from_gbuffer`](#iev_create_from_gbuffer) ([`msg_ievent.c:152`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/root-linux/src/msg_ievent.c#L152)) deserialises the WS
   frame.
...
socket via [`ytls_new_secure_filter()`](#ytls_new_secure_filter) ([`c_tcp.c`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/root-linux/src/c_tcp.c)), and from then
