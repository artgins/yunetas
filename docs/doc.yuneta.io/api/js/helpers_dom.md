...
(js_createElement2)=
## [`createElement2()`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L3135)
...
(js_createOneHtml)=
### [`createOneHtml(htmlString)`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L2946)

Builds one element from a string of HTML.

(js_parseSVG)=
### [`parseSVG(string)`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L3271)

Builds an SVG element from a string of SVG code.

(js_getPositionRelativeToBody)=
### [`getPositionRelativeToBody(element)`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L3243)
...
(js_escapeHtml)=
### [`escapeHtml(str)`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L2913)
...
(js_safeSrc)=
### [`safeSrc(url)`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L2931)
...
(js_refresh_language)=
## [`refresh_language()`](https://github.com/artgins/gobj-js/blob/7.21.0/src/helpers.js#L3279)
