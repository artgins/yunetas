...
(js_trace_level_t)=
### [`trace_level_t`](https://github.com/artgins/gobj-js/blob/7.25.1/src/gobj.js#L406)
...
### [`gobj_set_global_trace(level, set)`](https://github.com/artgins/gobj-js/blob/7.25.1/src/gobj.js#L631)
...
### [`gobj_set_global_no_trace(level, set)`](https://github.com/artgins/gobj-js/blob/7.25.1/src/gobj.js#L645)
...
### [`gobj_global_trace_level()`](https://github.com/artgins/gobj-js/blob/7.25.1/src/gobj.js#L659)

Gives the global mask, as a number.

(js_gobj_global_trace_no_level)=
### [`gobj_global_trace_no_level()`](https://github.com/artgins/gobj-js/blob/7.25.1/src/gobj.js#L664)

Gives the global silencing mask, as a number.

(js_gobj_set_global_trace2)=
### [`gobj_set_global_trace2(bitmask, set)`](https://github.com/artgins/gobj-js/blob/7.25.1/src/gobj.js#L670)
...
### [`gobj_set_global_no_trace2(bitmask, set)`](https://github.com/artgins/gobj-js/blob/7.25.1/src/gobj.js#L680)

The silencing partner of [`gobj_set_global_trace2()`](#js_gobj_set_global_trace2).

(js_gobj_get_global_trace_level)=
### [`gobj_get_global_trace_level()`](https://github.com/artgins/gobj-js/blob/7.25.1/src/gobj.js#L695)
...
### [`gobj_get_global_trace_no_level()`](https://github.com/artgins/gobj-js/blob/7.25.1/src/gobj.js#L700)

Gives the global silencing levels in force, as a list of names.

(js_gobj_repr_global_trace_levels)=
### [`gobj_repr_global_trace_levels()`](https://github.com/artgins/gobj-js/blob/7.25.1/src/gobj.js#L833)
...
### [`gobj_set_deep_trace(value)`](https://github.com/artgins/gobj-js/blob/7.25.1/src/gobj.js#L736)
...
### [`gobj_set_gclass_trace(gclass, level, set)`](https://github.com/artgins/gobj-js/blob/7.25.1/src/gobj.js#L746)
...
### [`gobj_get_gclass_trace_level(gclass)`](https://github.com/artgins/gobj-js/blob/7.25.1/src/gobj.js#L705)
...
### [`gobj_get_gclass_trace_level2(gclass)`](https://github.com/artgins/gobj-js/blob/7.25.1/src/gobj.js#L715)
...
### [`gobj_get_gclass_trace_no_level(gclass)`](https://github.com/artgins/gobj-js/blob/7.25.1/src/gobj.js#L725)

Gives the silencing levels of a gclass, as a list of names.

(js_gobj_set_gclass_no_trace)=
### [`gobj_set_gclass_no_trace(gclass, level, set)`](https://github.com/artgins/gobj-js/blob/7.25.1/src/gobj.js#L794)
...
### [`gobj_set_gobj_trace(gobj, level, set)`](https://github.com/artgins/gobj-js/blob/7.25.1/src/gobj.js#L766)

Turns a level on or off for one gobj. Returns `0`, or `-1` when `gobj` is empty.

(js_gobj_set_gobj_no_trace)=
### [`gobj_set_gobj_no_trace(gobj, level, set)`](https://github.com/artgins/gobj-js/blob/7.25.1/src/gobj.js#L814)

Silences a level for one gobj.

(js_gobj_trace_level)=
### [`gobj_trace_level(gobj)`](https://github.com/artgins/gobj-js/blob/7.25.1/src/gobj.js#L519)
...
### [`gobj_trace_no_level(gobj)`](https://github.com/artgins/gobj-js/blob/7.25.1/src/gobj.js#L534)
...
### [`gobj_set_trace_machine_format(format)`](https://github.com/artgins/gobj-js/blob/7.25.1/src/gobj.js#L370)

Chooses the format of the lines of the `machine` trace.

(js_gobj_trace_machine_format)=
### [`gobj_trace_machine_format()`](https://github.com/artgins/gobj-js/blob/7.25.1/src/gobj.js#L375)
