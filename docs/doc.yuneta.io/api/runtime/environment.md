...
## [`register_yuneta_environment()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/root-linux/src/yunetas_environment.c#L30)
...
(yuneta_xpermission)=
## [`yuneta_xpermission()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/root-linux/src/yunetas_environment.c#L51)
...
(yuneta_rpermission)=
## [`yuneta_rpermission()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/root-linux/src/yunetas_environment.c#L59)
...
(yuneta_root_dir)=
## [`yuneta_root_dir()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/root-linux/src/yunetas_environment.c#L67)
...
(yuneta_domain_dir)=
## [`yuneta_domain_dir()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/root-linux/src/yunetas_environment.c#L75)
...
(yuneta_realm_dir)=
## [`yuneta_realm_dir()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/root-linux/src/yunetas_environment.c#L83)
...
(yuneta_realm_file)=
## [`yuneta_realm_file()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/root-linux/src/yunetas_environment.c#L112)
...
(yuneta_log_dir)=
## [`yuneta_log_dir()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/root-linux/src/yunetas_environment.c#L133)
...
(yuneta_log_file)=
## [`yuneta_log_file()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/root-linux/src/yunetas_environment.c#L141)
...
(yuneta_bin_dir)=
## [`yuneta_bin_dir()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/root-linux/src/yunetas_environment.c#L161)
...
(yuneta_bin_file)=
## [`yuneta_bin_file()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/root-linux/src/yunetas_environment.c#L169)
...
(yuneta_store_dir)=
## [`yuneta_store_dir()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/root-linux/src/yunetas_environment.c#L189)
...
(yuneta_store_file)=
## [`yuneta_store_file()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/root-linux/src/yunetas_environment.c#L219)
...
## [`yuneta_realm_store_dir()`](https://github.com/artgins/yunetas/blob/7.8.4/kernel/c/root-linux/src/yunetas_environment.c#L241)
