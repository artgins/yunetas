...
(js_strcmp)=
### [`strcmp(str1, str2)`](https://github.com/artgins/gobj-js/blob/7.16.4/src/helpers.js#L816)

Compares two strings. Returns a negative number, `0` or a positive number.

(js_strncmp)=
### [`strncmp(str1, str2, lgth)`](https://github.com/artgins/gobj-js/blob/7.16.4/src/helpers.js#L792)

Compares the first `lgth` characters of two strings.

(js_strcasecmp)=
### [`strcasecmp(str1, str2)`](https://github.com/artgins/gobj-js/blob/7.16.4/src/helpers.js#L834)

Compares two strings, and ignores the case.

(js_strstr)=
### [`strstr(haystack, needle, bool)`](https://github.com/artgins/gobj-js/blob/7.16.4/src/helpers.js#L909)
...
### [`cmp_two_simple_json(jn_var1, jn_var2)`](https://github.com/artgins/gobj-js/blob/7.16.4/src/helpers.js#L856)
...
(js_str_in_list)=
### [`str_in_list(list, str, ignore_case)`](https://github.com/artgins/gobj-js/blob/7.16.4/src/helpers.js#L2192)

Tells if a string is in a list.

(js_strs_in_list)=
### [`strs_in_list(list, strs, ignore_case)`](https://github.com/artgins/gobj-js/blob/7.16.4/src/helpers.js#L2225)

Tells if one of the strings of `strs` is in a list.

(js_index_in_list)=
### [`index_in_list(list, elm)`](https://github.com/artgins/gobj-js/blob/7.16.4/src/helpers.js#L3334)

Gives the index of an element in a list. Returns `-1` when the list does not
hold it.

(js_id_index_in_obj_list)=
### [`id_index_in_obj_list(list, id)`](https://github.com/artgins/gobj-js/blob/7.16.4/src/helpers.js#L2177)

Gives the index of the record with the field `id` in a list of records. Returns
`-1` when the list does not hold it.

(js_delete_from_list)=
### [`delete_from_list(list, elm)`](https://github.com/artgins/gobj-js/blob/7.16.4/src/helpers.js#L2248)

Takes an element out of a list, in place.

(js_list2options)=
### [`list2options(list, field_id, field_value)`](https://github.com/artgins/gobj-js/blob/7.16.4/src/helpers.js#L2113)
...
### [`current_timestamp()`](https://github.com/artgins/gobj-js/blob/7.16.4/src/helpers.js#L3303)

Gives the time of now as an ISO 8601 string with the milliseconds and the time
zone, such as `"2024-02-24T14:05:30.123+0200"`.

(js_get_now)=
### [`get_now()`](https://github.com/artgins/gobj-js/blob/7.16.4/src/helpers.js#L3326)

Gives the UTC time of now.

(js_timeTracker)=
### [`timeTracker(tracker_name, verbose)`](https://github.com/artgins/gobj-js/blob/7.16.4/src/helpers.js#L3268)
...
(js_build_path)=
### [`build_path(...segments)`](https://github.com/artgins/gobj-js/blob/7.16.4/src/helpers.js#L3466)
...
(js_clean_name)=
### [`clean_name(name)`](https://github.com/artgins/gobj-js/blob/7.16.4/src/helpers.js#L3371)

Gives a name without the characters that a name must not hold.

(js_node_uuid)=
### [`node_uuid()`](https://github.com/artgins/gobj-js/blob/7.16.4/src/helpers.js#L3349)

Builds a unique identifier for this browser, and keeps it.

(js_debounce)=
### [`debounce(func, wait, immediate)`](https://github.com/artgins/gobj-js/blob/7.16.4/src/helpers.js#L3407)
...
### [`get_function_name(func)`](https://github.com/artgins/gobj-js/blob/7.16.4/src/helpers.js#L3379)

Gives the name of a function. A trace of an action uses it.

(js_create_json_record)=
### [`create_json_record(json_desc, value)`](https://github.com/artgins/gobj-js/blob/7.16.4/src/helpers.js#L2756)
