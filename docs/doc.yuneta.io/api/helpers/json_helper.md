...
- [`helpers.h`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.h)
- [`helpers.c`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c)

(anystring2json)=
## [`anystring2json()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L2440)
...
(bits2gbuffer)=
## [`bits2gbuffer()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L1897)
...
(bits2jn_strlist)=
## [`bits2jn_strlist()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L1878)
...
(cmp_two_simple_json)=
## [`cmp_two_simple_json()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L2346)
...
(create_json_record)=
## [`create_json_record()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L1706)
...
(debug_json)=
## [`debug_json()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L5193)
...
(get_real_precision)=
## [`get_real_precision()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L2629)
...
(jn2bool)=
## [`jn2bool()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L2321)
...
(jn2integer)=
## [`jn2integer()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L2267)
...
(jn2real)=
## [`jn2real()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L2244)
...
(jn2string)=
## [`jn2string()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L2296)
...
(json2str)=
## [`json2str()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L2638)
...
(json2uglystr)=
## [`json2uglystr()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L2651)
...
## [`json_check_refcounts()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L2687)
...
(json_config)=
## [`json_config()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/json_config.c#L333)
...
(json_desc_to_schema)=
## [`json_desc_to_schema()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L1846)
...
(json_is_identical)=
## [`json_is_identical()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L2420)
...
(json_list_str_index)=
## [`json_list_str_index()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L1956)
...
## [`json_print_refcounts()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L2845)
...
(json_str_in_list)=
## [`json_str_in_list()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L2939)
...
(load_json_from_file)=
## [`load_json_from_file()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L1548)
...
## [`load_persistent_json()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L1468)
...
(print_json)=
## [`print_json()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L5039)
...
(save_json_to_file)=
## [`save_json_to_file()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L1596)
...
(set_real_precision)=
## [`set_real_precision()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L2623)
...
(string2json)=
## [`string2json()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L2507)
...
(strings2bits)=
## [`strings2bits()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L1929)
...
(anyfile2json)=
## [`anyfile2json()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L2478)
...
(is_metadata_key)=
## [`is_metadata_key()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L5834)
...
(is_private_key)=
## [`is_private_key()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L5855)
...
## [`json_config_string2json()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L2534)
...
## [`json_dict_recursive_update()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L2198)
...
(json_is_range)=
## [`json_is_range()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L2098)
...
(json_list_find)=
## [`json_list_find()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L2054)
...
(json_list_int)=
## [`json_list_int()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L1992)
...
(json_list_int_index)=
## [`json_list_int_index()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L2024)
...
(json_list_update)=
## [`json_list_update()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L2073)
...
(json_listsrange2set)=
## [`json_listsrange2set()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L2158)
...
(json_range_list)=
## [`json_range_list()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L2129)
...
(json_size)=
## [`json_size()`](https://github.com/artgins/yunetas/blob/7.9.5/kernel/c/gobj-c/src/helpers.c#L2663)
