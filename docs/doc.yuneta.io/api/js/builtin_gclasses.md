...
(js_register_c_yuno)=
## [`C_YUNO`](https://github.com/artgins/gobj-js/blob/7.25.6/src/c_yuno.js#L522)
...
(js_register_c_timer)=
## [`C_TIMER`](https://github.com/artgins/gobj-js/blob/7.25.6/src/c_timer.js#L323)
...
(js_set_timeout)=
### [`set_timeout(gobj, msec)`](https://github.com/artgins/gobj-js/blob/7.25.6/src/c_timer.js#L341)

Arms a timer of one shot. It publishes `EV_TIMEOUT` when the time passes.

(js_set_timeout_periodic)=
### [`set_timeout_periodic(gobj, msec)`](https://github.com/artgins/gobj-js/blob/7.25.6/src/c_timer.js#L359)

Arms a periodic timer. It publishes `EV_TIMEOUT_PERIODIC` at each period.

(js_clear_timeout)=
### [`clear_timeout(gobj)`](https://github.com/artgins/gobj-js/blob/7.25.6/src/c_timer.js#L377)
...
## [`C_IEVENT_CLI`](https://github.com/artgins/gobj-js/blob/7.25.6/src/c_ievent_cli.js#L1516)
