...
> ([`AMD64.sh`](https://github.com/artgins/yunetas/blob/7.6.0/packages/deb/AMD64.sh), [`ARM32.sh`](https://github.com/artgins/yunetas/blob/7.6.0/packages/deb/ARM32.sh), [`ARMhf.sh`](https://github.com/artgins/yunetas/blob/7.6.0/packages/deb/ARMhf.sh), [`RISCV64.sh`](https://github.com/artgins/yunetas/blob/7.6.0/packages/deb/RISCV64.sh)). Requires the
...
> re-run [`./set_compiler.sh`](https://github.com/artgins/yunetas/blob/7.6.0/set_compiler.sh) so the external libs are rebuilt with
