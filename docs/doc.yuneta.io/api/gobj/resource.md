...
## [`gobj_create_resource()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/gobj.c#L9642)
...
## [`gobj_delete_resource()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/gobj.c#L9726)
...
(gobj_get_resource)=
## [`gobj_get_resource()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/gobj.c#L9811)
...
(gobj_list_resource)=
## [`gobj_list_resource()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/gobj.c#L9774)
...
(gobj_save_resource)=
## [`gobj_save_resource()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/gobj.c#L9680)
