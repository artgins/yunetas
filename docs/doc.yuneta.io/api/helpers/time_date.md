...
(current_timestamp)=
## [`current_timestamp()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/helpers.c#L5249)
...
(date_mode_from_type)=
## [`date_mode_from_type()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/helpers.c#L3630)
...
(date_overflows)=
## [`date_overflows()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/helpers.c#L4797)
...
(datestamp)=
## [`datestamp()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/helpers.c#L4349)
...
(formatdate)=
## [`formatdate()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/helpers.c#L5608)
...
(htonll)=
## [`htonll()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/helpers.c#L5460)
...
(list_open_files)=
## [`list_open_files()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/helpers.c#L5490)
...
(ntohll)=
## [`ntohll()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/helpers.c#L5475)
...
(parse_date)=
## [`parse_date()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/helpers.c#L4281)
...
(parse_date_basic)=
## [`parse_date_basic()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/helpers.c#L4187)
...
(parse_date_format)=
## [`parse_date_format()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/helpers.c#L4319)
...
(parse_expiry_date)=
## [`parse_expiry_date()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/helpers.c#L4259)
...
(show_date)=
## [`show_date()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/helpers.c#L3639)
...
(show_date_relative)=
## [`show_date_relative()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/helpers.c#L3553)
...
(start_msectimer)=
## [`start_msectimer()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/helpers.c#L5323)
...
(start_sectimer)=
## [`start_sectimer()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/helpers.c#L5294)
...
(t2timestamp)=
## [`t2timestamp()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/helpers.c#L5275)
...
(test_msectimer)=
## [`test_msectimer()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/helpers.c#L5333)
...
(test_sectimer)=
## [`test_sectimer()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/helpers.c#L5306)
...
(time_in_seconds)=
## [`time_in_seconds()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/helpers.c#L5373)
...
(tm2timestamp)=
## [`tm2timestamp()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/helpers.c#L5266)
...
(tm_to_time_t)=
## [`tm_to_time_t()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/helpers.c#L3429)
...
(get_days_range)=
## [`get_days_range()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/helpers.c#L7587)
...
(get_hours_range)=
## [`get_hours_range()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/helpers.c#L7555)
...
(get_months_range)=
## [`get_months_range()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/helpers.c#L7663)
...
(get_weeks_range)=
## [`get_weeks_range()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/helpers.c#L7618)
...
(get_years_range)=
## [`get_years_range()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/helpers.c#L7694)
...
(gmtime2timezone)=
## [`gmtime2timezone()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/helpers.c#L5552)
...
## [`time_in_milliseconds()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/helpers.c#L5360)
...
## [`time_in_milliseconds_monotonic()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/helpers.c#L5348)
