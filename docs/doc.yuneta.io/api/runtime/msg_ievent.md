...
(iev_create2)=
## [`iev_create2()`](https://github.com/artgins/yunetas/blob/7.5.7/kernel/c/root-linux/src/msg_ievent.c#L81)
...
## [`iev_create_to_gbuffer()`](https://github.com/artgins/yunetas/blob/7.5.7/kernel/c/root-linux/src/msg_ievent.c#L107)
...
## [`iev_create_from_gbuffer()`](https://github.com/artgins/yunetas/blob/7.5.7/kernel/c/root-linux/src/msg_ievent.c#L152)
...
(msg_iev_pop_stack)=
## [`msg_iev_pop_stack()`](https://github.com/artgins/yunetas/blob/7.5.7/kernel/c/root-linux/src/msg_ievent.c#L419)
...
## [`msg_iev_set_back_metadata()`](https://github.com/artgins/yunetas/blob/7.5.7/kernel/c/root-linux/src/msg_ievent.c#L500)
...
## [`msg_iev_build_response()`](https://github.com/artgins/yunetas/blob/7.5.7/kernel/c/root-linux/src/msg_ievent.c#L541)
...
## [`msg_iev_build_response_without_reverse_dst()`](https://github.com/artgins/yunetas/blob/7.5.7/kernel/c/root-linux/src/msg_ievent.c#L557)
...
## [`msg_iev_clean_metadata()`](https://github.com/artgins/yunetas/blob/7.5.7/kernel/c/root-linux/src/msg_ievent.c#L578)
...
(trace_inter_event2)=
## [`trace_inter_event2()`](https://github.com/artgins/yunetas/blob/7.5.7/kernel/c/root-linux/src/msg_ievent.c#L641)
