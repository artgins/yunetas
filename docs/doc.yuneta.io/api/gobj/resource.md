...
## [`gobj_create_resource()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L9688)
...
## [`gobj_delete_resource()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L9772)
...
(gobj_get_resource)=
## [`gobj_get_resource()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L9857)
...
(gobj_list_resource)=
## [`gobj_list_resource()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L9820)
...
(gobj_save_resource)=
## [`gobj_save_resource()`](https://github.com/artgins/yunetas/blob/7.9.7/kernel/c/gobj-c/src/gobj.c#L9726)
