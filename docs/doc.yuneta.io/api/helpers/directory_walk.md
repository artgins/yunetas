...
## [`get_ordered_filename_array()`](https://github.com/artgins/yunetas/blob/7.16.3/kernel/c/gobj-c/src/helpers.c#L3434)
...
(walk_dir_tree)=
## [`walk_dir_tree()`](https://github.com/artgins/yunetas/blob/7.16.3/kernel/c/gobj-c/src/helpers.c#L3170)
...
(dir_array_free)=
## [`dir_array_free()`](https://github.com/artgins/yunetas/blob/7.16.3/kernel/c/gobj-c/src/helpers.c#L3222)
...
(dir_array_sort)=
## [`dir_array_sort()`](https://github.com/artgins/yunetas/blob/7.16.3/kernel/c/gobj-c/src/helpers.c#L3349)
...
## [`find_files_with_suffix_array()`](https://github.com/artgins/yunetas/blob/7.16.3/kernel/c/gobj-c/src/helpers.c#L3264)
...
(walk_dir_array)=
## [`walk_dir_array()`](https://github.com/artgins/yunetas/blob/7.16.3/kernel/c/gobj-c/src/helpers.c#L3387)
