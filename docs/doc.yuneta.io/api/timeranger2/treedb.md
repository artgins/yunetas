...
- [`tr_treedb.c`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c)

(_treedb_create_topic_cols_desc)=
## [`_treedb_create_topic_cols_desc()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L420)
...
(add_jtree_path)=
## [`add_jtree_path()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L8480)
...
## [`create_template_record()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L9193)
...
(current_snap_tag)=
## [`current_snap_tag()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L119)
...
(decode_child_ref)=
## [`decode_child_ref()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L3455)
...
(decode_parent_ref)=
## [`decode_parent_ref()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L3401)
...
(node_collapsed_view)=
## [`node_collapsed_view()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L7472)
...
(parse_hooks)=
## [`parse_hooks()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L1904)
...
(parse_schema)=
## [`parse_schema()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L1825)
...
(parse_schema_cols)=
## [`parse_schema_cols()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L1860)
...
(set_volatil_values)=
## [`set_volatil_values()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L2801)
...
## [`treedb_activate_snap()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L9055)
...
(treedb_autolink)=
## [`treedb_autolink()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L6861)
...
(treedb_clean_node)=
## [`treedb_clean_node()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L6709)
...
(treedb_close_db)=
## [`treedb_close_db()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L1081)
...
(treedb_close_topic)=
## [`treedb_close_topic()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L1412)
...
(treedb_create_node)=
## [`treedb_create_node()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L4498)
...
(treedb_create_topic)=
## [`treedb_create_topic()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L1120)
...
## [`treedb_delete_instance()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L5452)
...
(treedb_delete_node)=
## [`treedb_delete_node()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L5098)
...
(treedb_delete_topic)=
## [`treedb_delete_topic()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L1462)
...
(treedb_get_id_index)=
## [`treedb_get_id_index()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L226)
...
(treedb_get_instance)=
## [`treedb_get_instance()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L7413)
...
(treedb_get_node)=
## [`treedb_get_node()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L7370)
...
## [`treedb_get_topic_hooks()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L8700)
...
## [`treedb_get_topic_links()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L8659)
...
## [`treedb_is_treedbs_topic()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L211)
...
(treedb_link_nodes)=
## [`treedb_link_nodes()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L7038)
...
## [`treedb_list_instances()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L7744)
...
(treedb_list_nodes)=
## [`treedb_list_nodes()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L7603)
...
(treedb_list_parents)=
## [`treedb_list_parents()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L8219)
...
(treedb_list_snaps)=
## [`treedb_list_snaps()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L9173)
...
(treedb_list_treedb)=
## [`treedb_list_treedb()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L1492)
...
## [`treedb_node_children()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L8428)
...
(treedb_node_jtree)=
## [`treedb_node_jtree()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L8588)
...
(treedb_open_db)=
## [`treedb_open_db()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L485)
...
(treedb_parent_refs)=
## [`treedb_parent_refs()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L8129)
...
(treedb_save_node)=
## [`treedb_save_node()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L4861)
...
(treedb_set_callback)=
## [`treedb_set_callback()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L1036)
...
(treedb_set_trace)=
## [`treedb_set_trace()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L4320)
...
(treedb_shoot_snap)=
## [`treedb_shoot_snap()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L8844)
...
(treedb_topic_pkey2s)=
## [`treedb_topic_pkey2s()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L132)
...
## [`treedb_topic_pkey2s_filter()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L147)
...
(treedb_topic_size)=
## [`treedb_topic_size()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L1574)
...
(treedb_topics)=
## [`treedb_topics()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L1525)
...
(treedb_unlink_nodes)=
## [`treedb_unlink_nodes()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L7069)
...
(treedb_update_node)=
## [`treedb_update_node()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L5018)
...
(get_hook_list)=
## [`get_hook_list()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L4330)
...
## [`topic_desc_fkey_names()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L2108)
...
## [`topic_desc_hook_names()`](https://github.com/artgins/yunetas/blob/7.5.8/kernel/c/timeranger2/src/tr_treedb.c#L2083)
