...
(gobj_end)=
## [`gobj_end()`](https://github.com/artgins/yunetas/blob/7.16.1/kernel/c/gobj-c/src/gobj.c#L644)
...
(gobj_get_exit_code)=
## [`gobj_get_exit_code()`](https://github.com/artgins/yunetas/blob/7.16.1/kernel/c/gobj-c/src/gobj.c#L636)
...
(gobj_is_shutdowning)=
## [`gobj_is_shutdowning()`](https://github.com/artgins/yunetas/blob/7.16.1/kernel/c/gobj-c/src/gobj.c#L620)
...
(gobj_set_exit_code)=
## [`gobj_set_exit_code()`](https://github.com/artgins/yunetas/blob/7.16.1/kernel/c/gobj-c/src/gobj.c#L628)
...
(gobj_start_up)=
## [`gobj_start_up()`](https://github.com/artgins/yunetas/blob/7.16.1/kernel/c/gobj-c/src/gobj.c#L530)
...
(gobj_set_shutdown)=
## [`gobj_set_shutdown()`](https://github.com/artgins/yunetas/blob/7.16.1/kernel/c/gobj-c/src/gobj.c#L609)
