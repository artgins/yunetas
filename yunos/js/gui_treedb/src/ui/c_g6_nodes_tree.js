...
/************************************************************
 *  Inject custom SVG symbols not provided by G6 so they can
 *  be referenced by the toolbar via <use xlink:href="#id">.
 *  Called once; subsequent calls are no-ops (guarded by id).
 ************************************************************/
function inject_custom_toolbar_icons()
{
    ...
    div.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg">
        <symbol id="save" viewBox="64 64 896 896">
