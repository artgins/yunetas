...
(print_track_mem)=
## [`print_track_mem()`](https://github.com/artgins/yunetas/blob/7.9.2/kernel/c/gobj-c/src/gbmem.c#L275)
...
## [`set_memory_check_list()`](https://github.com/artgins/yunetas/blob/7.9.2/kernel/c/gobj-c/src/gbmem.c#L265)
...
(gbmem_calloc)=
## [`gbmem_calloc()`](https://github.com/artgins/yunetas/blob/7.9.2/kernel/c/gobj-c/src/gbmem.c#L182)
...
(gbmem_free)=
## [`gbmem_free()`](https://github.com/artgins/yunetas/blob/7.9.2/kernel/c/gobj-c/src/gbmem.c#L166)
...
## [`gbmem_get_allocators()`](https://github.com/artgins/yunetas/blob/7.9.2/kernel/c/gobj-c/src/gbmem.c#L133)
...
## [`gbmem_get_maximum_block()`](https://github.com/artgins/yunetas/blob/7.9.2/kernel/c/gobj-c/src/gbmem.c#L237)
...
(gbmem_malloc)=
## [`gbmem_malloc()`](https://github.com/artgins/yunetas/blob/7.9.2/kernel/c/gobj-c/src/gbmem.c#L158)
...
(gbmem_realloc)=
## [`gbmem_realloc()`](https://github.com/artgins/yunetas/blob/7.9.2/kernel/c/gobj-c/src/gbmem.c#L174)
...
## [`gbmem_set_allocators()`](https://github.com/artgins/yunetas/blob/7.9.2/kernel/c/gobj-c/src/gbmem.c#L116)
...
(gbmem_setup)=
## [`gbmem_setup()`](https://github.com/artgins/yunetas/blob/7.9.2/kernel/c/gobj-c/src/gbmem.c#L80)
...
(gbmem_shutdown)=
## [`gbmem_shutdown()`](https://github.com/artgins/yunetas/blob/7.9.2/kernel/c/gobj-c/src/gbmem.c#L108)
...
(gbmem_strdup)=
## [`gbmem_strdup()`](https://github.com/artgins/yunetas/blob/7.9.2/kernel/c/gobj-c/src/gbmem.c#L226)
...
(gbmem_strndup)=
## [`gbmem_strndup()`](https://github.com/artgins/yunetas/blob/7.9.2/kernel/c/gobj-c/src/gbmem.c#L190)
...
## [`get_cur_system_memory()`](https://github.com/artgins/yunetas/blob/7.9.2/kernel/c/gobj-c/src/gbmem.c#L253)
...
## [`get_max_system_memory()`](https://github.com/artgins/yunetas/blob/7.9.2/kernel/c/gobj-c/src/gbmem.c#L245)
