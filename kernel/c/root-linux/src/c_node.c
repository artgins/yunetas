...
PRIVATE int create_gclass(gclass_name_t gclass_name)
{
    ...
    event_type_t event_types[] = {
        {EV_TREEDB_UPDATE_NODE,     EVF_PUBLIC_EVENT,   0,  NULL},
        {EV_TREEDB_NODE_CREATED,    EVF_PUBLIC_EVENT|EVF_OUTPUT_EVENT|EVF_NO_WARN_SUBS,   0,  NULL},
        {EV_TREEDB_NODE_UPDATED,    EVF_PUBLIC_EVENT|EVF_OUTPUT_EVENT|EVF_NO_WARN_SUBS,   0,  NULL},
        {EV_TREEDB_NODE_DELETED,    EVF_PUBLIC_EVENT|EVF_OUTPUT_EVENT|EVF_NO_WARN_SUBS,   0,  NULL},
        {0, 0,   0,  NULL}
    };
