...
(mt_create_resource)=
- [`mt_create_resource`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/root-linux/src/c_resource2.c#L206):
   - Purpose: Creates a new resource managed by the GObject.
   - Example: Initializing data structures or external dependencies.

(mt_list_resource)=
- [`mt_list_resource`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/root-linux/src/c_resource2.c#L425):
   - Purpose: Lists resources managed by the GObject.
   - Example: Returning an iterator or JSON representation.

(mt_save_resource)=
- [`mt_save_resource`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/root-linux/src/c_resource2.c#L310):
   - Purpose: Saves or updates a resource.
   - Example: Persisting data to storage.

(mt_delete_resource)=
- [`mt_delete_resource`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/root-linux/src/c_resource2.c#L359):
...
(mt_authenticate)=
- [`mt_authenticate`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/root-linux/src/c_authz.c#L730):
...
(mt_disable)=
- [`mt_disable`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/root-linux/src/c_channel.c#L118):
   - Purpose: Disables the GObject.
   - Example: Preventing further operations until re-enabled.

(mt_enable)=
- [`mt_enable`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/root-linux/src/c_channel.c#L107):
...
(mt_create_node)=
- [`mt_create_node`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/root-linux/src/c_node.c#L751)
  - Purpose: Methods for managing nodes in TreeDB.
  - Example: Adding, updating, deleting, or linking nodes.

(mt_update_node)=
- [`mt_update_node`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/root-linux/src/c_node.c#L835)
  - Purpose: Methods for managing nodes in TreeDB.
  - Example: Adding, updating, deleting, or linking nodes.

(mt_delete_node)=
- [`mt_delete_node`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/root-linux/src/c_node.c#L970)
  - Purpose: Methods for managing nodes in TreeDB.
  - Example: Adding, updating, deleting, or linking nodes.

(mt_link_nodes)=
- [`mt_link_nodes`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/root-linux/src/c_node.c#L1104)
  - Purpose: Methods for managing nodes in TreeDB.
  - Example: Adding, updating, deleting, or linking nodes.

(mt_unlink_nodes)=
- [`mt_unlink_nodes`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/root-linux/src/c_node.c#L1228):
   - Purpose: Methods for managing nodes in TreeDB.
   - Example: Adding, updating, deleting, or linking nodes.

(mt_topic_desc)=
- [`mt_topic_desc`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/root-linux/src/c_node.c#L581):
  - Purpose: Methods for inspecting TreeDB topics.
  - Example: Describing topics or retrieving metadata.

(mt_topic_links)=
- [`mt_topic_links`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/root-linux/src/c_node.c#L630):
  - Purpose: Methods for inspecting TreeDB topics.
  - Example: Describing topics or retrieving metadata.

(mt_topic_hooks)=
- [`mt_topic_hooks`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/root-linux/src/c_node.c#L690):
  - Purpose: Methods for inspecting TreeDB topics.
  - Example: Describing topics or retrieving metadata.
...
(mt_shoot_snap)=
- [`mt_shoot_snap`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/root-linux/src/c_node.c#L1880):
  - Purpose: Manage snapshots in the TreeDB.
  - Example: Creating or restoring data snapshots.

(mt_activate_snap)=
- [`mt_activate_snap`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/root-linux/src/c_node.c#L1903):
  - Purpose: Manage snapshots in the TreeDB.
  - Example: Creating or restoring data snapshots.

(mt_list_snaps)=
- [`mt_list_snaps`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/root-linux/src/c_node.c#L1924):
   - Purpose: Manage snapshots in the TreeDB.
   - Example: Creating or restoring data snapshots.
...
- [`gobj_get_resource()`](#gobj_get_resource):
    - [`mt_get_resource`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/root-linux/src/c_resource2.c#L486): Called when a resource is get.
...
- [`gobj_treedb_topics()`](#gobj_treedb_topics):
    - [`mt_treedb_topics`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/root-linux/src/c_node.c#L562): Lists the topics within a TreeDB.
...
- [`gobj_get_node()`](#gobj_get_node):
    - [`mt_get_node`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/root-linux/src/c_node.c#L1352): Retrieves a specific node.
- [`gobj_list_nodes()`](#gobj_list_nodes):
    - [`mt_list_nodes`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/root-linux/src/c_node.c#L1402): Lists all nodes in a topic.
- [`gobj_list_instances()`](#gobj_list_instances):
    - [`mt_list_instances`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/root-linux/src/c_node.c#L1487): Lists instances of nodes.
- [`gobj_node_parents()`](#gobj_node_parents):
    - [`mt_node_parents`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/root-linux/src/c_node.c#L1553): Lists the parent nodes of a specific node.
- [`gobj_node_children()`](#gobj_node_children):
    - [`mt_node_children`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/root-linux/src/c_node.c#L1640): Lists the child nodes of a specific node.
- [`gobj_topic_jtree()`](#gobj_topic_jtree):
    - [`mt_topic_jtree`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/root-linux/src/c_node.c#L1734): Retrieves the JSON representation of a topic's tree structure.
- [`gobj_node_tree()`](#gobj_node_tree):
    - [`mt_node_tree`](https://github.com/artgins/yunetas/blob/7.13.0/kernel/c/root-linux/src/c_node.c#L1806): Retrieves the tree structure of nodes.
