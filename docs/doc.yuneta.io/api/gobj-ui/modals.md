...
**Source code:** [`src/shell_modals.js`](https://github.com/artgins/gobj-ui.js/blob/7.23.72/src/shell_modals.js)
...
### [`yui_shell_show_info(shell, message, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.23.72/src/shell_modals.js#L167)

Shows a message of information.

(js_yui_shell_show_warning)=
### [`yui_shell_show_warning(shell, message, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.23.72/src/shell_modals.js#L171)

Shows a warning.

(js_yui_shell_show_error)=
### [`yui_shell_show_error(shell, message, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.23.72/src/shell_modals.js#L175)
...
## [`yui_shell_show_modal(shell, content, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.23.72/src/shell_modals.js#L190)
...
### [`yui_shell_confirm_ok(shell, message, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.23.72/src/shell_modals.js#L545)
...
### [`yui_shell_confirm_yesno(shell, message, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.23.72/src/shell_modals.js#L556)
...
### [`yui_shell_confirm_yesnocancel(shell, message, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.23.72/src/shell_modals.js#L593)
...
### [`yui_shell_confirm_danger(shell, message, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.23.72/src/shell_modals.js#L580)
