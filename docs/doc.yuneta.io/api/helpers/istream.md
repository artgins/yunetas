...
(istream_clear)=
## [`istream_clear()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/root-linux/src/istream.c#L436)
...
(istream_consume)=
## [`istream_consume()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/root-linux/src/istream.c#L166)
...
(istream_create)=
## [`istream_create()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/root-linux/src/istream.c#L32)
...
## [`istream_cur_rd_pointer()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/root-linux/src/istream.c#L248)
...
(istream_destroy)=
## [`istream_destroy()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/root-linux/src/istream.c#L83)
...
## [`istream_extract_matched_data()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/root-linux/src/istream.c#L356)
...
(istream_get_gbuffer)=
## [`istream_get_gbuffer()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/root-linux/src/istream.c#L285)
...
## [`istream_is_completed()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/root-linux/src/istream.c#L445)
...
(istream_length)=
## [`istream_length()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/root-linux/src/istream.c#L267)
...
(istream_new_gbuffer)=
## [`istream_new_gbuffer()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/root-linux/src/istream.c#L323)
...
(istream_pop_gbuffer)=
## [`istream_pop_gbuffer()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/root-linux/src/istream.c#L303)
...
## [`istream_read_until_delimiter()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/root-linux/src/istream.c#L101)
...
## [`istream_read_until_num_bytes()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/root-linux/src/istream.c#L146)
...
(istream_reset_rd)=
## [`istream_reset_rd()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/root-linux/src/istream.c#L416)
...
(istream_reset_wr)=
## [`istream_reset_wr()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/root-linux/src/istream.c#L395)
