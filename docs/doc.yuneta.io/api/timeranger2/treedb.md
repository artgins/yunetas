...
- [`tr_treedb.c`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c)

(_treedb_create_topic_cols_desc)=
## [`_treedb_create_topic_cols_desc()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L493)
...
(add_jtree_path)=
## [`add_jtree_path()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L9599)
...
## [`create_template_record()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L12742)
...
(current_snap_tag)=
## [`current_snap_tag()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L142)
...
(decode_child_ref)=
## [`decode_child_ref()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L4005)
...
(decode_parent_ref)=
## [`decode_parent_ref()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L3951)
...
(node_collapsed_view)=
## [`node_collapsed_view()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L8591)
...
(parse_hooks)=
## [`parse_hooks()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L2140)
...
(parse_schema)=
## [`parse_schema()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L2061)
...
(parse_schema_cols)=
## [`parse_schema_cols()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L2096)
...
(set_volatil_values)=
## [`set_volatil_values()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L3116)
...
## [`treedb_activate_snap()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L12604)
...
(treedb_autolink)=
## [`treedb_autolink()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L7924)
...
(treedb_clean_node)=
## [`treedb_clean_node()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L7772)
...
(treedb_close_db)=
## [`treedb_close_db()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L1246)
...
(treedb_close_topic)=
## [`treedb_close_topic()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L1623)
...
(treedb_create_node)=
## [`treedb_create_node()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L5133)
...
(treedb_create_topic)=
## [`treedb_create_topic()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L1286)
...
## [`treedb_delete_instance()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L6486)
...
(treedb_delete_node)=
## [`treedb_delete_node()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L6004)
...
(treedb_delete_topic)=
## [`treedb_delete_topic()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L1673)
...
(treedb_get_id_index)=
## [`treedb_get_id_index()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L269)
...
(treedb_get_instance)=
## [`treedb_get_instance()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L8532)
...
(treedb_get_node)=
## [`treedb_get_node()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L8489)
...
## [`treedb_get_topic_hooks()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L9819)
...
## [`treedb_get_topic_links()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L9778)
...
## [`treedb_is_treedbs_topic()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L254)
...
(treedb_link_nodes)=
## [`treedb_link_nodes()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L8110)
...
## [`treedb_list_instances()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L8863)
...
(treedb_list_nodes)=
## [`treedb_list_nodes()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L8722)
...
(treedb_list_parents)=
## [`treedb_list_parents()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L9338)
...
(treedb_list_snaps)=
## [`treedb_list_snaps()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L12722)
...
(treedb_list_treedb)=
## [`treedb_list_treedb()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L1728)
...
## [`treedb_node_children()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L9547)
...
(treedb_node_jtree)=
## [`treedb_node_jtree()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L9707)
...
(treedb_open_db)=
## [`treedb_open_db()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L579)
...
(treedb_parent_refs)=
## [`treedb_parent_refs()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L9248)
...
(treedb_save_node)=
## [`treedb_save_node()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L5621)
...
(treedb_set_callback)=
## [`treedb_set_callback()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L1201)
...
## [`treedb_set_node_immutable()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L5801)
...
(treedb_set_trace)=
## [`treedb_set_trace()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L4850)
...
(treedb_shoot_snap)=
## [`treedb_shoot_snap()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L12393)
...
(treedb_topic_pkey2s)=
## [`treedb_topic_pkey2s()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L155)
...
## [`treedb_topic_pkey2s_filter()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L170)
...
## [`treedb_create_system_schema()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L462)
...
(treedb_topic_size)=
## [`treedb_topic_size()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L1810)
...
(treedb_topics)=
## [`treedb_topics()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L1761)
...
(treedb_unlink_nodes)=
## [`treedb_unlink_nodes()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L8188)
...
(treedb_update_node)=
## [`treedb_update_node()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L5851)
...
(get_hook_list)=
## [`get_hook_list()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L4860)
...
## [`topic_desc_fkey_names()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L2344)
...
## [`topic_desc_hook_names()`](https://github.com/artgins/yunetas/blob/7.18.2/kernel/c/timeranger2/src/tr_treedb.c#L2319)
