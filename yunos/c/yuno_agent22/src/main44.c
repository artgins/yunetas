 ...
 *                      Names
 ***************************************************************************/
#define APP_NAME        "yuneta_agent44"
#define APP_DOC         "Yuneta Agent44"
    ...
    'environment': {                                                \n\
        ...
        'daemon_log_handlers': {                                    \n\
            'to_file': {                                            \n\
                'handler_type': 'file',                             \n\
                'handler_options': 255,                             \n\
                'filename_mask': 'yuneta_agent44-W.log'             \n\
            },                                                      \n\
            'to_udp': {                                             \n\
                'handler_type': 'udp',                              \n\
                'url': 'udp://127.0.0.1:1992',                      \n\
...
static int register_yuno_and_more(void)
{
    ...
    // gobj_set_gclass_trace(gclass_find_by_name(C_PTY), "traffic", TRUE);
