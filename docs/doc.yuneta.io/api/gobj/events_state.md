...
(gobj_change_state)=
## [`gobj_change_state()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/gobj.c#L8004)
...
(gobj_current_state)=
## [`gobj_current_state()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/gobj.c#L8091)
...
(gobj_event_type)=
## [`gobj_event_type()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/gobj.c#L8173)
...
## [`gobj_event_type_by_name()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/gobj.c#L8225)
...
(gobj_has_event)=
## [`gobj_has_event()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/gobj.c#L8136)
...
## [`gobj_has_output_event()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/gobj.c#L8152)
...
(gobj_has_state)=
## [`gobj_has_state()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/gobj.c#L8122)
...
(gobj_in_this_state)=
## [`gobj_in_this_state()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/gobj.c#L8110)
...
(gobj_send_event)=
## [`gobj_send_event()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/gobj.c#L7524)
...
(gobj_post_event)=
## [`gobj_post_event()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/gobj.c#L7811)
...
## [`gobj_posted_events_size()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/gobj.c#L7917)
...
## [`gobj_deliver_posted_events()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/gobj.c#L7933)
...
## [`gobj_find_event_type()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/gobj.c#L1049)
...
## [`gobj_send_event_to_children()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/gobj.c#L7756)
...
## [`gobj_send_event_to_children_tree()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/gobj.c#L7782)
