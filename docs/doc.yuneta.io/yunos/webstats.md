...
**Full design:** [`yunos/c/webstats/README.md`](https://github.com/artgins/yunetas/blob/7.15.0/yunos/c/webstats/README.md)
...
| `email_from_domain` | — | Domain the hostname is composed with. Empty: the sender is left to the email service |
