...
- [`tr_queue.h`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/timeranger2/src/tr_queue.h)
- [`tr_queue.c`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/timeranger2/src/tr_queue.c)

(trq_answer)=
## [`trq_answer()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/timeranger2/src/tr_queue.c#L845)
...
(trq_check_backup)=
## [`trq_check_backup()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/timeranger2/src/tr_queue.c#L872)
...
A `topic_desc.json` that can be read and does not load (a broken json) is
...
## [`trq_check_pending_rowid()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/timeranger2/src/tr_queue.c#L703)
...
(trq_close)=
## [`trq_close()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/timeranger2/src/tr_queue.c#L337)
...
(trq_get_by_rowid)=
## [`trq_get_by_rowid()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/timeranger2/src/tr_queue.c#L687)
...
(trq_get_metadata)=
## [`trq_get_metadata()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/timeranger2/src/tr_queue.c#L830)
...
(trq_load)=
## [`trq_load()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/timeranger2/src/tr_queue.c#L448)
...
(trq_load_all)=
## [`trq_load_all()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/timeranger2/src/tr_queue.c#L561)
...
(trq_msg_json)=
## [`trq_msg_json()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/timeranger2/src/tr_queue.c#L776)
...
(trq_open)=
## [`trq_open()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/timeranger2/src/tr_queue.c#L48)
...
(trq_set_hard_flag)=
## [`trq_set_hard_flag()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/timeranger2/src/tr_queue.c#L737)
...
(trq_set_metadata)=
## [`trq_set_metadata()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/timeranger2/src/tr_queue.c#L815)
...
(trq_set_soft_mark)=
## [`trq_set_soft_mark()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/timeranger2/src/tr_queue.c#L756)
...
(trq_unload_msg)=
## [`trq_unload_msg()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/timeranger2/src/tr_queue.c#L726)
...
(trq_append2)=
## [`trq_append2()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/timeranger2/src/tr_queue.c#L641)
...
## [`trq_load_all_by_time()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/timeranger2/src/tr_queue.c#L593)
...
(trq_msg_md)=
## [`trq_msg_md()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/timeranger2/src/tr_queue.h#L215)
