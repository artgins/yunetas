...
- [`log_udp_handler.h`](https://github.com/artgins/yunetas/blob/7.9.0/kernel/c/gobj-c/src/log_udp_handler.h)
- [`log_udp_handler.c`](https://github.com/artgins/yunetas/blob/7.9.0/kernel/c/gobj-c/src/log_udp_handler.c)

(udpc_close)=
## [`udpc_close()`](https://github.com/artgins/yunetas/blob/7.9.0/kernel/c/gobj-c/src/log_udp_handler.c#L293)
...
(udpc_end)=
## [`udpc_end()`](https://github.com/artgins/yunetas/blob/7.9.0/kernel/c/gobj-c/src/log_udp_handler.c#L142)
...
(udpc_fwrite)=
## [`udpc_fwrite()`](https://github.com/artgins/yunetas/blob/7.9.0/kernel/c/gobj-c/src/log_udp_handler.c#L495)
...
(udpc_open)=
## [`udpc_open()`](https://github.com/artgins/yunetas/blob/7.9.0/kernel/c/gobj-c/src/log_udp_handler.c#L154)
...
(udpc_start_up)=
## [`udpc_start_up()`](https://github.com/artgins/yunetas/blob/7.9.0/kernel/c/gobj-c/src/log_udp_handler.c#L121)
...
(udpc_write)=
## [`udpc_write()`](https://github.com/artgins/yunetas/blob/7.9.0/kernel/c/gobj-c/src/log_udp_handler.c#L319)
