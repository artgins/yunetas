...
## [`gobj_create_resource()`](https://github.com/artgins/yunetas/blob/7.8.3/kernel/c/gobj-c/src/gobj.c#L9668)
...
## [`gobj_delete_resource()`](https://github.com/artgins/yunetas/blob/7.8.3/kernel/c/gobj-c/src/gobj.c#L9752)
...
(gobj_get_resource)=
## [`gobj_get_resource()`](https://github.com/artgins/yunetas/blob/7.8.3/kernel/c/gobj-c/src/gobj.c#L9837)
...
(gobj_list_resource)=
## [`gobj_list_resource()`](https://github.com/artgins/yunetas/blob/7.8.3/kernel/c/gobj-c/src/gobj.c#L9800)
...
(gobj_save_resource)=
## [`gobj_save_resource()`](https://github.com/artgins/yunetas/blob/7.8.3/kernel/c/gobj-c/src/gobj.c#L9706)
