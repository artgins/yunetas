...
(anystring2json)=
## [`anystring2json()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L2493)
...
(bits2gbuffer)=
## [`bits2gbuffer()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L1950)
...
(bits2jn_strlist)=
## [`bits2jn_strlist()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L1931)
...
(cmp_two_simple_json)=
## [`cmp_two_simple_json()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L2399)
...
(create_json_record)=
## [`create_json_record()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L1759)
...
(debug_json)=
## [`debug_json()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L5234)
...
(get_real_precision)=
## [`get_real_precision()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L2682)
...
(jn2bool)=
## [`jn2bool()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L2374)
...
(jn2integer)=
## [`jn2integer()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L2320)
...
(jn2real)=
## [`jn2real()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L2297)
...
(jn2string)=
## [`jn2string()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L2349)
...
(json2str)=
## [`json2str()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L2691)
...
(json2uglystr)=
## [`json2uglystr()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L2704)
...
## [`json_check_refcounts()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L2717)
...
(json_config)=
## [`json_config()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/json_config.c#L333)
...
(json_desc_to_schema)=
## [`json_desc_to_schema()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L1899)
...
(json_is_identical)=
## [`json_is_identical()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L2473)
...
(json_list_str_index)=
## [`json_list_str_index()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L2009)
...
## [`json_print_refcounts()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L2881)
...
(json_str_in_list)=
## [`json_str_in_list()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L2975)
...
(load_json_from_file)=
## [`load_json_from_file()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L1599)
...
## [`load_persistent_json()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L1519)
...
(print_json)=
## [`print_json()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L5080)
...
(save_json_to_file)=
## [`save_json_to_file()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L1647)
...
(set_real_precision)=
## [`set_real_precision()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L2676)
...
(string2json)=
## [`string2json()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L2560)
...
(strings2bits)=
## [`strings2bits()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L1982)
...
(anyfile2json)=
## [`anyfile2json()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L2531)
...
(is_metadata_key)=
## [`is_metadata_key()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L5875)
...
(is_private_key)=
## [`is_private_key()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L5896)
...
## [`json_config_string2json()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L2587)
...
## [`json_dict_recursive_update()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L2251)
...
(json_is_range)=
## [`json_is_range()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L2151)
...
(json_list_find)=
## [`json_list_find()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L2107)
...
(json_list_int)=
## [`json_list_int()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L2045)
...
(json_list_int_index)=
## [`json_list_int_index()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L2077)
...
(json_list_update)=
## [`json_list_update()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L2126)
...
(json_listsrange2set)=
## [`json_listsrange2set()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L2211)
...
(json_range_list)=
## [`json_range_list()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.c#L2182)
...
(json_size)=
## [`json_size()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.h#L128)
...
(empty_json)=
## [`empty_json()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.h#L151)
...
(json_absent)=
## [`json_absent()`](https://github.com/artgins/yunetas/blob/7.25.4/kernel/c/gobj-c/src/helpers.h#L162)
