...
|------|------------|----------------|
| [`yunetas`](yunetas-cli.md) | The management/build CLI (`pipx install yunetas`). Front-end for everything below. | [`utils/python/tui_yunetas`](https://github.com/artgins/yunetas/tree/7.8.5/utils/python/tui_yunetas) (git submodule, published on PyPI) |
