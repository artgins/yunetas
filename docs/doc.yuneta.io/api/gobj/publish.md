...
## [`gobj_find_subscribings()`](https://github.com/artgins/yunetas/blob/7.8.2/kernel/c/gobj-c/src/gobj.c#L8766)
...
## [`gobj_find_subscriptions()`](https://github.com/artgins/yunetas/blob/7.8.2/kernel/c/gobj-c/src/gobj.c#L8740)
...
## [`gobj_list_subscriptions()`](https://github.com/artgins/yunetas/blob/7.8.2/kernel/c/gobj-c/src/gobj.c#L8823)
...
(gobj_publish_event)=
## [`gobj_publish_event()`](https://github.com/artgins/yunetas/blob/7.8.2/kernel/c/gobj-c/src/gobj.c#L8877)
...
## [`gobj_subscribe_event()`](https://github.com/artgins/yunetas/blob/7.8.2/kernel/c/gobj-c/src/gobj.c#L8391)
...
## [`gobj_unsubscribe_event()`](https://github.com/artgins/yunetas/blob/7.8.2/kernel/c/gobj-c/src/gobj.c#L8596)
...
## [`gobj_unsubscribe_list()`](https://github.com/artgins/yunetas/blob/7.8.2/kernel/c/gobj-c/src/gobj.c#L8716)
...
## [`gobj_list_subscribings()`](https://github.com/artgins/yunetas/blob/7.8.2/kernel/c/gobj-c/src/gobj.c#L8850)
...
(gobj_subs_desc)=
## [`gobj_subs_desc()`](https://github.com/artgins/yunetas/blob/7.8.2/kernel/c/gobj-c/src/gobj.c#L8018)
