...
## [`get_ordered_filename_array()`](https://github.com/artgins/yunetas/blob/7.16.1/kernel/c/gobj-c/src/helpers.c#L3428)
...
(walk_dir_tree)=
## [`walk_dir_tree()`](https://github.com/artgins/yunetas/blob/7.16.1/kernel/c/gobj-c/src/helpers.c#L3164)
...
(dir_array_free)=
## [`dir_array_free()`](https://github.com/artgins/yunetas/blob/7.16.1/kernel/c/gobj-c/src/helpers.c#L3216)
...
(dir_array_sort)=
## [`dir_array_sort()`](https://github.com/artgins/yunetas/blob/7.16.1/kernel/c/gobj-c/src/helpers.c#L3343)
...
## [`find_files_with_suffix_array()`](https://github.com/artgins/yunetas/blob/7.16.1/kernel/c/gobj-c/src/helpers.c#L3258)
...
(walk_dir_array)=
## [`walk_dir_array()`](https://github.com/artgins/yunetas/blob/7.16.1/kernel/c/gobj-c/src/helpers.c#L3381)
