...
- [`tr_treedb.h`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.h)
- [`tr_treedb.c`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c)

(_treedb_create_topic_cols_desc)=
## [`_treedb_create_topic_cols_desc()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L524)
...
(add_jtree_path)=
## [`add_jtree_path()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L10520)
...
## [`create_template_record()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L13988)
...
(current_snap_tag)=
## [`current_snap_tag()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L173)
...
(decode_child_ref)=
## [`decode_child_ref()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L4238)
...
(decode_parent_ref)=
## [`decode_parent_ref()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L4184)
...
(node_collapsed_view)=
## [`node_collapsed_view()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L9467)
...
(parse_hooks)=
## [`parse_hooks()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L2356)
...
(parse_schema)=
## [`parse_schema()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L2268)
...
(parse_schema_cols)=
## [`parse_schema_cols()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L2303)
...
(set_volatil_values)=
## [`set_volatil_values()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L3349)
...
## [`treedb_activate_snap()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L13850)
...
(treedb_autolink)=
## [`treedb_autolink()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L8529)
...
(treedb_clean_node)=
## [`treedb_clean_node()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L8456)
...
(treedb_close_db)=
## [`treedb_close_db()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L1351)
...
(treedb_close_topic)=
## [`treedb_close_topic()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L1827)
...
(treedb_create_node)=
## [`treedb_create_node()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L5417)
...
|---|---|
| `uuid` | A random UUID. |
| `rowid` | One past every id the topic ever handed out. An id is never reused, not even after its node is deleted: a snap's id rides the records it tagged. The counter lives in the topic's `topic_var.json` (`last_rowid_id`) and survives a `topic_version` change, which re-creates that file from the schema. |
...
(treedb_create_topic)=
## [`treedb_create_topic()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L1470)
...
## [`treedb_delete_instance()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L6859)
...
(treedb_delete_node)=
## [`treedb_delete_node()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L6372)
...
(treedb_delete_topic)=
## [`treedb_delete_topic()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L1877)
...
(treedb_get_id_index)=
## [`treedb_get_id_index()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L300)
...
(treedb_get_instance)=
## [`treedb_get_instance()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L9408)
...
(treedb_get_node)=
## [`treedb_get_node()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L9365)
...
## [`treedb_get_topic_hooks()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L10752)
...
## [`treedb_get_topic_links()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L10711)
...
## [`treedb_is_treedbs_topic()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L285)
...
(treedb_link_nodes)=
## [`treedb_link_nodes()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L8976)
...
## [`treedb_list_instances()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L9740)
...
(treedb_list_nodes)=
## [`treedb_list_nodes()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L9599)
...
(treedb_list_parents)=
## [`treedb_list_parents()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L10215)
...
(treedb_list_snaps)=
## [`treedb_list_snaps()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L13968)
...
(treedb_list_treedb)=
## [`treedb_list_treedb()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L1932)
...
## [`treedb_node_children()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L10464)
...
(treedb_node_jtree)=
## [`treedb_node_jtree()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L10636)
...
(treedb_open_db)=
## [`treedb_open_db()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L610)
...
([`treedb_schema_yuneta_agent.c`](https://github.com/artgins/yunetas/blob/7.24.0/yunos/c/yuno_agent/src/treedb_schema_yuneta_agent.c)):
...
(treedb_parent_refs)=
## [`treedb_parent_refs()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L10125)
...
## [`treedb_replace_links()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L8825)
...
(treedb_save_node)=
## [`treedb_save_node()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L6000)
...
(treedb_set_callback)=
## [`treedb_set_callback()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L1306)
...
## [`treedb_set_node_immutable()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L6121)
...
(treedb_set_trace)=
## [`treedb_set_trace()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L5084)
...
(treedb_shoot_snap)=
## [`treedb_shoot_snap()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L13646)
...
(treedb_topic_pkey2s)=
## [`treedb_topic_pkey2s()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L186)
...
## [`treedb_topic_pkey2s_filter()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L201)
...
## [`treedb_create_system_schema()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L493)
...
(treedb_topic_size)=
## [`treedb_topic_size()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L2014)
...
(treedb_topics)=
## [`treedb_topics()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L1965)
...
(treedb_unlink_nodes)=
## [`treedb_unlink_nodes()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L9064)
...
(treedb_update_node)=
## [`treedb_update_node()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L6172)
...
(get_hook_list)=
## [`get_hook_list()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L5094)
...
## [`topic_desc_fkey_names()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L2577)
...
## [`topic_desc_hook_names()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/timeranger2/src/tr_treedb.c#L2552)
