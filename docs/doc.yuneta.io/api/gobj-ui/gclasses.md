...
### [`register_c_yui_shell()`](https://github.com/artgins/gobj-ui.js/blob/7.23.135/src/c_yui_shell.js#L3108)
...
### [`register_c_yui_nav()`](https://github.com/artgins/gobj-ui.js/blob/7.23.135/src/c_yui_nav.js#L1030)
...
### [`register_c_yui_pager()`](https://github.com/artgins/gobj-ui.js/blob/7.23.135/src/c_yui_pager.js#L540)

`C_YUI_PAGER` holds a stack of pages inside one zone, for a movement that goes
in and returns.

(js_register_c_yui_wizard)=
### [`register_c_yui_wizard()`](https://github.com/artgins/gobj-ui.js/blob/7.23.135/src/c_yui_wizard.js#L609)

`C_YUI_WIZARD` drives a sequence of steps with a way forward and a way back.

(js_register_c_yui_service_view)=
### [`register_c_yui_service_view()`](https://github.com/artgins/gobj-ui.js/blob/7.23.135/src/c_yui_service_view.js#L353)

`C_YUI_SERVICE_VIEW` puts a view of a service in a zone of the shell.

(js_yui_mount_service_view)=
### [`yui_mount_service_view(host, spec)`](https://github.com/artgins/gobj-ui.js/blob/7.23.135/src/c_yui_service_view.js#L147)

Puts a view of a service in a host, from a description of it.

(js_expose_view_container)=
### [`expose_view_container(host, view)`](https://github.com/artgins/gobj-ui.js/blob/7.23.135/src/c_yui_service_view.js#L210)
...
### [`register_c_yui_window()`](https://github.com/artgins/gobj-ui.js/blob/7.23.135/src/c_yui_window.js#L1266)

`C_YUI_WINDOW` draws a window that floats above the application.

(js_register_c_yui_window_manager)=
### [`register_c_yui_window_manager()`](https://github.com/artgins/gobj-ui.js/blob/7.23.135/src/c_yui_window_manager.js#L655)
...
### [`register_c_yui_form()`](https://github.com/artgins/gobj-ui.js/blob/7.23.135/src/c_yui_form.js#L3450)
...
### [`register_c_yui_json()`](https://github.com/artgins/gobj-ui.js/blob/7.23.135/src/c_yui_json.js#L1458)
...
### [`register_c_yui_json_graph()`](https://github.com/artgins/gobj-ui.js/blob/7.23.135/src/c_yui_json_graph.js#L2542)

`C_YUI_JSON_GRAPH` draws a JSON value as a graph.

(js_register_c_yui_period)=
### [`register_c_yui_period()`](https://github.com/artgins/gobj-ui.js/blob/7.23.135/src/c_yui_period.js#L1462)
...
### [`register_c_yui_treedb_topics()`](https://github.com/artgins/gobj-ui.js/blob/7.23.135/src/c_yui_treedb_topics.js#L2526)

`C_YUI_TREEDB_TOPICS` draws the topics of a treedb as cards, with a panel of
information.

(js_register_c_yui_treedb_graph)=
### [`register_c_yui_treedb_graph()`](https://github.com/artgins/gobj-ui.js/blob/7.23.135/src/c_yui_treedb_graph.js#L3261)
...
### [`register_c_yui_treedb_schema()`](https://github.com/artgins/gobj-ui.js/blob/7.23.135/src/c_yui_treedb_schema.js#L820)
...
### [`register_c_yui_schema_editor()`](https://github.com/artgins/gobj-ui.js/blob/7.23.135/src/c_yui_schema_editor.js#L3525)
...
### [`register_c_yui_treedb_topic_with_form()`](https://github.com/artgins/gobj-ui.js/blob/7.23.135/src/c_yui_treedb_topic_with_form.js#L4417)

`C_YUI_TREEDB_TOPIC_WITH_FORM` draws one topic with the form of its records.

(js_register_c_g6_nodes_tree)=
### [`register_c_g6_nodes_tree()`](https://github.com/artgins/gobj-ui.js/blob/7.23.135/src/c_g6_nodes_tree.js#L11484)
...
### [`register_c_yui_gobj_tree_js()`](https://github.com/artgins/gobj-ui.js/blob/7.23.135/src/c_yui_gobj_tree_js.js#L2992)

`C_YUI_GOBJ_TREE_JS` draws the tree of the gobjs of the application, for a
development panel.

(js_register_c_yui_gclass)=
### [`register_c_yui_gclass()`](https://github.com/artgins/gobj-ui.js/blob/7.23.135/src/c_yui_gclass.js#L1535)
...
### [`register_c_yui_fsm_graph()`](https://github.com/artgins/gobj-ui.js/blob/7.23.135/src/c_yui_fsm_graph.js#L1004)
...
### [`register_c_yui_uplot()`](https://github.com/artgins/gobj-ui.js/blob/7.23.135/src/c_yui_uplot.js#L598)

`C_YUI_UPLOT` draws a chart of a series of time with the library uPlot.

(js_register_c_yui_map)=
### [`register_c_yui_map()`](https://github.com/artgins/gobj-ui.js/blob/7.23.135/src/c_yui_map.js#L1102)
