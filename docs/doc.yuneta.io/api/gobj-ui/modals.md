...
**Source code:** [`src/shell_modals.js`](https://github.com/artgins/gobj-ui.js/blob/7.23.13/src/shell_modals.js)
...
### [`yui_shell_show_info(shell, message, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.23.13/src/shell_modals.js#L166)

Shows a message of information.

(js_yui_shell_show_warning)=
### [`yui_shell_show_warning(shell, message, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.23.13/src/shell_modals.js#L170)

Shows a warning.

(js_yui_shell_show_error)=
### [`yui_shell_show_error(shell, message, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.23.13/src/shell_modals.js#L174)
...
## [`yui_shell_show_modal(shell, content, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.23.13/src/shell_modals.js#L189)
...
### [`yui_shell_confirm_ok(shell, message, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.23.13/src/shell_modals.js#L544)
...
### [`yui_shell_confirm_yesno(shell, message, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.23.13/src/shell_modals.js#L555)
...
### [`yui_shell_confirm_yesnocancel(shell, message, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.23.13/src/shell_modals.js#L592)
...
### [`yui_shell_confirm_danger(shell, message, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.23.13/src/shell_modals.js#L579)
