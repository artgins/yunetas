...
(get_attrs_schema)=
## [`get_attrs_schema()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6592)
...
## [`get_sdata_flag_table()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6569)
...
(gobj2json)=
## [`gobj2json()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L7326)
...
(gobj_command_desc)=
## [`gobj_command_desc()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6544)
...
(gobj_full_name)=
## [`gobj_full_name()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6156)
...
(gobj_gclass)=
## [`gobj_gclass()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6147)
...
(gobj_gclass_name)=
## [`gobj_gclass_name()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6138)
...
## [`gobj_global_variables()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6226)
...
## [`gobj_add_global_variable()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6281)
...
(gobj_is_destroying)=
## [`gobj_is_destroying()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6316)
...
(gobj_is_disabled)=
## [`gobj_is_disabled()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6381)
...
(gobj_is_playing)=
## [`gobj_is_playing()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6340)
...
(gobj_is_pure_child)=
## [`gobj_is_pure_child()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6434)
...
(gobj_is_running)=
## [`gobj_is_running()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6328)
...
(gobj_is_service)=
## [`gobj_is_service()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6353)
...
(gobj_is_volatil)=
## [`gobj_is_volatil()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6392)
...
(gobj_name)=
## [`gobj_name()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6129)
...
(gobj_parent)=
## [`gobj_parent()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6305)
...
(gobj_priv_data)=
## [`gobj_priv_data()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6297)
...
## [`gobj_set_manual_start()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6419)
...
(gobj_set_volatil)=
## [`gobj_set_volatil()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6404)
...
(gobj_short_name)=
## [`gobj_short_name()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6203)
...
(gobj_typeof_gclass)=
## [`gobj_typeof_gclass()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6458)
...
## [`gobj_typeof_inherited_gclass()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6470)
...
(gobj_view_tree)=
## [`gobj_view_tree()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L7500)
...
(gobj_yuno)=
## [`gobj_yuno()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6036)
...
(gobj_yuno_id)=
## [`gobj_yuno_id()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6061)
...
(gobj_yuno_name)=
## [`gobj_yuno_name()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6047)
...
## [`gobj_yuno_node_owner()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6118)
...
(gobj_yuno_realm_env)=
## [`gobj_yuno_realm_env()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6111)
...
(gobj_yuno_realm_id)=
## [`gobj_yuno_realm_id()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6083)
...
## [`gobj_yuno_realm_name()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6104)
...
## [`gobj_yuno_realm_owner()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6090)
...
## [`gobj_yuno_realm_role()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6097)
...
(gobj_yuno_role)=
## [`gobj_yuno_role()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6054)
...
## [`gobj_yuno_role_plus_name()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6075)
...
(gobj_yuno_tag)=
## [`gobj_yuno_tag()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6068)
...
(gobj_audit_commands)=
## [`gobj_audit_commands()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L4983)
...
(gobj_is_bottom_gobj)=
## [`gobj_is_bottom_gobj()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6446)
...
(gobj_is_top_service)=
## [`gobj_is_top_service()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L6367)
...
## [`gobj_kw_get_user_data()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L3797)
...
## [`gobj_nearest_top_service()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L5238)
...
(gobj_top_services)=
## [`gobj_top_services()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/gobj.c#L1476)
