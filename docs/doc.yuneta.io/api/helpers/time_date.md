...
(current_timestamp)=
## [`current_timestamp()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L5284)
...
(date_mode_from_type)=
## [`date_mode_from_type()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L3665)
...
(date_overflows)=
## [`date_overflows()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L4832)
...
(datestamp)=
## [`datestamp()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L4384)
...
(formatdate)=
## [`formatdate()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L5643)
...
(htonll)=
## [`htonll()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L5495)
...
(list_open_files)=
## [`list_open_files()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L5525)
...
(ntohll)=
## [`ntohll()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L5510)
...
(parse_date)=
## [`parse_date()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L4316)
...
(parse_date_basic)=
## [`parse_date_basic()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L4222)
...
(parse_date_format)=
## [`parse_date_format()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L4354)
...
(parse_expiry_date)=
## [`parse_expiry_date()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L4294)
...
(show_date)=
## [`show_date()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L3674)
...
(show_date_relative)=
## [`show_date_relative()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L3588)
...
(start_msectimer)=
## [`start_msectimer()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L5358)
...
(start_sectimer)=
## [`start_sectimer()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L5329)
...
(t2timestamp)=
## [`t2timestamp()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L5310)
...
(test_msectimer)=
## [`test_msectimer()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L5368)
...
(test_sectimer)=
## [`test_sectimer()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L5341)
...
(time_in_seconds)=
## [`time_in_seconds()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L5408)
...
(tm2timestamp)=
## [`tm2timestamp()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L5301)
...
(tm_to_time_t)=
## [`tm_to_time_t()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L3464)
...
(get_days_range)=
## [`get_days_range()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L7701)
...
(get_hours_range)=
## [`get_hours_range()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L7669)
...
(get_months_range)=
## [`get_months_range()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L7777)
...
(get_weeks_range)=
## [`get_weeks_range()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L7732)
...
(get_years_range)=
## [`get_years_range()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L7808)
...
(gmtime2timezone)=
## [`gmtime2timezone()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L5587)
...
## [`time_in_milliseconds()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L5395)
...
## [`time_in_milliseconds_monotonic()`](https://github.com/artgins/yunetas/blob/7.17.3/kernel/c/gobj-c/src/helpers.c#L5383)
