...
- **`main` branch** (the v2 line, tag `2.0.0`+, npm `7.25.16`) — **active
...
versioned to track `YUNETA_VERSION` (SDK `7.25.4`, package **`7.25.2`** on npm since 2026-09-24)
...
ahead: `yunos/js/*` are on `^7.25.2`, wattyzer's gui on `^7.22.2` (2026-09-24). Check
