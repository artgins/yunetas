...
- [`ytls.c`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/ytls/src/ytls.c) /
  [`ytls.h`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/ytls/src/ytls.h)
- [`openssl.c`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/ytls/src/tls/openssl.c) /
  [`openssl.h`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/ytls/src/tls/openssl.h)
- [`mbedtls.c`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/ytls/src/tls/mbedtls.c) /
  [`mbedtls.h`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/ytls/src/tls/mbedtls.h)
...
(ytls_cleanup)=
## [`ytls_cleanup()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/ytls/src/ytls.c#L95)
...
## [`ytls_reload_certificates()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/ytls/src/ytls.c#L104)
...
(ytls_decrypt_data)=
## [`ytls_decrypt_data()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/ytls/src/ytls.c#L213)
...
(ytls_do_handshake)=
## [`ytls_do_handshake()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/ytls/src/ytls.c#L189)
...
(ytls_encrypt_data)=
## [`ytls_encrypt_data()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/ytls/src/ytls.c#L199)
...
(ytls_flush)=
## [`ytls_flush()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/ytls/src/ytls.c#L244)
...
## [`ytls_free_secure_filter()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/ytls/src/ytls.c#L180)
...
(ytls_get_cert_info)=
## [`ytls_get_cert_info()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/ytls/src/ytls.c#L119)
...
(ytls_get_last_error)=
## [`ytls_get_last_error()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/ytls/src/ytls.c#L226)
...
(ytls_init)=
## [`ytls_init()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/ytls/src/ytls.c#L36)
...
## [`ytls_new_secure_filter()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/ytls/src/ytls.c#L144)
...
(ytls_set_trace)=
## [`ytls_set_trace()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/ytls/src/ytls.c#L235)
...
(ytls_shutdown)=
## [`ytls_shutdown()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/ytls/src/ytls.c#L171)
...
(ytls_version)=
## [`ytls_version()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/ytls/src/ytls.c#L135)
...
(openssl_api_tls)=
## [`openssl_api_tls()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/ytls/src/tls/openssl.c#L1512)
...
(mbed_api_tls)=
## [`mbed_api_tls()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/ytls/src/tls/mbedtls.c#L1421)
