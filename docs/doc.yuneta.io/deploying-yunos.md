...
|------|------------|----------------|
| [`yunetas`](yunetas-cli.md) | The CLI that manages and builds (`pipx install yunetas`). It is the front end for everything below. | [`utils/python/tui_yunetas`](https://github.com/artgins/yunetas/tree/7.9.9/utils/python/tui_yunetas) (git submodule, published on PyPI) |
