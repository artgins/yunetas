...
- [`rotatory.h`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/rotatory.h)
- [`rotatory.c`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/rotatory.c)

(rotatory_close)=
## [`rotatory_close()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/rotatory.c#L280)
...
(rotatory_end)=
## [`rotatory_end()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/rotatory.c#L109)
...
(rotatory_flush)=
## [`rotatory_flush()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/rotatory.c#L392)
...
(rotatory_fwrite)=
## [`rotatory_fwrite()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/rotatory.c#L351)
...
(rotatory_open)=
## [`rotatory_open()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/rotatory.c#L122)
...
(rotatory_path)=
## [`rotatory_path()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/rotatory.c#L652)
...
(rotatory_start_up)=
## [`rotatory_start_up()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/rotatory.c#L91)
...
(rotatory_write)=
## [`rotatory_write()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/rotatory.c#L318)
...
## [`rotatory_subscribe2newfile()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/rotatory.c#L303)
...
(rotatory_truncate)=
## [`rotatory_truncate()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/rotatory.c#L375)
