...
(comm_prot_free)=
## [`comm_prot_free()`](https://github.com/artgins/yunetas/blob/7.18.1/kernel/c/gobj-c/src/helpers.c#L5986)
...
## [`comm_prot_get_gclass()`](https://github.com/artgins/yunetas/blob/7.18.1/kernel/c/gobj-c/src/helpers.c#L5959)
...
(comm_prot_register)=
## [`comm_prot_register()`](https://github.com/artgins/yunetas/blob/7.18.1/kernel/c/gobj-c/src/helpers.c#L5930)
...
(get_peername)=
## [`get_peername()`](https://github.com/artgins/yunetas/blob/7.18.1/kernel/c/gobj-c/src/helpers.c#L6917)
...
(get_sockname)=
## [`get_sockname()`](https://github.com/artgins/yunetas/blob/7.18.1/kernel/c/gobj-c/src/helpers.c#L6936)
...
(is_tcp_socket)=
## [`is_tcp_socket()`](https://github.com/artgins/yunetas/blob/7.18.1/kernel/c/gobj-c/src/helpers.c#L6845)
...
(is_udp_socket)=
## [`is_udp_socket()`](https://github.com/artgins/yunetas/blob/7.18.1/kernel/c/gobj-c/src/helpers.c#L6862)
...
## [`print_socket_address()`](https://github.com/artgins/yunetas/blob/7.18.1/kernel/c/gobj-c/src/helpers.c#L6879)
...
## [`set_tcp_socket_options()`](https://github.com/artgins/yunetas/blob/7.18.1/kernel/c/gobj-c/src/helpers.c#L6816)
