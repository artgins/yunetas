...
(get_url_schema)=
## [`get_url_schema()`](https://github.com/artgins/yunetas/blob/7.9.8/kernel/c/gobj-c/src/helpers.c#L6318)
...
(parse_url)=
## [`parse_url()`](https://github.com/artgins/yunetas/blob/7.9.8/kernel/c/gobj-c/src/helpers.c#L6187)
