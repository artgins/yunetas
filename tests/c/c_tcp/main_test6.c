 ...
 *          MAIN.C
 *
 *          Test: C_TCP, the stop of a client that is already disconnected
 *          publishes EV_STOPPED, and a start after it leaks nothing.
 *          See c_test6.c.
 *
 ...
 *                      Names
 ***************************************************************************/
#define APP_NAME        "test_tcp_" "test6"
#define APP_DOC         "Test C_TCP: the stop of a client already disconnected"
