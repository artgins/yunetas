...
(current_timestamp)=
## [`current_timestamp()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/gobj-c/src/helpers.c#L5860)
...
(date_mode_from_type)=
## [`date_mode_from_type()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/gobj-c/src/helpers.c#L4241)
...
(date_overflows)=
## [`date_overflows()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/gobj-c/src/helpers.c#L5408)
...
(datestamp)=
## [`datestamp()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/gobj-c/src/helpers.c#L4960)
...
(formatdate)=
## [`formatdate()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/gobj-c/src/helpers.c#L6219)
...
(htonll)=
## [`htonll()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/gobj-c/src/helpers.c#L6071)
...
(list_open_files)=
## [`list_open_files()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/gobj-c/src/helpers.c#L6101)
...
(ntohll)=
## [`ntohll()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/gobj-c/src/helpers.c#L6086)
...
(parse_date)=
## [`parse_date()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/gobj-c/src/helpers.c#L4892)
...
(parse_date_basic)=
## [`parse_date_basic()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/gobj-c/src/helpers.c#L4798)
...
(parse_date_format)=
## [`parse_date_format()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/gobj-c/src/helpers.c#L4930)
...
(parse_expiry_date)=
## [`parse_expiry_date()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/gobj-c/src/helpers.c#L4870)
...
(show_date)=
## [`show_date()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/gobj-c/src/helpers.c#L4250)
...
(show_date_relative)=
## [`show_date_relative()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/gobj-c/src/helpers.c#L4164)
...
(start_msectimer)=
## [`start_msectimer()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/gobj-c/src/helpers.c#L5934)
...
(start_sectimer)=
## [`start_sectimer()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/gobj-c/src/helpers.c#L5905)
...
(t2timestamp)=
## [`t2timestamp()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/gobj-c/src/helpers.c#L5886)
...
(test_msectimer)=
## [`test_msectimer()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/gobj-c/src/helpers.c#L5944)
...
(test_sectimer)=
## [`test_sectimer()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/gobj-c/src/helpers.c#L5917)
...
(time_in_seconds)=
## [`time_in_seconds()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/gobj-c/src/helpers.c#L5984)
...
(tm2timestamp)=
## [`tm2timestamp()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/gobj-c/src/helpers.c#L5877)
...
(tm_to_time_t)=
## [`tm_to_time_t()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/gobj-c/src/helpers.c#L4040)
...
(get_days_range)=
## [`get_days_range()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/gobj-c/src/helpers.c#L8277)
...
(get_hours_range)=
## [`get_hours_range()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/gobj-c/src/helpers.c#L8245)
...
(get_months_range)=
## [`get_months_range()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/gobj-c/src/helpers.c#L8353)
...
(get_weeks_range)=
## [`get_weeks_range()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/gobj-c/src/helpers.c#L8308)
...
(get_years_range)=
## [`get_years_range()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/gobj-c/src/helpers.c#L8384)
...
(gmtime2timezone)=
## [`gmtime2timezone()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/gobj-c/src/helpers.c#L6163)
...
## [`time_in_milliseconds()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/gobj-c/src/helpers.c#L5971)
...
## [`time_in_milliseconds_monotonic()`](https://github.com/artgins/yunetas/blob/7.25.6/kernel/c/gobj-c/src/helpers.c#L5959)
