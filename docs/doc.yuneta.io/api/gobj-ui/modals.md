...
**Source code:** [`src/shell_modals.js`](https://github.com/artgins/gobj-ui.js/blob/7.23.196/src/shell_modals.js)
...
### [`yui_shell_show_info(shell, message, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.23.196/src/shell_modals.js#L169)

Shows a message of information.

(js_yui_shell_show_warning)=
### [`yui_shell_show_warning(shell, message, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.23.196/src/shell_modals.js#L173)

Shows a warning.

(js_yui_shell_show_error)=
### [`yui_shell_show_error(shell, message, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.23.196/src/shell_modals.js#L177)
...
## [`yui_shell_show_modal(shell, content, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.23.196/src/shell_modals.js#L192)
...
### [`yui_shell_confirm_ok(shell, message, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.23.196/src/shell_modals.js#L556)
...
### [`yui_shell_confirm_yesno(shell, message, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.23.196/src/shell_modals.js#L567)
...
### [`yui_shell_confirm_yesnocancel(shell, message, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.23.196/src/shell_modals.js#L604)
...
### [`yui_shell_confirm_danger(shell, message, opts)`](https://github.com/artgins/gobj-ui.js/blob/7.23.196/src/shell_modals.js#L591)
