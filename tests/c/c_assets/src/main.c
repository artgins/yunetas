...
static int register_yuno_and_more(void)
{
    ...
    set_expected_results(
        ...
        json_pack("[{s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}, {s:s}]",
            ...
            /*  case 7a: gc-assets with a snap active is refused, and still
             *  sweeps the blob no row names  */
            "msg", "gc refused: a snap is active, the nodes in memory are its photo and not the live links (deactivate it first)",
