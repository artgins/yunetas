...
(js_GObj)=
## [`GObj`](https://github.com/artgins/gobj-js/blob/7.22.0/src/gobj.js#L202)
...
(js_gclass_create)=
## [`gclass_create()`](https://github.com/artgins/gobj-js/blob/7.22.0/src/gobj.js#L1186)
...
(js_gclass_flag_t)=
## [`gclass_flag_t`](https://github.com/artgins/gobj-js/blob/7.22.0/src/gobj.js#L248)
...
## [`gclass_find_by_name(gclass_name, verbose)`](https://github.com/artgins/gobj-js/blob/7.22.0/src/gobj.js#L1559)
...
## [`gclass_unregister(gclass)`](https://github.com/artgins/gobj-js/blob/7.22.0/src/gobj.js#L1300)

Takes a gclass out of the register. It accepts the gclass or its name.

(js_gclass_check_fsm)=
## [`gclass_check_fsm(gclass)`](https://github.com/artgins/gobj-js/blob/7.22.0/src/gobj.js#L1466)
...
(js_gclass_add_state)=
### [`gclass_add_state(gclass, state_name)`](https://github.com/artgins/gobj-js/blob/7.22.0/src/gobj.js#L1363)

Adds one state.

(js_gclass_add_ev_action)=
### [`gclass_add_ev_action(gclass, state_name, event_name, action, next_state)`](https://github.com/artgins/gobj-js/blob/7.22.0/src/gobj.js#L1383)

Adds one row of `(event, action, next state)` to a state.

(js_gclass_add_event_type)=
### [`gclass_add_event_type(gclass, event_name, event_flag)`](https://github.com/artgins/gobj-js/blob/7.22.0/src/gobj.js#L1430)

Adds one event to the list of the events of the gclass.

(js_gclass_event_type)=
### [`gclass_event_type(gclass, event_name)`](https://github.com/artgins/gobj-js/blob/7.22.0/src/gobj.js#L1443)
