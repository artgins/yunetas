...
`treedb_name`. Up to 7.25.4 and after, the open did nothing and answered `0`,
and neither said anything. Open and close a treedb with the commands, which
