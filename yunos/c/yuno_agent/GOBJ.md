...
| `mt_authz_checker`           | Inside [`gobj_user_has_authz`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/gobj-c/src/gobj.c#L9400) if installed ([gobj.c:9400](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/gobj-c/src/gobj.c#L9400))       | Per-gclass authz hook — see [`YUNO_AUTH.md`](YUNO_AUTH.md) §4.3   |

The full table (28+ slots — [`mt_create_resource`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/root-linux/src/c_resource2.c#L206), [`mt_save_resource`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/root-linux/src/c_resource2.c#L310),
[`mt_create_node`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/root-linux/src/c_node.c#L733), [`mt_link_nodes`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/root-linux/src/c_node.c#L1076), etc.) is in [`gobj.h`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/gobj-c/src/gobj.h). Most
...
`static json_t *cached` leaks at [`gobj_end`](https://github.com/artgins/yunetas/blob/7.5.2/kernel/c/gobj-c/src/gobj.c#L613) under
