...
- [`rotatory.h`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/rotatory.h)
- [`rotatory.c`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/rotatory.c)
...
(rotatory_close)=
## [`rotatory_close()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/rotatory.c#L350)
...
(rotatory_end)=
## [`rotatory_end()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/rotatory.c#L149)
...
(rotatory_flush)=
## [`rotatory_flush()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/rotatory.c#L526)
...
(rotatory_fwrite)=
## [`rotatory_fwrite()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/rotatory.c#L480)
...
(rotatory_open)=
## [`rotatory_open()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/rotatory.c#L162)
...
## [`rotatory_keep_all_old_files()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/rotatory.c#L416)
...
(rotatory_path)=
## [`rotatory_path()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/rotatory.c#L1198)
...
## [`rotatory_remove_old_files()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/rotatory.c#L1274)
...
(rotatory_start_up)=
## [`rotatory_start_up()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/rotatory.c#L131)
...
(rotatory_write)=
## [`rotatory_write()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/rotatory.c#L431)
...
## [`rotatory_subscribe2newfile()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/rotatory.c#L397)
...
(rotatory_truncate)=
## [`rotatory_truncate()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/rotatory.c#L507)
