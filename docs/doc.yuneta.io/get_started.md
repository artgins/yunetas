...
**Current version: [7.25.5](https://github.com/artgins/yunetas/tree/7.25.5)** ·
...
- [Installation](installation.md) — system prerequisites, the apt dependency
  list, and the one-time environment setup ([`menuconfig`](installation.md#configure-menuconfig), [`yunetas-env.sh`](https://github.com/artgins/yunetas/blob/7.25.5/yunetas-env.sh),
