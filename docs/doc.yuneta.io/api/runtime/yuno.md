...
(yuno_event_loop)=
## [`yuno_event_loop()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/root-linux/src/c_yuno.c#L5898)
...
(yuno_event_destroy)=
## [`yuno_event_destroy()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/root-linux/src/c_yuno.c#L5906)
...
(set_yuno_must_die)=
## [`set_yuno_must_die()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/root-linux/src/c_yuno.c#L5917)
...
(is_ip_allowed)=
## [`is_ip_allowed()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/root-linux/src/c_yuno.c#L5936)
...
(is_ip_denied)=
## [`is_ip_denied()`](https://github.com/artgins/yunetas/blob/7.24.0/kernel/c/root-linux/src/c_yuno.c#L5979)
