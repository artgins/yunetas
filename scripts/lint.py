...
"""
Linter for the Yunetas Kconfig files. Pass --help to see
...
def modules_file_dir():
    ...
    run((os.path.join("scripts", "yunetas_module.py"),
...
def run(cmd, cwd=TOP_DIR, check=True):
    ...
    # the working directory. It defaults to the top-level Yunetas directory.
    ...
    # https://github.com/yunetasproject-rtos/esp-idf/pull/2
