...
(js_createElement2)=
## [`createElement2()`](https://github.com/artgins/gobj-js/blob/7.25.1/src/helpers.js#L3192)
...
(js_createOneHtml)=
### [`createOneHtml(htmlString)`](https://github.com/artgins/gobj-js/blob/7.25.1/src/helpers.js#L3003)

Builds one element from a string of HTML.

(js_parseSVG)=
### [`parseSVG(string)`](https://github.com/artgins/gobj-js/blob/7.25.1/src/helpers.js#L3328)

Builds an SVG element from a string of SVG code.

(js_getPositionRelativeToBody)=
### [`getPositionRelativeToBody(element)`](https://github.com/artgins/gobj-js/blob/7.25.1/src/helpers.js#L3300)
...
(js_escapeHtml)=
### [`escapeHtml(str)`](https://github.com/artgins/gobj-js/blob/7.25.1/src/helpers.js#L2970)
...
(js_safeSrc)=
### [`safeSrc(url)`](https://github.com/artgins/gobj-js/blob/7.25.1/src/helpers.js#L2988)
...
(js_refresh_language)=
## [`refresh_language()`](https://github.com/artgins/gobj-js/blob/7.25.1/src/helpers.js#L3336)
