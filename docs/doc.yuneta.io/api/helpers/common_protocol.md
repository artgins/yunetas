...
(comm_prot_free)=
## [`comm_prot_free()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L6562)
...
## [`comm_prot_get_gclass()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L6535)
...
(comm_prot_register)=
## [`comm_prot_register()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L6506)
...
(get_peername)=
## [`get_peername()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L7493)
...
(get_sockname)=
## [`get_sockname()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L7512)
...
(is_tcp_socket)=
## [`is_tcp_socket()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L7421)
...
(is_udp_socket)=
## [`is_udp_socket()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L7438)
...
## [`print_socket_address()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L7455)
...
## [`set_tcp_socket_options()`](https://github.com/artgins/yunetas/blob/7.25.5/kernel/c/gobj-c/src/helpers.c#L7392)
