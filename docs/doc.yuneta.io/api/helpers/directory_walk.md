...
## [`get_ordered_filename_array()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L4024)
...
(walk_dir_tree)=
## [`walk_dir_tree()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L3631)
...
(dir_array_free)=
## [`dir_array_free()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L3686)
...
(dir_array_sort)=
## [`dir_array_sort()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L3893)
...
## [`find_files_with_suffix_array()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L3732)
...
(walk_dir_array)=
## [`walk_dir_array()`](https://github.com/artgins/yunetas/blob/7.25.7/kernel/c/gobj-c/src/helpers.c#L3945)
