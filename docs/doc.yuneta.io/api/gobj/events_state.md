...
(gobj_change_state)=
## [`gobj_change_state()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/gobj.c#L7725)
...
(gobj_current_state)=
## [`gobj_current_state()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/gobj.c#L7812)
...
(gobj_event_type)=
## [`gobj_event_type()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/gobj.c#L7894)
...
## [`gobj_event_type_by_name()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/gobj.c#L7946)
...
(gobj_has_event)=
## [`gobj_has_event()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/gobj.c#L7857)
...
## [`gobj_has_output_event()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/gobj.c#L7873)
...
(gobj_has_state)=
## [`gobj_has_state()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/gobj.c#L7843)
...
(gobj_in_this_state)=
## [`gobj_in_this_state()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/gobj.c#L7831)
...
(gobj_send_event)=
## [`gobj_send_event()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/gobj.c#L7441)
...
## [`gobj_find_event_type()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/gobj.c#L993)
...
## [`gobj_send_event_to_children()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/gobj.c#L7673)
...
## [`gobj_send_event_to_children_tree()`](https://github.com/artgins/yunetas/blob/7.5.3/kernel/c/gobj-c/src/gobj.c#L7699)
