...
SDATAPM (DTP_STRING,    "gobj_name",    0,              0,          "named-gobj or full gobj name"),
SDATAPM (DTP_STRING,    "gobj",         0,              "__yuno__", "named-gobj or full gobj name"),
SDATAPM (DTP_JSON,      "options",      0,              "[\"fullname\",\"state\",\"running\",\"playing\",\"service\", \"disabled\",\"gobj_trace_level\",\"gobj_trace_no_level\",\"bottom_gobj\"]",       "json list with strings, empty all"),
SDATA_END()
};
...
SDATA (DTP_LIST,    "required_services",SDF_RD,         "[]",           "Required services"),
