...
(ghttp_parser_create)=
## [`ghttp_parser_create()`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/root-linux/src/ghttp_parser.c#L63)
...
## [`ghttp_parser_destroy()`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/root-linux/src/ghttp_parser.c#L107)
...
## [`ghttp_parser_received()`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/root-linux/src/ghttp_parser.c#L136)
...
(ghttp_parser_finish)=
## [`ghttp_parser_finish()`](https://github.com/artgins/yunetas/blob/7.7.2/kernel/c/root-linux/src/ghttp_parser.c#L198)
