/****************************************************************************
 *          MAIN_TEST4_REFRESH.C
 *
 *          Self-contained auth_bff test: /auth/refresh happy path.
 *
 *          Same topology as main_test1_login.  The driver C_TEST4_REFRESH
 *          posts /auth/refresh with a Cookie header carrying a fake
 *          refresh_token; the mock Keycloak accepts any value and
 *          returns its default 200 envelope.
 *
 ...
 *                      Names
 ***************************************************************************/
#define APP_NAME        "test_auth_bff_test4_refresh"
#define APP_DOC         "Self-contained auth_bff /auth/refresh happy path"
...
{                                                                   \n\
    ...
    'services': [                                                   \n\
        {                                                           \n\
            'name': 'c_test4_refresh',                              \n\
            'gclass': 'C_TEST4_REFRESH',                            \n\
